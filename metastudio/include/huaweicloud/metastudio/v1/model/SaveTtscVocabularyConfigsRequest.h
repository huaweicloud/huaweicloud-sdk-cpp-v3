...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_SaveTtscVocabularyConfigsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_SaveTtscVocabularyConfigsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  SaveTtscVocabularyConfigsRequest
    : public ModelBase
{
public:
    SaveTtscVocabularyConfigsRequest();
    virtual ~SaveTtscVocabularyConfigsRequest();
    ...
    /////////////////////////////////////////////
    /// SaveTtscVocabularyConfigsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    SaveTtscVocabularyConfigsRequest& dereference_from_shared_ptr(std::shared_ptr<SaveTtscVocabularyConfigsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_SaveTtscVocabularyConfigsRequest_H_
