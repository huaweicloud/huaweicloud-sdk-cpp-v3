...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CommitAction_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CommitAction_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  CommitAction
    : public ModelBase
{
public:
    CommitAction();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CommitAction_H_
