...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelSimpleDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelSimpleDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  LabelSimpleDto
    : public ModelBase
{
public:
    LabelSimpleDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelSimpleDto_H_
