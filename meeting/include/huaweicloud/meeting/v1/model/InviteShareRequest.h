...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_InviteShareRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_InviteShareRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  InviteShareRequest
    : public ModelBase
{
public:
    InviteShareRequest();
    virtual ~InviteShareRequest();
    ...
    InviteShareDTO getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const InviteShareDTO& value);
...
protected:
    ...
    InviteShareDTO body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    InviteShareRequest& dereference_from_shared_ptr(std::shared_ptr<InviteShareRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_InviteShareRequest_H_
