...
bool ListInstancesResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("instances"))) {
        ...
        {
            std::vector<InstanceResponse> refVal;
...
std::vector<InstanceResponse>& ListInstancesResponse::getInstances()
{
    return instances_;
}

void ListInstancesResponse::setInstances(const std::vector<InstanceResponse>& value)
{
    instances_ = value;
