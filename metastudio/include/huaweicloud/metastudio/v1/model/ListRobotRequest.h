...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListRobotRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListRobotRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListRobotRequest
    : public ModelBase
{
public:
    ListRobotRequest();
    virtual ~ListRobotRequest();
    ...
    void unsetrobotType();
    void setRobotType(const std::string& value);
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListRobotRequest& dereference_from_shared_ptr(std::shared_ptr<ListRobotRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListRobotRequest_H_
