...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_ListAddonTemplatesRequest_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_ListAddonTemplatesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  ListAddonTemplatesRequest
    : public ModelBase
{
public:
    ListAddonTemplatesRequest();
    virtual ~ListAddonTemplatesRequest();
    ...
    /////////////////////////////////////////////
    /// ListAddonTemplatesRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListAddonTemplatesRequest& dereference_from_shared_ptr(std::shared_ptr<ListAddonTemplatesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_ListAddonTemplatesRequest_H_
