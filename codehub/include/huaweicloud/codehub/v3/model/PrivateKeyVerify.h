...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_PrivateKeyVerify_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_PrivateKeyVerify_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  PrivateKeyVerify
    : public ModelBase
{
public:
    PrivateKeyVerify();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_PrivateKeyVerify_H_
