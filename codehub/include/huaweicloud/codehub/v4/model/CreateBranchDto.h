...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CreateBranchDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CreateBranchDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  CreateBranchDto
    : public ModelBase
{
public:
    CreateBranchDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CreateBranchDto_H_
