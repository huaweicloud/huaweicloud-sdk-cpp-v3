...
#ifndef HUAWEICLOUD_SDK_VOD_V1_MODEL_VideoTypeRef_H_
#define HUAWEICLOUD_SDK_VOD_V1_MODEL_VideoTypeRef_H_
...
/// 
/// </summary>
class HUAWEICLOUD_VOD_V1_EXPORT  VideoTypeRef
    : public ModelBase
{
public:
    VideoTypeRef();
    virtual ~VideoTypeRef();
...
#endif // HUAWEICLOUD_SDK_VOD_V1_MODEL_VideoTypeRef_H_
