...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListDocumentSegmentRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListDocumentSegmentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListDocumentSegmentRequest
    : public ModelBase
{
public:
    ListDocumentSegmentRequest();
    virtual ~ListDocumentSegmentRequest();
    ...
    /////////////////////////////////////////////
    /// ListDocumentSegmentRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDocumentSegmentRequest& dereference_from_shared_ptr(std::shared_ptr<ListDocumentSegmentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListDocumentSegmentRequest_H_
