...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchCorpExternalDirRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchCorpExternalDirRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SearchCorpExternalDirRequest
    : public ModelBase
{
public:
    SearchCorpExternalDirRequest();
    virtual ~SearchCorpExternalDirRequest();
    ...
    /////////////////////////////////////////////
    /// SearchCorpExternalDirRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    SearchCorpExternalDirRequest& dereference_from_shared_ptr(std::shared_ptr<SearchCorpExternalDirRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchCorpExternalDirRequest_H_
