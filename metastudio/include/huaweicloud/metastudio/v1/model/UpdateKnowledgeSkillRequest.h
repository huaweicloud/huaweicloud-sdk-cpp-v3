...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateKnowledgeSkillRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateKnowledgeSkillRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateKnowledgeSkillRequest
    : public ModelBase
{
public:
    UpdateKnowledgeSkillRequest();
    virtual ~UpdateKnowledgeSkillRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateKnowledgeSkillRequest members
    ...
    UpdateKnowledgeSkillReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateKnowledgeSkillReq& value);
...
protected:
    ...
    std::string skillId_;
    bool skillIdIsSet_;
    UpdateKnowledgeSkillReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateKnowledgeSkillRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateKnowledgeSkillRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateKnowledgeSkillRequest_H_
