...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_RepoDailyCodeline_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_RepoDailyCodeline_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  RepoDailyCodeline
    : public ModelBase
{
public:
    RepoDailyCodeline();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_RepoDailyCodeline_H_
