...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInteractionRuleGroupsSummaryRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInteractionRuleGroupsSummaryRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListInteractionRuleGroupsSummaryRequest
    : public ModelBase
{
public:
    ListInteractionRuleGroupsSummaryRequest();
    virtual ~ListInteractionRuleGroupsSummaryRequest();
    ...
    /////////////////////////////////////////////
    /// ListInteractionRuleGroupsSummaryRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListInteractionRuleGroupsSummaryRequest& dereference_from_shared_ptr(std::shared_ptr<ListInteractionRuleGroupsSummaryRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInteractionRuleGroupsSummaryRequest_H_
