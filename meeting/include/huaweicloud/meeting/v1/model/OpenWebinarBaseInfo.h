...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenWebinarBaseInfo_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenWebinarBaseInfo_H_
...
/// 网络研讨会信息。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  OpenWebinarBaseInfo
    : public ModelBase
{
public:
    OpenWebinarBaseInfo();
    virtual ~OpenWebinarBaseInfo();
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenWebinarBaseInfo_H_
