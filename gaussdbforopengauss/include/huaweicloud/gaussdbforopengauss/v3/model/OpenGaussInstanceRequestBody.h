...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_OpenGaussInstanceRequestBody_H_
...
/// 实例信息
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  OpenGaussInstanceRequestBody
    : public ModelBase
{
public:
    OpenGaussInstanceRequestBody();
    virtual ~OpenGaussInstanceRequestBody();
    ...
    /////////////////////////////////////////////
    /// OpenGaussInstanceRequestBody members
    ...
    OpenGaussDatastoreOption getDatastore() const;
    bool datastoreIsSet() const;
    void unsetdatastore();
    void setDatastore(const OpenGaussDatastoreOption& value);
...
protected:
    std::string name_;
    bool nameIsSet_;
    OpenGaussDatastoreOption datastore_;
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_OpenGaussInstanceRequestBody_H_
