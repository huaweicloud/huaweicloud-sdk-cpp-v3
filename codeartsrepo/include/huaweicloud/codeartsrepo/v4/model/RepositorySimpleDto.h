...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositorySimpleDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositorySimpleDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  RepositorySimpleDto
    : public ModelBase
{
public:
    RepositorySimpleDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositorySimpleDto_H_
