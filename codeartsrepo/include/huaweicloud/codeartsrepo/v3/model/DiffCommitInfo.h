...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_DiffCommitInfo_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_DiffCommitInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  DiffCommitInfo
    : public ModelBase
{
public:
    DiffCommitInfo();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_DiffCommitInfo_H_
