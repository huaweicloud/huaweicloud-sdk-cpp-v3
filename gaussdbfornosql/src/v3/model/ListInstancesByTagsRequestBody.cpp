...
std::vector<MatchOption>& ListInstancesByTagsRequestBody::getMatches()
{
    return matches_;
}

void ListInstancesByTagsRequestBody::setMatches(const std::vector<MatchOption>& value)
{
    matches_ = value;
    matchesIsSet_ = true;
}
...
std::vector<TagOption>& ListInstancesByTagsRequestBody::getTags()
{
    return tags_;
}

void ListInstancesByTagsRequestBody::setTags(const std::vector<TagOption>& value)
{
    tags_ = value;
    tagsIsSet_ = true;
}
