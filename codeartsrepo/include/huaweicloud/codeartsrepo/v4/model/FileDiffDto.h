...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_FileDiffDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_FileDiffDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  FileDiffDto
    : public ModelBase
{
public:
    FileDiffDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_FileDiffDto_H_
