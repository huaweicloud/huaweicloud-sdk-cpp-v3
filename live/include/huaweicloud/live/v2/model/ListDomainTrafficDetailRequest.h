...
#ifndef HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListDomainTrafficDetailRequest_H_
#define HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListDomainTrafficDetailRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_LIVE_V2_EXPORT  ListDomainTrafficDetailRequest
    : public ModelBase
{
public:
    ListDomainTrafficDetailRequest();
    virtual ~ListDomainTrafficDetailRequest();
    ...
    /////////////////////////////////////////////
    /// ListDomainTrafficDetailRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDomainTrafficDetailRequest& dereference_from_shared_ptr(std::shared_ptr<ListDomainTrafficDetailRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListDomainTrafficDetailRequest_H_
