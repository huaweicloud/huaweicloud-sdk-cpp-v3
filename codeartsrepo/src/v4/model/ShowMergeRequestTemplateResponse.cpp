...
MergeRequestTemplateFromDto ShowMergeRequestTemplateResponse::getFrom() const
{
    return from_;
}

void ShowMergeRequestTemplateResponse::setFrom(const MergeRequestTemplateFromDto& value)
{
    from_ = value;
    fromIsSet_ = true;
}

bool ShowMergeRequestTemplateResponse::fromIsSet() const
{
    return fromIsSet_;
}

void ShowMergeRequestTemplateResponse::unsetfrom()
{
    fromIsSet_ = false;
}
