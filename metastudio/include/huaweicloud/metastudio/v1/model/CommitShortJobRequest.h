...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CommitShortJobRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CommitShortJobRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CommitShortJobRequest
    : public ModelBase
{
public:
    CommitShortJobRequest();
    virtual ~CommitShortJobRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    CommitShortJobRequest& dereference_from_shared_ptr(std::shared_ptr<CommitShortJobRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CommitShortJobRequest_H_
