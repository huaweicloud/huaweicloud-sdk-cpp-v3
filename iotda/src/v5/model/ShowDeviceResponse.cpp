...
std::vector<ModuleDTO>& ShowDeviceResponse::getModules()
{
    return modules_;
}

void ShowDeviceResponse::setModules(const std::vector<ModuleDTO>& value)
{
    modules_ = value;
    modulesIsSet_ = true;
}

bool ShowDeviceResponse::modulesIsSet() const
{
    return modulesIsSet_;
}

void ShowDeviceResponse::unsetmodules()
{
    modulesIsSet_ = false;
}
