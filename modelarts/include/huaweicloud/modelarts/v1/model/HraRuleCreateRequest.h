...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_HraRuleCreateRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_HraRuleCreateRequest_H_
...
/// HRA规则
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  HraRuleCreateRequest
    : public ModelBase
{
public:
    HraRuleCreateRequest();
    virtual ~HraRuleCreateRequest();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_HraRuleCreateRequest_H_
