...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListEngines_items_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListEngines_items_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ListEngines_items
    : public ModelBase
{
public:
    ListEngines_items();
    virtual ~ListEngines_items();
    ...
    ListEngines_image_info getImageInfo() const;
    bool imageInfoIsSet() const;
    void unsetimageInfo();
    void setImageInfo(const ListEngines_image_info& value);
...
protected:
    ...
    std::string runUser_;
    bool runUserIsSet_;
    ListEngines_image_info imageInfo_;
    bool imageInfoIsSet_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListEngines_items_H_
