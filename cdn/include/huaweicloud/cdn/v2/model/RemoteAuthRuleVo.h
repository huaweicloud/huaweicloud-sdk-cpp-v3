...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_RemoteAuthRuleVo_H_
...
/// 远程鉴权配置。
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  RemoteAuthRuleVo
    : public ModelBase
{
public:
    RemoteAuthRuleVo();
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_RemoteAuthRuleVo_H_
