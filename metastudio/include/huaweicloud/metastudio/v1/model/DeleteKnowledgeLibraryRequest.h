...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeLibraryRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeLibraryRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteKnowledgeLibraryRequest
    : public ModelBase
{
public:
    DeleteKnowledgeLibraryRequest();
    virtual ~DeleteKnowledgeLibraryRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteKnowledgeLibraryRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteKnowledgeLibraryRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteKnowledgeLibraryRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeLibraryRequest_H_
