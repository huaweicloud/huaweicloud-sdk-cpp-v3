...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_MergeRequestsItem_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_MergeRequestsItem_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  MergeRequestsItem
    : public ModelBase
{
public:
    MergeRequestsItem();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_MergeRequestsItem_H_
