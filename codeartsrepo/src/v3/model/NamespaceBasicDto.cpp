...
#include "huaweicloud/codeartsrepo/v3/model/NamespaceBasicDto.h"
...
web::json::value NamespaceBasicDto::toJson() const
{
    ...
    if(cellIsSet_) {
        val[utility::conversions::to_string_t("cell")] = ModelBase::toJson(cell_);
    }
    if(kindIsSet_) {
...
bool NamespaceBasicDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("cell"))) {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("cell"));
        if(!fieldValue.is_null())
        {
            std::string refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
...
std::string NamespaceBasicDto::getRegion() const
{
    return region_;
}

void NamespaceBasicDto::setRegion(const std::string& value)
{
    region_ = value;
    regionIsSet_ = true;
}

bool NamespaceBasicDto::regionIsSet() const
{
    return regionIsSet_;
}

void NamespaceBasicDto::unsetregion()
{
    regionIsSet_ = false;
}

std::string NamespaceBasicDto::getCell() const
{
    return cell_;
}

void NamespaceBasicDto::setCell(const std::string& value)
{
    cell_ = value;
    cellIsSet_ = true;
}

bool NamespaceBasicDto::cellIsSet() const
{
    return cellIsSet_;
}

void NamespaceBasicDto::unsetcell()
{
    cellIsSet_ = false;
}
