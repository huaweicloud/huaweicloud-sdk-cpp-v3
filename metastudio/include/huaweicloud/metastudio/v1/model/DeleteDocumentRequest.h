...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteDocumentRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteDocumentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteDocumentRequest
    : public ModelBase
{
public:
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteDocumentRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteDocumentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteDocumentRequest_H_
