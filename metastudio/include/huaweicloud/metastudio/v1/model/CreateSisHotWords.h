...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateSisHotWords_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateSisHotWords_H_
...
/// sis类型热词
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateSisHotWords
    : public ModelBase
{
public:
    CreateSisHotWords();
    virtual ~CreateSisHotWords();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateSisHotWords_H_
