...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_RecycleInstanceV3_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_RecycleInstanceV3_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  RecycleInstanceV3
    : public ModelBase
{
public:
    RecycleInstanceV3();
    virtual ~RecycleInstanceV3();
    ...
    std::string getDataVipIpv6() const;
    bool dataVipIpv6IsSet() const;
    void unsetdataVipIpv6();
    void setDataVipIpv6(const std::string& value);
...
protected:
    ...
    std::string dataVip_;
    bool dataVipIsSet_;
    std::string dataVipIpv6_;
    bool dataVipIpv6IsSet_;
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_RecycleInstanceV3_H_
