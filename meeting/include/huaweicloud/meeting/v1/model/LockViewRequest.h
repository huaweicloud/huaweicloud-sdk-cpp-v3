...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_LockViewRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_LockViewRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  LockViewRequest
    : public ModelBase
{
public:
    LockViewRequest();
    virtual ~LockViewRequest();
    ...
    RestLockSiteViewReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestLockSiteViewReqBody& value);
...
protected:
    ...
    RestLockSiteViewReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    LockViewRequest& dereference_from_shared_ptr(std::shared_ptr<LockViewRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_LockViewRequest_H_
