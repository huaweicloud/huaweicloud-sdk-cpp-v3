...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_Partition_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_Partition_H_
...
/// <summary>
/// **参数解释**： 集群分区信息 **约束限制**： 不涉及 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  Partition
    : public ModelBase
{
public:
    Partition();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_Partition_H_
