...
#ifndef HUAWEICLOUD_SDK_ORGANIZATIONS_V1_MODEL_PageInfoDto_H_
#define HUAWEICLOUD_SDK_ORGANIZATIONS_V1_MODEL_PageInfoDto_H_
...
/// 分页信息
/// </summary>
class HUAWEICLOUD_ORGANIZATIONS_V1_EXPORT  PageInfoDto
    : public ModelBase
{
public:
    PageInfoDto();
...
#endif // HUAWEICLOUD_SDK_ORGANIZATIONS_V1_MODEL_PageInfoDto_H_
