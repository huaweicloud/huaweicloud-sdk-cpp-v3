...
#ifndef HUAWEICLOUD_SDK_EIP_V3_MODEL_PublicipUpdateResp_H_
#define HUAWEICLOUD_SDK_EIP_V3_MODEL_PublicipUpdateResp_H_
...
/// 公网IP字段信息
/// </summary>
class HUAWEICLOUD_EIP_V3_EXPORT  PublicipUpdateResp
    : public ModelBase
{
public:
    PublicipUpdateResp();
...
#endif // HUAWEICLOUD_SDK_EIP_V3_MODEL_PublicipUpdateResp_H_
