...
web::json::value ChargeInfo::toJson() const
{
    ...
    if(promotionInfosIsSet_) {
        val[utility::conversions::to_string_t("promotion_infos")] = ModelBase::toJson(promotionInfos_);
    }
...
bool ChargeInfo::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("promotion_infos"))) {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("promotion_infos"));
        if(!fieldValue.is_null())
        {
            std::string refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
            setPromotionInfos(refVal);
        }
    }
    return ok;
}
...
std::string ChargeInfo::getPromotionInfos() const
{
    return promotionInfos_;
}

void ChargeInfo::setPromotionInfos(const std::string& value)
{
    promotionInfos_ = value;
    promotionInfosIsSet_ = true;
}

bool ChargeInfo::promotionInfosIsSet() const
{
    return promotionInfosIsSet_;
}

void ChargeInfo::unsetpromotionInfos()
{
    promotionInfosIsSet_ = false;
}
