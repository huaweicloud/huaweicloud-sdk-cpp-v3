...
web::json::value ListEnterpriseProjectsRequest::toJson() const
{
    ...
    if(nameKeywordIsSet_) {
        val[utility::conversions::to_string_t("name_keyword")] = ModelBase::toJson(nameKeyword_);
    }
    if(offsetIsSet_) {
...
bool ListEnterpriseProjectsRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("name_keyword"))) {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("name_keyword"));
        if(!fieldValue.is_null())
        {
            std::string refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
            setNameKeyword(refVal);
        }
    }
...
std::string ListEnterpriseProjectsRequest::getNameKeyword() const
{
    return nameKeyword_;
}

void ListEnterpriseProjectsRequest::setNameKeyword(const std::string& value)
{
    nameKeyword_ = value;
    nameKeywordIsSet_ = true;
}

bool ListEnterpriseProjectsRequest::nameKeywordIsSet() const
{
    return nameKeywordIsSet_;
}

void ListEnterpriseProjectsRequest::unsetnameKeyword()
{
    nameKeywordIsSet_ = false;
}
