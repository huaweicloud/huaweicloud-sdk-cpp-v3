...
#ifndef HUAWEICLOUD_SDK_IOTDM_V5_MODEL_UpdateInstanceResponse_H_
#define HUAWEICLOUD_SDK_IOTDM_V5_MODEL_UpdateInstanceResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_IOTDM_V5_EXPORT  UpdateInstanceResponse
    : public ModelBase, public HttpResponse
{
public:
    UpdateInstanceResponse();
    virtual ~UpdateInstanceResponse();
    ...
    /////////////////////////////////////////////
    /// UpdateInstanceResponse members
    ...
    std::vector<AccessInfo>& getAccessInfos();
    bool accessInfosIsSet() const;
    void unsetaccessInfos();
    void setAccessInfos(const std::vector<AccessInfo>& value);
    ...
    AdditionalParamsResp getAdditionalParams() const;
    bool additionalParamsIsSet() const;
    void unsetadditionalParams();
    void setAdditionalParams(const AdditionalParamsResp& value);
...
protected:
    ...
    std::vector<AccessInfo> accessInfos_;
    bool accessInfosIsSet_;
    ...
    AdditionalParamsResp additionalParams_;
...
#endif // HUAWEICLOUD_SDK_IOTDM_V5_MODEL_UpdateInstanceResponse_H_
