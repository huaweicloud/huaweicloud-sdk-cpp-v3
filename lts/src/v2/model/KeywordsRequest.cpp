...
CustomDate KeywordsRequest::getCustomDate() const
{
    return customDate_;
}

void KeywordsRequest::setCustomDate(const CustomDate& value)
{
    customDate_ = value;
    customDateIsSet_ = true;
}

bool KeywordsRequest::customDateIsSet() const
{
    return customDateIsSet_;
}

void KeywordsRequest::unsetcustomDate()
{
    customDateIsSet_ = false;
}

bool KeywordsRequest::isIsTimeRangeRelative() const
{
    return isTimeRangeRelative_;
}

void KeywordsRequest::setIsTimeRangeRelative(bool value)
{
    isTimeRangeRelative_ = value;
    isTimeRangeRelativeIsSet_ = true;
}

bool KeywordsRequest::isTimeRangeRelativeIsSet() const
{
    return isTimeRangeRelativeIsSet_;
}

void KeywordsRequest::unsetisTimeRangeRelative()
{
    isTimeRangeRelativeIsSet_ = false;
}
