...
#ifndef HUAWEICLOUD_SDK_LIVE_V2_MODEL_V2FramerateInfo_H_
#define HUAWEICLOUD_SDK_LIVE_V2_MODEL_V2FramerateInfo_H_
...
/// 实时帧率
/// </summary>
class HUAWEICLOUD_LIVE_V2_EXPORT  V2FramerateInfo
    : public ModelBase
{
public:
    V2FramerateInfo();
    virtual ~V2FramerateInfo();
...
#endif // HUAWEICLOUD_SDK_LIVE_V2_MODEL_V2FramerateInfo_H_
