...
#ifndef HUAWEICLOUD_SDK_GEIP_V3_MODEL_ShowGlobalEipSegment_H_
#define HUAWEICLOUD_SDK_GEIP_V3_MODEL_ShowGlobalEipSegment_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GEIP_V3_EXPORT  ShowGlobalEipSegment
    : public ModelBase
{
public:
    ShowGlobalEipSegment();
    virtual ~ShowGlobalEipSegment();
