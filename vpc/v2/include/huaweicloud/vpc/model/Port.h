...
#include "huaweicloud/vpc/model/AllowedAddressPair.h"
#include <string>
#include "huaweicloud/vpc/model/ExtraDhcpOpt.h"
#include "huaweicloud/vpc/model/FixedIp.h"
#include <vector>
#include "huaweicloud/vpc/model/DnsAssignMent.h"
...
/// 
/// </summary>
class HUAWEICLOUD_VPC_EXPORT  Port
    : public ModelBase
{
public:
    Port();
