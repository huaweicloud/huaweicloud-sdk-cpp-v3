...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartChatJobRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartChatJobRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowSmartChatJobRequest
    : public ModelBase
{
public:
    ShowSmartChatJobRequest();
    virtual ~ShowSmartChatJobRequest();
    ...
    /////////////////////////////////////////////
    /// ShowSmartChatJobRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowSmartChatJobRequest& dereference_from_shared_ptr(std::shared_ptr<ShowSmartChatJobRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartChatJobRequest_H_
