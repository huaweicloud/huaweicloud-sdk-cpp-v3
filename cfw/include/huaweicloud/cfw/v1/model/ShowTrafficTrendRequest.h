...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_ShowTrafficTrendRequest_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_ShowTrafficTrendRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  ShowTrafficTrendRequest
    : public ModelBase
{
public:
    ShowTrafficTrendRequest();
    virtual ~ShowTrafficTrendRequest();
    ...
    /////////////////////////////////////////////
    /// ShowTrafficTrendRequest members
    ...
    bool aggTypeIsSet() const;
    void unsetaggType();
    void setAggType(const std::string& value);
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowTrafficTrendRequest& dereference_from_shared_ptr(std::shared_ptr<ShowTrafficTrendRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_ShowTrafficTrendRequest_H_
