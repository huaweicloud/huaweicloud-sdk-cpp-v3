...
std::string UpdateCoverByThumbnailRequest::getAuthorization() const
{
    return authorization_;
}

void UpdateCoverByThumbnailRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool UpdateCoverByThumbnailRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void UpdateCoverByThumbnailRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
