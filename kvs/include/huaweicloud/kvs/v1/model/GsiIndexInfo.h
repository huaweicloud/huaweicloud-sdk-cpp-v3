...
#ifndef HUAWEICLOUD_SDK_KVS_V1_MODEL_GsiIndexInfo_H_
#define HUAWEICLOUD_SDK_KVS_V1_MODEL_GsiIndexInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_KVS_V1_EXPORT  GsiIndexInfo
    : public ModelBase
{
public:
    GsiIndexInfo();
    virtual ~GsiIndexInfo();
...
#endif // HUAWEICLOUD_SDK_KVS_V1_MODEL_GsiIndexInfo_H_
