...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryMemberDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryMemberDto_H_
...
/// 仓库成员详情
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  RepositoryMemberDto
    : public ModelBase
{
public:
    RepositoryMemberDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryMemberDto_H_
