...
#ifndef HUAWEICLOUD_SDK_GA_V1_MODEL_ListHealthChecksRequest_H_
#define HUAWEICLOUD_SDK_GA_V1_MODEL_ListHealthChecksRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GA_V1_EXPORT  ListHealthChecksRequest
    : public ModelBase
{
public:
    ListHealthChecksRequest();
    virtual ~ListHealthChecksRequest();
    ...
    /////////////////////////////////////////////
    /// ListHealthChecksRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListHealthChecksRequest& dereference_from_shared_ptr(std::shared_ptr<ListHealthChecksRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GA_V1_MODEL_ListHealthChecksRequest_H_
