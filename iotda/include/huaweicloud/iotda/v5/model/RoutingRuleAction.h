...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_RoutingRuleAction_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_RoutingRuleAction_H_
...
/// 创建或修改规则动作响应结构体
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  RoutingRuleAction
    : public ModelBase
{
public:
    RoutingRuleAction();
    virtual ~RoutingRuleAction();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_RoutingRuleAction_H_
