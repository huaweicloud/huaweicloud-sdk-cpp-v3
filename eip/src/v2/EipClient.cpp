...
std::shared_ptr<AddPublicipsIntoSharedBandwidthResponse> EipClient::addPublicipsIntoSharedBandwidth(AddPublicipsIntoSharedBandwidthRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForAddPublicipsIntoSharedBandwidth());
...
std::shared_ptr<BatchCreateSharedBandwidthsResponse> EipClient::batchCreateSharedBandwidths(BatchCreateSharedBandwidthsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForBatchCreateSharedBandwidths());
...
std::shared_ptr<BatchModifyBandwidthResponse> EipClient::batchModifyBandwidth(BatchModifyBandwidthRequest &request)
{
    std::string localVarPath = "/v2/{project_id}/batch-bandwidths/modify";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForBatchModifyBandwidth());

    std::shared_ptr<BatchModifyBandwidthResponse> localVarResult = std::make_shared<BatchModifyBandwidthResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ChangeBandwidthToPeriodResponse> EipClient::changeBandwidthToPeriod(ChangeBandwidthToPeriodRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForChangeBandwidthToPeriod());
...
std::shared_ptr<CreateSharedBandwidthResponse> EipClient::createSharedBandwidth(CreateSharedBandwidthRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForCreateSharedBandwidth());
...
std::shared_ptr<DeleteSharedBandwidthResponse> EipClient::deleteSharedBandwidth(DeleteSharedBandwidthRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForDeleteSharedBandwidth());
...
std::shared_ptr<ListBandwidthPkgResponse> EipClient::listBandwidthPkg(ListBandwidthPkgRequest &request)
{
    std::string localVarPath = "/v2/{project_id}/bandwidthpkgs";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForListBandwidthPkg());

    std::shared_ptr<ListBandwidthPkgResponse> localVarResult = std::make_shared<ListBandwidthPkgResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListBandwidthsResponse> EipClient::listBandwidths(ListBandwidthsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForListBandwidths());
...
std::shared_ptr<ListQuotasResponse> EipClient::listQuotas(ListQuotasRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForListQuotas());
...
std::shared_ptr<RemovePublicipsFromSharedBandwidthResponse> EipClient::removePublicipsFromSharedBandwidth(RemovePublicipsFromSharedBandwidthRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForRemovePublicipsFromSharedBandwidth());
...
std::shared_ptr<ShowBandwidthResponse> EipClient::showBandwidth(ShowBandwidthRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForShowBandwidth());
...
std::shared_ptr<UpdateBandwidthResponse> EipClient::updateBandwidth(UpdateBandwidthRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForUpdateBandwidth());
...
std::shared_ptr<UpdatePrePaidBandwidthResponse> EipClient::updatePrePaidBandwidth(UpdatePrePaidBandwidthRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForUpdatePrePaidBandwidth());
...
std::shared_ptr<BatchCreatePublicipTagsResponse> EipClient::batchCreatePublicipTags(BatchCreatePublicipTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForBatchCreatePublicipTags());
...
std::shared_ptr<BatchCreatePublicipsResponse> EipClient::batchCreatePublicips(BatchCreatePublicipsRequest &request)
{
    std::string localVarPath = "/v2/{project_id}/batchpublicips";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForBatchCreatePublicips());

    std::shared_ptr<BatchCreatePublicipsResponse> localVarResult = std::make_shared<BatchCreatePublicipsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchDeletePublicIpResponse> EipClient::batchDeletePublicIp(BatchDeletePublicIpRequest &request)
{
    std::string localVarPath = "/v2/{project_id}/batchpublicips";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForBatchDeletePublicIp());

    std::shared_ptr<BatchDeletePublicIpResponse> localVarResult = std::make_shared<BatchDeletePublicIpResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchDeletePublicipTagsResponse> EipClient::batchDeletePublicipTags(BatchDeletePublicipTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForBatchDeletePublicipTags());
...
std::shared_ptr<BatchDisassociatePublicipsResponse> EipClient::batchDisassociatePublicips(BatchDisassociatePublicipsRequest &request)
{
    std::string localVarPath = "/v2/{project_id}/batchpublicips";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PATCH", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForBatchDisassociatePublicips());

    std::shared_ptr<BatchDisassociatePublicipsResponse> localVarResult = std::make_shared<BatchDisassociatePublicipsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ChangePublicipToPeriodResponse> EipClient::changePublicipToPeriod(ChangePublicipToPeriodRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForChangePublicipToPeriod());
...
std::shared_ptr<CountPublicIpResponse> EipClient::countPublicIp(CountPublicIpRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForCountPublicIp());

    std::shared_ptr<CountPublicIpResponse> localVarResult = std::make_shared<CountPublicIpResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<CountPublicIpInstanceResponse> EipClient::countPublicIpInstance(CountPublicIpInstanceRequest &request)
{
    std::string localVarPath = "/v2/{project_id}/publicip/instances";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForCountPublicIpInstance());

    std::shared_ptr<CountPublicIpInstanceResponse> localVarResult = std::make_shared<CountPublicIpInstanceResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<CreatePrePaidPublicipResponse> EipClient::createPrePaidPublicip(CreatePrePaidPublicipRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForCreatePrePaidPublicip());
...
std::shared_ptr<CreatePublicipResponse> EipClient::createPublicip(CreatePublicipRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForCreatePublicip());
...
std::shared_ptr<CreatePublicipTagResponse> EipClient::createPublicipTag(CreatePublicipTagRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForCreatePublicipTag());
...
std::shared_ptr<DeletePublicipResponse> EipClient::deletePublicip(DeletePublicipRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForDeletePublicip());
...
std::shared_ptr<DeletePublicipTagResponse> EipClient::deletePublicipTag(DeletePublicipTagRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForDeletePublicipTag());
...
std::shared_ptr<ListPublicipTagsResponse> EipClient::listPublicipTags(ListPublicipTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForListPublicipTags());
...
std::shared_ptr<ListPublicipsByTagsResponse> EipClient::listPublicipsByTags(ListPublicipsByTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForListPublicipsByTags());
...
std::shared_ptr<ShowPublicIpTypeResponse> EipClient::showPublicIpType(ShowPublicIpTypeRequest &request)
{
    std::string localVarPath = "/v2/{project_id}/publicip_types";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForShowPublicIpType());

    std::shared_ptr<ShowPublicIpTypeResponse> localVarResult = std::make_shared<ShowPublicIpTypeResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowPublicipTagsResponse> EipClient::showPublicipTags(ShowPublicipTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForShowPublicipTags());
...
std::shared_ptr<UpdatePublicipResponse> EipClient::updatePublicip(UpdatePublicipRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForUpdatePublicip());
...
std::shared_ptr<ShowResourcesJobDetailResponse> EipClient::showResourcesJobDetail(ShowResourcesJobDetailRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForShowResourcesJobDetail());
...
std::shared_ptr<NeutronCreateFloatingIpResponse> EipClient::neutronCreateFloatingIp(NeutronCreateFloatingIpRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForNeutronCreateFloatingIp());
...
std::shared_ptr<NeutronDeleteFloatingIpResponse> EipClient::neutronDeleteFloatingIp(NeutronDeleteFloatingIpRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForNeutronDeleteFloatingIp());
...
std::shared_ptr<NeutronListFloatingIpsResponse> EipClient::neutronListFloatingIps(NeutronListFloatingIpsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForNeutronListFloatingIps());
...
std::shared_ptr<NeutronShowFloatingIpResponse> EipClient::neutronShowFloatingIp(NeutronShowFloatingIpRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForNeutronShowFloatingIp());
...
std::shared_ptr<NeutronUpdateFloatingIpResponse> EipClient::neutronUpdateFloatingIp(NeutronUpdateFloatingIpRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, EipMeta::genRequestDefForNeutronUpdateFloatingIp());
