...
int32_t ChargeInfoResult::getPeriodNum() const
{
    return periodNum_;
}

void ChargeInfoResult::setPeriodNum(int32_t value)
{
    periodNum_ = value;
...
bool ChargeInfoResult::isIsAutoRenew() const
{
    return isAutoRenew_;
}

void ChargeInfoResult::setIsAutoRenew(bool value)
{
    isAutoRenew_ = value;
...
bool ChargeInfoResult::isIsAutoPay() const
{
    return isAutoPay_;
}

void ChargeInfoResult::setIsAutoPay(bool value)
{
    isAutoPay_ = value;
