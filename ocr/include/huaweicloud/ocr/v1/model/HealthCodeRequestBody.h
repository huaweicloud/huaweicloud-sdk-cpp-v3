...
#ifndef HUAWEICLOUD_SDK_OCR_V1_MODEL_HealthCodeRequestBody_H_
#define HUAWEICLOUD_SDK_OCR_V1_MODEL_HealthCodeRequestBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_OCR_V1_EXPORT  HealthCodeRequestBody
    : public ModelBase
{
public:
    HealthCodeRequestBody();
    virtual ~HealthCodeRequestBody();
...
#endif // HUAWEICLOUD_SDK_OCR_V1_MODEL_HealthCodeRequestBody_H_
