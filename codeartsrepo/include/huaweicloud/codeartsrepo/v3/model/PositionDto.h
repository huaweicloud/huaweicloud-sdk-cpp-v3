...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_PositionDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_PositionDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  PositionDto
    : public ModelBase
{
public:
    PositionDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_PositionDto_H_
