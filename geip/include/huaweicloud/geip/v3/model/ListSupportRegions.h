...
#ifndef HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListSupportRegions_H_
#define HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListSupportRegions_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GEIP_V3_EXPORT  ListSupportRegions
    : public ModelBase
{
public:
    ListSupportRegions();
    virtual ~ListSupportRegions();
    ...
    void setRemoteEndpoint(const std::string& value);
...
#endif // HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListSupportRegions_H_
