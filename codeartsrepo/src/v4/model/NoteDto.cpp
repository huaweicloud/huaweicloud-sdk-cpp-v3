...
std::string NoteDto::getRepository() const
{
    return repository_;
}

void NoteDto::setRepository(const std::string& value)
{
    repository_ = value;
    repositoryIsSet_ = true;
}

bool NoteDto::repositoryIsSet() const
{
    return repositoryIsSet_;
}

void NoteDto::unsetrepository()
{
    repositoryIsSet_ = false;
}
...
bool NoteDto::isFromRobot() const
{
    return fromRobot_;
}

void NoteDto::setFromRobot(bool value)
{
    fromRobot_ = value;
    fromRobotIsSet_ = true;
}

bool NoteDto::fromRobotIsSet() const
{
    return fromRobotIsSet_;
}

void NoteDto::unsetfromRobot()
{
    fromRobotIsSet_ = false;
}

bool NoteDto::isModerationResult() const
{
    return moderationResult_;
}

void NoteDto::setModerationResult(bool value)
{
    moderationResult_ = value;
    moderationResultIsSet_ = true;
}

bool NoteDto::moderationResultIsSet() const
{
    return moderationResultIsSet_;
}

void NoteDto::unsetmoderationResult()
{
    moderationResultIsSet_ = false;
}

int64_t NoteDto::getModerationTime() const
{
    return moderationTime_;
}

void NoteDto::setModerationTime(int64_t value)
{
    moderationTime_ = value;
    moderationTimeIsSet_ = true;
}

bool NoteDto::moderationTimeIsSet() const
{
    return moderationTimeIsSet_;
}

void NoteDto::unsetmoderationTime()
{
    moderationTimeIsSet_ = false;
}

int32_t NoteDto::getModerationStatus() const
{
    return moderationStatus_;
}

void NoteDto::setModerationStatus(int32_t value)
{
    moderationStatus_ = value;
    moderationStatusIsSet_ = true;
}

bool NoteDto::moderationStatusIsSet() const
{
    return moderationStatusIsSet_;
}

void NoteDto::unsetmoderationStatus()
{
    moderationStatusIsSet_ = false;
}
