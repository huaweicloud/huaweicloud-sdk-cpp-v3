...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowDeptAndChildDeptResponse_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowDeptAndChildDeptResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  ShowDeptAndChildDeptResponse
    : public ModelBase, public HttpResponse
{
public:
    ShowDeptAndChildDeptResponse();
    virtual ~ShowDeptAndChildDeptResponse();
    ...
    /////////////////////////////////////////////
    /// ShowDeptAndChildDeptResponse members
    ...
    std::vector<QueryDeptResultDTO>& getChildDepts();
    bool childDeptsIsSet() const;
    void unsetchildDepts();
    void setChildDepts(const std::vector<QueryDeptResultDTO>& value);
...
protected:
    ...
    std::vector<QueryDeptResultDTO> childDepts_;
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowDeptAndChildDeptResponse_H_
