...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LabelDetailDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LabelDetailDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  LabelDetailDto
    : public ModelBase
{
public:
    LabelDetailDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LabelDetailDto_H_
