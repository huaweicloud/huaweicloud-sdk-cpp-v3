...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateDocumentSegmentParamRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateDocumentSegmentParamRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateDocumentSegmentParamRequest
    : public ModelBase
{
public:
    UpdateDocumentSegmentParamRequest();
    virtual ~UpdateDocumentSegmentParamRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateDocumentSegmentParamRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    UpdateDocumentSegmentParamRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateDocumentSegmentParamRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateDocumentSegmentParamRequest_H_
