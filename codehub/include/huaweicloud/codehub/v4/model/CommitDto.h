...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitDto_H_
...
/// commit相关信息
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  CommitDto
    : public ModelBase
{
public:
    CommitDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitDto_H_
