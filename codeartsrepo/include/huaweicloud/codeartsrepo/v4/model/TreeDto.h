...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_TreeDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_TreeDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  TreeDto
    : public ModelBase
{
public:
    TreeDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_TreeDto_H_
