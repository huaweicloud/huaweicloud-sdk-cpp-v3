...
#ifndef HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_UpdateIssueV4Response_H_
#define HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_UpdateIssueV4Response_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_PROJECTMAN_V4_EXPORT  UpdateIssueV4Response
    : public ModelBase, public HttpResponse
{
public:
    UpdateIssueV4Response();
    virtual ~UpdateIssueV4Response();
    ...
    IssueResponseV4_order getOrder() const;
    bool orderIsSet() const;
    void unsetorder();
    void setOrder(const IssueResponseV4_order& value);
...
#endif // HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_UpdateIssueV4Response_H_
