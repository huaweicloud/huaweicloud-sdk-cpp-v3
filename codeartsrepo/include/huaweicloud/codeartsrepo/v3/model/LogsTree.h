...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_LogsTree_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_LogsTree_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  LogsTree
    : public ModelBase
{
public:
    LogsTree();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_LogsTree_H_
