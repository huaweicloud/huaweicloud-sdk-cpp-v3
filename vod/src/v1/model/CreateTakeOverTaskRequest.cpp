...
std::string CreateTakeOverTaskRequest::getAuthorization() const
{
    return authorization_;
}

void CreateTakeOverTaskRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool CreateTakeOverTaskRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void CreateTakeOverTaskRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
