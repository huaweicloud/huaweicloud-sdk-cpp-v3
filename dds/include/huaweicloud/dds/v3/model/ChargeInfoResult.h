...
#ifndef HUAWEICLOUD_SDK_DDS_V3_MODEL_ChargeInfoResult_H_
#define HUAWEICLOUD_SDK_DDS_V3_MODEL_ChargeInfoResult_H_
...
/// 付费方式信息，与请求参数相同。
/// </summary>
class HUAWEICLOUD_DDS_V3_EXPORT  ChargeInfoResult
    : public ModelBase
{
public:
    ChargeInfoResult();
...
#endif // HUAWEICLOUD_SDK_DDS_V3_MODEL_ChargeInfoResult_H_
