...
std::string ShowResourcesDetailResponseBody::getMode() const
{
    return mode_;
}

void ShowResourcesDetailResponseBody::setMode(const std::string& value)
{
    mode_ = value;
    modeIsSet_ = true;
}

bool ShowResourcesDetailResponseBody::modeIsSet() const
{
    return modeIsSet_;
}

void ShowResourcesDetailResponseBody::unsetmode()
{
    modeIsSet_ = false;
}
