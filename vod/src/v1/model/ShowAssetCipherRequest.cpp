...
std::string ShowAssetCipherRequest::getAuthorization() const
{
    return authorization_;
}

void ShowAssetCipherRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool ShowAssetCipherRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void ShowAssetCipherRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
