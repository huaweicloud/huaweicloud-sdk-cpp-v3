...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ContributorDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ContributorDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  ContributorDto
    : public ModelBase
{
public:
    ContributorDto();
    virtual ~ContributorDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ContributorDto_H_
