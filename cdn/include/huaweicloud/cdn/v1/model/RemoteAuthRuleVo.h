...
#ifndef HUAWEICLOUD_SDK_CDN_V1_MODEL_RemoteAuthRuleVo_H_
#define HUAWEICLOUD_SDK_CDN_V1_MODEL_RemoteAuthRuleVo_H_
...
/// 远程鉴权配置。
/// </summary>
class HUAWEICLOUD_CDN_V1_EXPORT  RemoteAuthRuleVo
    : public ModelBase
{
public:
    RemoteAuthRuleVo();
    virtual ~RemoteAuthRuleVo();
...
#endif // HUAWEICLOUD_SDK_CDN_V1_MODEL_RemoteAuthRuleVo_H_
