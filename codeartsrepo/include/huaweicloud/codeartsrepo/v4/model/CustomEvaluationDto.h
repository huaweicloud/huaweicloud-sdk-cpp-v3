...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CustomEvaluationDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CustomEvaluationDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  CustomEvaluationDto
    : public ModelBase
{
public:
    CustomEvaluationDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CustomEvaluationDto_H_
