...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_LtsLogSlowQueryRequest_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_LtsLogSlowQueryRequest_H_
...
/// 慢日志请求体。
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  LtsLogSlowQueryRequest
    : public ModelBase
{
public:
    LtsLogSlowQueryRequest();
    virtual ~LtsLogSlowQueryRequest();
    ...
    /////////////////////////////////////////////
    /// LtsLogSlowQueryRequest members
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_LtsLogSlowQueryRequest_H_
