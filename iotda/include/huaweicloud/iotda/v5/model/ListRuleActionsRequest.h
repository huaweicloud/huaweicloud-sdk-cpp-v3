...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListRuleActionsRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListRuleActionsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListRuleActionsRequest
    : public ModelBase
{
public:
    ListRuleActionsRequest();
    virtual ~ListRuleActionsRequest();
    ...
    /////////////////////////////////////////////
    /// ListRuleActionsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListRuleActionsRequest& dereference_from_shared_ptr(std::shared_ptr<ListRuleActionsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListRuleActionsRequest_H_
