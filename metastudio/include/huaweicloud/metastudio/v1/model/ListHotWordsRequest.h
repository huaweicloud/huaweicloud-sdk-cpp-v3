...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListHotWordsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListHotWordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListHotWordsRequest
    : public ModelBase
{
public:
    ListHotWordsRequest();
    virtual ~ListHotWordsRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListHotWordsRequest& dereference_from_shared_ptr(std::shared_ptr<ListHotWordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListHotWordsRequest_H_
