...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_CreateRuleReq_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_CreateRuleReq_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  CreateRuleReq
    : public ModelBase
{
public:
    CreateRuleReq();
    virtual ~CreateRuleReq();
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_CreateRuleReq_H_
