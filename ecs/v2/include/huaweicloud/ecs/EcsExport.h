...
#	if defined(HUAWEICLOUD_ECS_SHARED)
#		define HUAWEICLOUD_ECS_EXPORT HUAWEICLOUD_EXPORT
#	else
#		define HUAWEICLOUD_ECS_EXPORT HUAWEICLOUD_IMPORT
#	endif
#else
#	define HUAWEICLOUD_ECS_EXPORT
#endif
