...
bool CreatePolicyRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("body"))) {
        ...
        {
            CreatePolicyRequestBody refVal;
...
CreatePolicyRequestBody CreatePolicyRequest::getBody() const
{
    return body_;
}

void CreatePolicyRequest::setBody(const CreatePolicyRequestBody& value)
{
    body_ = value;
    bodyIsSet_ = true;
}
