...
#ifndef HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_Dependency_H_
#define HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_Dependency_H_
...
/// 函数依赖包结构。
/// </summary>
class HUAWEICLOUD_FUNCTIONGRAPH_V2_EXPORT  Dependency
    : public ModelBase
{
public:
    Dependency();
...
#endif // HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_Dependency_H_
