...
#ifndef HUAWEICLOUD_SDK_IMS_V2_MODEL_ImageInfo_H_
#define HUAWEICLOUD_SDK_IMS_V2_MODEL_ImageInfo_H_
...
/// 镜像信息响应体
/// </summary>
class HUAWEICLOUD_IMS_V2_EXPORT  ImageInfo
    : public ModelBase
{
public:
    ImageInfo();
...
#endif // HUAWEICLOUD_SDK_IMS_V2_MODEL_ImageInfo_H_
