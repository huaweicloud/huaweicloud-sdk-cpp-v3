...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_HstsQuery_H_
#define HUAWEICLOUD_SDK_CDN_V2_MODEL_HstsQuery_H_
...
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  HstsQuery
    : public ModelBase
{
public:
    HstsQuery();
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_HstsQuery_H_
