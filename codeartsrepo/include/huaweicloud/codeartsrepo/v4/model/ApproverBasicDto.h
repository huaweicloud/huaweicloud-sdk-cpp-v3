...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ApproverBasicDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ApproverBasicDto_H_
...
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  ApproverBasicDto
    : public ModelBase
{
public:
    ApproverBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ApproverBasicDto_H_
