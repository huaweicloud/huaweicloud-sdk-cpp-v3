...
#ifndef HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_AssociateIssueDetail_H_
#define HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_AssociateIssueDetail_H_
...
/// 关联工作项详情
/// </summary>
class HUAWEICLOUD_PROJECTMAN_V4_EXPORT  AssociateIssueDetail
    : public ModelBase
{
public:
    AssociateIssueDetail();
    virtual ~AssociateIssueDetail();
...
#endif // HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_AssociateIssueDetail_H_
