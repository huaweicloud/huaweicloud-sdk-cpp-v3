...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_DiffRefsParamDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_DiffRefsParamDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  DiffRefsParamDto
    : public ModelBase
{
public:
    DiffRefsParamDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_DiffRefsParamDto_H_
