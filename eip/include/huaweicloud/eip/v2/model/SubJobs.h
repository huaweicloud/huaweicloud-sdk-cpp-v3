...
#ifndef HUAWEICLOUD_SDK_EIP_V2_MODEL_SubJobs_H_
#define HUAWEICLOUD_SDK_EIP_V2_MODEL_SubJobs_H_
...
/// 
/// </summary>
class HUAWEICLOUD_EIP_V2_EXPORT  SubJobs
    : public ModelBase
{
public:
    SubJobs();
...
#endif // HUAWEICLOUD_SDK_EIP_V2_MODEL_SubJobs_H_
