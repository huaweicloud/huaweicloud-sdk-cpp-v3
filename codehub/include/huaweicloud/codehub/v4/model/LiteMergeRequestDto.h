...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LiteMergeRequestDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LiteMergeRequestDto_H_
...
/// 简化版MR信息展示
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  LiteMergeRequestDto
    : public ModelBase
{
public:
    LiteMergeRequestDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LiteMergeRequestDto_H_
