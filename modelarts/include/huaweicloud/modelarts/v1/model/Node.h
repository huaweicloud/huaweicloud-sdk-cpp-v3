...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Node_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Node_H_
...
/// 节点的数据模型。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  Node
    : public ModelBase
{
public:
    Node();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Node_H_
