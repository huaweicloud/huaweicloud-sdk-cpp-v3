...
#ifndef HUAWEICLOUD_SDK_DRS_V5_MODEL_CollectDbObjectsAsyncRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_DRS_V5_EXPORT  CollectDbObjectsAsyncRequest
    : public ModelBase
{
public:
    CollectDbObjectsAsyncRequest();
    virtual ~CollectDbObjectsAsyncRequest();
    ...
    /////////////////////////////////////////////
    /// CollectDbObjectsAsyncRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    CollectDbObjectsAsyncRequest& dereference_from_shared_ptr(std::shared_ptr<CollectDbObjectsAsyncRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_DRS_V5_MODEL_CollectDbObjectsAsyncRequest_H_
