...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ExecuteSmartLiveCommandRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ExecuteSmartLiveCommandRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ExecuteSmartLiveCommandRequest
    : public ModelBase
{
public:
    ExecuteSmartLiveCommandRequest();
    virtual ~ExecuteSmartLiveCommandRequest();
    ...
    /////////////////////////////////////////////
    /// ExecuteSmartLiveCommandRequest members
    ...
    ControlSmartLiveReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const ControlSmartLiveReq& value);
...
protected:
    ...
    ControlSmartLiveReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    ExecuteSmartLiveCommandRequest& dereference_from_shared_ptr(std::shared_ptr<ExecuteSmartLiveCommandRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ExecuteSmartLiveCommandRequest_H_
