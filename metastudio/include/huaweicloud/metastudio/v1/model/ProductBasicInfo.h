...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ProductBasicInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ProductBasicInfo_H_
...
/// 商品基本信息
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ProductBasicInfo
    : public ModelBase
{
public:
    ProductBasicInfo();
    virtual ~ProductBasicInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ProductBasicInfo_H_
