...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPluginConfigRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPluginConfigRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowPluginConfigRequest
    : public ModelBase
{
public:
    ShowPluginConfigRequest();
    virtual ~ShowPluginConfigRequest();
    ...
    /////////////////////////////////////////////
    /// ShowPluginConfigRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowPluginConfigRequest& dereference_from_shared_ptr(std::shared_ptr<ShowPluginConfigRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPluginConfigRequest_H_
