...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ChatVoiceConfig_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ChatVoiceConfig_H_
...
/// 语音配置参数
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ChatVoiceConfig
    : public ModelBase
{
public:
    ChatVoiceConfig();
    virtual ~ChatVoiceConfig();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ChatVoiceConfig_H_
