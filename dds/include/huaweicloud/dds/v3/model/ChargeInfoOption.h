...
#ifndef HUAWEICLOUD_SDK_DDS_V3_MODEL_ChargeInfoOption_H_
#define HUAWEICLOUD_SDK_DDS_V3_MODEL_ChargeInfoOption_H_
...
/// </summary>
class HUAWEICLOUD_DDS_V3_EXPORT  ChargeInfoOption
    : public ModelBase
{
public:
    ChargeInfoOption();
...
#endif // HUAWEICLOUD_SDK_DDS_V3_MODEL_ChargeInfoOption_H_
