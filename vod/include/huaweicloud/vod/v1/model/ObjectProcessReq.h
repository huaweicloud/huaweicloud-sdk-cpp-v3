...
#ifndef HUAWEICLOUD_SDK_VOD_V1_MODEL_ObjectProcessReq_H_
#define HUAWEICLOUD_SDK_VOD_V1_MODEL_ObjectProcessReq_H_
...
/// 
/// </summary>
class HUAWEICLOUD_VOD_V1_EXPORT  ObjectProcessReq
    : public ModelBase
{
public:
    ObjectProcessReq();
    virtual ~ObjectProcessReq();
...
#endif // HUAWEICLOUD_SDK_VOD_V1_MODEL_ObjectProcessReq_H_
