...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_SimpleDiffDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_SimpleDiffDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  SimpleDiffDto
    : public ModelBase
{
public:
    SimpleDiffDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_SimpleDiffDto_H_
