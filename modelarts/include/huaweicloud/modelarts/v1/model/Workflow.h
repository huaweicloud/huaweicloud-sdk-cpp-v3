...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Workflow_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Workflow_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  Workflow
    : public ModelBase
{
public:
    Workflow();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Workflow_H_
