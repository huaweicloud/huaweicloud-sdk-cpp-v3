...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_RemoteConstraint_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_RemoteConstraint_H_
...
/// 数据输入约束。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  RemoteConstraint
    : public ModelBase
{
public:
    RemoteConstraint();
    virtual ~RemoteConstraint();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_RemoteConstraint_H_
