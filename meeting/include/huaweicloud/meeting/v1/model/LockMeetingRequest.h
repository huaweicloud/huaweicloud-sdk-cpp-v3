...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_LockMeetingRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_LockMeetingRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  LockMeetingRequest
    : public ModelBase
{
public:
    LockMeetingRequest();
    virtual ~LockMeetingRequest();
    ...
    RestLockReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestLockReqBody& value);
...
protected:
    ...
    RestLockReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    LockMeetingRequest& dereference_from_shared_ptr(std::shared_ptr<LockMeetingRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_LockMeetingRequest_H_
