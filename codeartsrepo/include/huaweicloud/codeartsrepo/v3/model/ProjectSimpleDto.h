...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_ProjectSimpleDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_ProjectSimpleDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  ProjectSimpleDto
    : public ModelBase
{
public:
    ProjectSimpleDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_ProjectSimpleDto_H_
