...
public:
    ...
    bool isDetectTextDirection() const;
    bool detectTextDirectionIsSet() const;
    void unsetdetectTextDirection();
    void setDetectTextDirection(bool value);
...
protected:
    ...
    bool detectTextDirection_;
    bool detectTextDirectionIsSet_;
