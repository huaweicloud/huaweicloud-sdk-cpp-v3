...
#ifndef HUAWEICLOUD_SDK_VPC_V2_MODEL_AddRouteTableRoute_H_
#define HUAWEICLOUD_SDK_VPC_V2_MODEL_AddRouteTableRoute_H_
...
/// 新增路由条目的字段
/// </summary>
class HUAWEICLOUD_VPC_V2_EXPORT  AddRouteTableRoute
    : public ModelBase
{
public:
    AddRouteTableRoute();
    virtual ~AddRouteTableRoute();
...
#endif // HUAWEICLOUD_SDK_VPC_V2_MODEL_AddRouteTableRoute_H_
