...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsTriggerTimeRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsTriggerTimeRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowPacifyWordsTriggerTimeRequest
    : public ModelBase
{
public:
    ShowPacifyWordsTriggerTimeRequest();
    virtual ~ShowPacifyWordsTriggerTimeRequest();
    ...
    /////////////////////////////////////////////
    /// ShowPacifyWordsTriggerTimeRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowPacifyWordsTriggerTimeRequest& dereference_from_shared_ptr(std::shared_ptr<ShowPacifyWordsTriggerTimeRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsTriggerTimeRequest_H_
