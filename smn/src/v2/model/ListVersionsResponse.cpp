...
std::vector<VersionItem>& ListVersionsResponse::getVersions()
{
    return versions_;
}

void ListVersionsResponse::setVersions(const std::vector<VersionItem>& value)
{
    versions_ = value;
    versionsIsSet_ = true;
}
