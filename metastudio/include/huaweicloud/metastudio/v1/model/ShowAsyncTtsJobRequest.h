...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowAsyncTtsJobRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowAsyncTtsJobRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowAsyncTtsJobRequest
    : public ModelBase
{
public:
    ShowAsyncTtsJobRequest();
    virtual ~ShowAsyncTtsJobRequest();
    ...
    /////////////////////////////////////////////
    /// ShowAsyncTtsJobRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowAsyncTtsJobRequest& dereference_from_shared_ptr(std::shared_ptr<ShowAsyncTtsJobRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowAsyncTtsJobRequest_H_
