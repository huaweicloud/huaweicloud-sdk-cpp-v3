...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SetMmrLiveRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SetMmrLiveRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SetMmrLiveRequest
    : public ModelBase
{
public:
    SetMmrLiveRequest();
    virtual ~SetMmrLiveRequest();
    ...
    RestSetMmrLiveReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestSetMmrLiveReqBody& value);
...
protected:
    ...
    RestSetMmrLiveReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    SetMmrLiveRequest& dereference_from_shared_ptr(std::shared_ptr<SetMmrLiveRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SetMmrLiveRequest_H_
