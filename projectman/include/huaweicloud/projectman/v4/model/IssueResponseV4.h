...
#ifndef HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_IssueResponseV4_H_
#define HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_IssueResponseV4_H_
...
/// 工作项属性
/// </summary>
class HUAWEICLOUD_PROJECTMAN_V4_EXPORT  IssueResponseV4
    : public ModelBase
{
public:
    IssueResponseV4();
    virtual ~IssueResponseV4();
...
#endif // HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_IssueResponseV4_H_
