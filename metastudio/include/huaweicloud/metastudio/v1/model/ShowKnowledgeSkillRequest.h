...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeSkillRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeSkillRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowKnowledgeSkillRequest
    : public ModelBase
{
public:
    ShowKnowledgeSkillRequest();
    virtual ~ShowKnowledgeSkillRequest();
    ...
    /////////////////////////////////////////////
    /// ShowKnowledgeSkillRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowKnowledgeSkillRequest& dereference_from_shared_ptr(std::shared_ptr<ShowKnowledgeSkillRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeSkillRequest_H_
