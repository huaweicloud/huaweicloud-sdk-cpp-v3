...
std::string ShowAssetResponse::getBlockReasonCode() const
{
    return blockReasonCode_;
}

void ShowAssetResponse::setBlockReasonCode(const std::string& value)
{
    blockReasonCode_ = value;
    blockReasonCodeIsSet_ = true;
}

bool ShowAssetResponse::blockReasonCodeIsSet() const
{
    return blockReasonCodeIsSet_;
}

void ShowAssetResponse::unsetblockReasonCode()
{
    blockReasonCodeIsSet_ = false;
}
...
std::vector<AutoOperationConfig>& ShowAssetResponse::getAutoOperationConfig()
{
    return autoOperationConfig_;
}

void ShowAssetResponse::setAutoOperationConfig(const std::vector<AutoOperationConfig>& value)
{
    autoOperationConfig_ = value;
    autoOperationConfigIsSet_ = true;
}

bool ShowAssetResponse::autoOperationConfigIsSet() const
{
    return autoOperationConfigIsSet_;
}

void ShowAssetResponse::unsetautoOperationConfig()
{
    autoOperationConfigIsSet_ = false;
}
