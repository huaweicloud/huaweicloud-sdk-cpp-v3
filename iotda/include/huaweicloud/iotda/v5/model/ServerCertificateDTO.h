...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ServerCertificateDTO_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ServerCertificateDTO_H_
...
/// 服务器证书结构体。
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ServerCertificateDTO
    : public ModelBase
{
public:
    ServerCertificateDTO();
    virtual ~ServerCertificateDTO();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ServerCertificateDTO_H_
