...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MRConflictFileDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MRConflictFileDto_H_
...
#include <huaweicloud/codehub/v4/model/ConflictSectionDto.h>
#include <string>
#include <vector>
...
/// 冲突文件详情
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  MRConflictFileDto
    : public ModelBase
{
public:
    MRConflictFileDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MRConflictFileDto_H_
