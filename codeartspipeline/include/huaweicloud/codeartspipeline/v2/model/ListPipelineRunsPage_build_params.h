...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListPipelineRunsPage_build_params_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListPipelineRunsPage_build_params_H_
...
/// **参数解释**： 构建参数。 **取值范围**： 不涉及。 
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  ListPipelineRunsPage_build_params
    : public ModelBase
{
public:
    ListPipelineRunsPage_build_params();
    virtual ~ListPipelineRunsPage_build_params();
    ...
    /////////////////////////////////////////////
    /// ListPipelineRunsPage_build_params members
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListPipelineRunsPage_build_params_H_
