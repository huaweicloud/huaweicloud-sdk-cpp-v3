...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UpdateFileBodyDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UpdateFileBodyDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  UpdateFileBodyDto
    : public ModelBase
{
public:
    UpdateFileBodyDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UpdateFileBodyDto_H_
