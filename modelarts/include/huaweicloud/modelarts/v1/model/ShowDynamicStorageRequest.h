...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowDynamicStorageRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowDynamicStorageRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ShowDynamicStorageRequest
    : public ModelBase
{
public:
    ShowDynamicStorageRequest();
    virtual ~ShowDynamicStorageRequest();
    ...
    /////////////////////////////////////////////
    /// ShowDynamicStorageRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowDynamicStorageRequest& dereference_from_shared_ptr(std::shared_ptr<ShowDynamicStorageRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowDynamicStorageRequest_H_
