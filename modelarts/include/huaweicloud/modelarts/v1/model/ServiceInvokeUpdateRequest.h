...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ServiceInvokeUpdateRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ServiceInvokeUpdateRequest_H_
...
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ServiceInvokeUpdateRequest
    : public ModelBase
{
public:
    ServiceInvokeUpdateRequest();
    virtual ~ServiceInvokeUpdateRequest();
    ...
    /////////////////////////////////////////////
    /// ServiceInvokeUpdateRequest members
    ...
    ElbConnectionUpdateRequest getElbConnection() const;
    bool elbConnectionIsSet() const;
    void unsetelbConnection();
    void setElbConnection(const ElbConnectionUpdateRequest& value);
...
protected:
    ...
    ElbConnectionUpdateRequest elbConnection_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ServiceInvokeUpdateRequest_H_
