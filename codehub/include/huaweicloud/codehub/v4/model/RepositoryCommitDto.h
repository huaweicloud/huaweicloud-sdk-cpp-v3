...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_RepositoryCommitDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_RepositoryCommitDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  RepositoryCommitDto
    : public ModelBase
{
public:
    RepositoryCommitDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_RepositoryCommitDto_H_
