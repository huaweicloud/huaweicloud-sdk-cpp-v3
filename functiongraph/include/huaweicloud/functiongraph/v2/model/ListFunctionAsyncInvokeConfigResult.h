...
#ifndef HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ListFunctionAsyncInvokeConfigResult_H_
#define HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ListFunctionAsyncInvokeConfigResult_H_
...
/// 函数异步配置返回结构体。
/// </summary>
class HUAWEICLOUD_FUNCTIONGRAPH_V2_EXPORT  ListFunctionAsyncInvokeConfigResult
    : public ModelBase
{
public:
    ListFunctionAsyncInvokeConfigResult();
    virtual ~ListFunctionAsyncInvokeConfigResult();
    ...
    /////////////////////////////////////////////
    /// ListFunctionAsyncInvokeConfigResult members
...
#endif // HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ListFunctionAsyncInvokeConfigResult_H_
