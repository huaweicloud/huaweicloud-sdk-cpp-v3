...
public:
    ...
    static HttpRequestDef genRequestDefForBatchResizeFlavor();
    ...
    static HttpRequestDef genRequestDefForBatchModifySubscription();
    static HttpRequestDef genRequestDefForCollectPublicationMonitor();
    ...
    static HttpRequestDef genRequestDefForListPublications4Subscription();
    static HttpRequestDef genRequestDefForListRemoteDb();
    static HttpRequestDef genRequestDefForListReplicationErrors();
    static HttpRequestDef genRequestDefForListReplicationProfiles();
    static HttpRequestDef genRequestDefForListSqlserverDatabases();
    static HttpRequestDef genRequestDefForListSqlserverDbUsers();
    static HttpRequestDef genRequestDefForListSubscriberInstances();
    ...
    static HttpRequestDef genRequestDefForRestartDbAgentJob();
    ...
    static HttpRequestDef genRequestDefForSwitchDbAgentJob();
    static HttpRequestDef genRequestDefForSyncReplicationMetadata();
    static HttpRequestDef genRequestDefForUpdateStatistics();
