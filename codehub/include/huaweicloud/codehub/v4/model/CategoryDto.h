...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CategoryDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CategoryDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  CategoryDto
    : public ModelBase
{
public:
    CategoryDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CategoryDto_H_
