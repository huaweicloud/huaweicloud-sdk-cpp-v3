...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowInferDeploymentHpaRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowInferDeploymentHpaRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ShowInferDeploymentHpaRequest
    : public ModelBase
{
public:
    ShowInferDeploymentHpaRequest();
    virtual ~ShowInferDeploymentHpaRequest();
    ...
    /////////////////////////////////////////////
    /// ShowInferDeploymentHpaRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowInferDeploymentHpaRequest& dereference_from_shared_ptr(std::shared_ptr<ShowInferDeploymentHpaRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowInferDeploymentHpaRequest_H_
