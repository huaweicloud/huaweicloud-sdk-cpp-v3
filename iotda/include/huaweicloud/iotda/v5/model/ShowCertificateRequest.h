...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ShowCertificateRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ShowCertificateRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ShowCertificateRequest
    : public ModelBase
{
public:
    ShowCertificateRequest();
    virtual ~ShowCertificateRequest();
    ...
    /////////////////////////////////////////////
    /// ShowCertificateRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowCertificateRequest& dereference_from_shared_ptr(std::shared_ptr<ShowCertificateRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ShowCertificateRequest_H_
