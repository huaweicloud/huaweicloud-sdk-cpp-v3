...
#ifndef HUAWEICLOUD_SDK_IOTDM_V5_MODEL_ListInstanceFlavorsRequest_H_
#define HUAWEICLOUD_SDK_IOTDM_V5_MODEL_ListInstanceFlavorsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDM_V5_EXPORT  ListInstanceFlavorsRequest
    : public ModelBase
{
public:
    ListInstanceFlavorsRequest();
    virtual ~ListInstanceFlavorsRequest();
    ...
    /////////////////////////////////////////////
    /// ListInstanceFlavorsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListInstanceFlavorsRequest& dereference_from_shared_ptr(std::shared_ptr<ListInstanceFlavorsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDM_V5_MODEL_ListInstanceFlavorsRequest_H_
