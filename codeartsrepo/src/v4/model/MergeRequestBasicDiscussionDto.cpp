...
int32_t MergeRequestBasicDiscussionDto::getRepositoryId() const
{
    return repositoryId_;
}

void MergeRequestBasicDiscussionDto::setRepositoryId(int32_t value)
{
    repositoryId_ = value;
    repositoryIdIsSet_ = true;
}

bool MergeRequestBasicDiscussionDto::repositoryIdIsSet() const
{
    return repositoryIdIsSet_;
}

void MergeRequestBasicDiscussionDto::unsetrepositoryId()
{
    repositoryIdIsSet_ = false;
}
...
std::string MergeRequestBasicDiscussionDto::getRepositoryFullPath() const
{
    return repositoryFullPath_;
}

void MergeRequestBasicDiscussionDto::setRepositoryFullPath(const std::string& value)
{
    repositoryFullPath_ = value;
    repositoryFullPathIsSet_ = true;
}

bool MergeRequestBasicDiscussionDto::repositoryFullPathIsSet() const
{
    return repositoryFullPathIsSet_;
}

void MergeRequestBasicDiscussionDto::unsetrepositoryFullPath()
{
    repositoryFullPathIsSet_ = false;
}
