...
#ifndef HUAWEICLOUD_SDK_LIVE_V1_MODEL_SetRefererChainInfo_H_
#define HUAWEICLOUD_SDK_LIVE_V1_MODEL_SetRefererChainInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LIVE_V1_EXPORT  SetRefererChainInfo
    : public ModelBase
{
public:
    SetRefererChainInfo();
    virtual ~SetRefererChainInfo();
...
#endif // HUAWEICLOUD_SDK_LIVE_V1_MODEL_SetRefererChainInfo_H_
