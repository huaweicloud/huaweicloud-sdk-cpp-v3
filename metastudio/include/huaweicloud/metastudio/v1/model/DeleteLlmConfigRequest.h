...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteLlmConfigRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteLlmConfigRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteLlmConfigRequest
    : public ModelBase
{
public:
    DeleteLlmConfigRequest();
    virtual ~DeleteLlmConfigRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteLlmConfigRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteLlmConfigRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteLlmConfigRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteLlmConfigRequest_H_
