...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_QueryTaskResultDTO_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_QueryTaskResultDTO_H_
...
/// 查询任务管理的返回结果DTO对象
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  QueryTaskResultDTO
    : public ModelBase
{
public:
    QueryTaskResultDTO();
    virtual ~QueryTaskResultDTO();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_QueryTaskResultDTO_H_
