...
public:
    ...
    static HttpRequestDef genRequestDefForCreateAccessControlTask();
    static HttpRequestDef genRequestDefForCreateDomain();
    static HttpRequestDef genRequestDefForCreateDomainByDuplicate();
    ...
    static HttpRequestDef genRequestDefForExportStatsOpen();
    static HttpRequestDef genRequestDefForListAccessControlTask();
    static HttpRequestDef genRequestDefForListBanUrl();
    static HttpRequestDef genRequestDefForListCdnDomainTopIps();
    static HttpRequestDef genRequestDefForListCdnDomainTopOriginUrl();
    static HttpRequestDef genRequestDefForListCdnDomainTopPath();
    ...
    static HttpRequestDef genRequestDefForListDomainConfigs();
    ...
    static HttpRequestDef genRequestDefForListSpecialConfiguration();
    ...
    static HttpRequestDef genRequestDefForShowDomainCountryStat();
    ...
    static HttpRequestDef genRequestDefForShowSpecialUser();
