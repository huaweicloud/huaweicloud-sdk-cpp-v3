...
#ifndef HUAWEICLOUD_SDK_GEIP_V3_MODEL_ShowInternetBandwidth_H_
#define HUAWEICLOUD_SDK_GEIP_V3_MODEL_ShowInternetBandwidth_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GEIP_V3_EXPORT  ShowInternetBandwidth
    : public ModelBase
{
public:
    ShowInternetBandwidth();
    virtual ~ShowInternetBandwidth();
...
#endif // HUAWEICLOUD_SDK_GEIP_V3_MODEL_ShowInternetBandwidth_H_
