...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_PluginConfigInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_PluginConfigInfo_H_
...
/// 插件配置基本信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  PluginConfigInfo
    : public ModelBase
{
public:
    PluginConfigInfo();
    virtual ~PluginConfigInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_PluginConfigInfo_H_
