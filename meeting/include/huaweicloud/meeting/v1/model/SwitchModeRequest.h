...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SwitchModeRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SwitchModeRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SwitchModeRequest
    : public ModelBase
{
public:
    SwitchModeRequest();
    ...
    RestSwitchModeReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestSwitchModeReqBody& value);
...
protected:
    ...
    RestSwitchModeReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    SwitchModeRequest& dereference_from_shared_ptr(std::shared_ptr<SwitchModeRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SwitchModeRequest_H_
