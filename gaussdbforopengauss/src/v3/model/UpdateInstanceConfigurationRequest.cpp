...
bool UpdateInstanceConfigurationRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("body"))) {
        ...
        if(!fieldValue.is_null())
        {
            OpenGaussModifyInstanceConfigurationRequest refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
            setBody(refVal);
        }
    }
...
OpenGaussModifyInstanceConfigurationRequest UpdateInstanceConfigurationRequest::getBody() const
{
    return body_;
}

void UpdateInstanceConfigurationRequest::setBody(const OpenGaussModifyInstanceConfigurationRequest& value)
{
    body_ = value;
    bodyIsSet_ = true;
}
