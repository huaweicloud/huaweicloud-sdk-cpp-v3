...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_CorpBasicInfoDTO_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_CorpBasicInfoDTO_H_
...
/// 企业注册信息。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  CorpBasicInfoDTO
    : public ModelBase
{
public:
    CorpBasicInfoDTO();
    virtual ~CorpBasicInfoDTO();
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_CorpBasicInfoDTO_H_
