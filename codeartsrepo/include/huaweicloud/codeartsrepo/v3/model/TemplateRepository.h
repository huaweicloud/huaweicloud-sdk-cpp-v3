...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_TemplateRepository_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_TemplateRepository_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  TemplateRepository
    : public ModelBase
{
public:
    TemplateRepository();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_TemplateRepository_H_
