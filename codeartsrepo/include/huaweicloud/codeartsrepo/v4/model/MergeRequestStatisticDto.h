...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MergeRequestStatisticDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MergeRequestStatisticDto_H_
...
/// 合并请求统计数据
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  MergeRequestStatisticDto
    : public ModelBase
{
public:
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MergeRequestStatisticDto_H_
