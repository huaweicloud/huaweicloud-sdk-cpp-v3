...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_SubmoduleReqDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_SubmoduleReqDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  SubmoduleReqDto
    : public ModelBase
{
public:
    SubmoduleReqDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_SubmoduleReqDto_H_
