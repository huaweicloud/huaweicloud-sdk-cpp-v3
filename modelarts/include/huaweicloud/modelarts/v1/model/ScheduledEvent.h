...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ScheduledEvent_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ScheduledEvent_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ScheduledEvent
    : public ModelBase
{
public:
    ScheduledEvent();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ScheduledEvent_H_
