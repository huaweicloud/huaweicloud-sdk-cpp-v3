...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_GpgSubKeyDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_GpgSubKeyDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  GpgSubKeyDto
    : public ModelBase
{
public:
    GpgSubKeyDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_GpgSubKeyDto_H_
