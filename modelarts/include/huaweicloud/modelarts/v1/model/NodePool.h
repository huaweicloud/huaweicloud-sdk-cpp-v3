...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NodePool_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NodePool_H_
...
/// 节点池的详细信息。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  NodePool
    : public ModelBase
{
public:
    NodePool();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NodePool_H_
