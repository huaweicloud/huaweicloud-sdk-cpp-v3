...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListPictureModelingJobsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListPictureModelingJobsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListPictureModelingJobsRequest
    : public ModelBase
{
public:
    ListPictureModelingJobsRequest();
    virtual ~ListPictureModelingJobsRequest();
    ...
    /////////////////////////////////////////////
    /// ListPictureModelingJobsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListPictureModelingJobsRequest& dereference_from_shared_ptr(std::shared_ptr<ListPictureModelingJobsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListPictureModelingJobsRequest_H_
