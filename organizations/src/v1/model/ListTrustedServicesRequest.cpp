...
std::string ListTrustedServicesRequest::getXSecurityToken() const
{
    return xSecurityToken_;
}

void ListTrustedServicesRequest::setXSecurityToken(const std::string& value)
{
    xSecurityToken_ = value;
    xSecurityTokenIsSet_ = true;
}

bool ListTrustedServicesRequest::xSecurityTokenIsSet() const
{
    return xSecurityTokenIsSet_;
}

void ListTrustedServicesRequest::unsetxSecurityToken()
{
    xSecurityTokenIsSet_ = false;
}
