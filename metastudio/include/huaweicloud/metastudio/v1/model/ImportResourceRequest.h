...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ImportResourceRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ImportResourceRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ImportResourceRequest
    : public ModelBase
{
public:
    ImportResourceRequest();
    virtual ~ImportResourceRequest();
    ...
    ImportResourceRequestBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const ImportResourceRequestBody& value);
...
protected:
    ...
    ImportResourceRequestBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    ImportResourceRequest& dereference_from_shared_ptr(std::shared_ptr<ImportResourceRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ImportResourceRequest_H_
