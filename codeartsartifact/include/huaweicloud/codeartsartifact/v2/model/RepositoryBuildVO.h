...
#ifndef HUAWEICLOUD_SDK_CODEARTSARTIFACT_V2_MODEL_RepositoryBuildVO_H_
#define HUAWEICLOUD_SDK_CODEARTSARTIFACT_V2_MODEL_RepositoryBuildVO_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSARTIFACT_V2_EXPORT  RepositoryBuildVO
    : public ModelBase
{
public:
    RepositoryBuildVO();
    virtual ~RepositoryBuildVO();
...
#endif // HUAWEICLOUD_SDK_CODEARTSARTIFACT_V2_MODEL_RepositoryBuildVO_H_
