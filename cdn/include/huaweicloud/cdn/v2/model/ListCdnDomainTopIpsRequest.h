...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_ListCdnDomainTopIpsRequest_H_
#define HUAWEICLOUD_SDK_CDN_V2_MODEL_ListCdnDomainTopIpsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  ListCdnDomainTopIpsRequest
    : public ModelBase
{
public:
    ListCdnDomainTopIpsRequest();
    virtual ~ListCdnDomainTopIpsRequest();
    ...
    /////////////////////////////////////////////
    /// ListCdnDomainTopIpsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListCdnDomainTopIpsRequest& dereference_from_shared_ptr(std::shared_ptr<ListCdnDomainTopIpsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_ListCdnDomainTopIpsRequest_H_
