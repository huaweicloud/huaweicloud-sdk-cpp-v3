...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_TasksObject_H_
#define HUAWEICLOUD_SDK_CDN_V2_MODEL_TasksObject_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  TasksObject
    : public ModelBase
{
public:
    TasksObject();
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_TasksObject_H_
