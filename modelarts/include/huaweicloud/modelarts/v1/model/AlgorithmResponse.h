...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_AlgorithmResponse_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_AlgorithmResponse_H_
...
/// 算法管理算法配置。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  AlgorithmResponse
    : public ModelBase
{
public:
    AlgorithmResponse();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_AlgorithmResponse_H_
