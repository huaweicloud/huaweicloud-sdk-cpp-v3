...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListLivePlatformsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListLivePlatformsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListLivePlatformsRequest
    : public ModelBase
{
public:
    ListLivePlatformsRequest();
    virtual ~ListLivePlatformsRequest();
    ...
    /////////////////////////////////////////////
    /// ListLivePlatformsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListLivePlatformsRequest& dereference_from_shared_ptr(std::shared_ptr<ListLivePlatformsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListLivePlatformsRequest_H_
