...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MilestoneBasicDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MilestoneBasicDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  MilestoneBasicDto
    : public ModelBase
{
public:
    MilestoneBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MilestoneBasicDto_H_
