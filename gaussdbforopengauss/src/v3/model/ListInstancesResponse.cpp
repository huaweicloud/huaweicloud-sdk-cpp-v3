...
bool ListInstancesResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("instances"))) {
        ...
        {
            std::vector<ListInstanceResponse> refVal;
...
std::vector<ListInstanceResponse>& ListInstancesResponse::getInstances()
{
    return instances_;
}

void ListInstancesResponse::setInstances(const std::vector<ListInstanceResponse>& value)
{
    instances_ = value;
