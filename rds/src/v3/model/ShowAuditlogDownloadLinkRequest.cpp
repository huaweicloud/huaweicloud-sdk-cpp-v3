...
bool ShowAuditlogDownloadLinkRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("body"))) {
        ...
        if(!fieldValue.is_null())
        {
            GenerateAuditlogDownloadLinkRequest refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
            setBody(refVal);
        }
    }
...
GenerateAuditlogDownloadLinkRequest ShowAuditlogDownloadLinkRequest::getBody() const
{
    return body_;
}

void ShowAuditlogDownloadLinkRequest::setBody(const GenerateAuditlogDownloadLinkRequest& value)
{
    body_ = value;
    bodyIsSet_ = true;
}
