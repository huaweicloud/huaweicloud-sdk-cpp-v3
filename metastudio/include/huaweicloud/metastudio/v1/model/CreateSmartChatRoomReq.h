...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateSmartChatRoomReq_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateSmartChatRoomReq_H_
...
/// 创建智能交互对话配置。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateSmartChatRoomReq
    : public ModelBase
{
public:
    CreateSmartChatRoomReq();
    virtual ~CreateSmartChatRoomReq();
    ...
    /////////////////////////////////////////////
    /// CreateSmartChatRoomReq members
    ...
    std::vector<ChatResourceConfig>& getChatResourceConfig();
    bool chatResourceConfigIsSet() const;
    void unsetchatResourceConfig();
    void setChatResourceConfig(const std::vector<ChatResourceConfig>& value);
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateSmartChatRoomReq_H_
