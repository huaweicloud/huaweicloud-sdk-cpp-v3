...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_CreateMeetingRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_CreateMeetingRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  CreateMeetingRequest
    : public ModelBase
{
public:
    CreateMeetingRequest();
    virtual ~CreateMeetingRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    CreateMeetingRequest& dereference_from_shared_ptr(std::shared_ptr<CreateMeetingRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_CreateMeetingRequest_H_
