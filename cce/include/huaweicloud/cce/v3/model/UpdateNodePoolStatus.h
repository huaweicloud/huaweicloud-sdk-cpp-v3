...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_UpdateNodePoolStatus_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_UpdateNodePoolStatus_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  UpdateNodePoolStatus
    : public ModelBase
{
public:
    UpdateNodePoolStatus();
    virtual ~UpdateNodePoolStatus();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_UpdateNodePoolStatus_H_
