...
bool CopyConfigurationRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("body"))) {
        ...
        if(!fieldValue.is_null())
        {
            ParamGroupCopyRequestBody refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
            setBody(refVal);
        }
    }
...
std::string CopyConfigurationRequest::getXLanguage() const
{
    return xLanguage_;
}

void CopyConfigurationRequest::setXLanguage(const std::string& value)
{
    xLanguage_ = value;
    xLanguageIsSet_ = true;
}

bool CopyConfigurationRequest::xLanguageIsSet() const
{
    return xLanguageIsSet_;
}

void CopyConfigurationRequest::unsetxLanguage()
{
    xLanguageIsSet_ = false;
}
...
ParamGroupCopyRequestBody CopyConfigurationRequest::getBody() const
{
    return body_;
}

void CopyConfigurationRequest::setBody(const ParamGroupCopyRequestBody& value)
{
    body_ = value;
    bodyIsSet_ = true;
}
