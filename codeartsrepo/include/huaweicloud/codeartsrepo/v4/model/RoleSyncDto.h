...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RoleSyncDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RoleSyncDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  RoleSyncDto
    : public ModelBase
{
public:
    RoleSyncDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RoleSyncDto_H_
