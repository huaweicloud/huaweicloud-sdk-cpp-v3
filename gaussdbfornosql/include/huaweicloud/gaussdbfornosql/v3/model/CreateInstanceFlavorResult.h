...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_CreateInstanceFlavorResult_H_
#define HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_CreateInstanceFlavorResult_H_
...
/// 实例规格详情，与请求参数相同。
/// </summary>
class HUAWEICLOUD_GAUSSDBFORNOSQL_V3_EXPORT  CreateInstanceFlavorResult
    : public ModelBase
{
public:
    CreateInstanceFlavorResult();
    virtual ~CreateInstanceFlavorResult();
    ...
    /////////////////////////////////////////////
    /// CreateInstanceFlavorResult members
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_CreateInstanceFlavorResult_H_
