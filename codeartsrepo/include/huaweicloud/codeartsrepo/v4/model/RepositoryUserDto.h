...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryUserDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryUserDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  RepositoryUserDto
    : public ModelBase
{
public:
    RepositoryUserDto();
    virtual ~RepositoryUserDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryUserDto_H_
