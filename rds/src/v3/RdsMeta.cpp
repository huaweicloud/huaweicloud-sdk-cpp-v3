...
HttpRequestDef RdsMeta::genRequestDefForCreateDrsJobTask() {
    HttpRequestDef reqDefBuilder;
    FieldDef bodyParam;
    reqDefBuilder.withRequestField(bodyParam.
        withName("Body").
...
HttpRequestDef RdsMeta::genRequestDefForListHistorySessions() {
    HttpRequestDef reqDefBuilder;
...
HttpRequestDef RdsMeta::genRequestDefForListHistoryTopSqls() {
    HttpRequestDef reqDefBuilder;
    reqDefBuilder.withRequestField(FieldDef().withName("UserName")
                  .withJsonTag("user_name")
                  .withLocationType(Query_));
...
HttpRequestDef RdsMeta::genRequestDefForListHistoryWaitEvents() {
    HttpRequestDef reqDefBuilder;
    reqDefBuilder.withRequestField(FieldDef().withName("StartTime")
                  .withJsonTag("start_time")
                  .withLocationType(Query_));
...
HttpRequestDef RdsMeta::genRequestDefForListInstanceBackupSummary() {
    HttpRequestDef reqDefBuilder;
...
HttpRequestDef RdsMeta::genRequestDefForListSparseBackupPolicy() {
    HttpRequestDef reqDefBuilder;
    reqDefBuilder.withResponseField(FieldDef().
        withName("xRequestId").
        withJsonTag("X-request-id").
...
HttpRequestDef RdsMeta::genRequestDefForShowAvailableBuildDrInstance() {
    HttpRequestDef reqDefBuilder;
    reqDefBuilder.withRequestField(FieldDef().withName("Type")
                  .withJsonTag("type")
                  .withLocationType(Query_));
...
HttpRequestDef RdsMeta::genRequestDefForShowBackupUsage() {
    HttpRequestDef reqDefBuilder;
    reqDefBuilder.withRequestField(FieldDef().withName("Engine")
                  .withJsonTag("engine")
                  .withLocationType(Query_));
...
HttpRequestDef RdsMeta::genRequestDefForShowDrsJobName() {
    HttpRequestDef reqDefBuilder;
    return reqDefBuilder;
}

HttpRequestDef RdsMeta::genRequestDefForShowHistorySessionAnalyseDownloadInfo() {
    HttpRequestDef reqDefBuilder;
    reqDefBuilder.withRequestField(FieldDef().withName("Type")
                  .withJsonTag("type")
                  .withLocationType(Query_));
...
HttpRequestDef RdsMeta::genRequestDefForShowHotClodSeparationStatus() {
    HttpRequestDef reqDefBuilder;
    FieldDef headerParamXLanguage;
    reqDefBuilder.withRequestField(headerParamXLanguage
                  .withName("XLanguage")
...
HttpRequestDef RdsMeta::genRequestDefForShowTopObjects() {
    HttpRequestDef reqDefBuilder;
    reqDefBuilder.withRequestField(FieldDef().withName("Top")
                  .withJsonTag("top")
                  .withLocationType(Query_));
    reqDefBuilder.withRequestField(FieldDef().withName("DatabaseName")
                  .withJsonTag("database_name")
...
HttpRequestDef RdsMeta::genRequestDefForUpdateInstanceAlias() {
    HttpRequestDef reqDefBuilder;
    FieldDef headerParamXLanguage;
    reqDefBuilder.withRequestField(headerParamXLanguage
                  .withName("XLanguage")
...
HttpRequestDef RdsMeta::genRequestDefForUpdateSparseBackupPolicy() {
    HttpRequestDef reqDefBuilder;
    FieldDef bodyParam;
    reqDefBuilder.withRequestField(bodyParam.
        withName("Body").
...
HttpRequestDef RdsMeta::genRequestDefForUploadHistorySessionAnalyase() {
    HttpRequestDef reqDefBuilder;
    FieldDef headerParamXLanguage;
    reqDefBuilder.withRequestField(headerParamXLanguage
                  .withName("XLanguage")
...
HttpRequestDef RdsMeta::genRequestDefForShowMsdtcLocalHost() {
    HttpRequestDef reqDefBuilder;
    return reqDefBuilder;
}
...
HttpRequestDef RdsMeta::genRequestDefForCreateJobSchedule() {
    HttpRequestDef reqDefBuilder;
    FieldDef bodyParam;
    reqDefBuilder.withRequestField(bodyParam.
        withName("Body").
...
HttpRequestDef RdsMeta::genRequestDefForDeleteJobSchedule() {
    HttpRequestDef reqDefBuilder;
    return reqDefBuilder;
}
...
HttpRequestDef RdsMeta::genRequestDefForListJobSchedules() {
    HttpRequestDef reqDefBuilder;
    reqDefBuilder.withRequestField(FieldDef().withName("ScheduleType")
                  .withJsonTag("schedule_type")
                  .withLocationType(Query_));
    reqDefBuilder.withRequestField(FieldDef().withName("ScheduleId")
...
HttpRequestDef RdsMeta::genRequestDefForModifyJobSchedule() {
    HttpRequestDef reqDefBuilder;
    FieldDef bodyParam;
    reqDefBuilder.withRequestField(bodyParam.
        withName("Body").
