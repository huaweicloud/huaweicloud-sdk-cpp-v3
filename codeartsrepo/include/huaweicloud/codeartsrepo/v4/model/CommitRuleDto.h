...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CommitRuleDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CommitRuleDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  CommitRuleDto
    : public ModelBase
{
public:
    CommitRuleDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CommitRuleDto_H_
