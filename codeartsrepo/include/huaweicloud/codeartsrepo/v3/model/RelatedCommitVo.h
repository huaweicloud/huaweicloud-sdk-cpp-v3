...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_RelatedCommitVo_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_RelatedCommitVo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  RelatedCommitVo
    : public ModelBase
{
public:
    RelatedCommitVo();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_RelatedCommitVo_H_
