...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_SnapshotTaskMetadata_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_SnapshotTaskMetadata_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  SnapshotTaskMetadata
    : public ModelBase
{
public:
    SnapshotTaskMetadata();
    virtual ~SnapshotTaskMetadata();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_SnapshotTaskMetadata_H_
