...
public:
    ...
    static HttpRequestDef genRequestDefForCreateKmsKey();
    ...
    static HttpRequestDef genRequestDefForDeleteKmsKey();
    ...
    static HttpRequestDef genRequestDefForDownloadHttpSignCert();
    static HttpRequestDef genRequestDefForListCloudService();
    static HttpRequestDef genRequestDefForListCloudServices();
    ...
    static HttpRequestDef genRequestDefForListTopicsWithAssociatedResources();
    ...
    static HttpRequestDef genRequestDefForShowKmsKey();
    static HttpRequestDef genRequestDefForShowNotifyPolicy();
    static HttpRequestDef genRequestDefForSubscribeTopic();
    static HttpRequestDef genRequestDefForUnsubscribeSubscription();
    static HttpRequestDef genRequestDefForUnsubscribeTopic();
    static HttpRequestDef genRequestDefForUpdateKmsKey();
