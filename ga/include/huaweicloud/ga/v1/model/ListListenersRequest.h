...
#ifndef HUAWEICLOUD_SDK_GA_V1_MODEL_ListListenersRequest_H_
#define HUAWEICLOUD_SDK_GA_V1_MODEL_ListListenersRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GA_V1_EXPORT  ListListenersRequest
    : public ModelBase
{
public:
    ListListenersRequest();
    virtual ~ListListenersRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListListenersRequest& dereference_from_shared_ptr(std::shared_ptr<ListListenersRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GA_V1_MODEL_ListListenersRequest_H_
