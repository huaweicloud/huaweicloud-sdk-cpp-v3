...
std::shared_ptr<BatchCreateOrDeleteTagsResponse> CsmsClient::batchCreateOrDeleteTags(BatchCreateOrDeleteTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForBatchCreateOrDeleteTags());
...
std::shared_ptr<CreateSecretResponse> CsmsClient::createSecret(CreateSecretRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForCreateSecret());
...
std::shared_ptr<CreateSecretEventResponse> CsmsClient::createSecretEvent(CreateSecretEventRequest &request)
{
    std::string localVarPath = "/v1/{project_id}/csms/events";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForCreateSecretEvent());

    std::shared_ptr<CreateSecretEventResponse> localVarResult = std::make_shared<CreateSecretEventResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreateSecretTagResponse> CsmsClient::createSecretTag(CreateSecretTagRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForCreateSecretTag());
...
std::shared_ptr<CreateSecretVersionResponse> CsmsClient::createSecretVersion(CreateSecretVersionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForCreateSecretVersion());
...
std::shared_ptr<DeleteSecretResponse> CsmsClient::deleteSecret(DeleteSecretRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForDeleteSecret());
...
std::shared_ptr<DeleteSecretEventResponse> CsmsClient::deleteSecretEvent(DeleteSecretEventRequest &request)
{
    std::string localVarPath = "/v1/{project_id}/csms/events/{event_name}";
    ...
    localVarPathParams["event_name"] = parameterToString(request.getEventName());
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForDeleteSecretEvent());

    std::shared_ptr<DeleteSecretEventResponse> localVarResult = std::make_shared<DeleteSecretEventResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<DeleteSecretForScheduleResponse> CsmsClient::deleteSecretForSchedule(DeleteSecretForScheduleRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForDeleteSecretForSchedule());
...
std::shared_ptr<DeleteSecretStageResponse> CsmsClient::deleteSecretStage(DeleteSecretStageRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForDeleteSecretStage());
...
std::shared_ptr<DeleteSecretTagResponse> CsmsClient::deleteSecretTag(DeleteSecretTagRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForDeleteSecretTag());
...
std::shared_ptr<DownloadSecretBlobResponse> CsmsClient::downloadSecretBlob(DownloadSecretBlobRequest &request)
{
    std::string localVarPath = "/v1/{project_id}/secrets/{secret_name}/backup";
...
std::shared_ptr<ListNotificationRecordsResponse> CsmsClient::listNotificationRecords(ListNotificationRecordsRequest &request)
{
    std::string localVarPath = "/v1/{project_id}/csms/notification-records";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForListNotificationRecords());

    std::shared_ptr<ListNotificationRecordsResponse> localVarResult = std::make_shared<ListNotificationRecordsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListProjectSecretsTagsResponse> CsmsClient::listProjectSecretsTags(ListProjectSecretsTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForListProjectSecretsTags());
...
std::shared_ptr<ListResourceInstancesResponse> CsmsClient::listResourceInstances(ListResourceInstancesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForListResourceInstances());
...
std::shared_ptr<ListSecretEventsResponse> CsmsClient::listSecretEvents(ListSecretEventsRequest &request)
{
    std::string localVarPath = "/v1/{project_id}/csms/events";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForListSecretEvents());

    std::shared_ptr<ListSecretEventsResponse> localVarResult = std::make_shared<ListSecretEventsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListSecretTagsResponse> CsmsClient::listSecretTags(ListSecretTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForListSecretTags());
...
std::shared_ptr<ListSecretVersionsResponse> CsmsClient::listSecretVersions(ListSecretVersionsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForListSecretVersions());
...
std::shared_ptr<ListSecretsResponse> CsmsClient::listSecrets(ListSecretsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForListSecrets());
...
std::shared_ptr<RestoreSecretResponse> CsmsClient::restoreSecret(RestoreSecretRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForRestoreSecret());
...
std::shared_ptr<ShowSecretResponse> CsmsClient::showSecret(ShowSecretRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForShowSecret());
...
std::shared_ptr<ShowSecretEventResponse> CsmsClient::showSecretEvent(ShowSecretEventRequest &request)
{
    std::string localVarPath = "/v1/{project_id}/csms/events/{event_name}";
...
std::shared_ptr<ShowSecretStageResponse> CsmsClient::showSecretStage(ShowSecretStageRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForShowSecretStage());
...
std::shared_ptr<UpdateSecretResponse> CsmsClient::updateSecret(UpdateSecretRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForUpdateSecret());
...
std::shared_ptr<UpdateSecretEventResponse> CsmsClient::updateSecretEvent(UpdateSecretEventRequest &request)
{
    std::string localVarPath = "/v1/{project_id}/csms/events/{event_name}";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForUpdateSecretEvent());

    std::shared_ptr<UpdateSecretEventResponse> localVarResult = std::make_shared<UpdateSecretEventResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateUserPasswordResponse> CsmsClient::updateUserPassword(UpdateUserPasswordRequest &request)
{
    std::string localVarPath = "/v1/csms/users/change-password";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForUpdateUserPassword());

    std::shared_ptr<UpdateUserPasswordResponse> localVarResult = std::make_shared<UpdateUserPasswordResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateVersionResponse> CsmsClient::updateVersion(UpdateVersionRequest &request)
{
    std::string localVarPath = "/v1/{project_id}/secrets/{secret_name}/versions/{version_id}";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForUpdateVersion());

    std::shared_ptr<UpdateVersionResponse> localVarResult = std::make_shared<UpdateVersionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UploadSecretBlobResponse> CsmsClient::uploadSecretBlob(UploadSecretBlobRequest &request)
{
    std::string localVarPath = "/v1/{project_id}/secrets/restore";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CsmsMeta::genRequestDefForUploadSecretBlob());

    std::shared_ptr<UploadSecretBlobResponse> localVarResult = std::make_shared<UploadSecretBlobResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::string CsmsClient::parameterToString(const Object& obj)
{
    auto val = obj.toJson();
    std::string value;
