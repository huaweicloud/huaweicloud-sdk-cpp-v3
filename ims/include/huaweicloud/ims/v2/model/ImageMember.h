...
#ifndef HUAWEICLOUD_SDK_IMS_V2_MODEL_ImageMember_H_
#define HUAWEICLOUD_SDK_IMS_V2_MODEL_ImageMember_H_
...
/// 
/// </summary>
class HUAWEICLOUD_IMS_V2_EXPORT  ImageMember
    : public ModelBase
{
public:
    ImageMember();
...
#endif // HUAWEICLOUD_SDK_IMS_V2_MODEL_ImageMember_H_
