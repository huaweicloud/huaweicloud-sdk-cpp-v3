...
#ifndef HUAWEICLOUD_SDK_ANTIDDOS_V2_MODEL_WarnConfig_H_
#define HUAWEICLOUD_SDK_ANTIDDOS_V2_MODEL_WarnConfig_H_
...
/// 告警配置信息。
/// </summary>
class HUAWEICLOUD_ANTIDDOS_V2_EXPORT  WarnConfig
    : public ModelBase
{
public:
    WarnConfig();
...
#endif // HUAWEICLOUD_SDK_ANTIDDOS_V2_MODEL_WarnConfig_H_
