...
ListAlertTemplatesResponse::ListAlertTemplatesResponse()
{
    endRow_ = 0L;
    endRowIsSet_ = false;
    hasNextPage_ = false;
...
void ListAlertTemplatesResponse::validate()
{
}

web::json::value ListAlertTemplatesResponse::toJson() const
{
...
bool ListAlertTemplatesResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("list"))) {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<AlertTemplateVo> refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
            setList(refVal);
        }
    }
...
int64_t ListAlertTemplatesResponse::getEndRow() const
{
    return endRow_;
}

void ListAlertTemplatesResponse::setEndRow(int64_t value)
{
    endRow_ = value;
    endRowIsSet_ = true;
}

bool ListAlertTemplatesResponse::endRowIsSet() const
{
    return endRowIsSet_;
}

void ListAlertTemplatesResponse::unsetendRow()
{
    endRowIsSet_ = false;
}

bool ListAlertTemplatesResponse::isHasNextPage() const
{
    return hasNextPage_;
}

void ListAlertTemplatesResponse::setHasNextPage(bool value)
{
    hasNextPage_ = value;
    hasNextPageIsSet_ = true;
}

bool ListAlertTemplatesResponse::hasNextPageIsSet() const
{
    return hasNextPageIsSet_;
}

void ListAlertTemplatesResponse::unsethasNextPage()
{
    hasNextPageIsSet_ = false;
}

bool ListAlertTemplatesResponse::isHasPreviousPage() const
{
    return hasPreviousPage_;
}

void ListAlertTemplatesResponse::setHasPreviousPage(bool value)
{
    hasPreviousPage_ = value;
    hasPreviousPageIsSet_ = true;
}

bool ListAlertTemplatesResponse::hasPreviousPageIsSet() const
{
    return hasPreviousPageIsSet_;
}

void ListAlertTemplatesResponse::unsethasPreviousPage()
{
    hasPreviousPageIsSet_ = false;
}

bool ListAlertTemplatesResponse::isIsFirstPage() const
{
    return isFirstPage_;
}

void ListAlertTemplatesResponse::setIsFirstPage(bool value)
{
    isFirstPage_ = value;
    isFirstPageIsSet_ = true;
}

bool ListAlertTemplatesResponse::isFirstPageIsSet() const
{
    return isFirstPageIsSet_;
}

void ListAlertTemplatesResponse::unsetisFirstPage()
{
    isFirstPageIsSet_ = false;
}

bool ListAlertTemplatesResponse::isIsLastPage() const
{
    return isLastPage_;
}

void ListAlertTemplatesResponse::setIsLastPage(bool value)
{
    isLastPage_ = value;
    isLastPageIsSet_ = true;
}

bool ListAlertTemplatesResponse::isLastPageIsSet() const
{
    return isLastPageIsSet_;
}

void ListAlertTemplatesResponse::unsetisLastPage()
{
    isLastPageIsSet_ = false;
}

std::vector<AlertTemplateVo>& ListAlertTemplatesResponse::getList()
{
    return list_;
}

void ListAlertTemplatesResponse::setList(const std::vector<AlertTemplateVo>& value)
{
    list_ = value;
    listIsSet_ = true;
}

bool ListAlertTemplatesResponse::listIsSet() const
{
    return listIsSet_;
}

void ListAlertTemplatesResponse::unsetlist()
{
    listIsSet_ = false;
}

int32_t ListAlertTemplatesResponse::getNavigateFirstPage() const
{
    return navigateFirstPage_;
}

void ListAlertTemplatesResponse::setNavigateFirstPage(int32_t value)
{
    navigateFirstPage_ = value;
    navigateFirstPageIsSet_ = true;
}

bool ListAlertTemplatesResponse::navigateFirstPageIsSet() const
{
    return navigateFirstPageIsSet_;
}

void ListAlertTemplatesResponse::unsetnavigateFirstPage()
{
    navigateFirstPageIsSet_ = false;
}

int32_t ListAlertTemplatesResponse::getNavigateLastPage() const
{
    return navigateLastPage_;
}

void ListAlertTemplatesResponse::setNavigateLastPage(int32_t value)
{
    navigateLastPage_ = value;
    navigateLastPageIsSet_ = true;
}

bool ListAlertTemplatesResponse::navigateLastPageIsSet() const
{
    return navigateLastPageIsSet_;
}

void ListAlertTemplatesResponse::unsetnavigateLastPage()
{
    navigateLastPageIsSet_ = false;
}

int32_t ListAlertTemplatesResponse::getNavigatePages() const
{
    return navigatePages_;
}

void ListAlertTemplatesResponse::setNavigatePages(int32_t value)
{
    navigatePages_ = value;
    navigatePagesIsSet_ = true;
}

bool ListAlertTemplatesResponse::navigatePagesIsSet() const
{
    return navigatePagesIsSet_;
}

void ListAlertTemplatesResponse::unsetnavigatePages()
{
    navigatePagesIsSet_ = false;
}

std::vector<int32_t>& ListAlertTemplatesResponse::getNavigatepageNums()
{
    return navigatepageNums_;
}

void ListAlertTemplatesResponse::setNavigatepageNums(std::vector<int32_t> value)
{
    navigatepageNums_ = value;
    navigatepageNumsIsSet_ = true;
}

bool ListAlertTemplatesResponse::navigatepageNumsIsSet() const
{
    return navigatepageNumsIsSet_;
}

void ListAlertTemplatesResponse::unsetnavigatepageNums()
{
    navigatepageNumsIsSet_ = false;
}

int32_t ListAlertTemplatesResponse::getNextPage() const
{
    return nextPage_;
}

void ListAlertTemplatesResponse::setNextPage(int32_t value)
{
    nextPage_ = value;
    nextPageIsSet_ = true;
}

bool ListAlertTemplatesResponse::nextPageIsSet() const
{
    return nextPageIsSet_;
}

void ListAlertTemplatesResponse::unsetnextPage()
{
    nextPageIsSet_ = false;
}

int32_t ListAlertTemplatesResponse::getPageNum() const
{
    return pageNum_;
}

void ListAlertTemplatesResponse::setPageNum(int32_t value)
{
    pageNum_ = value;
    pageNumIsSet_ = true;
}

bool ListAlertTemplatesResponse::pageNumIsSet() const
{
    return pageNumIsSet_;
}

void ListAlertTemplatesResponse::unsetpageNum()
{
    pageNumIsSet_ = false;
}

int32_t ListAlertTemplatesResponse::getPageSize() const
{
    return pageSize_;
}

void ListAlertTemplatesResponse::setPageSize(int32_t value)
{
    pageSize_ = value;
    pageSizeIsSet_ = true;
}

bool ListAlertTemplatesResponse::pageSizeIsSet() const
{
    return pageSizeIsSet_;
}

void ListAlertTemplatesResponse::unsetpageSize()
{
    pageSizeIsSet_ = false;
}

int32_t ListAlertTemplatesResponse::getPages() const
{
    return pages_;
}

void ListAlertTemplatesResponse::setPages(int32_t value)
{
    pages_ = value;
    pagesIsSet_ = true;
}

bool ListAlertTemplatesResponse::pagesIsSet() const
{
    return pagesIsSet_;
}

void ListAlertTemplatesResponse::unsetpages()
{
    pagesIsSet_ = false;
}

int32_t ListAlertTemplatesResponse::getPrePage() const
{
    return prePage_;
}

void ListAlertTemplatesResponse::setPrePage(int32_t value)
{
    prePage_ = value;
    prePageIsSet_ = true;
}

bool ListAlertTemplatesResponse::prePageIsSet() const
{
    return prePageIsSet_;
}

void ListAlertTemplatesResponse::unsetprePage()
{
    prePageIsSet_ = false;
}

int32_t ListAlertTemplatesResponse::getSize() const
{
    return size_;
}

void ListAlertTemplatesResponse::setSize(int32_t value)
{
    size_ = value;
    sizeIsSet_ = true;
}

bool ListAlertTemplatesResponse::sizeIsSet() const
{
    return sizeIsSet_;
}

void ListAlertTemplatesResponse::unsetsize()
{
    sizeIsSet_ = false;
}

int64_t ListAlertTemplatesResponse::getStartRow() const
{
    return startRow_;
}

void ListAlertTemplatesResponse::setStartRow(int64_t value)
{
    startRow_ = value;
    startRowIsSet_ = true;
}

bool ListAlertTemplatesResponse::startRowIsSet() const
{
    return startRowIsSet_;
}

void ListAlertTemplatesResponse::unsetstartRow()
{
    startRowIsSet_ = false;
}

int64_t ListAlertTemplatesResponse::getTotal() const
{
    return total_;
}

void ListAlertTemplatesResponse::setTotal(int64_t value)
{
    total_ = value;
    totalIsSet_ = true;
}

bool ListAlertTemplatesResponse::totalIsSet() const
{
    return totalIsSet_;
}

void ListAlertTemplatesResponse::unsettotal()
{
    totalIsSet_ = false;
}
