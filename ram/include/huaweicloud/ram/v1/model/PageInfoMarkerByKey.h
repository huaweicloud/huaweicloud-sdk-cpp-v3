...
#ifndef HUAWEICLOUD_SDK_RAM_V1_MODEL_PageInfoMarkerByKey_H_
#define HUAWEICLOUD_SDK_RAM_V1_MODEL_PageInfoMarkerByKey_H_
...
/// 分页详细信息。
/// </summary>
class HUAWEICLOUD_RAM_V1_EXPORT  PageInfoMarkerByKey
    : public ModelBase
{
public:
    PageInfoMarkerByKey();
    virtual ~PageInfoMarkerByKey();
...
#endif // HUAWEICLOUD_SDK_RAM_V1_MODEL_PageInfoMarkerByKey_H_
