...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchStatisticConferenceParticipantRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchStatisticConferenceParticipantRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SearchStatisticConferenceParticipantRequest
    : public ModelBase
{
public:
    SearchStatisticConferenceParticipantRequest();
    virtual ~SearchStatisticConferenceParticipantRequest();
    ...
    /////////////////////////////////////////////
    /// SearchStatisticConferenceParticipantRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    SearchStatisticConferenceParticipantRequest& dereference_from_shared_ptr(std::shared_ptr<SearchStatisticConferenceParticipantRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchStatisticConferenceParticipantRequest_H_
