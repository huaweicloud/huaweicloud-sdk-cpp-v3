...
#ifndef HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_IssueStatusResponseV4_H_
#define HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_IssueStatusResponseV4_H_
...
/// 工作项的统计信息
/// </summary>
class HUAWEICLOUD_PROJECTMAN_V4_EXPORT  IssueStatusResponseV4
    : public ModelBase
{
public:
    IssueStatusResponseV4();
    virtual ~IssueStatusResponseV4();
...
#endif // HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_IssueStatusResponseV4_H_
