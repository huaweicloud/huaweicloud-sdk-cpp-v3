...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ProductSummary_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ProductSummary_H_
...
/// 产品概要信息。
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ProductSummary
    : public ModelBase
{
public:
    ProductSummary();
    virtual ~ProductSummary();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ProductSummary_H_
