...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListPipelinesPage_latest_run_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListPipelinesPage_latest_run_H_
...
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  ListPipelinesPage_latest_run
    : public ModelBase
{
public:
    ListPipelinesPage_latest_run();
    virtual ~ListPipelinesPage_latest_run();
    ...
    /////////////////////////////////////////////
    /// ListPipelinesPage_latest_run members
    ...
    std::vector<ListPipelinesPage_latest_run_stage_status_list>& getStageStatusList();
    bool stageStatusListIsSet() const;
    void unsetstageStatusList();
    void setStageStatusList(const std::vector<ListPipelinesPage_latest_run_stage_status_list>& value);
    ...
    ListPipelinesPage_latest_run_build_params getBuildParams() const;
    bool buildParamsIsSet() const;
    void unsetbuildParams();
    void setBuildParams(const ListPipelinesPage_latest_run_build_params& value);
...
protected:
    ...
    std::vector<ListPipelinesPage_latest_run_stage_status_list> stageStatusList_;
    ...
    ListPipelinesPage_latest_run_build_params buildParams_;
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListPipelinesPage_latest_run_H_
