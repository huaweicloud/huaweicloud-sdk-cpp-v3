...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_PipelineBasicDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_PipelineBasicDto_H_
...
/// 流水线基本信息
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  PipelineBasicDto
    : public ModelBase
{
public:
    PipelineBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_PipelineBasicDto_H_
