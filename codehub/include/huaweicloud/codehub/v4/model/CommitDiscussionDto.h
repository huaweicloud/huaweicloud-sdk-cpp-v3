...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitDiscussionDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitDiscussionDto_H_
...
#include <huaweicloud/codehub/v4/model/CommitNoteDto.h>
#include <string>
...
/// commit单个检视意见信息。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  CommitDiscussionDto
    : public ModelBase
{
public:
    CommitDiscussionDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitDiscussionDto_H_
