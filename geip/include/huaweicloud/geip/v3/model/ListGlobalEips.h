...
#ifndef HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListGlobalEips_H_
#define HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListGlobalEips_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GEIP_V3_EXPORT  ListGlobalEips
    : public ModelBase
{
public:
    ListGlobalEips();
    virtual ~ListGlobalEips();
