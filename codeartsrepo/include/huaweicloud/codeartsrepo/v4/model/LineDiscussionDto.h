...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LineDiscussionDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LineDiscussionDto_H_
...
/// 单文件下单侧检视意见详情。
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  LineDiscussionDto
    : public ModelBase
{
public:
    LineDiscussionDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LineDiscussionDto_H_
