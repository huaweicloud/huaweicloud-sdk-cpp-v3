...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListNotebooksRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListNotebooksRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ListNotebooksRequest
    : public ModelBase
{
public:
    ListNotebooksRequest();
    virtual ~ListNotebooksRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListNotebooksRequest& dereference_from_shared_ptr(std::shared_ptr<ListNotebooksRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListNotebooksRequest_H_
