...
#ifndef HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListUpStreamDetailRequest_H_
#define HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListUpStreamDetailRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_LIVE_V2_EXPORT  ListUpStreamDetailRequest
    : public ModelBase
{
public:
    ListUpStreamDetailRequest();
    virtual ~ListUpStreamDetailRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListUpStreamDetailRequest& dereference_from_shared_ptr(std::shared_ptr<ListUpStreamDetailRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListUpStreamDetailRequest_H_
