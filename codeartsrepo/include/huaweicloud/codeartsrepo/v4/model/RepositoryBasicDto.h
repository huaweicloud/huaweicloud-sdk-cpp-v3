...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryBasicDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryBasicDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  RepositoryBasicDto
    : public ModelBase
{
public:
    RepositoryBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryBasicDto_H_
