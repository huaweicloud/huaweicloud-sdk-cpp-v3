...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_DataRequirementResp_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_DataRequirementResp_H_
...
/// 工作流需要的数据。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  DataRequirementResp
    : public ModelBase
{
public:
    DataRequirementResp();
    virtual ~DataRequirementResp();
    ...
    std::vector<ConstraintResp>& getConditions();
    bool conditionsIsSet() const;
    void unsetconditions();
    void setConditions(const std::vector<ConstraintResp>& value);
...
protected:
    ...
    std::string type_;
    bool typeIsSet_;
    std::vector<ConstraintResp> conditions_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_DataRequirementResp_H_
