...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_MysqlInstanceListInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  MysqlInstanceListInfo
    : public ModelBase
{
public:
    MysqlInstanceListInfo();
    virtual ~MysqlInstanceListInfo();
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_MysqlInstanceListInfo_H_
