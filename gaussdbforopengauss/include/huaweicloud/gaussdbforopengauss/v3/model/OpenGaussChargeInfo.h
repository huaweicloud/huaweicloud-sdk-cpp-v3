...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_OpenGaussChargeInfo_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_OpenGaussChargeInfo_H_
...
/// 计费类型信息，仅支持按需和包周期。
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  OpenGaussChargeInfo
    : public ModelBase
{
public:
    OpenGaussChargeInfo();
    virtual ~OpenGaussChargeInfo();
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_OpenGaussChargeInfo_H_
