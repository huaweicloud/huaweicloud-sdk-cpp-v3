...
AssessResult ShowVoiceTrainingJobResponse::getAssessResult() const
{
    return assessResult_;
}

void ShowVoiceTrainingJobResponse::setAssessResult(const AssessResult& value)
{
    assessResult_ = value;
    assessResultIsSet_ = true;
}

bool ShowVoiceTrainingJobResponse::assessResultIsSet() const
{
    return assessResultIsSet_;
}

void ShowVoiceTrainingJobResponse::unsetassessResult()
{
    assessResultIsSet_ = false;
}

bool ShowVoiceTrainingJobResponse::isIsOndemandResource() const
{
    return isOndemandResource_;
}

void ShowVoiceTrainingJobResponse::setIsOndemandResource(bool value)
{
    isOndemandResource_ = value;
    isOndemandResourceIsSet_ = true;
}

bool ShowVoiceTrainingJobResponse::isOndemandResourceIsSet() const
{
    return isOndemandResourceIsSet_;
}

void ShowVoiceTrainingJobResponse::unsetisOndemandResource()
{
    isOndemandResourceIsSet_ = false;
}
