...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_ListDbAgentJobHistorysResult_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_ListDbAgentJobHistorysResult_H_
...
/// 数据库代理作业执行历史步骤。
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  ListDbAgentJobHistorysResult
    : public ModelBase
{
public:
    ListDbAgentJobHistorysResult();
    virtual ~ListDbAgentJobHistorysResult();
    ...
    /////////////////////////////////////////////
    /// ListDbAgentJobHistorysResult members
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_ListDbAgentJobHistorysResult_H_
