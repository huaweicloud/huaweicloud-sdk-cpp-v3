...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_StopInferDeploymentRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_StopInferDeploymentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  StopInferDeploymentRequest
    : public ModelBase
{
public:
    StopInferDeploymentRequest();
    virtual ~StopInferDeploymentRequest();
    ...
    /////////////////////////////////////////////
    /// StopInferDeploymentRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    StopInferDeploymentRequest& dereference_from_shared_ptr(std::shared_ptr<StopInferDeploymentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_StopInferDeploymentRequest_H_
