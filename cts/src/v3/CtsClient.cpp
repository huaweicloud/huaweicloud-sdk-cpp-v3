...
{
    std::string localVarPath = "/v3/{project_id}/{resource_type}/{resource_id}/tags/create";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForBatchCreateResourceTags());

    std::shared_ptr<BatchCreateResourceTagsResponse> localVarResult = std::make_shared<BatchCreateResourceTagsResponse>();
...
std::shared_ptr<BatchDeleteResourceTagsResponse> CtsClient::batchDeleteResourceTags(BatchDeleteResourceTagsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/{resource_type}/{resource_id}/tags/delete";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForBatchDeleteResourceTags());

    std::shared_ptr<BatchDeleteResourceTagsResponse> localVarResult = std::make_shared<BatchDeleteResourceTagsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CheckObsBucketsResponse> CtsClient::checkObsBuckets(CheckObsBucketsRequest &request)
{
    std::string localVarPath = "/v3/{domain_id}/checkbucket";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForCheckObsBuckets());

    std::shared_ptr<CheckObsBucketsResponse> localVarResult = std::make_shared<CheckObsBucketsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreateNotificationResponse> CtsClient::createNotification(CreateNotificationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForCreateNotification());
...
std::shared_ptr<CreateTrackerResponse> CtsClient::createTracker(CreateTrackerRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForCreateTracker());
...
std::shared_ptr<DeleteNotificationResponse> CtsClient::deleteNotification(DeleteNotificationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForDeleteNotification());
...
std::shared_ptr<DeleteTrackerResponse> CtsClient::deleteTracker(DeleteTrackerRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForDeleteTracker());
...
std::shared_ptr<ListNotificationsResponse> CtsClient::listNotifications(ListNotificationsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForListNotifications());
...
std::shared_ptr<ListOperationsResponse> CtsClient::listOperations(ListOperationsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/operations";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForListOperations());

    std::shared_ptr<ListOperationsResponse> localVarResult = std::make_shared<ListOperationsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListQuotasResponse> CtsClient::listQuotas(ListQuotasRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForListQuotas());
...
std::shared_ptr<ListTraceResourcesResponse> CtsClient::listTraceResources(ListTraceResourcesRequest &request)
{
    std::string localVarPath = "/v3/{domain_id}/resources";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForListTraceResources());

    std::shared_ptr<ListTraceResourcesResponse> localVarResult = std::make_shared<ListTraceResourcesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListTracesResponse> CtsClient::listTraces(ListTracesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForListTraces());
...
std::shared_ptr<ListTrackersResponse> CtsClient::listTrackers(ListTrackersRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForListTrackers());
...
std::shared_ptr<ListUserResourcesResponse> CtsClient::listUserResources(ListUserResourcesRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/user-resources";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForListUserResources());

    std::shared_ptr<ListUserResourcesResponse> localVarResult = std::make_shared<ListUserResourcesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<UpdateNotificationResponse> CtsClient::updateNotification(UpdateNotificationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForUpdateNotification());
...
std::shared_ptr<UpdateTrackerResponse> CtsClient::updateTracker(UpdateTrackerRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, CtsMeta::genRequestDefForUpdateTracker());
