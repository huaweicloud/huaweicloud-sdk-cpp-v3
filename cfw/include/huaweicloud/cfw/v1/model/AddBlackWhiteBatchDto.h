...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_AddBlackWhiteBatchDto_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_AddBlackWhiteBatchDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  AddBlackWhiteBatchDto
    : public ModelBase
{
public:
    AddBlackWhiteBatchDto();
    virtual ~AddBlackWhiteBatchDto();
    ...
    /////////////////////////////////////////////
    /// AddBlackWhiteBatchDto members

    /// <summary>
    /// **参数解释**： 黑白名单信息列表 **约束限制**： 不涉及  **取值范围**： 不涉及 **默认取值**： 不涉及
    /// </summary>

    std::vector<BlackWhiteInfo>& getListItems();
    bool listItemsIsSet() const;
    void unsetlistItems();
    void setListItems(const std::vector<BlackWhiteInfo>& value);
...
protected:
    std::vector<BlackWhiteInfo> listItems_;
    bool listItemsIsSet_;
    int32_t listType_;
    bool listTypeIsSet_;
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_AddBlackWhiteBatchDto_H_
