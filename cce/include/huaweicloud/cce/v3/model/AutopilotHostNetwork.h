...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_AutopilotHostNetwork_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_AutopilotHostNetwork_H_
...
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  AutopilotHostNetwork
    : public ModelBase
{
public:
    AutopilotHostNetwork();
    virtual ~AutopilotHostNetwork();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_AutopilotHostNetwork_H_
