...
bool ListEnterpriseProjectsResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("enterprise_projects"))) {
        ...
        {
            std::vector<EnterpriseProjectItem> refVal;
...
std::vector<EnterpriseProjectItem>& ListEnterpriseProjectsResponse::getEnterpriseProjects()
{
    return enterpriseProjects_;
}

void ListEnterpriseProjectsResponse::setEnterpriseProjects(const std::vector<EnterpriseProjectItem>& value)
{
