...
#ifndef HUAWEICLOUD_SDK_EIP_V3_MODEL_PageInfoDict_H_
#define HUAWEICLOUD_SDK_EIP_V3_MODEL_PageInfoDict_H_
...
/// 分页页码信息
/// </summary>
class HUAWEICLOUD_EIP_V3_EXPORT  PageInfoDict
    : public ModelBase
{
public:
    PageInfoDict();
    virtual ~PageInfoDict();
...
#endif // HUAWEICLOUD_SDK_EIP_V3_MODEL_PageInfoDict_H_
