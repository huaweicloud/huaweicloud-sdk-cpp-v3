...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListDbBackupsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  ListDbBackupsRequest
    : public ModelBase
{
public:
    ListDbBackupsRequest();
    virtual ~ListDbBackupsRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDbBackupsRequest& dereference_from_shared_ptr(std::shared_ptr<ListDbBackupsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListDbBackupsRequest_H_
