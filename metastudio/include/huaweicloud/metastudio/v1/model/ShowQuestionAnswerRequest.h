...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowQuestionAnswerRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowQuestionAnswerRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowQuestionAnswerRequest
    : public ModelBase
{
public:
    ShowQuestionAnswerRequest();
    virtual ~ShowQuestionAnswerRequest();
    ...
    /////////////////////////////////////////////
    /// ShowQuestionAnswerRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowQuestionAnswerRequest& dereference_from_shared_ptr(std::shared_ptr<ShowQuestionAnswerRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowQuestionAnswerRequest_H_
