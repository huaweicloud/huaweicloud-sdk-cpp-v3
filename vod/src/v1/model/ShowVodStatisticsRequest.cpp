...
std::string ShowVodStatisticsRequest::getAuthorization() const
{
    return authorization_;
}

void ShowVodStatisticsRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool ShowVodStatisticsRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void ShowVodStatisticsRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
