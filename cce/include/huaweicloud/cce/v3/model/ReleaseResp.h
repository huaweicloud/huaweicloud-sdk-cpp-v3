...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_ReleaseResp_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_ReleaseResp_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  ReleaseResp
    : public ModelBase
{
public:
    ReleaseResp();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_ReleaseResp_H_
