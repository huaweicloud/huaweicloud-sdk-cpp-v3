...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_ListSlowLogsNewRequest_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_ListSlowLogsNewRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  ListSlowLogsNewRequest
    : public ModelBase
{
public:
    ListSlowLogsNewRequest();
    virtual ~ListSlowLogsNewRequest();
    ...
    /////////////////////////////////////////////
    /// ListSlowLogsNewRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListSlowLogsNewRequest& dereference_from_shared_ptr(std::shared_ptr<ListSlowLogsNewRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_ListSlowLogsNewRequest_H_
