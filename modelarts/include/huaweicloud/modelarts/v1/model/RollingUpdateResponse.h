...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_RollingUpdateResponse_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_RollingUpdateResponse_H_
...
/// **参数解释：** 滚动更新配置。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  RollingUpdateResponse
    : public ModelBase
{
public:
    RollingUpdateResponse();
    virtual ~RollingUpdateResponse();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_RollingUpdateResponse_H_
