...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_UpdateUserRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_UpdateUserRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  UpdateUserRequest
    : public ModelBase
{
public:
    UpdateUserRequest();
    ...
    ModUserDTO getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const ModUserDTO& value);
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_UpdateUserRequest_H_
