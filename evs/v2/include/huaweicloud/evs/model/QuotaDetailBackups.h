...
#ifndef HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailBackups_H_
#define HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailBackups_H_
...
/// </summary>
class HUAWEICLOUD_EVS_EXPORT  QuotaDetailBackups
    : public ModelBase
{
public:
    QuotaDetailBackups();
    virtual ~QuotaDetailBackups();
...
#endif // HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailBackups_H_
