...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ServiceInvokeCreateRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ServiceInvokeCreateRequest_H_
...
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ServiceInvokeCreateRequest
    : public ModelBase
{
public:
    ServiceInvokeCreateRequest();
    virtual ~ServiceInvokeCreateRequest();
    ...
    /////////////////////////////////////////////
    /// ServiceInvokeCreateRequest members
    ...
    ElbConnectionCreateRequest getElbConnection() const;
    bool elbConnectionIsSet() const;
    void unsetelbConnection();
    void setElbConnection(const ElbConnectionCreateRequest& value);
...
protected:
    ...
    ElbConnectionCreateRequest elbConnection_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ServiceInvokeCreateRequest_H_
