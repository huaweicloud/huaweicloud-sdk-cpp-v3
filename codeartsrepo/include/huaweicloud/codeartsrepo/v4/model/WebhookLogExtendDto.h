...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_WebhookLogExtendDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_WebhookLogExtendDto_H_
...
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  WebhookLogExtendDto
    : public ModelBase
{
public:
    WebhookLogExtendDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_WebhookLogExtendDto_H_
