...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UpdateMergeRequestDiscussionInfoResponse_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UpdateMergeRequestDiscussionInfoResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  UpdateMergeRequestDiscussionInfoResponse
    : public ModelBase, public HttpResponse
{
public:
    UpdateMergeRequestDiscussionInfoResponse();
    virtual ~UpdateMergeRequestDiscussionInfoResponse();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UpdateMergeRequestDiscussionInfoResponse_H_
