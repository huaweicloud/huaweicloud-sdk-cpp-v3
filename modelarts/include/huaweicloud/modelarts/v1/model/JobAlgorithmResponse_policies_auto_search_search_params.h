...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_JobAlgorithmResponse_policies_auto_search_search_params_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_JobAlgorithmResponse_policies_auto_search_search_params_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  JobAlgorithmResponse_policies_auto_search_search_params
    : public ModelBase
{
public:
    JobAlgorithmResponse_policies_auto_search_search_params();
    virtual ~JobAlgorithmResponse_policies_auto_search_search_params();
    ...
    /////////////////////////////////////////////
    /// JobAlgorithmResponse_policies_auto_search_search_params members
    ...
    std::vector<std::string>& getDiscreteValues();
    bool discreteValuesIsSet() const;
    void unsetdiscreteValues();
    void setDiscreteValues(const std::vector<std::string>& value);
...
protected:
    ...
    std::vector<std::string> discreteValues_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_JobAlgorithmResponse_policies_auto_search_search_params_H_
