...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartLiveRoomRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartLiveRoomRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowSmartLiveRoomRequest
    : public ModelBase
{
public:
    ShowSmartLiveRoomRequest();
    virtual ~ShowSmartLiveRoomRequest();
    ...
    /////////////////////////////////////////////
    /// ShowSmartLiveRoomRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowSmartLiveRoomRequest& dereference_from_shared_ptr(std::shared_ptr<ShowSmartLiveRoomRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartLiveRoomRequest_H_
