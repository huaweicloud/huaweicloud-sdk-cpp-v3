...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_DiffRefDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_DiffRefDto_H_
...
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  DiffRefDto
    : public ModelBase
{
public:
    DiffRefDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_DiffRefDto_H_
