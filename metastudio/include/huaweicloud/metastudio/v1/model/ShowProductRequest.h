...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowProductRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowProductRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowProductRequest
    : public ModelBase
{
public:
    ShowProductRequest();
    virtual ~ShowProductRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowProductRequest& dereference_from_shared_ptr(std::shared_ptr<ShowProductRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowProductRequest_H_
