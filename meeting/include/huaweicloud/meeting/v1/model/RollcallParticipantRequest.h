...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_RollcallParticipantRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_RollcallParticipantRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  RollcallParticipantRequest
    : public ModelBase
{
public:
    RollcallParticipantRequest();
    virtual ~RollcallParticipantRequest();
    ...
    /////////////////////////////////////////////
    /// RollcallParticipantRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    RollcallParticipantRequest& dereference_from_shared_ptr(std::shared_ptr<RollcallParticipantRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_RollcallParticipantRequest_H_
