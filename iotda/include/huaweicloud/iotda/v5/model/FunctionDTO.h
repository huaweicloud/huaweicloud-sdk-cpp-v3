...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_FunctionDTO_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_FunctionDTO_H_
...
/// 编解码函数信息
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  FunctionDTO
    : public ModelBase
{
public:
    FunctionDTO();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_FunctionDTO_H_
