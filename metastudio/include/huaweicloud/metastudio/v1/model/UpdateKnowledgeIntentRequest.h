...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateKnowledgeIntentRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateKnowledgeIntentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateKnowledgeIntentRequest
    : public ModelBase
{
public:
    UpdateKnowledgeIntentRequest();
    virtual ~UpdateKnowledgeIntentRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateKnowledgeIntentRequest members
    ...
    UpdateKnowledgeIntentReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateKnowledgeIntentReq& value);
...
protected:
    ...
    bool intentIdIsSet_;
    UpdateKnowledgeIntentReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateKnowledgeIntentRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateKnowledgeIntentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateKnowledgeIntentRequest_H_
