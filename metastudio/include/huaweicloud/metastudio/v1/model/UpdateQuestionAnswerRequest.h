...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateQuestionAnswerRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateQuestionAnswerRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateQuestionAnswerRequest
    : public ModelBase
{
public:
    UpdateQuestionAnswerRequest();
    virtual ~UpdateQuestionAnswerRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateQuestionAnswerRequest members
    ...
    UpdateQuestionAnswerReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateQuestionAnswerReq& value);
...
protected:
    ...
    UpdateQuestionAnswerReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateQuestionAnswerRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateQuestionAnswerRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateQuestionAnswerRequest_H_
