...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_HotWordsInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_HotWordsInfo_H_
...
/// 热词基本信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  HotWordsInfo
    : public ModelBase
{
public:
    HotWordsInfo();
    virtual ~HotWordsInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_HotWordsInfo_H_
