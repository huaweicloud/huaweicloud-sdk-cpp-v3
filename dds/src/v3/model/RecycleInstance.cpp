...
std::string RecycleInstance::getPayMode() const
{
    return payMode_;
}

void RecycleInstance::setPayMode(const std::string& value)
{
    payMode_ = value;
    payModeIsSet_ = true;
}

bool RecycleInstance::payModeIsSet() const
{
    return payModeIsSet_;
}

void RecycleInstance::unsetpayMode()
{
    payModeIsSet_ = false;
}
