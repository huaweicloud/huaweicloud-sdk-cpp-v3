...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MemberAccess_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MemberAccess_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  MemberAccess
    : public ModelBase
{
public:
    MemberAccess();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MemberAccess_H_
