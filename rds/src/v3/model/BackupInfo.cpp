...
std::vector<BackupDatabase>& BackupInfo::getDatabases()
{
    return databases_;
}

void BackupInfo::setDatabases(const std::vector<BackupDatabase>& value)
{
    databases_ = value;
    databasesIsSet_ = true;
}

bool BackupInfo::databasesIsSet() const
{
    return databasesIsSet_;
}

void BackupInfo::unsetdatabases()
{
    databasesIsSet_ = false;
}
