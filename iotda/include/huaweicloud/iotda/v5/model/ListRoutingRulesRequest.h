...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListRoutingRulesRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListRoutingRulesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListRoutingRulesRequest
    : public ModelBase
{
public:
    ListRoutingRulesRequest();
    virtual ~ListRoutingRulesRequest();
    ...
    /////////////////////////////////////////////
    /// ListRoutingRulesRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListRoutingRulesRequest& dereference_from_shared_ptr(std::shared_ptr<ListRoutingRulesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListRoutingRulesRequest_H_
