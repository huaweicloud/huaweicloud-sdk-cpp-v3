...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateActiveCodeRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateActiveCodeRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateActiveCodeRequest
    : public ModelBase
{
public:
    UpdateActiveCodeRequest();
    virtual ~UpdateActiveCodeRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateActiveCodeRequest members
    ...
    UpdateActiveCodeReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateActiveCodeReq& value);
...
protected:
    ...
    UpdateActiveCodeReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateActiveCodeRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateActiveCodeRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateActiveCodeRequest_H_
