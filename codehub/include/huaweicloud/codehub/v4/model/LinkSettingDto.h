...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LinkSettingDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LinkSettingDto_H_
...
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  LinkSettingDto
    : public ModelBase
{
public:
    LinkSettingDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LinkSettingDto_H_
