...
#ifndef HUAWEICLOUD_SDK_IMAGE_V2_MODEL_ImageMediaTaggingReq_H_
#define HUAWEICLOUD_SDK_IMAGE_V2_MODEL_ImageMediaTaggingReq_H_
...
/// </summary>
class HUAWEICLOUD_IMAGE_V2_EXPORT  ImageMediaTaggingReq
    : public ModelBase
{
public:
    ImageMediaTaggingReq();
    virtual ~ImageMediaTaggingReq();
...
#endif // HUAWEICLOUD_SDK_IMAGE_V2_MODEL_ImageMediaTaggingReq_H_
