...
std::string ListSlowLogsRequest::getXLanguage() const
{
    return xLanguage_;
}

void ListSlowLogsRequest::setXLanguage(const std::string& value)
{
    xLanguage_ = value;
    xLanguageIsSet_ = true;
}

bool ListSlowLogsRequest::xLanguageIsSet() const
{
    return xLanguageIsSet_;
}

void ListSlowLogsRequest::unsetxLanguage()
{
    xLanguageIsSet_ = false;
}
