...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateDialogReportConfigReq_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateDialogReportConfigReq_H_
...
/// 创建对话结果上报配置请求。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateDialogReportConfigReq
    : public ModelBase
{
public:
    CreateDialogReportConfigReq();
    virtual ~CreateDialogReportConfigReq();
    ...
    /////////////////////////////////////////////
    /// CreateDialogReportConfigReq members
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateDialogReportConfigReq_H_
