...
/// Response Object
/// </summary>
class HUAWEICLOUD_CODEARTSDEPLOY_V2_EXPORT  ShowDeploymentGroupDetailResponse
    : public ModelBase, public HttpResponse
{
public:
    ShowDeploymentGroupDetailResponse();
    virtual ~ShowDeploymentGroupDetailResponse();
...
#endif // HUAWEICLOUD_SDK_CODEARTSDEPLOY_V2_MODEL_ShowDeploymentGroupDetailResponse_H_
