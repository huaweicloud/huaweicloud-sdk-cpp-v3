...
#ifndef HUAWEICLOUD_SDK_CTS_V3_MODEL_TrackerObsInfo_H_
#define HUAWEICLOUD_SDK_CTS_V3_MODEL_TrackerObsInfo_H_
...
/// 转储桶信息。
/// </summary>
class HUAWEICLOUD_CTS_V3_EXPORT  TrackerObsInfo
    : public ModelBase
{
public:
    TrackerObsInfo();
    virtual ~TrackerObsInfo();
    ...
    int32_t getBucketLifecycle() const;
    bool bucketLifecycleIsSet() const;
    void unsetbucketLifecycle();
    void setBucketLifecycle(int32_t value);
...
#endif // HUAWEICLOUD_SDK_CTS_V3_MODEL_TrackerObsInfo_H_
