...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenRoomSettingReq_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenRoomSettingReq_H_
...
/// 网络研讨会高级设置请求。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  OpenRoomSettingReq
    : public ModelBase
{
public:
    OpenRoomSettingReq();
    virtual ~OpenRoomSettingReq();
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenRoomSettingReq_H_
