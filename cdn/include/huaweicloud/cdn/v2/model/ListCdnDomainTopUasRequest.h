...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_ListCdnDomainTopUasRequest_H_
#define HUAWEICLOUD_SDK_CDN_V2_MODEL_ListCdnDomainTopUasRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  ListCdnDomainTopUasRequest
    : public ModelBase
{
public:
    ListCdnDomainTopUasRequest();
    virtual ~ListCdnDomainTopUasRequest();
    ...
    /////////////////////////////////////////////
    /// ListCdnDomainTopUasRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListCdnDomainTopUasRequest& dereference_from_shared_ptr(std::shared_ptr<ListCdnDomainTopUasRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_ListCdnDomainTopUasRequest_H_
