...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Network_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Network_H_
...
/// 网络的详细信息。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  Network
    : public ModelBase
{
public:
    Network();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Network_H_
