...
#ifndef HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_ShowIpdWorkItemFlowRequest_H_
#define HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_ShowIpdWorkItemFlowRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_PROJECTMAN_V4_EXPORT  ShowIpdWorkItemFlowRequest
    : public ModelBase
{
public:
    ShowIpdWorkItemFlowRequest();
    virtual ~ShowIpdWorkItemFlowRequest();
    ...
    /////////////////////////////////////////////
    /// ShowIpdWorkItemFlowRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowIpdWorkItemFlowRequest& dereference_from_shared_ptr(std::shared_ptr<ShowIpdWorkItemFlowRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_ShowIpdWorkItemFlowRequest_H_
