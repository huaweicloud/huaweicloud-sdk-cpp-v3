...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_GpgKeyDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_GpgKeyDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  GpgKeyDto
    : public ModelBase
{
public:
    GpgKeyDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_GpgKeyDto_H_
