...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_AllowClientRecordRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_AllowClientRecordRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  AllowClientRecordRequest
    : public ModelBase
{
public:
    AllowClientRecordRequest();
    virtual ~AllowClientRecordRequest();
    ...
    /////////////////////////////////////////////
    /// AllowClientRecordRequest members
    ...
    RestAllowClientRecordReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestAllowClientRecordReqBody& value);
...
protected:
    ...
    RestAllowClientRecordReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    AllowClientRecordRequest& dereference_from_shared_ptr(std::shared_ptr<AllowClientRecordRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_AllowClientRecordRequest_H_
