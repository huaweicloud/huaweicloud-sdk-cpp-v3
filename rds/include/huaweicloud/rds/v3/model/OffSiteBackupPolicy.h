...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_OffSiteBackupPolicy_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_OffSiteBackupPolicy_H_
...
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  OffSiteBackupPolicy
    : public ModelBase
{
public:
    OffSiteBackupPolicy();
    virtual ~OffSiteBackupPolicy();
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_OffSiteBackupPolicy_H_
