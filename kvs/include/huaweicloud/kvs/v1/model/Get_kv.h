...
#ifndef HUAWEICLOUD_SDK_KVS_V1_MODEL_Get_kv_H_
#define HUAWEICLOUD_SDK_KVS_V1_MODEL_Get_kv_H_
...
/// 
/// </summary>
class HUAWEICLOUD_KVS_V1_EXPORT  Get_kv
    : public ModelBase
{
public:
    Get_kv();
...
#endif // HUAWEICLOUD_SDK_KVS_V1_MODEL_Get_kv_H_
