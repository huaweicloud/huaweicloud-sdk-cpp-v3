...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_FileContentInfo_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_FileContentInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  FileContentInfo
    : public ModelBase
{
public:
    FileContentInfo();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_FileContentInfo_H_
