...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListPipelinesPage_latest_run_build_params_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListPipelinesPage_latest_run_build_params_H_
...
/// **参数解释**： 构建参数。 **取值范围**： 不涉及。 
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  ListPipelinesPage_latest_run_build_params
    : public ModelBase
{
public:
    ListPipelinesPage_latest_run_build_params();
    virtual ~ListPipelinesPage_latest_run_build_params();
    ...
    /////////////////////////////////////////////
    /// ListPipelinesPage_latest_run_build_params members
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListPipelinesPage_latest_run_build_params_H_
