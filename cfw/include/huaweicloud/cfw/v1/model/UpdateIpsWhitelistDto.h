...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_UpdateIpsWhitelistDto_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_UpdateIpsWhitelistDto_H_
...
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  UpdateIpsWhitelistDto
    : public ModelBase
{
public:
    UpdateIpsWhitelistDto();
    virtual ~UpdateIpsWhitelistDto();
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_UpdateIpsWhitelistDto_H_
