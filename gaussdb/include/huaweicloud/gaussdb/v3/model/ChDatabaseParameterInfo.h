...
/// 数据库配置参数。
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  ChDatabaseParameterInfo
    : public ModelBase
{
public:
    ChDatabaseParameterInfo();
    virtual ~ChDatabaseParameterInfo();
    ...
    /////////////////////////////////////////////
    /// ChDatabaseParameterInfo members
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ChDatabaseParameterInfo_H_
