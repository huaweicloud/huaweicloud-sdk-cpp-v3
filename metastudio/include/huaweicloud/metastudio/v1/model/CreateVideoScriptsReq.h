...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateVideoScriptsReq_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateVideoScriptsReq_H_
...
/// 创视频制作脚本请求。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateVideoScriptsReq
    : public ModelBase
{
public:
    CreateVideoScriptsReq();
    virtual ~CreateVideoScriptsReq();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateVideoScriptsReq_H_
