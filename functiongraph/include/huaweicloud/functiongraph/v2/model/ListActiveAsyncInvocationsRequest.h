...
#ifndef HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ListActiveAsyncInvocationsRequest_H_
#define HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ListActiveAsyncInvocationsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_FUNCTIONGRAPH_V2_EXPORT  ListActiveAsyncInvocationsRequest
    : public ModelBase
{
public:
    ListActiveAsyncInvocationsRequest();
    virtual ~ListActiveAsyncInvocationsRequest();
    ...
    /////////////////////////////////////////////
    /// ListActiveAsyncInvocationsRequest members
    ...
    void unsetrequests();
    void setRequests(const std::string& value);
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListActiveAsyncInvocationsRequest& dereference_from_shared_ptr(std::shared_ptr<ListActiveAsyncInvocationsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ListActiveAsyncInvocationsRequest_H_
