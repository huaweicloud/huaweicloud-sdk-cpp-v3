...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_UserBasicDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_UserBasicDto_H_
...
/// 用户信息
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  UserBasicDto
    : public ModelBase
{
public:
    UserBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_UserBasicDto_H_
