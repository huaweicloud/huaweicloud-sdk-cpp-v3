...
std::string ListTranscodeTemplateRequest::getAuthorization() const
{
    return authorization_;
}

void ListTranscodeTemplateRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool ListTranscodeTemplateRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void ListTranscodeTemplateRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
