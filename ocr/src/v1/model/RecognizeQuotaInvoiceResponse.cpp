...
std::string RecognizeQuotaInvoiceResponse::getXRequestId() const
{
    return xRequestId_;
}

void RecognizeQuotaInvoiceResponse::setXRequestId(const std::string& value)
{
    xRequestId_ = value;
    xRequestIdIsSet_ = true;
}

bool RecognizeQuotaInvoiceResponse::xRequestIdIsSet() const
{
    return xRequestIdIsSet_;
}

void RecognizeQuotaInvoiceResponse::unsetxRequestId()
{
    xRequestIdIsSet_ = false;
}
