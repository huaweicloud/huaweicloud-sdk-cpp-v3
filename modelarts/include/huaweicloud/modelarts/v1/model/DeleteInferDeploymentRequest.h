...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_DeleteInferDeploymentRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_DeleteInferDeploymentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  DeleteInferDeploymentRequest
    : public ModelBase
{
public:
    DeleteInferDeploymentRequest();
    virtual ~DeleteInferDeploymentRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteInferDeploymentRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteInferDeploymentRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteInferDeploymentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_DeleteInferDeploymentRequest_H_
