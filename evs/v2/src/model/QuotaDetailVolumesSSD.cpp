...
std::string QuotaDetailVolumesSSD::getAllocated() const
{
    return allocated_;
}

void QuotaDetailVolumesSSD::setAllocated(const std::string& value)
{
    allocated_ = value;
    allocatedIsSet_ = true;
}

bool QuotaDetailVolumesSSD::allocatedIsSet() const
{
    return allocatedIsSet_;
}

void QuotaDetailVolumesSSD::unsetallocated()
{
    allocatedIsSet_ = false;
}
