...
std::string DeleteTemplateGroupRequest::getAuthorization() const
{
    return authorization_;
}

void DeleteTemplateGroupRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool DeleteTemplateGroupRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void DeleteTemplateGroupRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
