...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_WorkflowExecutionResp_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_WorkflowExecutionResp_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  WorkflowExecutionResp
    : public ModelBase
{
public:
    WorkflowExecutionResp();
    virtual ~WorkflowExecutionResp();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_WorkflowExecutionResp_H_
