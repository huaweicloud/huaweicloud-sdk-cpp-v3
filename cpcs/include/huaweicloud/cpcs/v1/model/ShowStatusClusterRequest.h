...
#ifndef HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatusClusterRequest_H_
#define HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatusClusterRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CPCS_V1_EXPORT  ShowStatusClusterRequest
    : public ModelBase
{
public:
    ShowStatusClusterRequest();
    virtual ~ShowStatusClusterRequest();
    ...
    /////////////////////////////////////////////
    /// ShowStatusClusterRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowStatusClusterRequest& dereference_from_shared_ptr(std::shared_ptr<ShowStatusClusterRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatusClusterRequest_H_
