...
#ifndef HUAWEICLOUD_SDK_RGC_V1_MODEL_OrganizationStructureBaseLineRsp_H_
#define HUAWEICLOUD_SDK_RGC_V1_MODEL_OrganizationStructureBaseLineRsp_H_
...
/// 纳管账号体系基础设置。
/// </summary>
class HUAWEICLOUD_RGC_V1_EXPORT  OrganizationStructureBaseLineRsp
    : public ModelBase
{
public:
    OrganizationStructureBaseLineRsp();
    virtual ~OrganizationStructureBaseLineRsp();
    ...
    /////////////////////////////////////////////
    /// OrganizationStructureBaseLineRsp members
    ...
    std::vector<AccountBaselineRsp>& getAccounts();
    bool accountsIsSet() const;
    void unsetaccounts();
    void setAccounts(const std::vector<AccountBaselineRsp>& value);
...
protected:
    ...
    std::vector<AccountBaselineRsp> accounts_;
    bool accountsIsSet_;
...
#endif // HUAWEICLOUD_SDK_RGC_V1_MODEL_OrganizationStructureBaseLineRsp_H_
