...
#include "huaweicloud/ecs/model/PostPaidServerExtendParam.h"
#include <string>
#include "huaweicloud/ecs/model/PostPaidServerNic.h"
#include "huaweicloud/ecs/model/PostPaidServerTag.h"
#include "huaweicloud/ecs/model/PostPaidServerSchedulerHints.h"
#include "huaweicloud/ecs/model/PostPaidServerRootVolume.h"
#include "huaweicloud/ecs/model/PostPaidServerDataVolume.h"
#include "huaweicloud/ecs/model/PostPaidServerPublicip.h"
#include <map>
#include <vector>
...
/// 创建弹性云服务器（按需）接口Body体。
/// </summary>
class HUAWEICLOUD_ECS_EXPORT  PostPaidServer
    : public ModelBase
{
public:
    PostPaidServer();
