...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_SubscriptionOption_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_SubscriptionOption_H_
...
/// 订阅选项。
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  SubscriptionOption
    : public ModelBase
{
public:
    SubscriptionOption();
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_SubscriptionOption_H_
