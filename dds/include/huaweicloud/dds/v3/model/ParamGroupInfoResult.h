...
#ifndef HUAWEICLOUD_SDK_DDS_V3_MODEL_ParamGroupInfoResult_H_
#define HUAWEICLOUD_SDK_DDS_V3_MODEL_ParamGroupInfoResult_H_
...
/// 
/// </summary>
class HUAWEICLOUD_DDS_V3_EXPORT  ParamGroupInfoResult
    : public ModelBase
{
public:
    ParamGroupInfoResult();
    virtual ~ParamGroupInfoResult();
...
#endif // HUAWEICLOUD_SDK_DDS_V3_MODEL_ParamGroupInfoResult_H_
