...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_RuntimeConfig_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_RuntimeConfig_H_
...
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  RuntimeConfig
    : public ModelBase
{
public:
    RuntimeConfig();
    ...
    ServiceInvoke getServiceInvoke() const;
    bool serviceInvokeIsSet() const;
    void unsetserviceInvoke();
    void setServiceInvoke(const ServiceInvoke& value);
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_RuntimeConfig_H_
