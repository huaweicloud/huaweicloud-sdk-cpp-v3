...
#ifndef HUAWEICLOUD_SDK_CODEARTSDEPLOY_V2_MODEL_DeploymentUpdateHost_H_
...
/// 主机信息body体
/// </summary>
class HUAWEICLOUD_CODEARTSDEPLOY_V2_EXPORT  DeploymentUpdateHost
    : public ModelBase
{
public:
    DeploymentUpdateHost();
    virtual ~DeploymentUpdateHost();
...
#endif // HUAWEICLOUD_SDK_CODEARTSDEPLOY_V2_MODEL_DeploymentUpdateHost_H_
