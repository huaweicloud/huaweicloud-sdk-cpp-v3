...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_TenantRepositoryDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_TenantRepositoryDto_H_
...
/// 租户下仓库列表
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  TenantRepositoryDto
    : public ModelBase
{
public:
    TenantRepositoryDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_TenantRepositoryDto_H_
