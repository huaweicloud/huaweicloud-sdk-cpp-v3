...
int32_t ListTtscVocabularyGroupsRequest::getLimit() const
{
    return limit_;
}

void ListTtscVocabularyGroupsRequest::setLimit(int32_t value)
{
    limit_ = value;
    limitIsSet_ = true;
}

bool ListTtscVocabularyGroupsRequest::limitIsSet() const
{
    return limitIsSet_;
}

void ListTtscVocabularyGroupsRequest::unsetlimit()
{
    limitIsSet_ = false;
}

int32_t ListTtscVocabularyGroupsRequest::getOffset() const
{
    return offset_;
}

void ListTtscVocabularyGroupsRequest::setOffset(int32_t value)
{
    offset_ = value;
    offsetIsSet_ = true;
}

bool ListTtscVocabularyGroupsRequest::offsetIsSet() const
{
    return offsetIsSet_;
}

void ListTtscVocabularyGroupsRequest::unsetoffset()
{
    offsetIsSet_ = false;
}

std::string ListTtscVocabularyGroupsRequest::getGroupId() const
{
    return groupId_;
}

void ListTtscVocabularyGroupsRequest::setGroupId(const std::string& value)
{
    groupId_ = value;
    groupIdIsSet_ = true;
}

bool ListTtscVocabularyGroupsRequest::groupIdIsSet() const
{
    return groupIdIsSet_;
}

void ListTtscVocabularyGroupsRequest::unsetgroupId()
{
    groupIdIsSet_ = false;
}
