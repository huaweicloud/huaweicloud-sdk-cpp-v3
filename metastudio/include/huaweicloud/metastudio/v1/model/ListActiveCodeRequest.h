...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListActiveCodeRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListActiveCodeRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListActiveCodeRequest
    : public ModelBase
{
public:
    ListActiveCodeRequest();
    virtual ~ListActiveCodeRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListActiveCodeRequest& dereference_from_shared_ptr(std::shared_ptr<ListActiveCodeRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListActiveCodeRequest_H_
