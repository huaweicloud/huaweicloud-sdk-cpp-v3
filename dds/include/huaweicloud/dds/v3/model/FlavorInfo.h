...
#ifndef HUAWEICLOUD_SDK_DDS_V3_MODEL_FlavorInfo_H_
#define HUAWEICLOUD_SDK_DDS_V3_MODEL_FlavorInfo_H_
...
/// 规格信息。
/// </summary>
class HUAWEICLOUD_DDS_V3_EXPORT  FlavorInfo
    : public ModelBase
{
public:
    FlavorInfo();
    ...
    std::vector<std::string>& getEngineVersions();
    bool engineVersionsIsSet() const;
    void unsetengineVersions();
    void setEngineVersions(const std::vector<std::string>& value);
...
#endif // HUAWEICLOUD_SDK_DDS_V3_MODEL_FlavorInfo_H_
