...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowPacifyWordsRequest
    : public ModelBase
{
public:
    ShowPacifyWordsRequest();
    virtual ~ShowPacifyWordsRequest();
    ...
    /////////////////////////////////////////////
    /// ShowPacifyWordsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowPacifyWordsRequest& dereference_from_shared_ptr(std::shared_ptr<ShowPacifyWordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsRequest_H_
