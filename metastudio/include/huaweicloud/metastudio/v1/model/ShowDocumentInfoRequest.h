...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowDocumentInfoRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowDocumentInfoRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowDocumentInfoRequest
    : public ModelBase
{
public:
    ShowDocumentInfoRequest();
    virtual ~ShowDocumentInfoRequest();
    ...
    /////////////////////////////////////////////
    /// ShowDocumentInfoRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowDocumentInfoRequest& dereference_from_shared_ptr(std::shared_ptr<ShowDocumentInfoRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowDocumentInfoRequest_H_
