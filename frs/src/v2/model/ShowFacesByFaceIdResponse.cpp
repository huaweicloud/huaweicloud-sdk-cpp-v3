...
std::string ShowFacesByFaceIdResponse::getXRequestId() const
{
    return xRequestId_;
}

void ShowFacesByFaceIdResponse::setXRequestId(const std::string& value)
{
    xRequestId_ = value;
    xRequestIdIsSet_ = true;
}

bool ShowFacesByFaceIdResponse::xRequestIdIsSet() const
{
    return xRequestIdIsSet_;
}

void ShowFacesByFaceIdResponse::unsetxRequestId()
{
    xRequestIdIsSet_ = false;
}
