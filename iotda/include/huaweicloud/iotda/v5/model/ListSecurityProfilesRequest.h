...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListSecurityProfilesRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListSecurityProfilesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListSecurityProfilesRequest
    : public ModelBase
{
public:
    ListSecurityProfilesRequest();
    virtual ~ListSecurityProfilesRequest();
    ...
    /////////////////////////////////////////////
    /// ListSecurityProfilesRequest members
    ...
    /// <summary>
    /// **参数说明**：绑定资源ID。必须配合target_type一起使用，target_type为PRODUCT时，target_id格式为:资源空间ID:产品ID
    /// </summary>
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListSecurityProfilesRequest& dereference_from_shared_ptr(std::shared_ptr<ListSecurityProfilesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListSecurityProfilesRequest_H_
