...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateInstructionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateInstructionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateInstructionRequest
    : public ModelBase
{
public:
    UpdateInstructionRequest();
    virtual ~UpdateInstructionRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateInstructionRequest members
    ...
    UpdateInstructionReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateInstructionReq& value);
...
protected:
    ...
    UpdateInstructionReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateInstructionRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateInstructionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateInstructionRequest_H_
