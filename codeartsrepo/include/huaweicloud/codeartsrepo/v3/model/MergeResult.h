...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_MergeResult_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_MergeResult_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  MergeResult
    : public ModelBase
{
public:
    MergeResult();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_MergeResult_H_
