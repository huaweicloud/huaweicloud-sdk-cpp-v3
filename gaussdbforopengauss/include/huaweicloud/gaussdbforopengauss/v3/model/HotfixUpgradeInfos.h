...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_HotfixUpgradeInfos_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_HotfixUpgradeInfos_H_
...
/// 可以升级的热补丁信息。
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  HotfixUpgradeInfos
    : public ModelBase
{
public:
    HotfixUpgradeInfos();
    virtual ~HotfixUpgradeInfos();
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_HotfixUpgradeInfos_H_
