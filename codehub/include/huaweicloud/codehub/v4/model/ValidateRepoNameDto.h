...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ValidateRepoNameDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ValidateRepoNameDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ValidateRepoNameDto
    : public ModelBase
{
public:
    ValidateRepoNameDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ValidateRepoNameDto_H_
