...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ListGaussMySqlInstancesUnifyStatusRequest_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ListGaussMySqlInstancesUnifyStatusRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  ListGaussMySqlInstancesUnifyStatusRequest
    : public ModelBase
{
public:
    ListGaussMySqlInstancesUnifyStatusRequest();
    virtual ~ListGaussMySqlInstancesUnifyStatusRequest();
    ...
    /////////////////////////////////////////////
    /// ListGaussMySqlInstancesUnifyStatusRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListGaussMySqlInstancesUnifyStatusRequest& dereference_from_shared_ptr(std::shared_ptr<ListGaussMySqlInstancesUnifyStatusRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ListGaussMySqlInstancesUnifyStatusRequest_H_
