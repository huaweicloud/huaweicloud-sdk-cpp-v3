...
BackupPolicyItem ShowBackupPolicyResponse::getBackupPolicy() const
{
    return backupPolicy_;
}

void ShowBackupPolicyResponse::setBackupPolicy(const BackupPolicyItem& value)
{
    backupPolicy_ = value;
