...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MultipleRoleDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MultipleRoleDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  MultipleRoleDto
    : public ModelBase
{
public:
    MultipleRoleDto();
    virtual ~MultipleRoleDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MultipleRoleDto_H_
