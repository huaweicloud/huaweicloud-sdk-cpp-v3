...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_BatchDeletePacifyWordsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_BatchDeletePacifyWordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  BatchDeletePacifyWordsRequest
    : public ModelBase
{
public:
    BatchDeletePacifyWordsRequest();
    virtual ~BatchDeletePacifyWordsRequest();
    ...
    /////////////////////////////////////////////
    /// BatchDeletePacifyWordsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    BatchDeletePacifyWordsRequest& dereference_from_shared_ptr(std::shared_ptr<BatchDeletePacifyWordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_BatchDeletePacifyWordsRequest_H_
