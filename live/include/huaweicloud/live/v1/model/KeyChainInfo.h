...
#ifndef HUAWEICLOUD_SDK_LIVE_V1_MODEL_KeyChainInfo_H_
#define HUAWEICLOUD_SDK_LIVE_V1_MODEL_KeyChainInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LIVE_V1_EXPORT  KeyChainInfo
    : public ModelBase
{
public:
    KeyChainInfo();
    virtual ~KeyChainInfo();
...
#endif // HUAWEICLOUD_SDK_LIVE_V1_MODEL_KeyChainInfo_H_
