...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_WorkItemSimpleDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_WorkItemSimpleDto_H_
...
/// **参数解释：** 关联工作项基本信息。
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  WorkItemSimpleDto
    : public ModelBase
{
public:
    WorkItemSimpleDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_WorkItemSimpleDto_H_
