...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowHotQuestionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowHotQuestionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowHotQuestionRequest
    : public ModelBase
{
public:
    ShowHotQuestionRequest();
    virtual ~ShowHotQuestionRequest();
    ...
    /////////////////////////////////////////////
    /// ShowHotQuestionRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowHotQuestionRequest& dereference_from_shared_ptr(std::shared_ptr<ShowHotQuestionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowHotQuestionRequest_H_
