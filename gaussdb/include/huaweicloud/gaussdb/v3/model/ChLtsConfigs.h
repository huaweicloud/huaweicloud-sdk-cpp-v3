...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ChLtsConfigs_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ChLtsConfigs_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  ChLtsConfigs
    : public ModelBase
{
public:
    ChLtsConfigs();
    virtual ~ChLtsConfigs();
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ChLtsConfigs_H_
