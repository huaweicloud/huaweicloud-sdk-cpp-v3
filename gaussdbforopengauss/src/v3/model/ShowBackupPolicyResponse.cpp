...
ShowBackupPolicy ShowBackupPolicyResponse::getBackupPolicy() const
{
    return backupPolicy_;
}

void ShowBackupPolicyResponse::setBackupPolicy(const ShowBackupPolicy& value)
{
    backupPolicy_ = value;
