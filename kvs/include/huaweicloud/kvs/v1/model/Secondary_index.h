...
#ifndef HUAWEICLOUD_SDK_KVS_V1_MODEL_Secondary_index_H_
#define HUAWEICLOUD_SDK_KVS_V1_MODEL_Secondary_index_H_
...
/// 二级索引定义，元素key为数组下标。
/// </summary>
class HUAWEICLOUD_KVS_V1_EXPORT  Secondary_index
    : public ModelBase
{
public:
    Secondary_index();
...
#endif // HUAWEICLOUD_SDK_KVS_V1_MODEL_Secondary_index_H_
