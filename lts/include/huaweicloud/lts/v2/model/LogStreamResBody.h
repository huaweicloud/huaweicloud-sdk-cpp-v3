...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_LogStreamResBody_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_LogStreamResBody_H_
...
/// 返回的日志流信息
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  LogStreamResBody
    : public ModelBase
{
public:
    LogStreamResBody();
    virtual ~LogStreamResBody();
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_LogStreamResBody_H_
