...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_Task_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_Task_H_
...
/// 
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  Task
    : public ModelBase
{
public:
    Task();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_Task_H_
