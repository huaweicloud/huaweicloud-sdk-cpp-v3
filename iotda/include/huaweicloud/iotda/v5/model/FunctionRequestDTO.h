...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_FunctionRequestDTO_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_FunctionRequestDTO_H_
...
/// 编解码函数信息
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  FunctionRequestDTO
    : public ModelBase
{
public:
    FunctionRequestDTO();
    virtual ~FunctionRequestDTO();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_FunctionRequestDTO_H_
