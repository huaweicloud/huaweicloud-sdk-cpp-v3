...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_InPlaceMigrate_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_InPlaceMigrate_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  InPlaceMigrate
    : public ModelBase
{
public:
    InPlaceMigrate();
    virtual ~InPlaceMigrate();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_InPlaceMigrate_H_
