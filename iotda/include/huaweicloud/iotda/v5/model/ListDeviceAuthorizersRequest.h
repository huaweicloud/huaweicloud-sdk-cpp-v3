...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListDeviceAuthorizersRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListDeviceAuthorizersRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListDeviceAuthorizersRequest
    : public ModelBase
{
public:
    ListDeviceAuthorizersRequest();
    virtual ~ListDeviceAuthorizersRequest();
    ...
    /////////////////////////////////////////////
    /// ListDeviceAuthorizersRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDeviceAuthorizersRequest& dereference_from_shared_ptr(std::shared_ptr<ListDeviceAuthorizersRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListDeviceAuthorizersRequest_H_
