...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListBridgesRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListBridgesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListBridgesRequest
    : public ModelBase
{
public:
    ListBridgesRequest();
    virtual ~ListBridgesRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListBridgesRequest& dereference_from_shared_ptr(std::shared_ptr<ListBridgesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListBridgesRequest_H_
