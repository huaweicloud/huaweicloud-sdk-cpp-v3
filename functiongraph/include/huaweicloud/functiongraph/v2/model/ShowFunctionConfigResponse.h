...
#ifndef HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ShowFunctionConfigResponse_H_
#define HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ShowFunctionConfigResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_FUNCTIONGRAPH_V2_EXPORT  ShowFunctionConfigResponse
    : public ModelBase, public HttpResponse
{
public:
    ShowFunctionConfigResponse();
    virtual ~ShowFunctionConfigResponse();
    ...
    /////////////////////////////////////////////
    /// ShowFunctionConfigResponse members
    ...
    bool isReservedInstanceIdleMode() const;
    bool reservedInstanceIdleModeIsSet() const;
    void unsetreservedInstanceIdleMode();
    void setReservedInstanceIdleMode(bool value);

    /// <summary>
    /// 是否配置下沉apig路由规则。
    /// </summary>

    bool isApigRouteEnable() const;
    bool apigRouteEnableIsSet() const;
    void unsetapigRouteEnable();
    void setApigRouteEnable(bool value);
    ...
    bool isAllowEphemeralStorage() const;
    bool allowEphemeralStorageIsSet() const;
    void unsetallowEphemeralStorage();
    void setAllowEphemeralStorage(bool value);
...
protected:
    ...
    bool reservedInstanceIdleMode_;
    bool reservedInstanceIdleModeIsSet_;
    bool apigRouteEnable_;
    bool apigRouteEnableIsSet_;
    std::string heartbeatHandler_;
    bool heartbeatHandlerIsSet_;
    bool enableClassIsolation_;
    bool enableClassIsolationIsSet_;
    bool allowEphemeralStorage_;
    bool allowEphemeralStorageIsSet_;
...
#endif // HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ShowFunctionConfigResponse_H_
