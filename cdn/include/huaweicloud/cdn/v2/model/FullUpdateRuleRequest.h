...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_FullUpdateRuleRequest_H_
#define HUAWEICLOUD_SDK_CDN_V2_MODEL_FullUpdateRuleRequest_H_
...
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  FullUpdateRuleRequest
    : public ModelBase
{
public:
    FullUpdateRuleRequest();
    virtual ~FullUpdateRuleRequest();
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_FullUpdateRuleRequest_H_
