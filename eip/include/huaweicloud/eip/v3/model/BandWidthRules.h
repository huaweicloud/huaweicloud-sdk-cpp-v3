...
#ifndef HUAWEICLOUD_SDK_EIP_V3_MODEL_BandWidthRules_H_
#define HUAWEICLOUD_SDK_EIP_V3_MODEL_BandWidthRules_H_
...
/// 带宽规则对象
/// </summary>
class HUAWEICLOUD_EIP_V3_EXPORT  BandWidthRules
    : public ModelBase
{
public:
    BandWidthRules();
...
#endif // HUAWEICLOUD_SDK_EIP_V3_MODEL_BandWidthRules_H_
