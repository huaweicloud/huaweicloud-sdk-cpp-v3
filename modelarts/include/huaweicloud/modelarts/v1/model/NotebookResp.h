...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NotebookResp_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NotebookResp_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  NotebookResp
    : public ModelBase
{
public:
    NotebookResp();
    virtual ~NotebookResp();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NotebookResp_H_
