...
std::vector<std::string>& ShowProjectWebhookResponse::getNotePlainTextFilter()
{
    return notePlainTextFilter_;
}

void ShowProjectWebhookResponse::setNotePlainTextFilter(const std::vector<std::string>& value)
{
    notePlainTextFilter_ = value;
    notePlainTextFilterIsSet_ = true;
}

bool ShowProjectWebhookResponse::notePlainTextFilterIsSet() const
{
    return notePlainTextFilterIsSet_;
}

void ShowProjectWebhookResponse::unsetnotePlainTextFilter()
{
    notePlainTextFilterIsSet_ = false;
}
...
std::vector<WebHookEventCfgDto>& ShowProjectWebhookResponse::getEventCfgs()
{
    return eventCfgs_;
}

void ShowProjectWebhookResponse::setEventCfgs(const std::vector<WebHookEventCfgDto>& value)
{
    eventCfgs_ = value;
    eventCfgsIsSet_ = true;
}

bool ShowProjectWebhookResponse::eventCfgsIsSet() const
{
    return eventCfgsIsSet_;
}

void ShowProjectWebhookResponse::unseteventCfgs()
{
    eventCfgsIsSet_ = false;
}

std::vector<WebHookBranchCfgDto>& ShowProjectWebhookResponse::getProjectCfgs()
{
    return projectCfgs_;
}

void ShowProjectWebhookResponse::setProjectCfgs(const std::vector<WebHookBranchCfgDto>& value)
{
    projectCfgs_ = value;
    projectCfgsIsSet_ = true;
}

bool ShowProjectWebhookResponse::projectCfgsIsSet() const
{
    return projectCfgsIsSet_;
}

void ShowProjectWebhookResponse::unsetprojectCfgs()
{
    projectCfgsIsSet_ = false;
}

std::vector<WebHookBranchCfgDto>& ShowProjectWebhookResponse::getBranchCfgs()
{
    return branchCfgs_;
}

void ShowProjectWebhookResponse::setBranchCfgs(const std::vector<WebHookBranchCfgDto>& value)
{
    branchCfgs_ = value;
    branchCfgsIsSet_ = true;
}

bool ShowProjectWebhookResponse::branchCfgsIsSet() const
{
    return branchCfgsIsSet_;
}

void ShowProjectWebhookResponse::unsetbranchCfgs()
{
    branchCfgsIsSet_ = false;
}
...
std::string ShowProjectWebhookResponse::getService() const
{
    return service_;
}

void ShowProjectWebhookResponse::setService(const std::string& value)
{
    service_ = value;
    serviceIsSet_ = true;
}

bool ShowProjectWebhookResponse::serviceIsSet() const
{
    return serviceIsSet_;
}

void ShowProjectWebhookResponse::unsetservice()
{
    serviceIsSet_ = false;
}
