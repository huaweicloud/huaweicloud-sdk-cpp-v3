...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_AddTrustedIpAddressRequestBody_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_AddTrustedIpAddressRequestBody_H_
...
/// **参数解释：** 添加ip白名单请求体。
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  AddTrustedIpAddressRequestBody
    : public ModelBase
{
public:
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_AddTrustedIpAddressRequestBody_H_
