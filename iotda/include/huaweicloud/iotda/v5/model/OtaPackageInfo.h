...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_OtaPackageInfo_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_OtaPackageInfo_H_
...
/// 设备升级包信息
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  OtaPackageInfo
    : public ModelBase
{
public:
    OtaPackageInfo();
    virtual ~OtaPackageInfo();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_OtaPackageInfo_H_
