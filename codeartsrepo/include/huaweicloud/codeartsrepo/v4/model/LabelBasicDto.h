...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelBasicDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelBasicDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  LabelBasicDto
    : public ModelBase
{
public:
    LabelBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelBasicDto_H_
