...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListInstancesResult_H_
...
/// 实例信息。
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  ListInstancesResult
    : public ModelBase
{
public:
    ListInstancesResult();
    ...
    ListHaResult getHa() const;
    bool haIsSet() const;
    void unsetha();
    void setHa(const ListHaResult& value);
    ...
    ListInstanceDatastore getDatastore() const;
    bool datastoreIsSet() const;
    void unsetdatastore();
    void setDatastore(const ListInstanceDatastore& value);
    ...
    std::vector<NodeResult>& getNodes();
    bool nodesIsSet() const;
    void unsetnodes();
    void setNodes(const std::vector<NodeResult>& value);
    ...
    std::vector<TagResult>& getTags();
    bool tagsIsSet() const;
    void unsettags();
    void setTags(const std::vector<TagResult>& value);
    ...
    MySQLCompatibilityResult getMysqlCompatibility() const;
    bool mysqlCompatibilityIsSet() const;
    void unsetmysqlCompatibility();
    void setMysqlCompatibility(const MySQLCompatibilityResult& value);
...
protected:
    ...
    std::string region_;
    bool regionIsSet_;
    ListInstanceDatastore datastore_;
    ...
    bool timeZoneIsSet_;
    std::vector<TagResult> tags_;
    bool tagsIsSet_;
    std::string diskUsage_;
    bool diskUsageIsSet_;
    MySQLCompatibilityResult mysqlCompatibility_;
    bool mysqlCompatibilityIsSet_;
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListInstancesResult_H_
