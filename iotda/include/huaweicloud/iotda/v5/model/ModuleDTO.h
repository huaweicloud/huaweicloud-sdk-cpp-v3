...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ModuleDTO_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ModuleDTO_H_
...
/// OTA模块结构。
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ModuleDTO
    : public ModelBase
{
public:
    ModuleDTO();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ModuleDTO_H_
