...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_ProjectRepository_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_ProjectRepository_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  ProjectRepository
    : public ModelBase
{
public:
    ProjectRepository();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_ProjectRepository_H_
