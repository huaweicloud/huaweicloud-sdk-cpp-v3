...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_BeforeHbaConfOption_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_BeforeHbaConfOption_H_
...
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  BeforeHbaConfOption
    : public ModelBase
{
public:
    BeforeHbaConfOption();
    virtual ~BeforeHbaConfOption();
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_BeforeHbaConfOption_H_
