...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CheckVoiceAssetRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CheckVoiceAssetRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CheckVoiceAssetRequest
    : public ModelBase
{
public:
    CheckVoiceAssetRequest();
    virtual ~CheckVoiceAssetRequest();
    ...
    /////////////////////////////////////////////
    /// CheckVoiceAssetRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    CheckVoiceAssetRequest& dereference_from_shared_ptr(std::shared_ptr<CheckVoiceAssetRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CheckVoiceAssetRequest_H_
