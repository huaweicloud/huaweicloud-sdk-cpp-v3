...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateRobotReq_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateRobotReq_H_
...
/// 修改应用请求。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateRobotReq
    : public ModelBase
{
public:
    UpdateRobotReq();
    virtual ~UpdateRobotReq();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateRobotReq_H_
