...
#ifndef HUAWEICLOUD_SDK_DDS_V3_MODEL_CreateKillOpRuleRequestBody_H_
#define HUAWEICLOUD_SDK_DDS_V3_MODEL_CreateKillOpRuleRequestBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_DDS_V3_EXPORT  CreateKillOpRuleRequestBody
    : public ModelBase
{
public:
    CreateKillOpRuleRequestBody();
    virtual ~CreateKillOpRuleRequestBody();
    ...
    /////////////////////////////////////////////
    /// CreateKillOpRuleRequestBody members
    ...
    void setOperationTypes(const std::vector<std::string>& value);
    ...
    void unsetclientIps();
    void setClientIps(const std::vector<std::string>& value);
...
#endif // HUAWEICLOUD_SDK_DDS_V3_MODEL_CreateKillOpRuleRequestBody_H_
