...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SetRoleRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SetRoleRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SetRoleRequest
    : public ModelBase
{
public:
    SetRoleRequest();
    virtual ~SetRoleRequest();
    ...
    RestChairTokenReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestChairTokenReqBody& value);
...
protected:
    ...
    RestChairTokenReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    SetRoleRequest& dereference_from_shared_ptr(std::shared_ptr<SetRoleRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SetRoleRequest_H_
