...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListWelcomeSpeechRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListWelcomeSpeechRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListWelcomeSpeechRequest
    : public ModelBase
{
public:
    ListWelcomeSpeechRequest();
    virtual ~ListWelcomeSpeechRequest();
    ...
    /////////////////////////////////////////////
    /// ListWelcomeSpeechRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListWelcomeSpeechRequest& dereference_from_shared_ptr(std::shared_ptr<ListWelcomeSpeechRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListWelcomeSpeechRequest_H_
