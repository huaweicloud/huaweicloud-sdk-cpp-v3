...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ReqSettingDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ReqSettingDto_H_
...
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ReqSettingDto
    : public ModelBase
{
public:
    ReqSettingDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ReqSettingDto_H_
