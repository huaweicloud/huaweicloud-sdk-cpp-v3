...
std::string JobDetail::getStartTime() const
{
    return startTime_;
}

void JobDetail::setStartTime(const std::string& value)
{
    startTime_ = value;
    startTimeIsSet_ = true;
}

bool JobDetail::startTimeIsSet() const
{
    return startTimeIsSet_;
}

void JobDetail::unsetstartTime()
{
    startTimeIsSet_ = false;
}

std::string JobDetail::getEndTime() const
{
    return endTime_;
}

void JobDetail::setEndTime(const std::string& value)
{
    endTime_ = value;
    endTimeIsSet_ = true;
}

bool JobDetail::endTimeIsSet() const
{
    return endTimeIsSet_;
}

void JobDetail::unsetendTime()
{
    endTimeIsSet_ = false;
}
