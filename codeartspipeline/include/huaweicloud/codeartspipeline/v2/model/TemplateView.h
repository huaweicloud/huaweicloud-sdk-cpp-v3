...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_TemplateView_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_TemplateView_H_
...
/// 流水线创建状态响应体
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  TemplateView
    : public ModelBase
{
public:
    TemplateView();
    ...
    void setTemplateUrl(const std::string& value);
    ...
    bool isNeedHub() const;
    bool needHubIsSet() const;
    void unsetneedHub();
    void setNeedHub(bool value);
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_TemplateView_H_
