...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_UpdateInferHraRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_UpdateInferHraRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  UpdateInferHraRequest
    : public ModelBase
{
public:
    UpdateInferHraRequest();
    virtual ~UpdateInferHraRequest();
    ...
    UpdateHraRequestBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateHraRequestBody& value);
...
protected:
    ...
    UpdateHraRequestBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateInferHraRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateInferHraRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_UpdateInferHraRequest_H_
