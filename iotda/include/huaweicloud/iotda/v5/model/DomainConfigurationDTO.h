...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DomainConfigurationDTO_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DomainConfigurationDTO_H_
...
/// 域配置结构体
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  DomainConfigurationDTO
    : public ModelBase
{
public:
    DomainConfigurationDTO();
    virtual ~DomainConfigurationDTO();
    ...
    /////////////////////////////////////////////
    /// DomainConfigurationDTO members
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DomainConfigurationDTO_H_
