...
#ifndef HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatisticCertificateRequest_H_
#define HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatisticCertificateRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CPCS_V1_EXPORT  ShowStatisticCertificateRequest
    : public ModelBase
{
public:
    ShowStatisticCertificateRequest();
    virtual ~ShowStatisticCertificateRequest();
    ...
    /////////////////////////////////////////////
    /// ShowStatisticCertificateRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowStatisticCertificateRequest& dereference_from_shared_ptr(std::shared_ptr<ShowStatisticCertificateRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatisticCertificateRequest_H_
