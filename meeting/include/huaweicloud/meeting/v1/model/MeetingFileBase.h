...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_MeetingFileBase_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_MeetingFileBase_H_
...
/// 会议纪要文件信息。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  MeetingFileBase
    : public ModelBase
{
public:
    MeetingFileBase();
    virtual ~MeetingFileBase();
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_MeetingFileBase_H_
