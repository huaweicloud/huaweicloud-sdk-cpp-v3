...
#ifndef HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_CreateBuildJobScm_H_
#define HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_CreateBuildJobScm_H_
...
/// 构建执行SCM
/// </summary>
class HUAWEICLOUD_CODEARTSBUILD_V3_EXPORT  CreateBuildJobScm
    : public ModelBase
{
public:
    CreateBuildJobScm();
    virtual ~CreateBuildJobScm();
...
#endif // HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_CreateBuildJobScm_H_
