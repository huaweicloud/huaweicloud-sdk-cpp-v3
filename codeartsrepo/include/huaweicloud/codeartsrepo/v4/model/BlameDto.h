...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BlameDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BlameDto_H_
...
#include <huaweicloud/codeartsrepo/v4/model/LineContentDto.h>
#include <string>
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  BlameDto
    : public ModelBase
{
public:
    BlameDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BlameDto_H_
