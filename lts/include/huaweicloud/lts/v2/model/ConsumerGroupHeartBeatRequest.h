...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_ConsumerGroupHeartBeatRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  ConsumerGroupHeartBeatRequest
    : public ModelBase
{
public:
    ConsumerGroupHeartBeatRequest();
    virtual ~ConsumerGroupHeartBeatRequest();
    ...
    /////////////////////////////////////////////
    /// ConsumerGroupHeartBeatRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ConsumerGroupHeartBeatRequest& dereference_from_shared_ptr(std::shared_ptr<ConsumerGroupHeartBeatRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_ConsumerGroupHeartBeatRequest_H_
