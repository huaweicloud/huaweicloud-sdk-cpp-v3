...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowAsrVocabularyRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowAsrVocabularyRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowAsrVocabularyRequest
    : public ModelBase
{
public:
    ShowAsrVocabularyRequest();
    virtual ~ShowAsrVocabularyRequest();
    ...
    /////////////////////////////////////////////
    /// ShowAsrVocabularyRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowAsrVocabularyRequest& dereference_from_shared_ptr(std::shared_ptr<ShowAsrVocabularyRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowAsrVocabularyRequest_H_
