...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_MaintenanceWindow_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_MaintenanceWindow_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  MaintenanceWindow
    : public ModelBase
{
public:
    MaintenanceWindow();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_MaintenanceWindow_H_
