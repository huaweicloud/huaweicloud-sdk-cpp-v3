...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_PrecheckClusterTask_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_PrecheckClusterTask_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  PrecheckClusterTask
    : public ModelBase
{
public:
    PrecheckClusterTask();
    virtual ~PrecheckClusterTask();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_PrecheckClusterTask_H_
