...
HotfixUpgradeInfos::~HotfixUpgradeInfos() = default;

void HotfixUpgradeInfos::validate()
{
}

web::json::value HotfixUpgradeInfos::toJson() const
{
...
bool HotfixUpgradeInfos::fromJson(const web::json::value& val)
{
    bool ok = true;
...
std::string HotfixUpgradeInfos::getVersion() const
{
    return version_;
}

void HotfixUpgradeInfos::setVersion(const std::string& value)
{
    version_ = value;
    versionIsSet_ = true;
}

bool HotfixUpgradeInfos::versionIsSet() const
{
    return versionIsSet_;
}

void HotfixUpgradeInfos::unsetversion()
{
    versionIsSet_ = false;
}

std::string HotfixUpgradeInfos::getCommonPatch() const
{
    return commonPatch_;
}

void HotfixUpgradeInfos::setCommonPatch(const std::string& value)
{
    commonPatch_ = value;
    commonPatchIsSet_ = true;
}

bool HotfixUpgradeInfos::commonPatchIsSet() const
{
    return commonPatchIsSet_;
}

void HotfixUpgradeInfos::unsetcommonPatch()
{
    commonPatchIsSet_ = false;
}

bool HotfixUpgradeInfos::isBackupSensitive() const
{
    return backupSensitive_;
}

void HotfixUpgradeInfos::setBackupSensitive(bool value)
{
    backupSensitive_ = value;
    backupSensitiveIsSet_ = true;
}

bool HotfixUpgradeInfos::backupSensitiveIsSet() const
{
    return backupSensitiveIsSet_;
}

void HotfixUpgradeInfos::unsetbackupSensitive()
{
    backupSensitiveIsSet_ = false;
}

std::string HotfixUpgradeInfos::getDescripition() const
{
    return descripition_;
}

void HotfixUpgradeInfos::setDescripition(const std::string& value)
{
    descripition_ = value;
    descripitionIsSet_ = true;
}

bool HotfixUpgradeInfos::descripitionIsSet() const
{
    return descripitionIsSet_;
}

void HotfixUpgradeInfos::unsetdescripition()
{
    descripitionIsSet_ = false;
}
