...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowAsrVocabularyAssociationRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowAsrVocabularyAssociationRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowAsrVocabularyAssociationRequest
    : public ModelBase
{
public:
    ShowAsrVocabularyAssociationRequest();
    virtual ~ShowAsrVocabularyAssociationRequest();
    ...
    /////////////////////////////////////////////
    /// ShowAsrVocabularyAssociationRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowAsrVocabularyAssociationRequest& dereference_from_shared_ptr(std::shared_ptr<ShowAsrVocabularyAssociationRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowAsrVocabularyAssociationRequest_H_
