...
#ifndef HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListTranscodeDataRequest_H_
#define HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListTranscodeDataRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_LIVE_V2_EXPORT  ListTranscodeDataRequest
    : public ModelBase
{
public:
    ListTranscodeDataRequest();
    virtual ~ListTranscodeDataRequest();
    ...
    /////////////////////////////////////////////
    /// ListTranscodeDataRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListTranscodeDataRequest& dereference_from_shared_ptr(std::shared_ptr<ListTranscodeDataRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListTranscodeDataRequest_H_
