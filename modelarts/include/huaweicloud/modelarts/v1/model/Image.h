...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Image_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Image_H_
...
/// 实例镜像信息。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  Image
    : public ModelBase
{
public:
    Image();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Image_H_
