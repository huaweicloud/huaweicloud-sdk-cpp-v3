...
std::string DeleteWatermarkTemplateRequest::getAuthorization() const
{
    return authorization_;
}

void DeleteWatermarkTemplateRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool DeleteWatermarkTemplateRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void DeleteWatermarkTemplateRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
