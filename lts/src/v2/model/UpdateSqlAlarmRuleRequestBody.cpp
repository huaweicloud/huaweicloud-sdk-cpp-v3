...
NotificationSaveRule UpdateSqlAlarmRuleRequestBody::getNotificationSaveRule() const
{
    return notificationSaveRule_;
}

void UpdateSqlAlarmRuleRequestBody::setNotificationSaveRule(const NotificationSaveRule& value)
{
