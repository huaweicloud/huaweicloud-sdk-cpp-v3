...
public:
    ...
    std::vector<std::string>& getSuccessedInstanceIds();
    bool successedInstanceIdsIsSet() const;
    void unsetsuccessedInstanceIds();
    void setSuccessedInstanceIds(const std::vector<std::string>& value);


protected:
    std::vector<std::string> successedInstanceIds_;
