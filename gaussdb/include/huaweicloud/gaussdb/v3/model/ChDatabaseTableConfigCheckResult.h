...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ChDatabaseTableConfigCheckResult_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ChDatabaseTableConfigCheckResult_H_
...
/// 表配置校验结果。
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  ChDatabaseTableConfigCheckResult
    : public ModelBase
{
public:
    ChDatabaseTableConfigCheckResult();
    virtual ~ChDatabaseTableConfigCheckResult();
    ...
    /////////////////////////////////////////////
    /// ChDatabaseTableConfigCheckResult members
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ChDatabaseTableConfigCheckResult_H_
