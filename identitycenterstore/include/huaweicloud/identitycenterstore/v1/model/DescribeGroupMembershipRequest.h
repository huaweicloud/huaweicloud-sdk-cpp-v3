...
#ifndef HUAWEICLOUD_SDK_IDENTITYCENTERSTORE_V1_MODEL_DescribeGroupMembershipRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IDENTITYCENTERSTORE_V1_EXPORT  DescribeGroupMembershipRequest
    : public ModelBase
{
public:
    DescribeGroupMembershipRequest();
    virtual ~DescribeGroupMembershipRequest();
    ...
    /////////////////////////////////////////////
    /// DescribeGroupMembershipRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DescribeGroupMembershipRequest& dereference_from_shared_ptr(std::shared_ptr<DescribeGroupMembershipRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IDENTITYCENTERSTORE_V1_MODEL_DescribeGroupMembershipRequest_H_
