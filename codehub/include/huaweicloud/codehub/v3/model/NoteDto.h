...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_NoteDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_NoteDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  NoteDto
    : public ModelBase
{
public:
    NoteDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_NoteDto_H_
