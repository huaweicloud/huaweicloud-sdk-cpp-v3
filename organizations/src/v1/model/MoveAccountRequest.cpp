...
std::string MoveAccountRequest::getXSecurityToken() const
{
    return xSecurityToken_;
}

void MoveAccountRequest::setXSecurityToken(const std::string& value)
{
    xSecurityToken_ = value;
    xSecurityTokenIsSet_ = true;
}

bool MoveAccountRequest::xSecurityTokenIsSet() const
{
    return xSecurityTokenIsSet_;
}

void MoveAccountRequest::unsetxSecurityToken()
{
    xSecurityTokenIsSet_ = false;
}
