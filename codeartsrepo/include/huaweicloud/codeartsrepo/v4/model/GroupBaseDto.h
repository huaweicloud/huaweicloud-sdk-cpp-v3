...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_GroupBaseDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_GroupBaseDto_H_
...
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  GroupBaseDto
    : public ModelBase
{
public:
    GroupBaseDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_GroupBaseDto_H_
