...
#ifndef HUAWEICLOUD_SDK_OCR_V1_MODEL_VinRequestBody_H_
#define HUAWEICLOUD_SDK_OCR_V1_MODEL_VinRequestBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_OCR_V1_EXPORT  VinRequestBody
    : public ModelBase
{
public:
    VinRequestBody();
    virtual ~VinRequestBody();
...
#endif // HUAWEICLOUD_SDK_OCR_V1_MODEL_VinRequestBody_H_
