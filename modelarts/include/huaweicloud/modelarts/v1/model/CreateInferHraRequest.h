...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_CreateInferHraRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_CreateInferHraRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  CreateInferHraRequest
    : public ModelBase
{
public:
    CreateInferHraRequest();
    virtual ~CreateInferHraRequest();
    ...
    CreateHraRequestBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const CreateHraRequestBody& value);
...
protected:
    ...
    CreateHraRequestBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    CreateInferHraRequest& dereference_from_shared_ptr(std::shared_ptr<CreateInferHraRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_CreateInferHraRequest_H_
