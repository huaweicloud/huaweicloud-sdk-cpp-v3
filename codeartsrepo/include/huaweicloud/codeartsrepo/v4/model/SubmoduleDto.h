...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_SubmoduleDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_SubmoduleDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  SubmoduleDto
    : public ModelBase
{
public:
    SubmoduleDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_SubmoduleDto_H_
