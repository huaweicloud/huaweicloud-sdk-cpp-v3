#ifndef HUAWEICLOUD_SDK_KMS_V2_KmsRegion_H_
#define HUAWEICLOUD_SDK_KMS_V2_KmsRegion_H_
...
class HUAWEICLOUD_KMS_V2_EXPORT KmsRegion {
public:
    KmsRegion();
    virtual ~KmsRegion();
...
#endif // HUAWEICLOUD_SDK_KMS_V2_KmsRegion_H_