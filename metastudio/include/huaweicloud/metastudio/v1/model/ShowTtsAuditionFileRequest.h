...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowTtsAuditionFileRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowTtsAuditionFileRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowTtsAuditionFileRequest
    : public ModelBase
{
public:
    ShowTtsAuditionFileRequest();
    virtual ~ShowTtsAuditionFileRequest();
    ...
    /////////////////////////////////////////////
    /// ShowTtsAuditionFileRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowTtsAuditionFileRequest& dereference_from_shared_ptr(std::shared_ptr<ShowTtsAuditionFileRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowTtsAuditionFileRequest_H_
