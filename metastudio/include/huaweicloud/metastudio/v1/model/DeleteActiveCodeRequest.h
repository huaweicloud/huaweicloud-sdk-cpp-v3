...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteActiveCodeRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteActiveCodeRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteActiveCodeRequest
    : public ModelBase
{
public:
    DeleteActiveCodeRequest();
    virtual ~DeleteActiveCodeRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteActiveCodeRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteActiveCodeRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteActiveCodeRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteActiveCodeRequest_H_
