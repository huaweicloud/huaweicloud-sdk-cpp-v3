...
ResourceDetail TagResource::getResourceDetail() const
{
    return resourceDetail_;
}

void TagResource::setResourceDetail(const ResourceDetail& value)
{
...
std::vector<ResourceTag>& TagResource::getTags()
{
    return tags_;
}

void TagResource::setTags(const std::vector<ResourceTag>& value)
{
    tags_ = value;
    tagsIsSet_ = true;
}
