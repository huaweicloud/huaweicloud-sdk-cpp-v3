...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_PipelineTemplateSimpleVO_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_PipelineTemplateSimpleVO_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  PipelineTemplateSimpleVO
    : public ModelBase
{
public:
    PipelineTemplateSimpleVO();
    virtual ~PipelineTemplateSimpleVO();
    ...
    /////////////////////////////////////////////
    /// PipelineTemplateSimpleVO members
    ...
    std::vector<PipelineTemplateSimpleVO_stages>& getStages();
    bool stagesIsSet() const;
    void unsetstages();
    void setStages(const std::vector<PipelineTemplateSimpleVO_stages>& value);
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_PipelineTemplateSimpleVO_H_
