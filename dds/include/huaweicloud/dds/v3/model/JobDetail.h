...
#ifndef HUAWEICLOUD_SDK_DDS_V3_MODEL_JobDetail_H_
#define HUAWEICLOUD_SDK_DDS_V3_MODEL_JobDetail_H_
...
/// 
/// </summary>
class HUAWEICLOUD_DDS_V3_EXPORT  JobDetail
    : public ModelBase
{
public:
    JobDetail();
...
#endif // HUAWEICLOUD_SDK_DDS_V3_MODEL_JobDetail_H_
