...
#ifndef HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListGlobalEipSegments_H_
#define HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListGlobalEipSegments_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GEIP_V3_EXPORT  ListGlobalEipSegments
    : public ModelBase
{
public:
    ListGlobalEipSegments();
    virtual ~ListGlobalEipSegments();
    ...
    InternetBandwidthInfo getInternetBandwidth() const;
    bool internetBandwidthIsSet() const;
    void unsetinternetBandwidth();
    void setInternetBandwidth(const InternetBandwidthInfo& value);

    /// <summary>
    /// 
    /// </summary>

    InstanceInfo getAssociateInstance() const;
    bool associateInstanceIsSet() const;
    void unsetassociateInstance();
    void setAssociateInstance(const InstanceInfo& value);
...
protected:
    ...
    InternetBandwidthInfo internetBandwidth_;
    bool internetBandwidthIsSet_;
    InstanceInfo associateInstance_;
    bool associateInstanceIsSet_;
    bool isPrePaid_;
