...
#ifndef HUAWEICLOUD_SDK_CDN_V1_MODEL_BackSources_H_
#define HUAWEICLOUD_SDK_CDN_V1_MODEL_BackSources_H_
...
/// 高级回源信息源站配置。
/// </summary>
class HUAWEICLOUD_CDN_V1_EXPORT  BackSources
    : public ModelBase
{
public:
    BackSources();
...
#endif // HUAWEICLOUD_SDK_CDN_V1_MODEL_BackSources_H_
