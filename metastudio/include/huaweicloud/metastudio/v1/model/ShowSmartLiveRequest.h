...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartLiveRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartLiveRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowSmartLiveRequest
    : public ModelBase
{
public:
    ShowSmartLiveRequest();
    virtual ~ShowSmartLiveRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowSmartLiveRequest& dereference_from_shared_ptr(std::shared_ptr<ShowSmartLiveRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartLiveRequest_H_
