...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListKnowledgeQuestionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListKnowledgeQuestionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListKnowledgeQuestionRequest
    : public ModelBase
{
public:
    ListKnowledgeQuestionRequest();
    virtual ~ListKnowledgeQuestionRequest();
    ...
    /////////////////////////////////////////////
    /// ListKnowledgeQuestionRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListKnowledgeQuestionRequest& dereference_from_shared_ptr(std::shared_ptr<ListKnowledgeQuestionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListKnowledgeQuestionRequest_H_
