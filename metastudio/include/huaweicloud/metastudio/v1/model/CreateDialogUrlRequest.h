...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateDialogUrlRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateDialogUrlRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateDialogUrlRequest
    : public ModelBase
{
public:
    CreateDialogUrlRequest();
    virtual ~CreateDialogUrlRequest();
    ...
    /////////////////////////////////////////////
    /// CreateDialogUrlRequest members
    ...
    CreateDialogUrlReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const CreateDialogUrlReq& value);
...
protected:
    ...
    CreateDialogUrlReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    CreateDialogUrlRequest& dereference_from_shared_ptr(std::shared_ptr<CreateDialogUrlRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateDialogUrlRequest_H_
