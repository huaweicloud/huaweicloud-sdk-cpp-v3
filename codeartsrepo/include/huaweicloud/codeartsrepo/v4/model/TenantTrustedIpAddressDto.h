...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_TenantTrustedIpAddressDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_TenantTrustedIpAddressDto_H_
...
/// **参数解释：** ip白名单信息。
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  TenantTrustedIpAddressDto
    : public ModelBase
{
public:
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_TenantTrustedIpAddressDto_H_
