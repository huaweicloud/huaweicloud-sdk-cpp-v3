...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_ErrorlogForLtsRequest_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_ErrorlogForLtsRequest_H_
...
/// 查询实例的错误日志对象
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  ErrorlogForLtsRequest
    : public ModelBase
{
public:
    ErrorlogForLtsRequest();
    virtual ~ErrorlogForLtsRequest();
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_ErrorlogForLtsRequest_H_
