...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigDeatilUpdate_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  AccessConfigDeatilUpdate
    : public ModelBase
{
public:
    AccessConfigDeatilUpdate();
    virtual ~AccessConfigDeatilUpdate();
    ...
    /////////////////////////////////////////////
    /// AccessConfigDeatilUpdate members
    ...
    AccessConfigFormatUpdate getFormat() const;
    bool formatIsSet() const;
    void unsetformat();
    void setFormat(const AccessConfigFormatUpdate& value);

    /// <summary>
    /// 
    /// </summary>

    AccessConfigWindowsLogInfoUpdate getWindowsLogInfo() const;
    bool windowsLogInfoIsSet() const;
    void unsetwindowsLogInfo();
    void setWindowsLogInfo(const AccessConfigWindowsLogInfoUpdate& value);
...
protected:
    ...
    AccessConfigFormatUpdate format_;
    bool formatIsSet_;
    AccessConfigWindowsLogInfoUpdate windowsLogInfo_;
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigDeatilUpdate_H_
