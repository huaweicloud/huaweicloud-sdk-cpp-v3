...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_CertificatesRspDTO_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_CertificatesRspDTO_H_
...
/// 
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  CertificatesRspDTO
    : public ModelBase
{
public:
    CertificatesRspDTO();
    virtual ~CertificatesRspDTO();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_CertificatesRspDTO_H_
