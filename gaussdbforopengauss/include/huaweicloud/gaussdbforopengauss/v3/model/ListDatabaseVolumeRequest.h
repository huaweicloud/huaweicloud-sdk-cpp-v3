...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListDatabaseVolumeRequest_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListDatabaseVolumeRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  ListDatabaseVolumeRequest
    : public ModelBase
{
public:
    ListDatabaseVolumeRequest();
    virtual ~ListDatabaseVolumeRequest();
    ...
    /////////////////////////////////////////////
    /// ListDatabaseVolumeRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDatabaseVolumeRequest& dereference_from_shared_ptr(std::shared_ptr<ListDatabaseVolumeRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListDatabaseVolumeRequest_H_
