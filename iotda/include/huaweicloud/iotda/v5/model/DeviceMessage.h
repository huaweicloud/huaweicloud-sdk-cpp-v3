...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DeviceMessage_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DeviceMessage_H_
...
/// 
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  DeviceMessage
    : public ModelBase
{
public:
    DeviceMessage();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DeviceMessage_H_
