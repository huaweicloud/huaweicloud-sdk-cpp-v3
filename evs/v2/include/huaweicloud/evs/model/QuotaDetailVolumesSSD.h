...
#ifndef HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailVolumesSSD_H_
...
/// </summary>
class HUAWEICLOUD_EVS_EXPORT  QuotaDetailVolumesSSD
    : public ModelBase
{
public:
    QuotaDetailVolumesSSD();
    virtual ~QuotaDetailVolumesSSD();
...
#endif // HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailVolumesSSD_H_
