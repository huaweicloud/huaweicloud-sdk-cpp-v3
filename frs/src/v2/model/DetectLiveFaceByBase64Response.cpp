...
std::string DetectLiveFaceByBase64Response::getXRequestId() const
{
    return xRequestId_;
}

void DetectLiveFaceByBase64Response::setXRequestId(const std::string& value)
{
    xRequestId_ = value;
    xRequestIdIsSet_ = true;
}

bool DetectLiveFaceByBase64Response::xRequestIdIsSet() const
{
    return xRequestIdIsSet_;
}

void DetectLiveFaceByBase64Response::unsetxRequestId()
{
    xRequestIdIsSet_ = false;
}
