...
BlackWhiteListId UpdateBlackWhiteListResponse::getData() const
{
    return data_;
}

void UpdateBlackWhiteListResponse::setData(const BlackWhiteListId& value)
{
    data_ = value;
    dataIsSet_ = true;
}
