...
#ifndef HUAWEICLOUD_SDK_OCR_V1_MODEL_AnswerBlockList_H_
#define HUAWEICLOUD_SDK_OCR_V1_MODEL_AnswerBlockList_H_
...
/// 
/// </summary>
class HUAWEICLOUD_OCR_V1_EXPORT  AnswerBlockList
    : public ModelBase
{
public:
    AnswerBlockList();
    virtual ~AnswerBlockList();
...
#endif // HUAWEICLOUD_SDK_OCR_V1_MODEL_AnswerBlockList_H_
