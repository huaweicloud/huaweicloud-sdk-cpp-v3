...
std::string ListEntitiesRequest::getXSecurityToken() const
{
    return xSecurityToken_;
}

void ListEntitiesRequest::setXSecurityToken(const std::string& value)
{
    xSecurityToken_ = value;
    xSecurityTokenIsSet_ = true;
}

bool ListEntitiesRequest::xSecurityTokenIsSet() const
{
    return xSecurityTokenIsSet_;
}

void ListEntitiesRequest::unsetxSecurityToken()
{
    xSecurityTokenIsSet_ = false;
}
