...
#ifndef HUAWEICLOUD_SDK_GEIP_V3_MODEL_ExtLimitPojo_H_
#define HUAWEICLOUD_SDK_GEIP_V3_MODEL_ExtLimitPojo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GEIP_V3_EXPORT  ExtLimitPojo
    : public ModelBase
{
public:
    ExtLimitPojo();
...
#endif // HUAWEICLOUD_SDK_GEIP_V3_MODEL_ExtLimitPojo_H_
