...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DeleteDeviceMessageRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DeleteDeviceMessageRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  DeleteDeviceMessageRequest
    : public ModelBase
{
public:
    DeleteDeviceMessageRequest();
    virtual ~DeleteDeviceMessageRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteDeviceMessageRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteDeviceMessageRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteDeviceMessageRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DeleteDeviceMessageRequest_H_
