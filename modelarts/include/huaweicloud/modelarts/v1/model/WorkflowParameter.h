...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_WorkflowParameter_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_WorkflowParameter_H_
...
/// 参数。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  WorkflowParameter
    : public ModelBase
{
public:
    WorkflowParameter();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_WorkflowParameter_H_
