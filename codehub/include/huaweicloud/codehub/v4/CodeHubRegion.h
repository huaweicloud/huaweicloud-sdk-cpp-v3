#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_CodeHubRegion_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_CodeHubRegion_H_
...
class HUAWEICLOUD_CODEHUB_V4_EXPORT CodeHubRegion {
public:
    CodeHubRegion();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_CodeHubRegion_H_