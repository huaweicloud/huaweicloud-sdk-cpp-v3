...
std::string NotificationsResponseBody::getAgencyName() const
{
    return agencyName_;
}

void NotificationsResponseBody::setAgencyName(const std::string& value)
{
    agencyName_ = value;
    agencyNameIsSet_ = true;
}

bool NotificationsResponseBody::agencyNameIsSet() const
{
    return agencyNameIsSet_;
}

void NotificationsResponseBody::unsetagencyName()
{
    agencyNameIsSet_ = false;
}
