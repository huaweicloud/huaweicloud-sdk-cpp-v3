...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_BasicRoleDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_BasicRoleDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  BasicRoleDto
    : public ModelBase
{
public:
    BasicRoleDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_BasicRoleDto_H_
