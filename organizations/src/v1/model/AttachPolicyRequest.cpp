...
std::string AttachPolicyRequest::getXSecurityToken() const
{
    return xSecurityToken_;
}

void AttachPolicyRequest::setXSecurityToken(const std::string& value)
{
    xSecurityToken_ = value;
    xSecurityTokenIsSet_ = true;
}

bool AttachPolicyRequest::xSecurityTokenIsSet() const
{
    return xSecurityTokenIsSet_;
}

void AttachPolicyRequest::unsetxSecurityToken()
{
    xSecurityTokenIsSet_ = false;
}
