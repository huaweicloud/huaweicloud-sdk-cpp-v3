...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateInstructionReq_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateInstructionReq_H_
...
/// 修改指令请求。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateInstructionReq
    : public ModelBase
{
public:
    UpdateInstructionReq();
    virtual ~UpdateInstructionReq();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateInstructionReq_H_
