...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_NamespaceBasicDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_NamespaceBasicDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  NamespaceBasicDto
    : public ModelBase
{
public:
    NamespaceBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_NamespaceBasicDto_H_
