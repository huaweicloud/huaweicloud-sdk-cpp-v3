#ifndef HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_FunctionGraphRegion_H_
#define HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_FunctionGraphRegion_H_
...
class HUAWEICLOUD_FUNCTIONGRAPH_V2_EXPORT FunctionGraphRegion {
public:
    FunctionGraphRegion();
    virtual ~FunctionGraphRegion();
...
#endif // HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_FunctionGraphRegion_H_