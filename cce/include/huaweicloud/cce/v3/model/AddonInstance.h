...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_AddonInstance_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_AddonInstance_H_
...
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  AddonInstance
    : public ModelBase
{
public:
    AddonInstance();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_AddonInstance_H_
