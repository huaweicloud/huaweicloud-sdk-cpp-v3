...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_CreateMessageRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_CreateMessageRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  CreateMessageRequest
    : public ModelBase
{
public:
    ...
    DeviceMessageRequest getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const DeviceMessageRequest& value);
...
protected:
    ...
    DeviceMessageRequest body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    CreateMessageRequest& dereference_from_shared_ptr(std::shared_ptr<CreateMessageRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_CreateMessageRequest_H_
