...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListTransferAssetJobsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListTransferAssetJobsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListTransferAssetJobsRequest
    : public ModelBase
{
public:
    ListTransferAssetJobsRequest();
    virtual ~ListTransferAssetJobsRequest();
    ...
    /////////////////////////////////////////////
    /// ListTransferAssetJobsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListTransferAssetJobsRequest& dereference_from_shared_ptr(std::shared_ptr<ListTransferAssetJobsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListTransferAssetJobsRequest_H_
