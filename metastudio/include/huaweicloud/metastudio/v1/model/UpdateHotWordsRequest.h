...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateHotWordsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateHotWordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateHotWordsRequest
    : public ModelBase
{
public:
    UpdateHotWordsRequest();
    virtual ~UpdateHotWordsRequest();
    ...
    UpdateHotWordsReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateHotWordsReq& value);
...
protected:
    ...
    UpdateHotWordsReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateHotWordsRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateHotWordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateHotWordsRequest_H_
