...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_HotfixRollbackInfos_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_HotfixRollbackInfos_H_
...
/// 可以回退的热补丁信息。
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  HotfixRollbackInfos
    : public ModelBase
{
public:
    HotfixRollbackInfos();
    virtual ~HotfixRollbackInfos();
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_HotfixRollbackInfos_H_
