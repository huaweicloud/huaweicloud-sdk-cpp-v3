...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_NotesCountDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_NotesCountDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  NotesCountDto
    : public ModelBase
{
public:
    NotesCountDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_NotesCountDto_H_
