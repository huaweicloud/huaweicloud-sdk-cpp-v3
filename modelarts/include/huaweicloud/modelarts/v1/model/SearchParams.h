...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_SearchParams_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_SearchParams_H_
...
/// 搜索参数。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  SearchParams
    : public ModelBase
{
public:
    SearchParams();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_SearchParams_H_
