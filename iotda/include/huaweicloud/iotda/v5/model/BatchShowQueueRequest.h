...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_BatchShowQueueRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_BatchShowQueueRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  BatchShowQueueRequest
    : public ModelBase
{
public:
    BatchShowQueueRequest();
    virtual ~BatchShowQueueRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    BatchShowQueueRequest& dereference_from_shared_ptr(std::shared_ptr<BatchShowQueueRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_BatchShowQueueRequest_H_
