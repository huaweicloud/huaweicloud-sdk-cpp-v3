...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Task_algorithm_job_config_engine_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Task_algorithm_job_config_engine_H_
...
/// **参数解释**：算法的引擎。 **约束限制**：不涉及。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  Task_algorithm_job_config_engine
    : public ModelBase
{
public:
    Task_algorithm_job_config_engine();
    virtual ~Task_algorithm_job_config_engine();
    ...
    /////////////////////////////////////////////
    /// Task_algorithm_job_config_engine members
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Task_algorithm_job_config_engine_H_
