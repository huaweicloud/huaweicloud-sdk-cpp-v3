...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowRobotRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowRobotRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowRobotRequest
    : public ModelBase
{
public:
    ShowRobotRequest();
    virtual ~ShowRobotRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowRobotRequest& dereference_from_shared_ptr(std::shared_ptr<ShowRobotRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowRobotRequest_H_
