...
#ifndef HUAWEICLOUD_SDK_CDN_V1_MODEL_Domains_H_
#define HUAWEICLOUD_SDK_CDN_V1_MODEL_Domains_H_
...
#include <huaweicloud/cdn/v1/model/EpResourceTag.h>
...
/// 域名信息
/// </summary>
class HUAWEICLOUD_CDN_V1_EXPORT  Domains
    : public ModelBase
{
public:
    Domains();
    ...
    std::vector<EpResourceTag>& getTags();
    bool tagsIsSet() const;
    void unsettags();
    void setTags(const std::vector<EpResourceTag>& value);
...
protected:
    ...
    std::vector<EpResourceTag> tags_;
    bool tagsIsSet_;
...
#endif // HUAWEICLOUD_SDK_CDN_V1_MODEL_Domains_H_
