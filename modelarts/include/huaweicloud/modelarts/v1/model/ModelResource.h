...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ModelResource_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ModelResource_H_
...
/// <summary>
/// **参数解释：** 模型&amp;权重文件存储挂载配置。 **约束限制：** 不涉及。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ModelResource
    : public ModelBase
{
public:
    ModelResource();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ModelResource_H_
