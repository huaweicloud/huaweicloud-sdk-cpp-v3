...
MergeRequestTemplateFromDto RepositoryMergeRequestTemplateDto::getFrom() const
{
    return from_;
}

void RepositoryMergeRequestTemplateDto::setFrom(const MergeRequestTemplateFromDto& value)
{
    from_ = value;
    fromIsSet_ = true;
}

bool RepositoryMergeRequestTemplateDto::fromIsSet() const
{
    return fromIsSet_;
}

void RepositoryMergeRequestTemplateDto::unsetfrom()
{
    fromIsSet_ = false;
}
