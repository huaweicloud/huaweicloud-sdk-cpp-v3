...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_BacklogPolicyInfo_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_BacklogPolicyInfo_H_
...
/// 数据流转积压策略结构体
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  BacklogPolicyInfo
    : public ModelBase
{
public:
    BacklogPolicyInfo();
    virtual ~BacklogPolicyInfo();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_BacklogPolicyInfo_H_
