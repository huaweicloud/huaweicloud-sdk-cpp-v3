...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MergeRequestTemplateDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MergeRequestTemplateDto_H_
...
/// 合并请求模板返回体
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  MergeRequestTemplateDto
    : public ModelBase
{
public:
    MergeRequestTemplateDto();
    virtual ~MergeRequestTemplateDto();
    ...
    /////////////////////////////////////////////
    /// MergeRequestTemplateDto members
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MergeRequestTemplateDto_H_
