...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_RestoreExistingInstanceRequestBody_source_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_RestoreExistingInstanceRequestBody_source_H_
...
/// 恢复数据源对象。
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  RestoreExistingInstanceRequestBody_source
    : public ModelBase
{
public:
    RestoreExistingInstanceRequestBody_source();
    virtual ~RestoreExistingInstanceRequestBody_source();
    ...
    /////////////////////////////////////////////
    /// RestoreExistingInstanceRequestBody_source members
    ...
    bool isRestoreAllDatabase() const;
    bool restoreAllDatabaseIsSet() const;
    void unsetrestoreAllDatabase();
    void setRestoreAllDatabase(bool value);
...
protected:
    ...
    bool restoreAllDatabase_;
    bool restoreAllDatabaseIsSet_;
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_RestoreExistingInstanceRequestBody_source_H_
