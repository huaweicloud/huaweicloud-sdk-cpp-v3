...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListTtsaJobsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListTtsaJobsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListTtsaJobsRequest
    : public ModelBase
{
public:
    ListTtsaJobsRequest();
    virtual ~ListTtsaJobsRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListTtsaJobsRequest& dereference_from_shared_ptr(std::shared_ptr<ListTtsaJobsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListTtsaJobsRequest_H_
