...
int32_t AccessConfigInfo::getLogSplitSize() const
{
    return logSplitSize_;
}

void AccessConfigInfo::setLogSplitSize(int32_t value)
{
    logSplitSize_ = value;
    logSplitSizeIsSet_ = true;
}

bool AccessConfigInfo::logSplitSizeIsSet() const
{
    return logSplitSizeIsSet_;
}

void AccessConfigInfo::unsetlogSplitSize()
{
    logSplitSizeIsSet_ = false;
}

int32_t AccessConfigInfo::getRecursiveDepth() const
{
    return recursiveDepth_;
}

void AccessConfigInfo::setRecursiveDepth(int32_t value)
{
    recursiveDepth_ = value;
    recursiveDepthIsSet_ = true;
}

bool AccessConfigInfo::recursiveDepthIsSet() const
{
    return recursiveDepthIsSet_;
}

void AccessConfigInfo::unsetrecursiveDepth()
{
    recursiveDepthIsSet_ = false;
}

std::string AccessConfigInfo::getAccessConfigTypeSource() const
{
    return accessConfigTypeSource_;
}

void AccessConfigInfo::setAccessConfigTypeSource(const std::string& value)
{
    accessConfigTypeSource_ = value;
    accessConfigTypeSourceIsSet_ = true;
}

bool AccessConfigInfo::accessConfigTypeSourceIsSet() const
{
    return accessConfigTypeSourceIsSet_;
}

void AccessConfigInfo::unsetaccessConfigTypeSource()
{
    accessConfigTypeSourceIsSet_ = false;
}
