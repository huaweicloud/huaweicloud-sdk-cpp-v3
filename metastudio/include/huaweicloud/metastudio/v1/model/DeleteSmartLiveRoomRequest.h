...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteSmartLiveRoomRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteSmartLiveRoomRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteSmartLiveRoomRequest
    : public ModelBase
{
public:
    DeleteSmartLiveRoomRequest();
    virtual ~DeleteSmartLiveRoomRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteSmartLiveRoomRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteSmartLiveRoomRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteSmartLiveRoomRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteSmartLiveRoomRequest_H_
