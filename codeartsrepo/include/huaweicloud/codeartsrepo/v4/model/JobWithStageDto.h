...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_JobWithStageDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_JobWithStageDto_H_
...
#include <string>
#include <huaweicloud/codeartsrepo/v4/model/BaseJobDto.h>
...
/// 任务带阶段信息
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  JobWithStageDto
    : public ModelBase
{
public:
    JobWithStageDto();
    virtual ~JobWithStageDto();
    ...
    int32_t getStageId() const;
    bool stageIdIsSet() const;
    void unsetstageId();
    void setStageId(int32_t value);
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_JobWithStageDto_H_
