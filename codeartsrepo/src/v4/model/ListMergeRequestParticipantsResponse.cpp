...
std::string ListMergeRequestParticipantsResponse::getXTotal() const
{
    return xTotal_;
}

void ListMergeRequestParticipantsResponse::setXTotal(const std::string& value)
{
    xTotal_ = value;
    xTotalIsSet_ = true;
}

bool ListMergeRequestParticipantsResponse::xTotalIsSet() const
{
    return xTotalIsSet_;
}

void ListMergeRequestParticipantsResponse::unsetxTotal()
{
    xTotalIsSet_ = false;
}
