...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsIntentRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsIntentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowPacifyWordsIntentRequest
    : public ModelBase
{
public:
    ShowPacifyWordsIntentRequest();
    virtual ~ShowPacifyWordsIntentRequest();
    ...
    /////////////////////////////////////////////
    /// ShowPacifyWordsIntentRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowPacifyWordsIntentRequest& dereference_from_shared_ptr(std::shared_ptr<ShowPacifyWordsIntentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsIntentRequest_H_
