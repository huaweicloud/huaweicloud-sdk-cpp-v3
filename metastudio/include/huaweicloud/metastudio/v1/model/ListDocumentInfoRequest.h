...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListDocumentInfoRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListDocumentInfoRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListDocumentInfoRequest
    : public ModelBase
{
public:
    ListDocumentInfoRequest();
    virtual ~ListDocumentInfoRequest();
    ...
    /////////////////////////////////////////////
    /// ListDocumentInfoRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDocumentInfoRequest& dereference_from_shared_ptr(std::shared_ptr<ListDocumentInfoRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListDocumentInfoRequest_H_
