...
#ifndef HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_AddKeystorePermissionResponseBody_H_
#define HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_AddKeystorePermissionResponseBody_H_
...
/// 执行任务接口请求体
/// </summary>
class HUAWEICLOUD_CODEARTSBUILD_V3_EXPORT  AddKeystorePermissionResponseBody
    : public ModelBase
{
public:
    AddKeystorePermissionResponseBody();
    virtual ~AddKeystorePermissionResponseBody();
    ...
    /////////////////////////////////////////////
    /// AddKeystorePermissionResponseBody members
...
#endif // HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_AddKeystorePermissionResponseBody_H_
