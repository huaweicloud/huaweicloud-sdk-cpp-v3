...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelDetailDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelDetailDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  LabelDetailDto
    : public ModelBase
{
public:
    LabelDetailDto();
    virtual ~LabelDetailDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelDetailDto_H_
