...
#ifndef HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_CreateIssueRequestV4_H_
#define HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_CreateIssueRequestV4_H_
...
/// 工作项属性
/// </summary>
class HUAWEICLOUD_PROJECTMAN_V4_EXPORT  CreateIssueRequestV4
    : public ModelBase
{
public:
    CreateIssueRequestV4();
    virtual ~CreateIssueRequestV4();
...
#endif // HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_CreateIssueRequestV4_H_
