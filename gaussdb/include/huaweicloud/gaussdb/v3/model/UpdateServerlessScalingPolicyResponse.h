...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_UpdateServerlessScalingPolicyResponse_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_UpdateServerlessScalingPolicyResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  UpdateServerlessScalingPolicyResponse
    : public ModelBase, public HttpResponse
{
public:
    UpdateServerlessScalingPolicyResponse();
    virtual ~UpdateServerlessScalingPolicyResponse();
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_UpdateServerlessScalingPolicyResponse_H_
