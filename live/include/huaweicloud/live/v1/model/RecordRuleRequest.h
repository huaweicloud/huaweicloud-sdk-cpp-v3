...
#ifndef HUAWEICLOUD_SDK_LIVE_V1_MODEL_RecordRuleRequest_H_
#define HUAWEICLOUD_SDK_LIVE_V1_MODEL_RecordRuleRequest_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LIVE_V1_EXPORT  RecordRuleRequest
    : public ModelBase
{
public:
    RecordRuleRequest();
    virtual ~RecordRuleRequest();
...
#endif // HUAWEICLOUD_SDK_LIVE_V1_MODEL_RecordRuleRequest_H_
