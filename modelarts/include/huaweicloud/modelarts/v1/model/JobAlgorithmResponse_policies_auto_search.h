...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_JobAlgorithmResponse_policies_auto_search_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_JobAlgorithmResponse_policies_auto_search_H_
...
/// 超参搜索配置。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  JobAlgorithmResponse_policies_auto_search
    : public ModelBase
{
public:
    JobAlgorithmResponse_policies_auto_search();
    virtual ~JobAlgorithmResponse_policies_auto_search();
    ...
    /////////////////////////////////////////////
    /// JobAlgorithmResponse_policies_auto_search members
    ...
    std::vector<JobAlgorithmResponse_policies_auto_search_search_params>& getSearchParams();
    bool searchParamsIsSet() const;
    void unsetsearchParams();
    void setSearchParams(const std::vector<JobAlgorithmResponse_policies_auto_search_search_params>& value);
...
protected:
    ...
    std::vector<JobAlgorithmResponse_policies_auto_search_search_params> searchParams_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_JobAlgorithmResponse_policies_auto_search_H_
