...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowLayoutRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowLayoutRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  ShowLayoutRequest
    : public ModelBase
{
public:
    ShowLayoutRequest();
    virtual ~ShowLayoutRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowLayoutRequest& dereference_from_shared_ptr(std::shared_ptr<ShowLayoutRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowLayoutRequest_H_
