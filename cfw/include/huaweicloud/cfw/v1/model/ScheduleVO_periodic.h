...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_ScheduleVO_periodic_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_ScheduleVO_periodic_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  ScheduleVO_periodic
    : public ModelBase
{
public:
    ScheduleVO_periodic();
    virtual ~ScheduleVO_periodic();
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_ScheduleVO_periodic_H_
