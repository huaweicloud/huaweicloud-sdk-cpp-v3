...
#ifndef HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatusServiceRequest_H_
#define HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatusServiceRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CPCS_V1_EXPORT  ShowStatusServiceRequest
    : public ModelBase
{
public:
    ShowStatusServiceRequest();
    virtual ~ShowStatusServiceRequest();
    ...
    /////////////////////////////////////////////
    /// ShowStatusServiceRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowStatusServiceRequest& dereference_from_shared_ptr(std::shared_ptr<ShowStatusServiceRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatusServiceRequest_H_
