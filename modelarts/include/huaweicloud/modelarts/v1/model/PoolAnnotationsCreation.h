...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_PoolAnnotationsCreation_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_PoolAnnotationsCreation_H_
...
/// 资源池的注释信息。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  PoolAnnotationsCreation
    : public ModelBase
{
public:
    PoolAnnotationsCreation();
    virtual ~PoolAnnotationsCreation();
    ...
    /////////////////////////////////////////////
    /// PoolAnnotationsCreation members
    ...
    std::string getOsModelartsAutoPay() const;
    bool osModelartsAutoPayIsSet() const;
    void unsetosModelartsAutoPay();
    void setOsModelartsAutoPay(const std::string& value);
...
protected:
    ...
    std::string osModelartsAutoPay_;
    bool osModelartsAutoPayIsSet_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_PoolAnnotationsCreation_H_
