...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DownloadDocumentRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DownloadDocumentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DownloadDocumentRequest
    : public ModelBase
{
public:
    DownloadDocumentRequest();
    virtual ~DownloadDocumentRequest();
    ...
    /////////////////////////////////////////////
    /// DownloadDocumentRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DownloadDocumentRequest& dereference_from_shared_ptr(std::shared_ptr<DownloadDocumentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DownloadDocumentRequest_H_
