...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_KeywordsResBody_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_KeywordsResBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  KeywordsResBody
    : public ModelBase
{
public:
    KeywordsResBody();
    virtual ~KeywordsResBody();
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_KeywordsResBody_H_
