...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_CommitInfo_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_CommitInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  CommitInfo
    : public ModelBase
{
public:
    CommitInfo();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_CommitInfo_H_
