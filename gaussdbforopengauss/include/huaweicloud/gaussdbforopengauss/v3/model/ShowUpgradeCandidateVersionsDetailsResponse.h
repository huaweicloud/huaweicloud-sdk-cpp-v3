...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ShowUpgradeCandidateVersionsDetailsResponse_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ShowUpgradeCandidateVersionsDetailsResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  ShowUpgradeCandidateVersionsDetailsResponse
    : public ModelBase, public HttpResponse
{
public:
    ShowUpgradeCandidateVersionsDetailsResponse();
    virtual ~ShowUpgradeCandidateVersionsDetailsResponse();
    ...
    /////////////////////////////////////////////
    /// ShowUpgradeCandidateVersionsDetailsResponse members
    ...
    std::vector<CanBeUpgradedHotfixDetail>& getHotfixUpgradeInfos();
    bool hotfixUpgradeInfosIsSet() const;
    void unsethotfixUpgradeInfos();
    void setHotfixUpgradeInfos(const std::vector<CanBeUpgradedHotfixDetail>& value);

    /// <summary>
    /// 可以回滚的热补丁信息。
    /// </summary>

    std::vector<CanBeRollbackedHotfixDetail>& getHotfixRollbackInfos();
    bool hotfixRollbackInfosIsSet() const;
    void unsethotfixRollbackInfos();
    void setHotfixRollbackInfos(const std::vector<CanBeRollbackedHotfixDetail>& value);
...
protected:
    ...
    std::vector<CanBeUpgradedHotfixDetail> hotfixUpgradeInfos_;
    bool hotfixUpgradeInfosIsSet_;
    std::vector<CanBeRollbackedHotfixDetail> hotfixRollbackInfos_;
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ShowUpgradeCandidateVersionsDetailsResponse_H_
