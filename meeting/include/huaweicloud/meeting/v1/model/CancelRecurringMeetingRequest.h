...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_CancelRecurringMeetingRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_CancelRecurringMeetingRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  CancelRecurringMeetingRequest
    : public ModelBase
{
public:
    CancelRecurringMeetingRequest();
    virtual ~CancelRecurringMeetingRequest();
    ...
    /////////////////////////////////////////////
    /// CancelRecurringMeetingRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    CancelRecurringMeetingRequest& dereference_from_shared_ptr(std::shared_ptr<CancelRecurringMeetingRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_CancelRecurringMeetingRequest_H_
