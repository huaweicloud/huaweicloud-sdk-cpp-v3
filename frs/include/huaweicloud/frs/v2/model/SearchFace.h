...
#ifndef HUAWEICLOUD_SDK_FRS_V2_MODEL_SearchFace_H_
#define HUAWEICLOUD_SDK_FRS_V2_MODEL_SearchFace_H_
...
/// 
/// </summary>
class HUAWEICLOUD_FRS_V2_EXPORT  SearchFace
    : public ModelBase
{
public:
    SearchFace();
...
#endif // HUAWEICLOUD_SDK_FRS_V2_MODEL_SearchFace_H_
