...
#ifndef HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailSnapshots_H_
...
/// </summary>
class HUAWEICLOUD_EVS_EXPORT  QuotaDetailSnapshots
    : public ModelBase
{
public:
    QuotaDetailSnapshots();
    virtual ~QuotaDetailSnapshots();
...
#endif // HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailSnapshots_H_
