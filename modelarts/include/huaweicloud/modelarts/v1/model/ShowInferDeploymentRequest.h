...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowInferDeploymentRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowInferDeploymentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ShowInferDeploymentRequest
    : public ModelBase
{
public:
    ShowInferDeploymentRequest();
    virtual ~ShowInferDeploymentRequest();
    ...
    /////////////////////////////////////////////
    /// ShowInferDeploymentRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowInferDeploymentRequest& dereference_from_shared_ptr(std::shared_ptr<ShowInferDeploymentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowInferDeploymentRequest_H_
