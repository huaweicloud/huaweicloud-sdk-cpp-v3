...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_GrantedUsersDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_GrantedUsersDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  GrantedUsersDto
    : public ModelBase
{
public:
    GrantedUsersDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_GrantedUsersDto_H_
