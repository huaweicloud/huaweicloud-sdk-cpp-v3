...
bool UpdateMergeRequestDiscussionResponse::isFromRobot() const
{
    return fromRobot_;
}

void UpdateMergeRequestDiscussionResponse::setFromRobot(bool value)
{
    fromRobot_ = value;
    fromRobotIsSet_ = true;
}

bool UpdateMergeRequestDiscussionResponse::fromRobotIsSet() const
{
    return fromRobotIsSet_;
}

void UpdateMergeRequestDiscussionResponse::unsetfromRobot()
{
    fromRobotIsSet_ = false;
}
