...
#ifndef HUAWEICLOUD_SDK_OCR_V1_MODEL_WaybillElectronicRequestBody_H_
#define HUAWEICLOUD_SDK_OCR_V1_MODEL_WaybillElectronicRequestBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_OCR_V1_EXPORT  WaybillElectronicRequestBody
    : public ModelBase
{
public:
    WaybillElectronicRequestBody();
    virtual ~WaybillElectronicRequestBody();
...
#endif // HUAWEICLOUD_SDK_OCR_V1_MODEL_WaybillElectronicRequestBody_H_
