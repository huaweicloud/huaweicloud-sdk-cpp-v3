...
std::string CreateAssetReviewTaskRequest::getAuthorization() const
{
    return authorization_;
}

void CreateAssetReviewTaskRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool CreateAssetReviewTaskRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void CreateAssetReviewTaskRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
