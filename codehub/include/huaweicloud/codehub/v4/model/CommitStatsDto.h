...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitStatsDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitStatsDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  CommitStatsDto
    : public ModelBase
{
public:
    CommitStatsDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitStatsDto_H_
