...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ValidateRobotRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ValidateRobotRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ValidateRobotRequest
    : public ModelBase
{
public:
    ValidateRobotRequest();
    virtual ~ValidateRobotRequest();
    ...
    ValidateRobotReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const ValidateRobotReq& value);
...
protected:
    ...
    ValidateRobotReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    ValidateRobotRequest& dereference_from_shared_ptr(std::shared_ptr<ValidateRobotRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ValidateRobotRequest_H_
