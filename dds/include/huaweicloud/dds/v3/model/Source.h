...
#ifndef HUAWEICLOUD_SDK_DDS_V3_MODEL_Source_H_
#define HUAWEICLOUD_SDK_DDS_V3_MODEL_Source_H_
...
/// 
/// </summary>
class HUAWEICLOUD_DDS_V3_EXPORT  Source
    : public ModelBase
{
public:
    Source();
...
#endif // HUAWEICLOUD_SDK_DDS_V3_MODEL_Source_H_
