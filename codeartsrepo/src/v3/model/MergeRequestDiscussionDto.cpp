...
int32_t MergeRequestDiscussionDto::getProjectId() const
{
    return projectId_;
}

void MergeRequestDiscussionDto::setProjectId(int32_t value)
{
    projectId_ = value;
    projectIdIsSet_ = true;
}

bool MergeRequestDiscussionDto::projectIdIsSet() const
{
    return projectIdIsSet_;
}

void MergeRequestDiscussionDto::unsetprojectId()
{
    projectIdIsSet_ = false;
}
...
std::string MergeRequestDiscussionDto::getProjectFullPath() const
{
    return projectFullPath_;
}

void MergeRequestDiscussionDto::setProjectFullPath(const std::string& value)
{
    projectFullPath_ = value;
    projectFullPathIsSet_ = true;
}

bool MergeRequestDiscussionDto::projectFullPathIsSet() const
{
    return projectFullPathIsSet_;
}

void MergeRequestDiscussionDto::unsetprojectFullPath()
{
    projectFullPathIsSet_ = false;
}
