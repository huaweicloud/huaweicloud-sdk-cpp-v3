...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CommitStatistic_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CommitStatistic_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  CommitStatistic
    : public ModelBase
{
public:
    CommitStatistic();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CommitStatistic_H_
