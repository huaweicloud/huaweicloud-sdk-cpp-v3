...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteRobotRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteRobotRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteRobotRequest
    : public ModelBase
{
public:
    DeleteRobotRequest();
    virtual ~DeleteRobotRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteRobotRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteRobotRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteRobotRequest_H_
