...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_CreateNodePoolRequestBody_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_CreateNodePoolRequestBody_H_
...
/// 创建资源池请求体。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  CreateNodePoolRequestBody
    : public ModelBase
{
public:
    CreateNodePoolRequestBody();
    virtual ~CreateNodePoolRequestBody();
    ...
    /////////////////////////////////////////////
    /// CreateNodePoolRequestBody members
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_CreateNodePoolRequestBody_H_
