...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_QueryQueueBase_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_QueryQueueBase_H_
...
/// 队列信息结构体，返回基本信息。
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  QueryQueueBase
    : public ModelBase
{
public:
    QueryQueueBase();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_QueryQueueBase_H_
