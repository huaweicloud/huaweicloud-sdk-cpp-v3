...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_CreateLimitTaskResponse_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_CreateLimitTaskResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  CreateLimitTaskResponse
    : public ModelBase, public HttpResponse
{
public:
    CreateLimitTaskResponse();
    virtual ~CreateLimitTaskResponse();
    ...
    /////////////////////////////////////////////
    /// CreateLimitTaskResponse members
    ...
    std::vector<CreateLimitTaskNodeResult>& getNodeInfos();
    bool nodeInfosIsSet() const;
    void unsetnodeInfos();
    void setNodeInfos(const std::vector<CreateLimitTaskNodeResult>& value);
...
protected:
    ...
    bool modifierIsSet_;
    std::vector<CreateLimitTaskNodeResult> nodeInfos_;
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_CreateLimitTaskResponse_H_
