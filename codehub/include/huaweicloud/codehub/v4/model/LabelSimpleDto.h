...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LabelSimpleDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LabelSimpleDto_H_
...
#include <huaweicloud/codehub/v4/model/LabelBaseDto.h>
#include <string>
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  LabelSimpleDto
    : public ModelBase
{
public:
    LabelSimpleDto();
    virtual ~LabelSimpleDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_LabelSimpleDto_H_
