...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_CreateCommitResponseBody_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_CreateCommitResponseBody_H_
...
#include <string>
#include <huaweicloud/codehub/v3/model/CreateCommitResponseBody_stats.h>
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  CreateCommitResponseBody
    : public ModelBase
{
public:
    CreateCommitResponseBody();
    virtual ~CreateCommitResponseBody();
    ...
    /////////////////////////////////////////////
    /// CreateCommitResponseBody members
    ...
    CreateCommitResponseBody_stats getStats() const;
    bool statsIsSet() const;
    void unsetstats();
    void setStats(const CreateCommitResponseBody_stats& value);
...
protected:
    ...
    CreateCommitResponseBody_stats stats_;
    bool statsIsSet_;
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_CreateCommitResponseBody_H_
