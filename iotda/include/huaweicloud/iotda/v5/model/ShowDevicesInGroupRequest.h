...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ShowDevicesInGroupRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ShowDevicesInGroupRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ShowDevicesInGroupRequest
    : public ModelBase
{
public:
    ShowDevicesInGroupRequest();
    virtual ~ShowDevicesInGroupRequest();
    ...
    /////////////////////////////////////////////
    /// ShowDevicesInGroupRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowDevicesInGroupRequest& dereference_from_shared_ptr(std::shared_ptr<ShowDevicesInGroupRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ShowDevicesInGroupRequest_H_
