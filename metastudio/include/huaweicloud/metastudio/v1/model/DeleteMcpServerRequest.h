...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteMcpServerRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteMcpServerRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteMcpServerRequest
    : public ModelBase
{
public:
    DeleteMcpServerRequest();
    virtual ~DeleteMcpServerRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteMcpServerRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteMcpServerRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteMcpServerRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteMcpServerRequest_H_
