...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Lease_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Lease_H_
...
/// 实例自动停止的倒计时信息。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  Lease
    : public ModelBase
{
public:
    Lease();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Lease_H_
