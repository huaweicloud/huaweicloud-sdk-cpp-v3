...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_CanBeUpgradedHotfixDetail_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_CanBeUpgradedHotfixDetail_H_
...
/// 可以升级的热补丁信息。
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  CanBeUpgradedHotfixDetail
    : public ModelBase
{
public:
    CanBeUpgradedHotfixDetail();
    virtual ~CanBeUpgradedHotfixDetail();
    ...
    /////////////////////////////////////////////
    /// CanBeUpgradedHotfixDetail members
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_CanBeUpgradedHotfixDetail_H_
