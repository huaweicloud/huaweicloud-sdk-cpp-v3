...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdatePluginConfigRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdatePluginConfigRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdatePluginConfigRequest
    : public ModelBase
{
public:
    UpdatePluginConfigRequest();
    virtual ~UpdatePluginConfigRequest();
    ...
    /////////////////////////////////////////////
    /// UpdatePluginConfigRequest members
    ...
    UpdatePluginConfigReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdatePluginConfigReq& value);
...
protected:
    ...
    UpdatePluginConfigReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdatePluginConfigRequest& dereference_from_shared_ptr(std::shared_ptr<UpdatePluginConfigRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdatePluginConfigRequest_H_
