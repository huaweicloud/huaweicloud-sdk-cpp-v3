...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ListSlowLogsRequest_H_
#define HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ListSlowLogsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GAUSSDBFORNOSQL_V3_EXPORT  ListSlowLogsRequest
    : public ModelBase
{
public:
    ListSlowLogsRequest();
    virtual ~ListSlowLogsRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListSlowLogsRequest& dereference_from_shared_ptr(std::shared_ptr<ListSlowLogsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ListSlowLogsRequest_H_
