...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_LiveRoomEventCallBackConfig_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_LiveRoomEventCallBackConfig_H_
...
/// 
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  LiveRoomEventCallBackConfig
    : public ModelBase
{
public:
    LiveRoomEventCallBackConfig();
    virtual ~LiveRoomEventCallBackConfig();
    ...
    /////////////////////////////////////////////
    /// LiveRoomEventCallBackConfig members
    ...
    bool isIsInheritancePlatformCallback() const;
    bool isInheritancePlatformCallbackIsSet() const;
    void unsetisInheritancePlatformCallback();
    void setIsInheritancePlatformCallback(bool value);
...
protected:
    ...
    bool isInheritancePlatformCallback_;
    bool isInheritancePlatformCallbackIsSet_;
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_LiveRoomEventCallBackConfig_H_
