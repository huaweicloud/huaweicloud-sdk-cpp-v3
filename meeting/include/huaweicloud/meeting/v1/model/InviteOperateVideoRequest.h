...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_InviteOperateVideoRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_InviteOperateVideoRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  InviteOperateVideoRequest
    : public ModelBase
{
public:
    InviteOperateVideoRequest();
    virtual ~InviteOperateVideoRequest();
    ...
    /////////////////////////////////////////////
    /// InviteOperateVideoRequest members
    ...
    RestVideoBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestVideoBody& value);
...
protected:
    ...
    RTTR_ENABLE()
public:
    InviteOperateVideoRequest& dereference_from_shared_ptr(std::shared_ptr<InviteOperateVideoRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_InviteOperateVideoRequest_H_
