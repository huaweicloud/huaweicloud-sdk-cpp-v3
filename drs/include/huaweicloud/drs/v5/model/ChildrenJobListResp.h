...
#ifndef HUAWEICLOUD_SDK_DRS_V5_MODEL_ChildrenJobListResp_H_
#define HUAWEICLOUD_SDK_DRS_V5_MODEL_ChildrenJobListResp_H_
...
/// 子任务列表响应体。
/// </summary>
class HUAWEICLOUD_DRS_V5_EXPORT  ChildrenJobListResp
    : public ModelBase
{
public:
    ChildrenJobListResp();
    virtual ~ChildrenJobListResp();
...
#endif // HUAWEICLOUD_SDK_DRS_V5_MODEL_ChildrenJobListResp_H_
