...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ResetActiveCodeRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ResetActiveCodeRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ResetActiveCodeRequest
    : public ModelBase
{
public:
    ResetActiveCodeRequest();
    virtual ~ResetActiveCodeRequest();
    ...
    /////////////////////////////////////////////
    /// ResetActiveCodeRequest members
    ...
    ResetActiveCodeReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const ResetActiveCodeReq& value);
...
protected:
    ...
    ResetActiveCodeReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    ResetActiveCodeRequest& dereference_from_shared_ptr(std::shared_ptr<ResetActiveCodeRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ResetActiveCodeRequest_H_
