...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteHotWordsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteHotWordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteHotWordsRequest
    : public ModelBase
{
public:
    DeleteHotWordsRequest();
    virtual ~DeleteHotWordsRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteHotWordsRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteHotWordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteHotWordsRequest_H_
