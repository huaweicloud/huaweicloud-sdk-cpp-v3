...
#ifndef HUAWEICLOUD_SDK_CDN_V1_MODEL_CacheUrlParameterFilter_H_
#define HUAWEICLOUD_SDK_CDN_V1_MODEL_CacheUrlParameterFilter_H_
...
/// 缓存url参数配置。
/// </summary>
class HUAWEICLOUD_CDN_V1_EXPORT  CacheUrlParameterFilter
    : public ModelBase
{
public:
...
#endif // HUAWEICLOUD_SDK_CDN_V1_MODEL_CacheUrlParameterFilter_H_
