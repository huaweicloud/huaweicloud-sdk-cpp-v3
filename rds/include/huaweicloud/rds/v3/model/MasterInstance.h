...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_MasterInstance_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_MasterInstance_H_
...
/// 
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  MasterInstance
    : public ModelBase
{
public:
    MasterInstance();
    virtual ~MasterInstance();
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_MasterInstance_H_
