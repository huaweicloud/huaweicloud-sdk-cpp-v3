...
#ifndef HUAWEICLOUD_SDK_IOTDM_V5_MODEL_ListInstanceTasksRequest_H_
#define HUAWEICLOUD_SDK_IOTDM_V5_MODEL_ListInstanceTasksRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDM_V5_EXPORT  ListInstanceTasksRequest
    : public ModelBase
{
public:
    ListInstanceTasksRequest();
    virtual ~ListInstanceTasksRequest();
    ...
    /////////////////////////////////////////////
    /// ListInstanceTasksRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListInstanceTasksRequest& dereference_from_shared_ptr(std::shared_ptr<ListInstanceTasksRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDM_V5_MODEL_ListInstanceTasksRequest_H_
