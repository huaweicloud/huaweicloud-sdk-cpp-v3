...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ServiceResponse_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ServiceResponse_H_
...
/// **参数解释：** 在线服务返回体
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ServiceResponse
    : public ModelBase
{
public:
    ServiceResponse();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ServiceResponse_H_
