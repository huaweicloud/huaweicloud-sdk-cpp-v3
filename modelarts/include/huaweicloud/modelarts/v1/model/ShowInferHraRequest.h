...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowInferHraRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowInferHraRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ShowInferHraRequest
    : public ModelBase
{
public:
    ShowInferHraRequest();
    virtual ~ShowInferHraRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowInferHraRequest& dereference_from_shared_ptr(std::shared_ptr<ShowInferHraRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ShowInferHraRequest_H_
