...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListInstanceDetailsRequest_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListInstanceDetailsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  ListInstanceDetailsRequest
    : public ModelBase
{
public:
    ListInstanceDetailsRequest();
    virtual ~ListInstanceDetailsRequest();
    ...
    /////////////////////////////////////////////
    /// ListInstanceDetailsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListInstanceDetailsRequest& dereference_from_shared_ptr(std::shared_ptr<ListInstanceDetailsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListInstanceDetailsRequest_H_
