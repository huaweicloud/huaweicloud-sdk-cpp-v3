...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_VideoScriptsShowInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_VideoScriptsShowInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  VideoScriptsShowInfo
    : public ModelBase
{
public:
    VideoScriptsShowInfo();
    virtual ~VideoScriptsShowInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_VideoScriptsShowInfo_H_
