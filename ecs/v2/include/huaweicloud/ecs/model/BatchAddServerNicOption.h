...
#include "huaweicloud/ecs/model/Ipv6Bandwidth.h"
#include <string>
#include <vector>
#include "huaweicloud/ecs/model/ServerNicSecurityGroup.h"
...
/// 
/// </summary>
class HUAWEICLOUD_ECS_EXPORT  BatchAddServerNicOption
    : public ModelBase
{
public:
