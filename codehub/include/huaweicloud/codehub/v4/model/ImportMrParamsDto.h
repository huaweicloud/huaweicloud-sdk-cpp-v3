...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ImportMrParamsDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ImportMrParamsDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ImportMrParamsDto
    : public ModelBase
{
public:
    ImportMrParamsDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ImportMrParamsDto_H_
