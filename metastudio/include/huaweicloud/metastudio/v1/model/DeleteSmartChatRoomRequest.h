...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteSmartChatRoomRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteSmartChatRoomRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteSmartChatRoomRequest
    : public ModelBase
{
public:
    DeleteSmartChatRoomRequest();
    virtual ~DeleteSmartChatRoomRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteSmartChatRoomRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteSmartChatRoomRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteSmartChatRoomRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteSmartChatRoomRequest_H_
