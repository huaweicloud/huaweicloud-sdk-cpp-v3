...
#ifndef HUAWEICLOUD_SDK_ANTIDDOS_V2_MODEL_ExtendDDoSSet_H_
#define HUAWEICLOUD_SDK_ANTIDDOS_V2_MODEL_ExtendDDoSSet_H_
...
/// 扩展配置列表
/// </summary>
class HUAWEICLOUD_ANTIDDOS_V2_EXPORT  ExtendDDoSSet
    : public ModelBase
{
public:
    ExtendDDoSSet();
...
#endif // HUAWEICLOUD_SDK_ANTIDDOS_V2_MODEL_ExtendDDoSSet_H_
