...
#ifndef HUAWEICLOUD_SDK_CBR_V1_MODEL_CbcProductInfoUpdate_H_
#define HUAWEICLOUD_SDK_CBR_V1_MODEL_CbcProductInfoUpdate_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CBR_V1_EXPORT  CbcProductInfoUpdate
    : public ModelBase
{
public:
    CbcProductInfoUpdate();
    virtual ~CbcProductInfoUpdate();
...
#endif // HUAWEICLOUD_SDK_CBR_V1_MODEL_CbcProductInfoUpdate_H_
