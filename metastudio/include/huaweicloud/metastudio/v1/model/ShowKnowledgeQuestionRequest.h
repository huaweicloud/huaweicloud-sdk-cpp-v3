...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeQuestionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeQuestionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowKnowledgeQuestionRequest
    : public ModelBase
{
public:
    ShowKnowledgeQuestionRequest();
    virtual ~ShowKnowledgeQuestionRequest();
    ...
    /////////////////////////////////////////////
    /// ShowKnowledgeQuestionRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowKnowledgeQuestionRequest& dereference_from_shared_ptr(std::shared_ptr<ShowKnowledgeQuestionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeQuestionRequest_H_
