...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_InfluxdbSlowLogDetail_H_
#define HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_InfluxdbSlowLogDetail_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GAUSSDBFORNOSQL_V3_EXPORT  InfluxdbSlowLogDetail
    : public ModelBase
{
public:
    InfluxdbSlowLogDetail();
    virtual ~InfluxdbSlowLogDetail();
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_InfluxdbSlowLogDetail_H_
