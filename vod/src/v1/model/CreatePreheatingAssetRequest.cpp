...
std::string CreatePreheatingAssetRequest::getAuthorization() const
{
    return authorization_;
}

void CreatePreheatingAssetRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool CreatePreheatingAssetRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void CreatePreheatingAssetRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
