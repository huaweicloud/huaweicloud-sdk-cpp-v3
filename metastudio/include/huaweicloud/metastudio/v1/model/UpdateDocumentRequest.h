...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateDocumentRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateDocumentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateDocumentRequest
    : public ModelBase
{
public:
    ...
    UpdateDocumentRequestBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateDocumentRequestBody& value);
...
protected:
    ...
    UpdateDocumentRequestBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateDocumentRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateDocumentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateDocumentRequest_H_
