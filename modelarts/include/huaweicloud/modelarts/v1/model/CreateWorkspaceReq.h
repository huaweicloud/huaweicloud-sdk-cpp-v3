...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_CreateWorkspaceReq_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_CreateWorkspaceReq_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  CreateWorkspaceReq
    : public ModelBase
{
public:
    CreateWorkspaceReq();
    virtual ~CreateWorkspaceReq();
    ...
    /////////////////////////////////////////////
    /// CreateWorkspaceReq members

    /// <summary>
    /// 授权用户列表，默认为空。需要与“auth_type”参数配合使用，且仅当授权类型为“INTERNAL”时才会生效。
    /// </summary>

    std::vector<CreateWorkspaceReq_grants>& getGrants();
    bool grantsIsSet() const;
    void unsetgrants();
    void setGrants(const std::vector<CreateWorkspaceReq_grants>& value);
...
protected:
    std::vector<CreateWorkspaceReq_grants> grants_;
    bool grantsIsSet_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_CreateWorkspaceReq_H_
