...
#	if defined(HUAWEICLOUD_EIP_V2_SHARED)
#		define HUAWEICLOUD_EIP_V2_EXPORT HUAWEICLOUD_EXPORT
#	else
#		define HUAWEICLOUD_EIP_V2_EXPORT HUAWEICLOUD_IMPORT
#	endif
#else
#	define HUAWEICLOUD_EIP_V2_EXPORT
#endif
