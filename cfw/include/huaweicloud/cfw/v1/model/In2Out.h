...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_In2Out_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_In2Out_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  In2Out
    : public ModelBase
{
public:
    In2Out();
    ...
    std::vector<ItemVO>& getDstHost();
    bool dstHostIsSet() const;
    void unsetdstHost();
    void setDstHost(const std::vector<ItemVO>& value);
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_In2Out_H_
