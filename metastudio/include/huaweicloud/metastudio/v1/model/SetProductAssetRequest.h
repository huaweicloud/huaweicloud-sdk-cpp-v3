...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_SetProductAssetRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_SetProductAssetRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  SetProductAssetRequest
    : public ModelBase
{
public:
    SetProductAssetRequest();
    virtual ~SetProductAssetRequest();
    ...
    /////////////////////////////////////////////
    /// SetProductAssetRequest members
    ...
    ProductAssetReleation getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const ProductAssetReleation& value);
...
protected:
    ...
    ProductAssetReleation body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    SetProductAssetRequest& dereference_from_shared_ptr(std::shared_ptr<SetProductAssetRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_SetProductAssetRequest_H_
