...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MergeRequestBasicDiscussionDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MergeRequestBasicDiscussionDto_H_
...
/// 合并请求单个检视意见基础信息。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  MergeRequestBasicDiscussionDto
    : public ModelBase
{
public:
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MergeRequestBasicDiscussionDto_H_
