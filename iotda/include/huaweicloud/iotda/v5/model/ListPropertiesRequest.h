...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListPropertiesRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListPropertiesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListPropertiesRequest
    : public ModelBase
{
public:
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListPropertiesRequest& dereference_from_shared_ptr(std::shared_ptr<ListPropertiesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListPropertiesRequest_H_
