...
bool ShowDeployTaskDetailResponse::isCanDisable() const
{
    return canDisable_;
}

void ShowDeployTaskDetailResponse::setCanDisable(bool value)
{
    canDisable_ = value;
    canDisableIsSet_ = true;
}

bool ShowDeployTaskDetailResponse::canDisableIsSet() const
{
    return canDisableIsSet_;
}

void ShowDeployTaskDetailResponse::unsetcanDisable()
{
    canDisableIsSet_ = false;
}
...
std::string ShowDeployTaskDetailResponse::getAppId() const
{
    return appId_;
}

void ShowDeployTaskDetailResponse::setAppId(const std::string& value)
{
    appId_ = value;
    appIdIsSet_ = true;
}

bool ShowDeployTaskDetailResponse::appIdIsSet() const
{
    return appIdIsSet_;
}

void ShowDeployTaskDetailResponse::unsetappId()
{
    appIdIsSet_ = false;
}

bool ShowDeployTaskDetailResponse::isIsDisable() const
{
    return isDisable_;
}

void ShowDeployTaskDetailResponse::setIsDisable(bool value)
{
    isDisable_ = value;
    isDisableIsSet_ = true;
}

bool ShowDeployTaskDetailResponse::isDisableIsSet() const
{
    return isDisableIsSet_;
}

void ShowDeployTaskDetailResponse::unsetisDisable()
{
    isDisableIsSet_ = false;
}
