...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_AssociateVmrRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_AssociateVmrRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  AssociateVmrRequest
    : public ModelBase
{
public:
    AssociateVmrRequest();
    virtual ~AssociateVmrRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    AssociateVmrRequest& dereference_from_shared_ptr(std::shared_ptr<AssociateVmrRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_AssociateVmrRequest_H_
