...
bool GlanceUpdateImageResponse::isDeleted() const
{
    return deleted_;
}

void GlanceUpdateImageResponse::setDeleted(bool value)
{
    deleted_ = value;
    deletedIsSet_ = true;
}

bool GlanceUpdateImageResponse::deletedIsSet() const
{
    return deletedIsSet_;
}

void GlanceUpdateImageResponse::unsetdeleted()
{
    deletedIsSet_ = false;
}

std::string GlanceUpdateImageResponse::getDeletedAt() const
{
    return deletedAt_;
}

void GlanceUpdateImageResponse::setDeletedAt(const std::string& value)
{
    deletedAt_ = value;
    deletedAtIsSet_ = true;
}

bool GlanceUpdateImageResponse::deletedAtIsSet() const
{
    return deletedAtIsSet_;
}

void GlanceUpdateImageResponse::unsetdeletedAt()
{
    deletedAtIsSet_ = false;
}
