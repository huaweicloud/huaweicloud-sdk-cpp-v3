...
#ifndef HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatisticResourceRequest_H_
#define HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatisticResourceRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CPCS_V1_EXPORT  ShowStatisticResourceRequest
    : public ModelBase
{
public:
    ShowStatisticResourceRequest();
    virtual ~ShowStatisticResourceRequest();
    ...
    /////////////////////////////////////////////
    /// ShowStatisticResourceRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowStatisticResourceRequest& dereference_from_shared_ptr(std::shared_ptr<ShowStatisticResourceRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatisticResourceRequest_H_
