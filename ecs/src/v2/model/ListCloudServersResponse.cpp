...
int32_t ListCloudServersResponse::getCount() const
{
    return count_;
}

void ListCloudServersResponse::setCount(int32_t value)
{
    count_ = value;
    countIsSet_ = true;
}

bool ListCloudServersResponse::countIsSet() const
{
    return countIsSet_;
}

void ListCloudServersResponse::unsetcount()
{
    countIsSet_ = false;
}
