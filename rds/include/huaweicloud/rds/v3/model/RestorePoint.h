...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_RestorePoint_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_RestorePoint_H_
...
/// 
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  RestorePoint
    : public ModelBase
{
public:
    RestorePoint();
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_RestorePoint_H_
