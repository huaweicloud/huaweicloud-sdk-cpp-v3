...
std::vector<std::string>& UpdateRepositoryWebhookResponse::getNotePlainTextFilter()
{
    return notePlainTextFilter_;
}

void UpdateRepositoryWebhookResponse::setNotePlainTextFilter(const std::vector<std::string>& value)
{
    notePlainTextFilter_ = value;
    notePlainTextFilterIsSet_ = true;
}

bool UpdateRepositoryWebhookResponse::notePlainTextFilterIsSet() const
{
    return notePlainTextFilterIsSet_;
}

void UpdateRepositoryWebhookResponse::unsetnotePlainTextFilter()
{
    notePlainTextFilterIsSet_ = false;
}
...
std::vector<WebHookEventCfgDto>& UpdateRepositoryWebhookResponse::getEventCfgs()
{
    return eventCfgs_;
}

void UpdateRepositoryWebhookResponse::setEventCfgs(const std::vector<WebHookEventCfgDto>& value)
{
    eventCfgs_ = value;
    eventCfgsIsSet_ = true;
}

bool UpdateRepositoryWebhookResponse::eventCfgsIsSet() const
{
    return eventCfgsIsSet_;
}

void UpdateRepositoryWebhookResponse::unseteventCfgs()
{
    eventCfgsIsSet_ = false;
}

std::vector<WebHookBranchCfgDto>& UpdateRepositoryWebhookResponse::getProjectCfgs()
{
    return projectCfgs_;
}

void UpdateRepositoryWebhookResponse::setProjectCfgs(const std::vector<WebHookBranchCfgDto>& value)
{
    projectCfgs_ = value;
    projectCfgsIsSet_ = true;
}

bool UpdateRepositoryWebhookResponse::projectCfgsIsSet() const
{
    return projectCfgsIsSet_;
}

void UpdateRepositoryWebhookResponse::unsetprojectCfgs()
{
    projectCfgsIsSet_ = false;
}

std::vector<WebHookBranchCfgDto>& UpdateRepositoryWebhookResponse::getBranchCfgs()
{
    return branchCfgs_;
}

void UpdateRepositoryWebhookResponse::setBranchCfgs(const std::vector<WebHookBranchCfgDto>& value)
{
    branchCfgs_ = value;
    branchCfgsIsSet_ = true;
}

bool UpdateRepositoryWebhookResponse::branchCfgsIsSet() const
{
    return branchCfgsIsSet_;
}

void UpdateRepositoryWebhookResponse::unsetbranchCfgs()
{
    branchCfgsIsSet_ = false;
}
...
std::string UpdateRepositoryWebhookResponse::getService() const
{
    return service_;
}

void UpdateRepositoryWebhookResponse::setService(const std::string& value)
{
    service_ = value;
    serviceIsSet_ = true;
}

bool UpdateRepositoryWebhookResponse::serviceIsSet() const
{
    return serviceIsSet_;
}

void UpdateRepositoryWebhookResponse::unsetservice()
{
    serviceIsSet_ = false;
}
