...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_FlowControlPolicyInfo_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_FlowControlPolicyInfo_H_
...
/// 数据流转流控策略结构体
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  FlowControlPolicyInfo
    : public ModelBase
{
public:
    FlowControlPolicyInfo();
    virtual ~FlowControlPolicyInfo();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_FlowControlPolicyInfo_H_
