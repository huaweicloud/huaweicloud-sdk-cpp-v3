...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_IncrementalBackups_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_IncrementalBackups_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  IncrementalBackups
    : public ModelBase
{
public:
    IncrementalBackups();
    virtual ~IncrementalBackups();
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_IncrementalBackups_H_
