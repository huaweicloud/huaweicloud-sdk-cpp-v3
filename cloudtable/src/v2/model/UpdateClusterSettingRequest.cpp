...
std::string UpdateClusterSettingRequest::getProjectId() const
{
    return projectId_;
}

void UpdateClusterSettingRequest::setProjectId(const std::string& value)
{
    projectId_ = value;
    projectIdIsSet_ = true;
}

bool UpdateClusterSettingRequest::projectIdIsSet() const
{
    return projectIdIsSet_;
}

void UpdateClusterSettingRequest::unsetprojectId()
{
    projectIdIsSet_ = false;
}
