...
#ifndef HUAWEICLOUD_SDK_OCR_V1_MODEL_HkIdCardRequestBody_H_
#define HUAWEICLOUD_SDK_OCR_V1_MODEL_HkIdCardRequestBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_OCR_V1_EXPORT  HkIdCardRequestBody
    : public ModelBase
{
public:
    HkIdCardRequestBody();
    virtual ~HkIdCardRequestBody();
...
#endif // HUAWEICLOUD_SDK_OCR_V1_MODEL_HkIdCardRequestBody_H_
