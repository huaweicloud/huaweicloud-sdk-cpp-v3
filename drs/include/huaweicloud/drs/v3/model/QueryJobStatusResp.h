...
#ifndef HUAWEICLOUD_SDK_DRS_V3_MODEL_QueryJobStatusResp_H_
#define HUAWEICLOUD_SDK_DRS_V3_MODEL_QueryJobStatusResp_H_
...
/// 批量查询任务状态返回体
/// </summary>
class HUAWEICLOUD_DRS_V3_EXPORT  QueryJobStatusResp
    : public ModelBase
{
public:
    QueryJobStatusResp();
    virtual ~QueryJobStatusResp();
...
#endif // HUAWEICLOUD_SDK_DRS_V3_MODEL_QueryJobStatusResp_H_
