...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_UpdateBacklogPolicy_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_UpdateBacklogPolicy_H_
...
/// 修改数据流转积压策略请求结构体
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  UpdateBacklogPolicy
    : public ModelBase
{
public:
    UpdateBacklogPolicy();
    virtual ~UpdateBacklogPolicy();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_UpdateBacklogPolicy_H_
