...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BranchSimpleDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BranchSimpleDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  BranchSimpleDto
    : public ModelBase
{
public:
    BranchSimpleDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BranchSimpleDto_H_
