...
#ifndef HUAWEICLOUD_SDK_IOTDM_V5_MODEL_InstanceTask_H_
#define HUAWEICLOUD_SDK_IOTDM_V5_MODEL_InstanceTask_H_
...
/// 实例任务信息
/// </summary>
class HUAWEICLOUD_IOTDM_V5_EXPORT  InstanceTask
    : public ModelBase
{
public:
    InstanceTask();
...
#endif // HUAWEICLOUD_SDK_IOTDM_V5_MODEL_InstanceTask_H_
