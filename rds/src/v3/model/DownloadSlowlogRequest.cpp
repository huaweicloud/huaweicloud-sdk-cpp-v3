...
std::string DownloadSlowlogRequest::getXLanguage() const
{
    return xLanguage_;
}

void DownloadSlowlogRequest::setXLanguage(const std::string& value)
{
    xLanguage_ = value;
    xLanguageIsSet_ = true;
}

bool DownloadSlowlogRequest::xLanguageIsSet() const
{
    return xLanguageIsSet_;
}

void DownloadSlowlogRequest::unsetxLanguage()
{
    xLanguageIsSet_ = false;
}
...
SlowlogDownloadRequest DownloadSlowlogRequest::getBody() const
{
    return body_;
}

void DownloadSlowlogRequest::setBody(const SlowlogDownloadRequest& value)
{
    body_ = value;
    bodyIsSet_ = true;
}
