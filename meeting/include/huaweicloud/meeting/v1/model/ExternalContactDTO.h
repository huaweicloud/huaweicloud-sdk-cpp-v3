...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_ExternalContactDTO_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_ExternalContactDTO_H_
...
/// 外部联系人信息。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  ExternalContactDTO
    : public ModelBase
{
public:
    ExternalContactDTO();
    virtual ~ExternalContactDTO();
    ...
    std::string getCustomNumber() const;
    bool customNumberIsSet() const;
    void unsetcustomNumber();
    void setCustomNumber(const std::string& value);
...
protected:
    ...
    std::string name_;
    bool nameIsSet_;
    std::string customNumber_;
    bool customNumberIsSet_;
    double updateTime_;
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_ExternalContactDTO_H_
