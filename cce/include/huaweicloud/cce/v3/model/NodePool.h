...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_NodePool_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_NodePool_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  NodePool
    : public ModelBase
{
public:
    NodePool();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_NodePool_H_
