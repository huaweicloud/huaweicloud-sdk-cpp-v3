...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateRoleReq_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateRoleReq_H_
...
/// 创建角色请求。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateRoleReq
    : public ModelBase
{
public:
    CreateRoleReq();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateRoleReq_H_
