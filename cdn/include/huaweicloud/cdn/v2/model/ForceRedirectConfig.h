...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_ForceRedirectConfig_H_
#define HUAWEICLOUD_SDK_CDN_V2_MODEL_ForceRedirectConfig_H_
...
/// 强制跳转。
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  ForceRedirectConfig
    : public ModelBase
{
public:
    ForceRedirectConfig();
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_ForceRedirectConfig_H_
