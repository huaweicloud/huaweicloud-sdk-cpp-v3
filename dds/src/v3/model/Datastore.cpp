...
std::string Datastore::getStorageEngine() const
{
    return storageEngine_;
}

void Datastore::setStorageEngine(const std::string& value)
{
    storageEngine_ = value;
    storageEngineIsSet_ = true;
}

bool Datastore::storageEngineIsSet() const
{
    return storageEngineIsSet_;
}

void Datastore::unsetstorageEngine()
{
    storageEngineIsSet_ = false;
}
