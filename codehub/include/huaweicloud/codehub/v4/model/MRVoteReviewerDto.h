...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MRVoteReviewerDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MRVoteReviewerDto_H_
...
/// **参数解释：** 合并请求检视用户详细信息
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  MRVoteReviewerDto
    : public ModelBase
{
public:
    MRVoteReviewerDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MRVoteReviewerDto_H_
