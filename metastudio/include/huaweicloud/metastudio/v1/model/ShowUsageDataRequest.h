...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowUsageDataRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowUsageDataRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowUsageDataRequest
    : public ModelBase
{
public:
    ShowUsageDataRequest();
    virtual ~ShowUsageDataRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowUsageDataRequest& dereference_from_shared_ptr(std::shared_ptr<ShowUsageDataRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowUsageDataRequest_H_
