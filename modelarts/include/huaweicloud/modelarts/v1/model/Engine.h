...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Engine_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Engine_H_
...
/// 算法、训练作业所依赖的引擎。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  Engine
    : public ModelBase
{
public:
    Engine();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Engine_H_
