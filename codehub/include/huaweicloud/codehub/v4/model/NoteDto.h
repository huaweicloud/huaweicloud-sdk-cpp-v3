...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_NoteDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_NoteDto_H_
...
/// 评论详细信息。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  NoteDto
    : public ModelBase
{
public:
    NoteDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_NoteDto_H_
