...
#ifndef HUAWEICLOUD_SDK_EIP_V2_MODEL_UpdateBandwidthOption_H_
#define HUAWEICLOUD_SDK_EIP_V2_MODEL_UpdateBandwidthOption_H_
...
/// 更新带宽对象(三个参数不能全为空)
/// </summary>
class HUAWEICLOUD_EIP_V2_EXPORT  UpdateBandwidthOption
    : public ModelBase
{
public:
    UpdateBandwidthOption();
    virtual ~UpdateBandwidthOption();
...
#endif // HUAWEICLOUD_SDK_EIP_V2_MODEL_UpdateBandwidthOption_H_
