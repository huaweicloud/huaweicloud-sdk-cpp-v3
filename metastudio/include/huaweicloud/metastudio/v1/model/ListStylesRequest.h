...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListStylesRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListStylesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListStylesRequest
    : public ModelBase
{
public:
    ListStylesRequest();
    virtual ~ListStylesRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListStylesRequest& dereference_from_shared_ptr(std::shared_ptr<ListStylesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListStylesRequest_H_
