...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_HotQuestionInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_HotQuestionInfo_H_
...
/// 热点问题信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  HotQuestionInfo
    : public ModelBase
{
public:
    HotQuestionInfo();
    virtual ~HotQuestionInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_HotQuestionInfo_H_
