...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListNodePoolNodesRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListNodePoolNodesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ListNodePoolNodesRequest
    : public ModelBase
{
public:
    ListNodePoolNodesRequest();
    virtual ~ListNodePoolNodesRequest();
    ...
    /////////////////////////////////////////////
    /// ListNodePoolNodesRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListNodePoolNodesRequest& dereference_from_shared_ptr(std::shared_ptr<ListNodePoolNodesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListNodePoolNodesRequest_H_
