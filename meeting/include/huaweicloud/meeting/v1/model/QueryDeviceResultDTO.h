...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_QueryDeviceResultDTO_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_QueryDeviceResultDTO_H_
...
/// 终端信息。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  QueryDeviceResultDTO
    : public ModelBase
{
public:
    QueryDeviceResultDTO();
    virtual ~QueryDeviceResultDTO();
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_QueryDeviceResultDTO_H_
