...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ChangesTreeDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ChangesTreeDto_H_
...
/// 合并请求文件变更列表详情
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ChangesTreeDto
    : public ModelBase
{
public:
    ChangesTreeDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ChangesTreeDto_H_
