...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_BaseUser_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_BaseUser_H_
...
/// 用户基础信息。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  BaseUser
    : public ModelBase
{
public:
    BaseUser();
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_BaseUser_H_
