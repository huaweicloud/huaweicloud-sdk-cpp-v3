...
#ifndef HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_CreateTemplatesItems_H_
#define HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_CreateTemplatesItems_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSBUILD_V3_EXPORT  CreateTemplatesItems
    : public ModelBase
{
public:
    CreateTemplatesItems();
    virtual ~CreateTemplatesItems();
...
#endif // HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_CreateTemplatesItems_H_
