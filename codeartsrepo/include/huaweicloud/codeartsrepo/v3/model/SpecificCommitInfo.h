...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_SpecificCommitInfo_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_SpecificCommitInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  SpecificCommitInfo
    : public ModelBase
{
public:
    SpecificCommitInfo();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_SpecificCommitInfo_H_
