...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_FileBodyDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_FileBodyDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  FileBodyDto
    : public ModelBase
{
public:
    FileBodyDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_FileBodyDto_H_
