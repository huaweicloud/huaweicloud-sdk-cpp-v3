...
AccessConfigDeatil UpdateAccessConfigRequestBody::getAccessConfigDetail() const
{
    return accessConfigDetail_;
}

void UpdateAccessConfigRequestBody::setAccessConfigDetail(const AccessConfigDeatil& value)
{
