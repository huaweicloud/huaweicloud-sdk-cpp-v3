...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_ShowFlowTopRequest_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_ShowFlowTopRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  ShowFlowTopRequest
    : public ModelBase
{
public:
    ShowFlowTopRequest();
    virtual ~ShowFlowTopRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowFlowTopRequest& dereference_from_shared_ptr(std::shared_ptr<ShowFlowTopRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_ShowFlowTopRequest_H_
