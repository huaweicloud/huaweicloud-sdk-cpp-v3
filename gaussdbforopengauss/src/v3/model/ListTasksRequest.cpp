...
std::string ListTasksRequest::getXLanguage() const
{
    return xLanguage_;
}

void ListTasksRequest::setXLanguage(const std::string& value)
{
    xLanguage_ = value;
    xLanguageIsSet_ = true;
}

bool ListTasksRequest::xLanguageIsSet() const
{
    return xLanguageIsSet_;
}

void ListTasksRequest::unsetxLanguage()
{
    xLanguageIsSet_ = false;
}
