...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_StructTemplate_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_StructTemplate_H_
...
/// 结构化模板实体
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  StructTemplate
    : public ModelBase
{
public:
    StructTemplate();
    virtual ~StructTemplate();
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_StructTemplate_H_
