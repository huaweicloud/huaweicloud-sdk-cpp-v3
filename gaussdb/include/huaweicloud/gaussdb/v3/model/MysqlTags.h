...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_MysqlTags_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_MysqlTags_H_
...
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  MysqlTags
    : public ModelBase
{
public:
    MysqlTags();
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_MysqlTags_H_
