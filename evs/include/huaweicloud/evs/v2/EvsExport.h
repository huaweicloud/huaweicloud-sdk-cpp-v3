...
#	if defined(HUAWEICLOUD_EVS_V2_SHARED)
#		define HUAWEICLOUD_EVS_V2_EXPORT HUAWEICLOUD_EXPORT
#	else
#		define HUAWEICLOUD_EVS_V2_EXPORT HUAWEICLOUD_IMPORT
#	endif
#else
#	define HUAWEICLOUD_EVS_V2_EXPORT
#endif
