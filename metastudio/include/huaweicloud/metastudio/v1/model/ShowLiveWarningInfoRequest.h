...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowLiveWarningInfoRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowLiveWarningInfoRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowLiveWarningInfoRequest
    : public ModelBase
{
public:
    ShowLiveWarningInfoRequest();
    virtual ~ShowLiveWarningInfoRequest();
    ...
    /////////////////////////////////////////////
    /// ShowLiveWarningInfoRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowLiveWarningInfoRequest& dereference_from_shared_ptr(std::shared_ptr<ShowLiveWarningInfoRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowLiveWarningInfoRequest_H_
