...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_ListTwoTemplatesRequest_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_ListTwoTemplatesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  ListTwoTemplatesRequest
    : public ModelBase
{
public:
    ListTwoTemplatesRequest();
    virtual ~ListTwoTemplatesRequest();
    ...
    /////////////////////////////////////////////
    /// ListTwoTemplatesRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListTwoTemplatesRequest& dereference_from_shared_ptr(std::shared_ptr<ListTwoTemplatesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_ListTwoTemplatesRequest_H_
