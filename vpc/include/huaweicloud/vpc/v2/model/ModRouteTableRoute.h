...
#ifndef HUAWEICLOUD_SDK_VPC_V2_MODEL_ModRouteTableRoute_H_
#define HUAWEICLOUD_SDK_VPC_V2_MODEL_ModRouteTableRoute_H_
...
/// 修改路由条目的字段
/// </summary>
class HUAWEICLOUD_VPC_V2_EXPORT  ModRouteTableRoute
    : public ModelBase
{
public:
    ModRouteTableRoute();
    virtual ~ModRouteTableRoute();
...
#endif // HUAWEICLOUD_SDK_VPC_V2_MODEL_ModRouteTableRoute_H_
