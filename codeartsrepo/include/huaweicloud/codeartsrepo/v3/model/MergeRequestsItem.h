...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_MergeRequestsItem_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_MergeRequestsItem_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  MergeRequestsItem
    : public ModelBase
{
public:
    MergeRequestsItem();
    virtual ~MergeRequestsItem();
    ...
    std::vector<Author>& getMergeRequestAssigneeList();
    bool mergeRequestAssigneeListIsSet() const;
    void unsetmergeRequestAssigneeList();
    void setMergeRequestAssigneeList(const std::vector<Author>& value);
...
protected:
    ...
    double iid_;
    bool iidIsSet_;
    std::vector<Author> mergeRequestAssigneeList_;
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_MergeRequestsItem_H_
