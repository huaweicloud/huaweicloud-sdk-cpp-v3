...
std::string GlanceShowImageMemberResponse::getMemberType() const
{
    return memberType_;
}

void GlanceShowImageMemberResponse::setMemberType(const std::string& value)
{
    memberType_ = value;
    memberTypeIsSet_ = true;
}

bool GlanceShowImageMemberResponse::memberTypeIsSet() const
{
    return memberTypeIsSet_;
}

void GlanceShowImageMemberResponse::unsetmemberType()
{
    memberTypeIsSet_ = false;
}

std::string GlanceShowImageMemberResponse::getUrn() const
{
    return urn_;
}

void GlanceShowImageMemberResponse::setUrn(const std::string& value)
{
    urn_ = value;
    urnIsSet_ = true;
}

bool GlanceShowImageMemberResponse::urnIsSet() const
{
    return urnIsSet_;
}

void GlanceShowImageMemberResponse::unseturn()
{
    urnIsSet_ = false;
}
