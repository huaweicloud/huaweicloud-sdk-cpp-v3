...
public:
    ...
    static HttpRequestDef genRequestDefForCreateAccessPoint();
    static HttpRequestDef genRequestDefForCreateAlias();
    static HttpRequestDef genRequestDefForCreateDatakey();
    static HttpRequestDef genRequestDefForCreateDatakeyCapsule();
    ...
    static HttpRequestDef genRequestDefForCreateKeyPolicy();
    ...
    static HttpRequestDef genRequestDefForDecryptDatakeyCapsule();
    static HttpRequestDef genRequestDefForDeleteAccessPoint();
    ...
    static HttpRequestDef genRequestDefForDeleteKeyPolicy();
    ...
    static HttpRequestDef genRequestDefForDisableAccessPoint();
    ...
    static HttpRequestDef genRequestDefForDownloadAccessPointPrivateKey();
    static HttpRequestDef genRequestDefForEnableAccessPoint();
    ...
    static HttpRequestDef genRequestDefForListAccessPoint();
    ...
    static HttpRequestDef genRequestDefForListKeyPolicy();
    ...
    static HttpRequestDef genRequestDefForRotateOnDemand();
    static HttpRequestDef genRequestDefForShowKeyPolicy();
    ...
    static HttpRequestDef genRequestDefForUpdateKeyPolicy();
