...
#ifndef HUAWEICLOUD_SDK_DRS_V5_MODEL_DbParamInfo_H_
...
/// </summary>
class HUAWEICLOUD_DRS_V5_EXPORT  DbParamInfo
    : public ModelBase
{
public:
    DbParamInfo();
    ...
    std::vector<DbParam>& getCommon();
    bool commonIsSet() const;
    void unsetcommon();
    void setCommon(const std::vector<DbParam>& value);

    /// <summary>
    /// 性能参数。对比结果一致也可以修改目标库的值。
    /// </summary>

    std::vector<DbParam>& getPerformance();
    bool performanceIsSet() const;
    void unsetperformance();
    void setPerformance(const std::vector<DbParam>& value);


protected:
    std::vector<DbParam> common_;
    bool commonIsSet_;
    std::vector<DbParam> performance_;
    bool performanceIsSet_;
...
#endif // HUAWEICLOUD_SDK_DRS_V5_MODEL_DbParamInfo_H_
