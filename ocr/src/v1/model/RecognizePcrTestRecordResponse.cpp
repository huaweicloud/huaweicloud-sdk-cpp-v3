...
std::string RecognizePcrTestRecordResponse::getXRequestId() const
{
    return xRequestId_;
}

void RecognizePcrTestRecordResponse::setXRequestId(const std::string& value)
{
    xRequestId_ = value;
    xRequestIdIsSet_ = true;
}

bool RecognizePcrTestRecordResponse::xRequestIdIsSet() const
{
    return xRequestIdIsSet_;
}

void RecognizePcrTestRecordResponse::unsetxRequestId()
{
    xRequestIdIsSet_ = false;
}
