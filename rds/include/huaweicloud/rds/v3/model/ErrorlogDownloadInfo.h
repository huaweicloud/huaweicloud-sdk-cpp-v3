...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_ErrorlogDownloadInfo_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_ErrorlogDownloadInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  ErrorlogDownloadInfo
    : public ModelBase
{
public:
    ErrorlogDownloadInfo();
    virtual ~ErrorlogDownloadInfo();
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_ErrorlogDownloadInfo_H_
