...
bool UpdateMergeRequestResponse::isIsSourceBranchDefault() const
{
    return isSourceBranchDefault_;
}

void UpdateMergeRequestResponse::setIsSourceBranchDefault(bool value)
{
    isSourceBranchDefault_ = value;
    isSourceBranchDefaultIsSet_ = true;
}

bool UpdateMergeRequestResponse::isSourceBranchDefaultIsSet() const
{
    return isSourceBranchDefaultIsSet_;
}

void UpdateMergeRequestResponse::unsetisSourceBranchDefault()
{
    isSourceBranchDefaultIsSet_ = false;
}
...
int32_t UpdateMergeRequestResponse::getUpvotes() const
{
    return upvotes_;
}

void UpdateMergeRequestResponse::setUpvotes(int32_t value)
{
    upvotes_ = value;
    upvotesIsSet_ = true;
}

bool UpdateMergeRequestResponse::upvotesIsSet() const
{
    return upvotesIsSet_;
}

void UpdateMergeRequestResponse::unsetupvotes()
{
    upvotesIsSet_ = false;
}

int32_t UpdateMergeRequestResponse::getDownvotes() const
{
    return downvotes_;
}

void UpdateMergeRequestResponse::setDownvotes(int32_t value)
{
    downvotes_ = value;
    downvotesIsSet_ = true;
}

bool UpdateMergeRequestResponse::downvotesIsSet() const
{
    return downvotesIsSet_;
}

void UpdateMergeRequestResponse::unsetdownvotes()
{
    downvotesIsSet_ = false;
}
...
UserBasicExternalDto UpdateMergeRequestResponse::getAssignee() const
{
    return assignee_;
}

void UpdateMergeRequestResponse::setAssignee(const UserBasicExternalDto& value)
{
    assignee_ = value;
    assigneeIsSet_ = true;
}

bool UpdateMergeRequestResponse::assigneeIsSet() const
{
    return assigneeIsSet_;
}

void UpdateMergeRequestResponse::unsetassignee()
{
    assigneeIsSet_ = false;
}
...
bool UpdateMergeRequestResponse::isShouldRemoveSourceBranch() const
{
    return shouldRemoveSourceBranch_;
}

void UpdateMergeRequestResponse::setShouldRemoveSourceBranch(bool value)
{
    shouldRemoveSourceBranch_ = value;
    shouldRemoveSourceBranchIsSet_ = true;
}

bool UpdateMergeRequestResponse::shouldRemoveSourceBranchIsSet() const
{
    return shouldRemoveSourceBranchIsSet_;
}

void UpdateMergeRequestResponse::unsetshouldRemoveSourceBranch()
{
    shouldRemoveSourceBranchIsSet_ = false;
}
...
bool UpdateMergeRequestResponse::isOnlyAssigneeCanMerge() const
{
    return onlyAssigneeCanMerge_;
}

void UpdateMergeRequestResponse::setOnlyAssigneeCanMerge(bool value)
{
    onlyAssigneeCanMerge_ = value;
    onlyAssigneeCanMergeIsSet_ = true;
}

bool UpdateMergeRequestResponse::onlyAssigneeCanMergeIsSet() const
{
    return onlyAssigneeCanMergeIsSet_;
}

void UpdateMergeRequestResponse::unsetonlyAssigneeCanMerge()
{
    onlyAssigneeCanMergeIsSet_ = false;
}
...
std::string UpdateMergeRequestResponse::getTopic() const
{
    return topic_;
}

void UpdateMergeRequestResponse::setTopic(const std::string& value)
{
    topic_ = value;
    topicIsSet_ = true;
}

bool UpdateMergeRequestResponse::topicIsSet() const
{
    return topicIsSet_;
}

void UpdateMergeRequestResponse::unsettopic()
{
    topicIsSet_ = false;
}
