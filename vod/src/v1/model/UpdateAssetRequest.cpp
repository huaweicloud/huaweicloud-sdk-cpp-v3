...
std::string UpdateAssetRequest::getAuthorization() const
{
    return authorization_;
}

void UpdateAssetRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool UpdateAssetRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void UpdateAssetRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
