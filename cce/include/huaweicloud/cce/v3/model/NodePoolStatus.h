...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_NodePoolStatus_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_NodePoolStatus_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  NodePoolStatus
    : public ModelBase
{
public:
    NodePoolStatus();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_NodePoolStatus_H_
