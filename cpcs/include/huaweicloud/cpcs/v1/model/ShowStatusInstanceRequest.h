...
#ifndef HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatusInstanceRequest_H_
#define HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatusInstanceRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CPCS_V1_EXPORT  ShowStatusInstanceRequest
    : public ModelBase
{
public:
    ShowStatusInstanceRequest();
    virtual ~ShowStatusInstanceRequest();
    ...
    /////////////////////////////////////////////
    /// ShowStatusInstanceRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowStatusInstanceRequest& dereference_from_shared_ptr(std::shared_ptr<ShowStatusInstanceRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatusInstanceRequest_H_
