...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListNetworksRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListNetworksRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  ListNetworksRequest
    : public ModelBase
{
public:
    ListNetworksRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListNetworksRequest& dereference_from_shared_ptr(std::shared_ptr<ListNetworksRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_ListNetworksRequest_H_
