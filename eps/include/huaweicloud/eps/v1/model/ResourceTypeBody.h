...
#ifndef HUAWEICLOUD_SDK_EPS_V1_MODEL_ResourceTypeBody_H_
#define HUAWEICLOUD_SDK_EPS_V1_MODEL_ResourceTypeBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_EPS_V1_EXPORT  ResourceTypeBody
    : public ModelBase
{
public:
    ResourceTypeBody();
...
#endif // HUAWEICLOUD_SDK_EPS_V1_MODEL_ResourceTypeBody_H_
