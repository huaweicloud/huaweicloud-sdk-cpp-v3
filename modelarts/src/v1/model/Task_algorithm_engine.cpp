...
Task_algorithm_engine::Task_algorithm_engine()
{
    engineId_ = "";
...
Task_algorithm_engine::~Task_algorithm_engine() = default;

void Task_algorithm_engine::validate()
{
}

web::json::value Task_algorithm_engine::toJson() const
{
...
bool Task_algorithm_engine::fromJson(const web::json::value& val)
{
    bool ok = true;
...
std::string Task_algorithm_engine::getEngineId() const
{
    return engineId_;
}

void Task_algorithm_engine::setEngineId(const std::string& value)
{
    engineId_ = value;
    engineIdIsSet_ = true;
}

bool Task_algorithm_engine::engineIdIsSet() const
{
    return engineIdIsSet_;
}

void Task_algorithm_engine::unsetengineId()
{
    engineIdIsSet_ = false;
}

std::string Task_algorithm_engine::getEngineName() const
{
    return engineName_;
}

void Task_algorithm_engine::setEngineName(const std::string& value)
{
    engineName_ = value;
    engineNameIsSet_ = true;
}

bool Task_algorithm_engine::engineNameIsSet() const
{
    return engineNameIsSet_;
}

void Task_algorithm_engine::unsetengineName()
{
    engineNameIsSet_ = false;
}

std::string Task_algorithm_engine::getEngineVersion() const
{
    return engineVersion_;
}

void Task_algorithm_engine::setEngineVersion(const std::string& value)
{
    engineVersion_ = value;
    engineVersionIsSet_ = true;
}

bool Task_algorithm_engine::engineVersionIsSet() const
{
    return engineVersionIsSet_;
}

void Task_algorithm_engine::unsetengineVersion()
{
    engineVersionIsSet_ = false;
}

std::string Task_algorithm_engine::getImageUrl() const
{
    return imageUrl_;
}

void Task_algorithm_engine::setImageUrl(const std::string& value)
{
    imageUrl_ = value;
    imageUrlIsSet_ = true;
}

bool Task_algorithm_engine::imageUrlIsSet() const
{
    return imageUrlIsSet_;
}

void Task_algorithm_engine::unsetimageUrl()
{
    imageUrlIsSet_ = false;
}

std::string Task_algorithm_engine::getRunUser() const
{
    return runUser_;
}

void Task_algorithm_engine::setRunUser(const std::string& value)
{
    runUser_ = value;
    runUserIsSet_ = true;
}

bool Task_algorithm_engine::runUserIsSet() const
{
    return runUserIsSet_;
}

void Task_algorithm_engine::unsetrunUser()
{
    runUserIsSet_ = false;
}
