...
#ifndef HUAWEICLOUD_SDK_LIVE_V1_MODEL_ListRecordContentsRequest_H_
#define HUAWEICLOUD_SDK_LIVE_V1_MODEL_ListRecordContentsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_LIVE_V1_EXPORT  ListRecordContentsRequest
    : public ModelBase
{
public:
    ListRecordContentsRequest();
    virtual ~ListRecordContentsRequest();
    ...
    /////////////////////////////////////////////
    /// ListRecordContentsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListRecordContentsRequest& dereference_from_shared_ptr(std::shared_ptr<ListRecordContentsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_LIVE_V1_MODEL_ListRecordContentsRequest_H_
