...
std::string ShowTakeOverTaskDetailsRequest::getAuthorization() const
{
    return authorization_;
}

void ShowTakeOverTaskDetailsRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool ShowTakeOverTaskDetailsRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void ShowTakeOverTaskDetailsRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
