...
bool DownloadErrorlogResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("list"))) {
        ...
        {
            std::vector<DownloadSlowlogResult> refVal;
...
std::vector<DownloadSlowlogResult>& DownloadErrorlogResponse::getList()
{
    return list_;
}

void DownloadErrorlogResponse::setList(const std::vector<DownloadSlowlogResult>& value)
{
    list_ = value;
    listIsSet_ = true;
}
