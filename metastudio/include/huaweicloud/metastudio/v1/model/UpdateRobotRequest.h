...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateRobotRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateRobotRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateRobotRequest
    : public ModelBase
{
public:
    UpdateRobotRequest();
    virtual ~UpdateRobotRequest();
    ...
    UpdateRobotReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateRobotReq& value);
...
protected:
    ...
    std::string robotId_;
    bool robotIdIsSet_;
    UpdateRobotReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateRobotRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateRobotRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateRobotRequest_H_
