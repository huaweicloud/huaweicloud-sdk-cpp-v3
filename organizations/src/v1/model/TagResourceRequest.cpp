...
std::string TagResourceRequest::getXSecurityToken() const
{
    return xSecurityToken_;
}

void TagResourceRequest::setXSecurityToken(const std::string& value)
{
    xSecurityToken_ = value;
    xSecurityTokenIsSet_ = true;
}

bool TagResourceRequest::xSecurityTokenIsSet() const
{
    return xSecurityTokenIsSet_;
}

void TagResourceRequest::unsetxSecurityToken()
{
    xSecurityTokenIsSet_ = false;
}
