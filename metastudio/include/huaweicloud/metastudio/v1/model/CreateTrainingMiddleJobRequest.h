...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTrainingMiddleJobRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTrainingMiddleJobRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateTrainingMiddleJobRequest
    : public ModelBase
{
public:
    CreateTrainingMiddleJobRequest();
    virtual ~CreateTrainingMiddleJobRequest();
    ...
    /////////////////////////////////////////////
    /// CreateTrainingMiddleJobRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    CreateTrainingMiddleJobRequest& dereference_from_shared_ptr(std::shared_ptr<CreateTrainingMiddleJobRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTrainingMiddleJobRequest_H_
