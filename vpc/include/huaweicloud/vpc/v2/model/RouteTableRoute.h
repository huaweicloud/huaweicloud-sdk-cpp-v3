...
#ifndef HUAWEICLOUD_SDK_VPC_V2_MODEL_RouteTableRoute_H_
#define HUAWEICLOUD_SDK_VPC_V2_MODEL_RouteTableRoute_H_
...
/// 
/// </summary>
class HUAWEICLOUD_VPC_V2_EXPORT  RouteTableRoute
    : public ModelBase
{
public:
    RouteTableRoute();
...
#endif // HUAWEICLOUD_SDK_VPC_V2_MODEL_RouteTableRoute_H_
