...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowActiveCodeRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowActiveCodeRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowActiveCodeRequest
    : public ModelBase
{
public:
    ShowActiveCodeRequest();
    virtual ~ShowActiveCodeRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowActiveCodeRequest& dereference_from_shared_ptr(std::shared_ptr<ShowActiveCodeRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowActiveCodeRequest_H_
