...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_TrustedIpAddressDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_TrustedIpAddressDto_H_
...
/// **参数解释：** ip白名单信息。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  TrustedIpAddressDto
    : public ModelBase
{
public:
    TrustedIpAddressDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_TrustedIpAddressDto_H_
