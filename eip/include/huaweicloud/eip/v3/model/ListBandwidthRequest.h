...
#ifndef HUAWEICLOUD_SDK_EIP_V3_MODEL_ListBandwidthRequest_H_
#define HUAWEICLOUD_SDK_EIP_V3_MODEL_ListBandwidthRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_EIP_V3_EXPORT  ListBandwidthRequest
    : public ModelBase
{
public:
    ListBandwidthRequest();
    virtual ~ListBandwidthRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListBandwidthRequest& dereference_from_shared_ptr(std::shared_ptr<ListBandwidthRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_EIP_V3_MODEL_ListBandwidthRequest_H_
