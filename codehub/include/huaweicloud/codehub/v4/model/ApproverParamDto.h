...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ApproverParamDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ApproverParamDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ApproverParamDto
    : public ModelBase
{
public:
    ApproverParamDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ApproverParamDto_H_
