...
#ifndef HUAWEICLOUD_SDK_EVS_V2_MODEL_SubJob_H_
#define HUAWEICLOUD_SDK_EVS_V2_MODEL_SubJob_H_
...
/// 子Job的详细信息。
/// </summary>
class HUAWEICLOUD_EVS_V2_EXPORT  SubJob
    : public ModelBase
{
public:
    SubJob();
...
#endif // HUAWEICLOUD_SDK_EVS_V2_MODEL_SubJob_H_
