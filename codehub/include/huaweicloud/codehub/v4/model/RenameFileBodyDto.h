...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_RenameFileBodyDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_RenameFileBodyDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  RenameFileBodyDto
    : public ModelBase
{
public:
    RenameFileBodyDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_RenameFileBodyDto_H_
