...
float ImageWatermark::getRandomTimeMin() const
{
    return randomTimeMin_;
}

void ImageWatermark::setRandomTimeMin(float value)
{
...
float ImageWatermark::getRandomTimeMax() const
{
    return randomTimeMax_;
}

void ImageWatermark::setRandomTimeMax(float value)
{
