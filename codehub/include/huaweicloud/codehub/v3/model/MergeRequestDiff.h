...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_MergeRequestDiff_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_MergeRequestDiff_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  MergeRequestDiff
    : public ModelBase
{
public:
    MergeRequestDiff();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_MergeRequestDiff_H_
