...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_CreateRecurringMeetingRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_CreateRecurringMeetingRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  CreateRecurringMeetingRequest
    : public ModelBase
{
public:
    CreateRecurringMeetingRequest();
    virtual ~CreateRecurringMeetingRequest();
    ...
    /////////////////////////////////////////////
    /// CreateRecurringMeetingRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    CreateRecurringMeetingRequest& dereference_from_shared_ptr(std::shared_ptr<CreateRecurringMeetingRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_CreateRecurringMeetingRequest_H_
