...
#ifndef HUAWEICLOUD_SDK_DDS_V3_MODEL_ErrorLogDetail_H_
#define HUAWEICLOUD_SDK_DDS_V3_MODEL_ErrorLogDetail_H_
...
/// 
/// </summary>
class HUAWEICLOUD_DDS_V3_EXPORT  ErrorLogDetail
    : public ModelBase
{
public:
    ErrorLogDetail();
    virtual ~ErrorLogDetail();
...
#endif // HUAWEICLOUD_SDK_DDS_V3_MODEL_ErrorLogDetail_H_
