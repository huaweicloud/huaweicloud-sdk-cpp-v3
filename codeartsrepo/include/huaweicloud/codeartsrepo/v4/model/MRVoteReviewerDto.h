...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MRVoteReviewerDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MRVoteReviewerDto_H_
...
/// **参数解释：** 合并请求检视用户详细信息
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  MRVoteReviewerDto
    : public ModelBase
{
public:
    MRVoteReviewerDto();
    virtual ~MRVoteReviewerDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MRVoteReviewerDto_H_
