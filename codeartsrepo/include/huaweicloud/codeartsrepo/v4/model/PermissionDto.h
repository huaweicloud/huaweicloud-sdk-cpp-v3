...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_PermissionDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_PermissionDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  PermissionDto
    : public ModelBase
{
public:
    PermissionDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_PermissionDto_H_
