...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateOnceCodeRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateOnceCodeRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateOnceCodeRequest
    : public ModelBase
{
public:
    CreateOnceCodeRequest();
    virtual ~CreateOnceCodeRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    CreateOnceCodeRequest& dereference_from_shared_ptr(std::shared_ptr<CreateOnceCodeRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateOnceCodeRequest_H_
