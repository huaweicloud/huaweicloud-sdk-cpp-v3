...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_MuteMeetingRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_MuteMeetingRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  MuteMeetingRequest
    : public ModelBase
{
public:
    MuteMeetingRequest();
    virtual ~MuteMeetingRequest();
    ...
    RestMuteReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestMuteReqBody& value);
...
protected:
    ...
    RestMuteReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    MuteMeetingRequest& dereference_from_shared_ptr(std::shared_ptr<MuteMeetingRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_MuteMeetingRequest_H_
