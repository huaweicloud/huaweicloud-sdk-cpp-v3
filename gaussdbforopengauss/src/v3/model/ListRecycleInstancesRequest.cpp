...
std::string ListRecycleInstancesRequest::getInstanceName() const
{
    return instanceName_;
}

void ListRecycleInstancesRequest::setInstanceName(const std::string& value)
{
    instanceName_ = value;
    instanceNameIsSet_ = true;
}

bool ListRecycleInstancesRequest::instanceNameIsSet() const
{
    return instanceNameIsSet_;
}

void ListRecycleInstancesRequest::unsetinstanceName()
{
    instanceNameIsSet_ = false;
}
