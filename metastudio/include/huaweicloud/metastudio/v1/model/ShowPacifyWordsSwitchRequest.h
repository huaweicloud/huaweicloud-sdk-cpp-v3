...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsSwitchRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsSwitchRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowPacifyWordsSwitchRequest
    : public ModelBase
{
public:
    ShowPacifyWordsSwitchRequest();
    virtual ~ShowPacifyWordsSwitchRequest();
    ...
    /////////////////////////////////////////////
    /// ShowPacifyWordsSwitchRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowPacifyWordsSwitchRequest& dereference_from_shared_ptr(std::shared_ptr<ShowPacifyWordsSwitchRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPacifyWordsSwitchRequest_H_
