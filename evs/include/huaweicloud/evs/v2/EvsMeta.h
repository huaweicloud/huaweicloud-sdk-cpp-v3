...
public:
    ...
    static HttpRequestDef genRequestDefForDeleteVolumeInRecycle();
    ...
    static HttpRequestDef genRequestDefForListVolumesInRecycle();
    ...
    static HttpRequestDef genRequestDefForRevertVolumeInRecycle();
