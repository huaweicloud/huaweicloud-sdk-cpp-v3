...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInstructionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInstructionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListInstructionRequest
    : public ModelBase
{
public:
    ListInstructionRequest();
    virtual ~ListInstructionRequest();
    ...
    /////////////////////////////////////////////
    /// ListInstructionRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListInstructionRequest& dereference_from_shared_ptr(std::shared_ptr<ListInstructionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInstructionRequest_H_
