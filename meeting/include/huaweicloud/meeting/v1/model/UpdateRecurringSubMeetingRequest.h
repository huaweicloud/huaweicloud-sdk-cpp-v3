...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_UpdateRecurringSubMeetingRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_UpdateRecurringSubMeetingRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  UpdateRecurringSubMeetingRequest
    : public ModelBase
{
public:
    UpdateRecurringSubMeetingRequest();
    virtual ~UpdateRecurringSubMeetingRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateRecurringSubMeetingRequest members
    ...
    RestScheduleCycleConfDTO getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestScheduleCycleConfDTO& value);
...
protected:
    ...
    RestScheduleCycleConfDTO body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateRecurringSubMeetingRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateRecurringSubMeetingRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_UpdateRecurringSubMeetingRequest_H_
