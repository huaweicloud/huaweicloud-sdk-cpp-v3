...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateRoleRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateRoleRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateRoleRequest
    : public ModelBase
{
public:
    UpdateRoleRequest();
    ...
    UpdateRoleReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateRoleReq& value);
...
protected:
    ...
    RTTR_ENABLE()
public:
    UpdateRoleRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateRoleRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateRoleRequest_H_
