...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListOtaModulesRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListOtaModulesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListOtaModulesRequest
    : public ModelBase
{
public:
    ListOtaModulesRequest();
    virtual ~ListOtaModulesRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListOtaModulesRequest& dereference_from_shared_ptr(std::shared_ptr<ListOtaModulesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListOtaModulesRequest_H_
