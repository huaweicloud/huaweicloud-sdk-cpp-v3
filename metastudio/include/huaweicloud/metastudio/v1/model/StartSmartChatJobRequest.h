...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_StartSmartChatJobRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_StartSmartChatJobRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  StartSmartChatJobRequest
    : public ModelBase
{
public:
    StartSmartChatJobRequest();
    virtual ~StartSmartChatJobRequest();
    ...
    /////////////////////////////////////////////
    /// StartSmartChatJobRequest members
    ...
    SmartChatJobsReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const SmartChatJobsReq& value);
...
protected:
    ...
    std::string robotId_;
    bool robotIdIsSet_;
    SmartChatJobsReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    StartSmartChatJobRequest& dereference_from_shared_ptr(std::shared_ptr<StartSmartChatJobRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_StartSmartChatJobRequest_H_
