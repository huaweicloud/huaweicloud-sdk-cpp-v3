...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ApprovalUserDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ApprovalUserDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  ApprovalUserDto
    : public ModelBase
{
public:
    ApprovalUserDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ApprovalUserDto_H_
