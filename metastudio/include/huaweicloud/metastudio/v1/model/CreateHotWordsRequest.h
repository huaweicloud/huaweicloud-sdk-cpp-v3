...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateHotWordsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateHotWordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateHotWordsRequest
    : public ModelBase
{
public:
    CreateHotWordsRequest();
    virtual ~CreateHotWordsRequest();
    ...
    CreateHotWordsReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const CreateHotWordsReq& value);
...
protected:
    ...
    CreateHotWordsReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    CreateHotWordsRequest& dereference_from_shared_ptr(std::shared_ptr<CreateHotWordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateHotWordsRequest_H_
