...
#ifndef HUAWEICLOUD_SDK_DRS_V3_MODEL_ListDataCompareOverviewRequest_H_
#define HUAWEICLOUD_SDK_DRS_V3_MODEL_ListDataCompareOverviewRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_DRS_V3_EXPORT  ListDataCompareOverviewRequest
    : public ModelBase
{
public:
    ListDataCompareOverviewRequest();
    virtual ~ListDataCompareOverviewRequest();
    ...
    /////////////////////////////////////////////
    /// ListDataCompareOverviewRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDataCompareOverviewRequest& dereference_from_shared_ptr(std::shared_ptr<ListDataCompareOverviewRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_DRS_V3_MODEL_ListDataCompareOverviewRequest_H_
