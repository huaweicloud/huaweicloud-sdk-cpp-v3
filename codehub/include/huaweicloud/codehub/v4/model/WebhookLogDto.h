...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_WebhookLogDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_WebhookLogDto_H_
...
/// **参数解释：** Webhook执行日志数据。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  WebhookLogDto
    : public ModelBase
{
public:
    WebhookLogDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_WebhookLogDto_H_
