...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_WebhookParamsDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_WebhookParamsDto_H_
...
/// **参数解释：** Webhook设置参数。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  WebhookParamsDto
    : public ModelBase
{
public:
    WebhookParamsDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_WebhookParamsDto_H_
