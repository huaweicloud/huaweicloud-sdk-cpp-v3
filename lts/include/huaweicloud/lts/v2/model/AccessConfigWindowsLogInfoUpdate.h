...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigWindowsLogInfoUpdate_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigWindowsLogInfoUpdate_H_
...
/// 日志接入采集Windows事件日志
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  AccessConfigWindowsLogInfoUpdate
    : public ModelBase
{
public:
    AccessConfigWindowsLogInfoUpdate();
    virtual ~AccessConfigWindowsLogInfoUpdate();
    ...
    /////////////////////////////////////////////
    /// AccessConfigWindowsLogInfoUpdate members
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigWindowsLogInfoUpdate_H_
