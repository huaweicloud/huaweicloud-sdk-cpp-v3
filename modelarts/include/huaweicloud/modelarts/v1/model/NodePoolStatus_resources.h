...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NodePoolStatus_resources_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NodePoolStatus_resources_H_
...
/// **参数解释**：节点池中不同状态的资源量。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  NodePoolStatus_resources
    : public ModelBase
{
public:
    NodePoolStatus_resources();
    virtual ~NodePoolStatus_resources();
    ...
    /////////////////////////////////////////////
    /// NodePoolStatus_resources members
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NodePoolStatus_resources_H_
