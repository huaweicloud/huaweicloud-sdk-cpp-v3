...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelCreateDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelCreateDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  LabelCreateDto
    : public ModelBase
{
public:
    LabelCreateDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelCreateDto_H_
