...
public:
    ...
    static HttpRequestDef genRequestDefForDeleteDeviceAuthenticationTemplate();
    static HttpRequestDef genRequestDefForListDeviceAuthenticationTemplates();
    static HttpRequestDef genRequestDefForShowDeviceAuthenticationTemplate();
    static HttpRequestDef genRequestDefForUpdateDeviceAuthenticationTemplate();
    ...
    static HttpRequestDef genRequestDefForDeleteDeviceCertificate();
    static HttpRequestDef genRequestDefForListDeviceByDeviceCertificate();
    static HttpRequestDef genRequestDefForListDeviceCertificate();
    static HttpRequestDef genRequestDefForShowDeviceCertificate();
    static HttpRequestDef genRequestDefForUpdateDeviceCertificate();
    ...
    static HttpRequestDef genRequestDefForAddHarmonySoftBus();
    static HttpRequestDef genRequestDefForCreateSyncHarmonySoftBus();
    static HttpRequestDef genRequestDefForDeleteHarmonySoftBus();
    static HttpRequestDef genRequestDefForListHarmonySoftBus();
    static HttpRequestDef genRequestDefForResetHarmonySoftBusKey();
    static HttpRequestDef genRequestDefForShowHarmonySoftBus();
    ...
    static HttpRequestDef genRequestDefForCreateSecurityProfile();
    static HttpRequestDef genRequestDefForDeleteSecurityProfile();
