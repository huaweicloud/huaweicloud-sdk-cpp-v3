...
#ifndef HUAWEICLOUD_SDK_ECS_V2_MODEL_NovaListServersRequest_H_
#define HUAWEICLOUD_SDK_ECS_V2_MODEL_NovaListServersRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_ECS_V2_EXPORT  NovaListServersRequest
    : public ModelBase
{
public:
    NovaListServersRequest();
    virtual ~NovaListServersRequest();
    ...
    /////////////////////////////////////////////
    /// NovaListServersRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    NovaListServersRequest& dereference_from_shared_ptr(std::shared_ptr<NovaListServersRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_ECS_V2_MODEL_NovaListServersRequest_H_
