...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_ForceRedirect_H_
#define HUAWEICLOUD_SDK_CDN_V2_MODEL_ForceRedirect_H_
...
/// 强制跳转。
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  ForceRedirect
    : public ModelBase
{
public:
    ForceRedirect();
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_ForceRedirect_H_
