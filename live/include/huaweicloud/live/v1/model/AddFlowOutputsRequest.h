...
#ifndef HUAWEICLOUD_SDK_LIVE_V1_MODEL_AddFlowOutputsRequest_H_
#define HUAWEICLOUD_SDK_LIVE_V1_MODEL_AddFlowOutputsRequest_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LIVE_V1_EXPORT  AddFlowOutputsRequest
    : public ModelBase
{
public:
    AddFlowOutputsRequest();
    virtual ~AddFlowOutputsRequest();
...
#endif // HUAWEICLOUD_SDK_LIVE_V1_MODEL_AddFlowOutputsRequest_H_
