...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_PoolMetadataDeletion_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_PoolMetadataDeletion_H_
...
/// 删除资源池时的metadata信息。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  PoolMetadataDeletion
    : public ModelBase
{
public:
    PoolMetadataDeletion();
    virtual ~PoolMetadataDeletion();
    ...
    std::string getDeletionTimestamp() const;
    bool deletionTimestampIsSet() const;
    void unsetdeletionTimestamp();
    void setDeletionTimestamp(const std::string& value);
...
protected:
    ...
    std::string deletionTimestamp_;
    bool deletionTimestampIsSet_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_PoolMetadataDeletion_H_
