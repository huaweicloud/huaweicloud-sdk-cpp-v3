...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_DeleteNodePoolStatus_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_DeleteNodePoolStatus_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  DeleteNodePoolStatus
    : public ModelBase
{
public:
    DeleteNodePoolStatus();
    virtual ~DeleteNodePoolStatus();
    ...
    int32_t getConfigurationSyncedNodeCount() const;
    bool configurationSyncedNodeCountIsSet() const;
    void unsetconfigurationSyncedNodeCount();
    void setConfigurationSyncedNodeCount(int32_t value);
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_DeleteNodePoolStatus_H_
