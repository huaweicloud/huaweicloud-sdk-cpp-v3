...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowOnlineMeetingDetailRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowOnlineMeetingDetailRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  ShowOnlineMeetingDetailRequest
    : public ModelBase
{
public:
    ShowOnlineMeetingDetailRequest();
    virtual ~ShowOnlineMeetingDetailRequest();
    ...
    /////////////////////////////////////////////
    /// ShowOnlineMeetingDetailRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowOnlineMeetingDetailRequest& dereference_from_shared_ptr(std::shared_ptr<ShowOnlineMeetingDetailRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowOnlineMeetingDetailRequest_H_
