...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_ExternalKeyMessage_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_ExternalKeyMessage_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  ExternalKeyMessage
    : public ModelBase
{
public:
    ExternalKeyMessage();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_ExternalKeyMessage_H_
