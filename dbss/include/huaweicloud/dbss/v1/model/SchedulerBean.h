...
#ifndef HUAWEICLOUD_SDK_DBSS_V1_MODEL_SchedulerBean_H_
#define HUAWEICLOUD_SDK_DBSS_V1_MODEL_SchedulerBean_H_
...
/// 调度信息
/// </summary>
class HUAWEICLOUD_DBSS_V1_EXPORT  SchedulerBean
    : public ModelBase
{
public:
    SchedulerBean();
    virtual ~SchedulerBean();
...
#endif // HUAWEICLOUD_SDK_DBSS_V1_MODEL_SchedulerBean_H_
