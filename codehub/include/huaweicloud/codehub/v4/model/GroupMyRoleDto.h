...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_GroupMyRoleDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_GroupMyRoleDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  GroupMyRoleDto
    : public ModelBase
{
public:
    GroupMyRoleDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_GroupMyRoleDto_H_
