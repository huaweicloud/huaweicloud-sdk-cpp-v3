...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_SyncImageResponse_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_SyncImageResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  SyncImageResponse
    : public ModelBase, public HttpResponse
{
public:
    SyncImageResponse();
    virtual ~SyncImageResponse();
    ...
    std::vector<std::string>& getSupportResCategories();
    bool supportResCategoriesIsSet() const;
    void unsetsupportResCategories();
    void setSupportResCategories(const std::vector<std::string>& value);
...
protected:
    ...
    std::vector<std::string> supportResCategories_;
    bool supportResCategoriesIsSet_;
    std::string swrPath_;
    bool swrPathIsSet_;
    std::string tag_;
    bool tagIsSet_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_SyncImageResponse_H_
