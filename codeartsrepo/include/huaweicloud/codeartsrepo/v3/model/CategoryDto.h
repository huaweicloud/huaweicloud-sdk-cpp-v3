...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CategoryDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CategoryDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  CategoryDto
    : public ModelBase
{
public:
    CategoryDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CategoryDto_H_
