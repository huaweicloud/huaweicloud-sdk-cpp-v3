...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateLlmConfigRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateLlmConfigRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateLlmConfigRequest
    : public ModelBase
{
public:
    UpdateLlmConfigRequest();
    virtual ~UpdateLlmConfigRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateLlmConfigRequest members
    ...
    UpdateLlmConfigReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateLlmConfigReq& value);
...
protected:
    ...
    UpdateLlmConfigReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateLlmConfigRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateLlmConfigRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateLlmConfigRequest_H_
