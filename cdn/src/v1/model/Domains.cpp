...
std::string Domains::getUserDomainId() const
{
    return userDomainId_;
}

void Domains::setUserDomainId(const std::string& value)
{
    userDomainId_ = value;
    userDomainIdIsSet_ = true;
}

bool Domains::userDomainIdIsSet() const
{
    return userDomainIdIsSet_;
}

void Domains::unsetuserDomainId()
{
    userDomainIdIsSet_ = false;
}
