...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowLivePlatformRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowLivePlatformRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowLivePlatformRequest
    : public ModelBase
{
public:
    ShowLivePlatformRequest();
    virtual ~ShowLivePlatformRequest();
    ...
    /////////////////////////////////////////////
    /// ShowLivePlatformRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowLivePlatformRequest& dereference_from_shared_ptr(std::shared_ptr<ShowLivePlatformRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowLivePlatformRequest_H_
