...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTtsaRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTtsaRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateTtsaRequest
    : public ModelBase
{
public:
    CreateTtsaRequest();
    virtual ~CreateTtsaRequest();
    ...
    CreateTTSAReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const CreateTTSAReq& value);
...
protected:
    ...
    RTTR_ENABLE()
public:
    CreateTtsaRequest& dereference_from_shared_ptr(std::shared_ptr<CreateTtsaRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTtsaRequest_H_
