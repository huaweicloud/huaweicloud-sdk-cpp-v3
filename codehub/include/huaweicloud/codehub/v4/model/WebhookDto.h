...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_WebhookDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_WebhookDto_H_
...
/// **参数解释：** Webhook数据。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  WebhookDto
    : public ModelBase
{
public:
    WebhookDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_WebhookDto_H_
