...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_UpdateDeviceProxy_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_UpdateDeviceProxy_H_
...
/// 添加设备代理结构体。
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  UpdateDeviceProxy
    : public ModelBase
{
public:
    UpdateDeviceProxy();
    virtual ~UpdateDeviceProxy();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_UpdateDeviceProxy_H_
