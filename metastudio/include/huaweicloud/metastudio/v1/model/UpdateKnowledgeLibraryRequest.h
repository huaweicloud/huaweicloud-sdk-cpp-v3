...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateKnowledgeLibraryRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateKnowledgeLibraryRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateKnowledgeLibraryRequest
    : public ModelBase
{
public:
    UpdateKnowledgeLibraryRequest();
    virtual ~UpdateKnowledgeLibraryRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateKnowledgeLibraryRequest members
    ...
    UpdateKnowledgeLibraryReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateKnowledgeLibraryReq& value);
...
protected:
    ...
    UpdateKnowledgeLibraryReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateKnowledgeLibraryRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateKnowledgeLibraryRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateKnowledgeLibraryRequest_H_
