...
std::string ListResourceInstancesRequest::getXSecurityToken() const
{
    return xSecurityToken_;
}

void ListResourceInstancesRequest::setXSecurityToken(const std::string& value)
{
    xSecurityToken_ = value;
    xSecurityTokenIsSet_ = true;
}

bool ListResourceInstancesRequest::xSecurityTokenIsSet() const
{
    return xSecurityTokenIsSet_;
}

void ListResourceInstancesRequest::unsetxSecurityToken()
{
    xSecurityTokenIsSet_ = false;
}
