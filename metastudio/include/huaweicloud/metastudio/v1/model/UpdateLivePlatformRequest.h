...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateLivePlatformRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateLivePlatformRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateLivePlatformRequest
    : public ModelBase
{
public:
    UpdateLivePlatformRequest();
    virtual ~UpdateLivePlatformRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateLivePlatformRequest members
    ...
    UpdateLivePlatformReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateLivePlatformReq& value);
...
protected:
    ...
    UpdateLivePlatformReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateLivePlatformRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateLivePlatformRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateLivePlatformRequest_H_
