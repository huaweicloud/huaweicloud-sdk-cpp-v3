...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ReviewDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ReviewDto_H_
...
/// 检视意见详细信息
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ReviewDto
    : public ModelBase
{
public:
    ReviewDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ReviewDto_H_
