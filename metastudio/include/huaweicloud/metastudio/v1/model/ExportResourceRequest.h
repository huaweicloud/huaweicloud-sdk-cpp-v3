...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ExportResourceRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ExportResourceRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ExportResourceRequest
    : public ModelBase
{
public:
    ExportResourceRequest();
    virtual ~ExportResourceRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ExportResourceRequest& dereference_from_shared_ptr(std::shared_ptr<ExportResourceRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ExportResourceRequest_H_
