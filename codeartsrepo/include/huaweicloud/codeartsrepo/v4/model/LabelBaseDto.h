...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelBaseDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelBaseDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  LabelBaseDto
    : public ModelBase
{
public:
    LabelBaseDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LabelBaseDto_H_
