...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_StopSmartLiveRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_StopSmartLiveRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  StopSmartLiveRequest
    : public ModelBase
{
public:
    StopSmartLiveRequest();
    virtual ~StopSmartLiveRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    StopSmartLiveRequest& dereference_from_shared_ptr(std::shared_ptr<StopSmartLiveRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_StopSmartLiveRequest_H_
