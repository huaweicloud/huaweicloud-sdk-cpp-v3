...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MrCherryRevertDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MrCherryRevertDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  MrCherryRevertDto
    : public ModelBase
{
public:
    MrCherryRevertDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_MrCherryRevertDto_H_
