...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoListInfo_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoListInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  RepoListInfo
    : public ModelBase
{
public:
    RepoListInfo();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoListInfo_H_
