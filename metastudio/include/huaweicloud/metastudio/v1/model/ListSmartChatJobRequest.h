...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListSmartChatJobRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListSmartChatJobRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListSmartChatJobRequest
    : public ModelBase
{
public:
    ListSmartChatJobRequest();
    virtual ~ListSmartChatJobRequest();
    ...
    /////////////////////////////////////////////
    /// ListSmartChatJobRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListSmartChatJobRequest& dereference_from_shared_ptr(std::shared_ptr<ListSmartChatJobRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListSmartChatJobRequest_H_
