...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ReqWorkItemDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ReqWorkItemDto_H_
...
#include <string>
#include <huaweicloud/codehub/v4/model/ReqWorkItemBasicDto.h>
...
/// **参数解释：** 工作项数据。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ReqWorkItemDto
    : public ModelBase
{
public:
    ReqWorkItemDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ReqWorkItemDto_H_
