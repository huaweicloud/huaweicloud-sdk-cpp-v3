...
#ifndef HUAWEICLOUD_SDK_EIP_V2_MODEL_BandwidthResp_H_
#define HUAWEICLOUD_SDK_EIP_V2_MODEL_BandwidthResp_H_
...
#include "huaweicloud/eip/model/PublicipInfoResp.h"
#include <string>
#include "huaweicloud/eip/model/BandWidthRules.h"
#include <vector>
...
/// 带宽对象
/// </summary>
class HUAWEICLOUD_EIP_EXPORT  BandwidthResp
    : public ModelBase
{
public:
    BandwidthResp();
...
#endif // HUAWEICLOUD_SDK_EIP_V2_MODEL_BandwidthResp_H_
