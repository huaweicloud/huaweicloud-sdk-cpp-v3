...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_NamespaceBasicDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_NamespaceBasicDto_H_
...
/// namespace基本信息
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  NamespaceBasicDto
    : public ModelBase
{
public:
    NamespaceBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_NamespaceBasicDto_H_
