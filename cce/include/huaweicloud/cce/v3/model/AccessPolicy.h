...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_AccessPolicy_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_AccessPolicy_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  AccessPolicy
    : public ModelBase
{
public:
    AccessPolicy();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_AccessPolicy_H_
