...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_HarmonySoftBusResponseDTO_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_HarmonySoftBusResponseDTO_H_
...
/// <summary>
/// 鸿蒙软总线信息结构体，创建、查询鸿蒙软总线时返回
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  HarmonySoftBusResponseDTO
    : public ModelBase
{
public:
    HarmonySoftBusResponseDTO();
    virtual ~HarmonySoftBusResponseDTO();
    ...
    /////////////////////////////////////////////
    /// HarmonySoftBusResponseDTO members
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_HarmonySoftBusResponseDTO_H_
