...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ChargeInfoOption_H_
#define HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ChargeInfoOption_H_
...
/// </summary>
class HUAWEICLOUD_GAUSSDBFORNOSQL_V3_EXPORT  ChargeInfoOption
    : public ModelBase
{
public:
    ChargeInfoOption();
    virtual ~ChargeInfoOption();
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ChargeInfoOption_H_
