...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListRoleRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListRoleRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListRoleRequest
    : public ModelBase
{
public:
    ListRoleRequest();
    virtual ~ListRoleRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListRoleRequest& dereference_from_shared_ptr(std::shared_ptr<ListRoleRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListRoleRequest_H_
