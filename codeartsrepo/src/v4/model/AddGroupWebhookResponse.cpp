...
std::vector<std::string>& AddGroupWebhookResponse::getNotePlainTextFilter()
{
    return notePlainTextFilter_;
}

void AddGroupWebhookResponse::setNotePlainTextFilter(const std::vector<std::string>& value)
{
    notePlainTextFilter_ = value;
    notePlainTextFilterIsSet_ = true;
}

bool AddGroupWebhookResponse::notePlainTextFilterIsSet() const
{
    return notePlainTextFilterIsSet_;
}

void AddGroupWebhookResponse::unsetnotePlainTextFilter()
{
    notePlainTextFilterIsSet_ = false;
}
...
std::vector<WebHookEventCfgDto>& AddGroupWebhookResponse::getEventCfgs()
{
    return eventCfgs_;
}

void AddGroupWebhookResponse::setEventCfgs(const std::vector<WebHookEventCfgDto>& value)
{
    eventCfgs_ = value;
    eventCfgsIsSet_ = true;
}

bool AddGroupWebhookResponse::eventCfgsIsSet() const
{
    return eventCfgsIsSet_;
}

void AddGroupWebhookResponse::unseteventCfgs()
{
    eventCfgsIsSet_ = false;
}

std::vector<WebHookBranchCfgDto>& AddGroupWebhookResponse::getProjectCfgs()
{
    return projectCfgs_;
}

void AddGroupWebhookResponse::setProjectCfgs(const std::vector<WebHookBranchCfgDto>& value)
{
    projectCfgs_ = value;
    projectCfgsIsSet_ = true;
}

bool AddGroupWebhookResponse::projectCfgsIsSet() const
{
    return projectCfgsIsSet_;
}

void AddGroupWebhookResponse::unsetprojectCfgs()
{
    projectCfgsIsSet_ = false;
}

std::vector<WebHookBranchCfgDto>& AddGroupWebhookResponse::getBranchCfgs()
{
    return branchCfgs_;
}

void AddGroupWebhookResponse::setBranchCfgs(const std::vector<WebHookBranchCfgDto>& value)
{
    branchCfgs_ = value;
    branchCfgsIsSet_ = true;
}

bool AddGroupWebhookResponse::branchCfgsIsSet() const
{
    return branchCfgsIsSet_;
}

void AddGroupWebhookResponse::unsetbranchCfgs()
{
    branchCfgsIsSet_ = false;
}
...
std::string AddGroupWebhookResponse::getService() const
{
    return service_;
}

void AddGroupWebhookResponse::setService(const std::string& value)
{
    service_ = value;
    serviceIsSet_ = true;
}

bool AddGroupWebhookResponse::serviceIsSet() const
{
    return serviceIsSet_;
}

void AddGroupWebhookResponse::unsetservice()
{
    serviceIsSet_ = false;
}
