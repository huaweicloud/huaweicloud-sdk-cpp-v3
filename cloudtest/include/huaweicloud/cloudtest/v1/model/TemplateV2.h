...
#ifndef HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_TemplateV2_H_
#define HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_TemplateV2_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CLOUDTEST_V1_EXPORT  TemplateV2
    : public ModelBase
{
public:
    TemplateV2();
    ...
    bool isEditPermission() const;
    bool editPermissionIsSet() const;
    void unseteditPermission();
...
protected:
    ...
    bool editPermission_;
    bool editPermissionIsSet_;
...
#endif // HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_TemplateV2_H_
