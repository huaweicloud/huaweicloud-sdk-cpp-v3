...
int32_t UserBasicDto::getServiceLicenseStatus() const
{
    return serviceLicenseStatus_;
}

void UserBasicDto::setServiceLicenseStatus(int32_t value)
{
    serviceLicenseStatus_ = value;
    serviceLicenseStatusIsSet_ = true;
}

bool UserBasicDto::serviceLicenseStatusIsSet() const
{
    return serviceLicenseStatusIsSet_;
}

void UserBasicDto::unsetserviceLicenseStatus()
{
    serviceLicenseStatusIsSet_ = false;
}
...
std::string UserBasicDto::getErrorMessage() const
{
    return errorMessage_;
}

void UserBasicDto::setErrorMessage(const std::string& value)
{
    errorMessage_ = value;
    errorMessageIsSet_ = true;
}

bool UserBasicDto::errorMessageIsSet() const
{
    return errorMessageIsSet_;
}

void UserBasicDto::unseterrorMessage()
{
    errorMessageIsSet_ = false;
}
