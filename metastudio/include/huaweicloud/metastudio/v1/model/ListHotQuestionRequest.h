...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListHotQuestionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListHotQuestionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListHotQuestionRequest
    : public ModelBase
{
public:
    ListHotQuestionRequest();
    virtual ~ListHotQuestionRequest();
    ...
    /////////////////////////////////////////////
    /// ListHotQuestionRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListHotQuestionRequest& dereference_from_shared_ptr(std::shared_ptr<ListHotQuestionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListHotQuestionRequest_H_
