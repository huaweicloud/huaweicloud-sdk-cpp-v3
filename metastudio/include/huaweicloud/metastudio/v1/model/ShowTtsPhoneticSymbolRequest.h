...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowTtsPhoneticSymbolRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowTtsPhoneticSymbolRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowTtsPhoneticSymbolRequest
    : public ModelBase
{
public:
    ShowTtsPhoneticSymbolRequest();
    virtual ~ShowTtsPhoneticSymbolRequest();
    ...
    /////////////////////////////////////////////
    /// ShowTtsPhoneticSymbolRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowTtsPhoneticSymbolRequest& dereference_from_shared_ptr(std::shared_ptr<ShowTtsPhoneticSymbolRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowTtsPhoneticSymbolRequest_H_
