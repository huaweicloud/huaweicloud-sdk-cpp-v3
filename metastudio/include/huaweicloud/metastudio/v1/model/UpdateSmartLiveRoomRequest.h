...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateSmartLiveRoomRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateSmartLiveRoomRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateSmartLiveRoomRequest
    : public ModelBase
{
public:
    UpdateSmartLiveRoomRequest();
    virtual ~UpdateSmartLiveRoomRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateSmartLiveRoomRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    UpdateSmartLiveRoomRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateSmartLiveRoomRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateSmartLiveRoomRequest_H_
