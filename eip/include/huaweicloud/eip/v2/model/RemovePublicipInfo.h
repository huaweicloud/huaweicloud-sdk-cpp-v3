...
#ifndef HUAWEICLOUD_SDK_EIP_V2_MODEL_RemovePublicipInfo_H_
#define HUAWEICLOUD_SDK_EIP_V2_MODEL_RemovePublicipInfo_H_
...
/// </summary>
class HUAWEICLOUD_EIP_V2_EXPORT  RemovePublicipInfo
    : public ModelBase
{
public:
    RemovePublicipInfo();
    virtual ~RemovePublicipInfo();
...
#endif // HUAWEICLOUD_SDK_EIP_V2_MODEL_RemovePublicipInfo_H_
