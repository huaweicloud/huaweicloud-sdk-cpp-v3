...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_StarRocksCreateRequest_be_volume_H_
...
/// BE节点存储规格。
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  StarRocksCreateRequest_be_volume
    : public ModelBase
{
public:
    StarRocksCreateRequest_be_volume();
    virtual ~StarRocksCreateRequest_be_volume();
    ...
    /////////////////////////////////////////////
    /// StarRocksCreateRequest_be_volume members
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_StarRocksCreateRequest_be_volume_H_
