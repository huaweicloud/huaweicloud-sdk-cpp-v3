...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateRobotRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateRobotRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateRobotRequest
    : public ModelBase
{
public:
    CreateRobotRequest();
    virtual ~CreateRobotRequest();
    ...
    CreateRobotReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const CreateRobotReq& value);
...
protected:
    ...
    CreateRobotReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    CreateRobotRequest& dereference_from_shared_ptr(std::shared_ptr<CreateRobotRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateRobotRequest_H_
