...
#ifndef HUAWEICLOUD_SDK_TMS_V1_MODEL_CreateTagRequest_H_
...
///  标签详情。
/// </summary>
class HUAWEICLOUD_TMS_V1_EXPORT  CreateTagRequest
    : public ModelBase
{
public:
    CreateTagRequest();
...
#endif // HUAWEICLOUD_SDK_TMS_V1_MODEL_CreateTagRequest_H_
