...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_CreatePublicationRequestDTO_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_CreatePublicationRequestDTO_H_
...
/// 发布信息。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  CreatePublicationRequestDTO
    : public ModelBase
{
public:
    CreatePublicationRequestDTO();
    virtual ~CreatePublicationRequestDTO();
    ...
    /////////////////////////////////////////////
    /// CreatePublicationRequestDTO members
    ...
    void setProgramList(const std::vector<std::string>& value);
...
protected:
    ...
    std::vector<std::string> programList_;
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_CreatePublicationRequestDTO_H_
