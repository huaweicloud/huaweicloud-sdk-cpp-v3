...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowInstructionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowInstructionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowInstructionRequest
    : public ModelBase
{
public:
    ShowInstructionRequest();
    virtual ~ShowInstructionRequest();
    ...
    /////////////////////////////////////////////
    /// ShowInstructionRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowInstructionRequest& dereference_from_shared_ptr(std::shared_ptr<ShowInstructionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowInstructionRequest_H_
