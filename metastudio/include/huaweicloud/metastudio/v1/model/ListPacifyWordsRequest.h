...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListPacifyWordsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListPacifyWordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListPacifyWordsRequest
    : public ModelBase
{
public:
    ListPacifyWordsRequest();
    virtual ~ListPacifyWordsRequest();
    ...
    /////////////////////////////////////////////
    /// ListPacifyWordsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListPacifyWordsRequest& dereference_from_shared_ptr(std::shared_ptr<ListPacifyWordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListPacifyWordsRequest_H_
