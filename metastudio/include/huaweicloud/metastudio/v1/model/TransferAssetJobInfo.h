...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_TransferAssetJobInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_TransferAssetJobInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  TransferAssetJobInfo
    : public ModelBase
{
public:
    TransferAssetJobInfo();
    virtual ~TransferAssetJobInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_TransferAssetJobInfo_H_
