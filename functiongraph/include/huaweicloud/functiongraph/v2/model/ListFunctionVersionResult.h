...
#ifndef HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ListFunctionVersionResult_H_
#define HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ListFunctionVersionResult_H_
...
/// 
/// </summary>
class HUAWEICLOUD_FUNCTIONGRAPH_V2_EXPORT  ListFunctionVersionResult
    : public ModelBase
{
public:
    ListFunctionVersionResult();
    virtual ~ListFunctionVersionResult();
    ...
    /////////////////////////////////////////////
    /// ListFunctionVersionResult members
    ...
    FunctionAsyncConfig getFunctionAsyncConfig() const;
    bool functionAsyncConfigIsSet() const;
    void unsetfunctionAsyncConfig();
    void setFunctionAsyncConfig(const FunctionAsyncConfig& value);
...
protected:
    ...
    bool longTime_;
    bool longTimeIsSet_;
    FunctionAsyncConfig functionAsyncConfig_;
    bool functionAsyncConfigIsSet_;
    std::string type_;
    bool typeIsSet_;
...
#endif // HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_ListFunctionVersionResult_H_
