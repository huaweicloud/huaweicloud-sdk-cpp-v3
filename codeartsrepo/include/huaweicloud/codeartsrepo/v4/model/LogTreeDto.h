...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LogTreeDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LogTreeDto_H_
...
/// **参数解释：** 文件/文件夹信息
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  LogTreeDto
    : public ModelBase
{
public:
    LogTreeDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_LogTreeDto_H_
