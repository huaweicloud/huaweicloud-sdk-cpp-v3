...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListInstancesDetailsRequest_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListInstancesDetailsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  ListInstancesDetailsRequest
    : public ModelBase
{
public:
    ListInstancesDetailsRequest();
    virtual ~ListInstancesDetailsRequest();
    ...
    /////////////////////////////////////////////
    /// ListInstancesDetailsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListInstancesDetailsRequest& dereference_from_shared_ptr(std::shared_ptr<ListInstancesDetailsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListInstancesDetailsRequest_H_
