...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListDatabaseInstancesRequest_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListDatabaseInstancesRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  ListDatabaseInstancesRequest
    : public ModelBase
{
public:
    ListDatabaseInstancesRequest();
    virtual ~ListDatabaseInstancesRequest();
    ...
    /////////////////////////////////////////////
    /// ListDatabaseInstancesRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDatabaseInstancesRequest& dereference_from_shared_ptr(std::shared_ptr<ListDatabaseInstancesRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_ListDatabaseInstancesRequest_H_
