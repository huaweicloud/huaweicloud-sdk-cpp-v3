...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListSmartLiveRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListSmartLiveRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListSmartLiveRequest
    : public ModelBase
{
public:
    ListSmartLiveRequest();
    virtual ~ListSmartLiveRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListSmartLiveRequest& dereference_from_shared_ptr(std::shared_ptr<ListSmartLiveRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListSmartLiveRequest_H_
