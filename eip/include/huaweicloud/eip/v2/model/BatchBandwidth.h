...
#ifndef HUAWEICLOUD_SDK_EIP_V2_MODEL_BatchBandwidth_H_
#define HUAWEICLOUD_SDK_EIP_V2_MODEL_BatchBandwidth_H_
...
/// 带宽信息
/// </summary>
class HUAWEICLOUD_EIP_V2_EXPORT  BatchBandwidth
    : public ModelBase
{
public:
    BatchBandwidth();
    virtual ~BatchBandwidth();
...
#endif // HUAWEICLOUD_SDK_EIP_V2_MODEL_BatchBandwidth_H_
