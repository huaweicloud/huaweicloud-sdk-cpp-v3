...
#ifndef HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_DeleteFunctionTriggerRequest_H_
#define HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_DeleteFunctionTriggerRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_FUNCTIONGRAPH_V2_EXPORT  DeleteFunctionTriggerRequest
    : public ModelBase
{
public:
    DeleteFunctionTriggerRequest();
    virtual ~DeleteFunctionTriggerRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteFunctionTriggerRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteFunctionTriggerRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteFunctionTriggerRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_DeleteFunctionTriggerRequest_H_
