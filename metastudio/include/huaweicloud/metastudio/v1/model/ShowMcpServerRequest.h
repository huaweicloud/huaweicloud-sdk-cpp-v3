...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowMcpServerRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowMcpServerRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowMcpServerRequest
    : public ModelBase
{
public:
    ShowMcpServerRequest();
    virtual ~ShowMcpServerRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowMcpServerRequest& dereference_from_shared_ptr(std::shared_ptr<ShowMcpServerRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowMcpServerRequest_H_
