...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowWelcomeSpeechSwitchRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowWelcomeSpeechSwitchRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowWelcomeSpeechSwitchRequest
    : public ModelBase
{
public:
    ShowWelcomeSpeechSwitchRequest();
    virtual ~ShowWelcomeSpeechSwitchRequest();
    ...
    /////////////////////////////////////////////
    /// ShowWelcomeSpeechSwitchRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowWelcomeSpeechSwitchRequest& dereference_from_shared_ptr(std::shared_ptr<ShowWelcomeSpeechSwitchRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowWelcomeSpeechSwitchRequest_H_
