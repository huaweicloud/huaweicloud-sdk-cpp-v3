...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_UserBasicDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_UserBasicDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  UserBasicDto
    : public ModelBase
{
public:
    UserBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_UserBasicDto_H_
