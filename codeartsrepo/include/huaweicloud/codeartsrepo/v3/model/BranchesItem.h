...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_BranchesItem_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_BranchesItem_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  BranchesItem
    : public ModelBase
{
public:
    BranchesItem();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_BranchesItem_H_
