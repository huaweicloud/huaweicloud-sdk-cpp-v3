...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_HangUpRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_HangUpRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  HangUpRequest
    : public ModelBase
{
public:
    HangUpRequest();
    ...
    RestBulkHangUpReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestBulkHangUpReqBody& value);
...
protected:
    ...
    RestBulkHangUpReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    HangUpRequest& dereference_from_shared_ptr(std::shared_ptr<HangUpRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_HangUpRequest_H_
