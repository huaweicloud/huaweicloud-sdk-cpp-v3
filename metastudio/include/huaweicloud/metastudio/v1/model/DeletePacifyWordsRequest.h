...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeletePacifyWordsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeletePacifyWordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeletePacifyWordsRequest
    : public ModelBase
{
public:
    DeletePacifyWordsRequest();
    virtual ~DeletePacifyWordsRequest();
    ...
    /////////////////////////////////////////////
    /// DeletePacifyWordsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeletePacifyWordsRequest& dereference_from_shared_ptr(std::shared_ptr<DeletePacifyWordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeletePacifyWordsRequest_H_
