...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_GroupConfigResponse_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_GroupConfigResponse_H_
...
/// **参数解释：** 服务部署配置。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  GroupConfigResponse
    : public ModelBase
{
public:
    GroupConfigResponse();
    virtual ~GroupConfigResponse();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_GroupConfigResponse_H_
