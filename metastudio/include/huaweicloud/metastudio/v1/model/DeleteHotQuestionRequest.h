...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteHotQuestionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteHotQuestionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteHotQuestionRequest
    : public ModelBase
{
public:
    DeleteHotQuestionRequest();
    virtual ~DeleteHotQuestionRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteHotQuestionRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteHotQuestionRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteHotQuestionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteHotQuestionRequest_H_
