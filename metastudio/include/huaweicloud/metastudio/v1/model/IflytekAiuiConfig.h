...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_IflytekAiuiConfig_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_IflytekAiuiConfig_H_
...
/// 科大讯飞AIUI应用配置
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  IflytekAiuiConfig
    : public ModelBase
{
public:
    IflytekAiuiConfig();
    virtual ~IflytekAiuiConfig();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_IflytekAiuiConfig_H_
