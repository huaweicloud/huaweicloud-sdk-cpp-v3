...
#ifndef HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_UpdateTestCaseListInfo_H_
#define HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_UpdateTestCaseListInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CLOUDTEST_V1_EXPORT  UpdateTestCaseListInfo
    : public ModelBase
{
public:
    UpdateTestCaseListInfo();
    virtual ~UpdateTestCaseListInfo();
    ...
    /////////////////////////////////////////////
    /// UpdateTestCaseListInfo members
    ...
    std::vector<CaseInfo>& getCaseList();
    bool caseListIsSet() const;
    void unsetcaseList();
    void setCaseList(const std::vector<CaseInfo>& value);

    /// <summary>
    /// 批量更新用例id列表
    /// </summary>

    std::vector<std::string>& getCaseIdList();
    bool caseIdListIsSet() const;
    void unsetcaseIdList();
    void setCaseIdList(const std::vector<std::string>& value);
...
protected:
    ...
    std::vector<CaseInfo> caseList_;
    bool caseListIsSet_;
    std::vector<std::string> caseIdList_;
    bool caseIdListIsSet_;
...
#endif // HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_UpdateTestCaseListInfo_H_
