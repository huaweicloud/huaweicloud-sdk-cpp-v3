#ifndef HUAWEICLOUD_SDK_LIVE_V2_LiveRegion_H_
#define HUAWEICLOUD_SDK_LIVE_V2_LiveRegion_H_
...
class HUAWEICLOUD_LIVE_V2_EXPORT LiveRegion {
public:
    LiveRegion();
    virtual ~LiveRegion();
...
#endif // HUAWEICLOUD_SDK_LIVE_V2_LiveRegion_H_