...
std::string CancelAssetTranscodeTaskRequest::getAuthorization() const
{
    return authorization_;
}

void CancelAssetTranscodeTaskRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool CancelAssetTranscodeTaskRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void CancelAssetTranscodeTaskRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
