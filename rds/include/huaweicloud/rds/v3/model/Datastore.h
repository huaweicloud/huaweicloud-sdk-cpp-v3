...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_Datastore_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_Datastore_H_
...
/// 
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  Datastore
    : public ModelBase
{
public:
    Datastore();
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_Datastore_H_
