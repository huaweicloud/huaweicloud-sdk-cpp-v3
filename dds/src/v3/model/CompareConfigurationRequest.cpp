...
bool CompareConfigurationRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("body"))) {
        ...
        {
            DiffConfigurationRequest refVal;
...
DiffConfigurationRequest CompareConfigurationRequest::getBody() const
{
    return body_;
}

void CompareConfigurationRequest::setBody(const DiffConfigurationRequest& value)
{
    body_ = value;
    bodyIsSet_ = true;
}
