...
int32_t SearchAutoEnlargePolicyResponse::getStepSize() const
{
    return stepSize_;
}

void SearchAutoEnlargePolicyResponse::setStepSize(int32_t value)
{
    stepSize_ = value;
    stepSizeIsSet_ = true;
}

bool SearchAutoEnlargePolicyResponse::stepSizeIsSet() const
{
    return stepSizeIsSet_;
}

void SearchAutoEnlargePolicyResponse::unsetstepSize()
{
    stepSizeIsSet_ = false;
}

int32_t SearchAutoEnlargePolicyResponse::getStepPercent() const
{
    return stepPercent_;
}

void SearchAutoEnlargePolicyResponse::setStepPercent(int32_t value)
{
    stepPercent_ = value;
    stepPercentIsSet_ = true;
}

bool SearchAutoEnlargePolicyResponse::stepPercentIsSet() const
{
    return stepPercentIsSet_;
}

void SearchAutoEnlargePolicyResponse::unsetstepPercent()
{
    stepPercentIsSet_ = false;
}
