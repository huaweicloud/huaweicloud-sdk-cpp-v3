...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_OtaModuleInfo_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_OtaModuleInfo_H_
...
/// OTA模块信息
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  OtaModuleInfo
    : public ModelBase
{
public:
    OtaModuleInfo();
    virtual ~OtaModuleInfo();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_OtaModuleInfo_H_
