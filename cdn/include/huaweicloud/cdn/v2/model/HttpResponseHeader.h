...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_HttpResponseHeader_H_
...
/// http响应头设置
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  HttpResponseHeader
    : public ModelBase
{
public:
    HttpResponseHeader();
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_HttpResponseHeader_H_
