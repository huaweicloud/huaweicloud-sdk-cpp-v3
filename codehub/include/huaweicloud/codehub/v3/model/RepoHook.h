...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoHook_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoHook_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  RepoHook
    : public ModelBase
{
public:
    RepoHook();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoHook_H_
