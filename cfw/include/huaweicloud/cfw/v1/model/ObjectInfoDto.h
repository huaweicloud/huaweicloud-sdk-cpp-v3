...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_ObjectInfoDto_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_ObjectInfoDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  ObjectInfoDto
    : public ModelBase
{
public:
    ObjectInfoDto();
    virtual ~ObjectInfoDto();
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_ObjectInfoDto_H_
