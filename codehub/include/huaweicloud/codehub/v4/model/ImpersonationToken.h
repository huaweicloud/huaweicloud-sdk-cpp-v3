...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ImpersonationToken_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ImpersonationToken_H_
...
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ImpersonationToken
    : public ModelBase
{
public:
    ImpersonationToken();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ImpersonationToken_H_
