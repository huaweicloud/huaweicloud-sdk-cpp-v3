...
std::string DetectLiveFaceByFileResponse::getXRequestId() const
{
    return xRequestId_;
}

void DetectLiveFaceByFileResponse::setXRequestId(const std::string& value)
{
    xRequestId_ = value;
    xRequestIdIsSet_ = true;
}

bool DetectLiveFaceByFileResponse::xRequestIdIsSet() const
{
    return xRequestIdIsSet_;
}

void DetectLiveFaceByFileResponse::unsetxRequestId()
{
    xRequestIdIsSet_ = false;
}
