...
CreateIssueRequestV4::CreateIssueRequestV4()
{
...
CreateIssueRequestV4::~CreateIssueRequestV4() = default;

void CreateIssueRequestV4::validate()
{
}

web::json::value CreateIssueRequestV4::toJson() const
{
...
bool CreateIssueRequestV4::fromJson(const web::json::value& val)
{
    bool ok = true;
...
double CreateIssueRequestV4::getActualWorkHours() const
{
    return actualWorkHours_;
}

void CreateIssueRequestV4::setActualWorkHours(double value)
{
    actualWorkHours_ = value;
    actualWorkHoursIsSet_ = true;
}

bool CreateIssueRequestV4::actualWorkHoursIsSet() const
{
    return actualWorkHoursIsSet_;
}

void CreateIssueRequestV4::unsetactualWorkHours()
{
    actualWorkHoursIsSet_ = false;
}

int32_t CreateIssueRequestV4::getAssignedId() const
{
    return assignedId_;
}

void CreateIssueRequestV4::setAssignedId(int32_t value)
{
    assignedId_ = value;
    assignedIdIsSet_ = true;
}

bool CreateIssueRequestV4::assignedIdIsSet() const
{
    return assignedIdIsSet_;
}

void CreateIssueRequestV4::unsetassignedId()
{
    assignedIdIsSet_ = false;
}

std::string CreateIssueRequestV4::getBeginTime() const
{
    return beginTime_;
}

void CreateIssueRequestV4::setBeginTime(const std::string& value)
{
    beginTime_ = value;
    beginTimeIsSet_ = true;
}

bool CreateIssueRequestV4::beginTimeIsSet() const
{
    return beginTimeIsSet_;
}

void CreateIssueRequestV4::unsetbeginTime()
{
    beginTimeIsSet_ = false;
}

std::string CreateIssueRequestV4::getDescription() const
{
    return description_;
}

void CreateIssueRequestV4::setDescription(const std::string& value)
{
    description_ = value;
    descriptionIsSet_ = true;
}

bool CreateIssueRequestV4::descriptionIsSet() const
{
    return descriptionIsSet_;
}

void CreateIssueRequestV4::unsetdescription()
{
    descriptionIsSet_ = false;
}

int32_t CreateIssueRequestV4::getDeveloperId() const
{
    return developerId_;
}

void CreateIssueRequestV4::setDeveloperId(int32_t value)
{
    developerId_ = value;
    developerIdIsSet_ = true;
}

bool CreateIssueRequestV4::developerIdIsSet() const
{
    return developerIdIsSet_;
}

void CreateIssueRequestV4::unsetdeveloperId()
{
    developerIdIsSet_ = false;
}

int32_t CreateIssueRequestV4::getDomainId() const
{
    return domainId_;
}

void CreateIssueRequestV4::setDomainId(int32_t value)
{
    domainId_ = value;
    domainIdIsSet_ = true;
}

bool CreateIssueRequestV4::domainIdIsSet() const
{
    return domainIdIsSet_;
}

void CreateIssueRequestV4::unsetdomainId()
{
    domainIdIsSet_ = false;
}

int32_t CreateIssueRequestV4::getDoneRatio() const
{
    return doneRatio_;
}

void CreateIssueRequestV4::setDoneRatio(int32_t value)
{
    doneRatio_ = value;
    doneRatioIsSet_ = true;
}

bool CreateIssueRequestV4::doneRatioIsSet() const
{
    return doneRatioIsSet_;
}

void CreateIssueRequestV4::unsetdoneRatio()
{
    doneRatioIsSet_ = false;
}

std::string CreateIssueRequestV4::getEndTime() const
{
    return endTime_;
}

void CreateIssueRequestV4::setEndTime(const std::string& value)
{
    endTime_ = value;
    endTimeIsSet_ = true;
}

bool CreateIssueRequestV4::endTimeIsSet() const
{
    return endTimeIsSet_;
}

void CreateIssueRequestV4::unsetendTime()
{
    endTimeIsSet_ = false;
}

double CreateIssueRequestV4::getExpectedWorkHours() const
{
    return expectedWorkHours_;
}

void CreateIssueRequestV4::setExpectedWorkHours(double value)
{
    expectedWorkHours_ = value;
    expectedWorkHoursIsSet_ = true;
}

bool CreateIssueRequestV4::expectedWorkHoursIsSet() const
{
    return expectedWorkHoursIsSet_;
}

void CreateIssueRequestV4::unsetexpectedWorkHours()
{
    expectedWorkHoursIsSet_ = false;
}

int32_t CreateIssueRequestV4::getIterationId() const
{
    return iterationId_;
}

void CreateIssueRequestV4::setIterationId(int32_t value)
{
    iterationId_ = value;
    iterationIdIsSet_ = true;
}

bool CreateIssueRequestV4::iterationIdIsSet() const
{
    return iterationIdIsSet_;
}

void CreateIssueRequestV4::unsetiterationId()
{
    iterationIdIsSet_ = false;
}

int32_t CreateIssueRequestV4::getModuleId() const
{
    return moduleId_;
}

void CreateIssueRequestV4::setModuleId(int32_t value)
{
    moduleId_ = value;
    moduleIdIsSet_ = true;
}

bool CreateIssueRequestV4::moduleIdIsSet() const
{
    return moduleIdIsSet_;
}

void CreateIssueRequestV4::unsetmoduleId()
{
    moduleIdIsSet_ = false;
}

std::string CreateIssueRequestV4::getName() const
{
    return name_;
}

void CreateIssueRequestV4::setName(const std::string& value)
{
    name_ = value;
    nameIsSet_ = true;
}

bool CreateIssueRequestV4::nameIsSet() const
{
    return nameIsSet_;
}

void CreateIssueRequestV4::unsetname()
{
    nameIsSet_ = false;
}

int32_t CreateIssueRequestV4::getParentIssueId() const
{
    return parentIssueId_;
}

void CreateIssueRequestV4::setParentIssueId(int32_t value)
{
    parentIssueId_ = value;
    parentIssueIdIsSet_ = true;
}

bool CreateIssueRequestV4::parentIssueIdIsSet() const
{
    return parentIssueIdIsSet_;
}

void CreateIssueRequestV4::unsetparentIssueId()
{
    parentIssueIdIsSet_ = false;
}

int32_t CreateIssueRequestV4::getPriorityId() const
{
    return priorityId_;
}

void CreateIssueRequestV4::setPriorityId(int32_t value)
{
    priorityId_ = value;
    priorityIdIsSet_ = true;
}

bool CreateIssueRequestV4::priorityIdIsSet() const
{
    return priorityIdIsSet_;
}

void CreateIssueRequestV4::unsetpriorityId()
{
    priorityIdIsSet_ = false;
}

int32_t CreateIssueRequestV4::getSeverityId() const
{
    return severityId_;
}

void CreateIssueRequestV4::setSeverityId(int32_t value)
{
    severityId_ = value;
    severityIdIsSet_ = true;
}

bool CreateIssueRequestV4::severityIdIsSet() const
{
    return severityIdIsSet_;
}

void CreateIssueRequestV4::unsetseverityId()
{
    severityIdIsSet_ = false;
}

int32_t CreateIssueRequestV4::getStatusId() const
{
    return statusId_;
}

void CreateIssueRequestV4::setStatusId(int32_t value)
{
    statusId_ = value;
    statusIdIsSet_ = true;
}

bool CreateIssueRequestV4::statusIdIsSet() const
{
    return statusIdIsSet_;
}

void CreateIssueRequestV4::unsetstatusId()
{
    statusIdIsSet_ = false;
}

int32_t CreateIssueRequestV4::getTrackerId() const
{
    return trackerId_;
}

void CreateIssueRequestV4::setTrackerId(int32_t value)
{
    trackerId_ = value;
    trackerIdIsSet_ = true;
}

bool CreateIssueRequestV4::trackerIdIsSet() const
{
    return trackerIdIsSet_;
}

void CreateIssueRequestV4::unsettrackerId()
{
    trackerIdIsSet_ = false;
}

std::vector<NewCustomField>& CreateIssueRequestV4::getNewCustomFields()
{
    return newCustomFields_;
}

void CreateIssueRequestV4::setNewCustomFields(const std::vector<NewCustomField>& value)
{
    newCustomFields_ = value;
    newCustomFieldsIsSet_ = true;
}

bool CreateIssueRequestV4::newCustomFieldsIsSet() const
{
    return newCustomFieldsIsSet_;
}

void CreateIssueRequestV4::unsetnewCustomFields()
{
    newCustomFieldsIsSet_ = false;
}
