...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_RoutingRule_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_RoutingRule_H_
...
/// 创建或修改规则条件的响应消息
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  RoutingRule
    : public ModelBase
{
public:
    RoutingRule();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_RoutingRule_H_
