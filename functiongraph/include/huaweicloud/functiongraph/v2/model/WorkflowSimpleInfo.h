...
#ifndef HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_WorkflowSimpleInfo_H_
#define HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_WorkflowSimpleInfo_H_
...
/// 函数流详情
/// </summary>
class HUAWEICLOUD_FUNCTIONGRAPH_V2_EXPORT  WorkflowSimpleInfo
    : public ModelBase
{
public:
    WorkflowSimpleInfo();
    virtual ~WorkflowSimpleInfo();
...
#endif // HUAWEICLOUD_SDK_FUNCTIONGRAPH_V2_MODEL_WorkflowSimpleInfo_H_
