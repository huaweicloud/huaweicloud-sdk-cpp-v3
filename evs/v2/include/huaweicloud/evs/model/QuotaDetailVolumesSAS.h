...
#ifndef HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailVolumesSAS_H_
#define HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailVolumesSAS_H_
...
/// </summary>
class HUAWEICLOUD_EVS_EXPORT  QuotaDetailVolumesSAS
    : public ModelBase
{
public:
    QuotaDetailVolumesSAS();
    virtual ~QuotaDetailVolumesSAS();
...
#endif // HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailVolumesSAS_H_
