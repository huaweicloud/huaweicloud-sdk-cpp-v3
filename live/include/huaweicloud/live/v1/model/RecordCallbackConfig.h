...
#ifndef HUAWEICLOUD_SDK_LIVE_V1_MODEL_RecordCallbackConfig_H_
#define HUAWEICLOUD_SDK_LIVE_V1_MODEL_RecordCallbackConfig_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LIVE_V1_EXPORT  RecordCallbackConfig
    : public ModelBase
{
public:
    RecordCallbackConfig();
    virtual ~RecordCallbackConfig();
...
#endif // HUAWEICLOUD_SDK_LIVE_V1_MODEL_RecordCallbackConfig_H_
