...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_DiffNoLineDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_DiffNoLineDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  DiffNoLineDto
    : public ModelBase
{
public:
    DiffNoLineDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_DiffNoLineDto_H_
