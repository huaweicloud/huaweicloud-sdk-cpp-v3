...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListKnowledgeSkillRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListKnowledgeSkillRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListKnowledgeSkillRequest
    : public ModelBase
{
public:
    ListKnowledgeSkillRequest();
    virtual ~ListKnowledgeSkillRequest();
    ...
    /////////////////////////////////////////////
    /// ListKnowledgeSkillRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListKnowledgeSkillRequest& dereference_from_shared_ptr(std::shared_ptr<ListKnowledgeSkillRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListKnowledgeSkillRequest_H_
