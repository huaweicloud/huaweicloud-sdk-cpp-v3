...
#ifndef HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_DownloadBuildRealTimeLogRequest_H_
#define HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_DownloadBuildRealTimeLogRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CODEARTSBUILD_V3_EXPORT  DownloadBuildRealTimeLogRequest
    : public ModelBase
{
public:
    DownloadBuildRealTimeLogRequest();
    virtual ~DownloadBuildRealTimeLogRequest();
    ...
    /////////////////////////////////////////////
    /// DownloadBuildRealTimeLogRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DownloadBuildRealTimeLogRequest& dereference_from_shared_ptr(std::shared_ptr<DownloadBuildRealTimeLogRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_DownloadBuildRealTimeLogRequest_H_
