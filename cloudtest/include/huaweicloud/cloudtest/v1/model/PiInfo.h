...
#ifndef HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_PiInfo_H_
#define HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_PiInfo_H_
...
/// pi迭代筛选条件
/// </summary>
class HUAWEICLOUD_CLOUDTEST_V1_EXPORT  PiInfo
    : public ModelBase
{
public:
    PiInfo();
...
#endif // HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_PiInfo_H_
