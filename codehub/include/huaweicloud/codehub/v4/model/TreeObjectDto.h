...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_TreeObjectDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_TreeObjectDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  TreeObjectDto
    : public ModelBase
{
public:
    TreeObjectDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_TreeObjectDto_H_
