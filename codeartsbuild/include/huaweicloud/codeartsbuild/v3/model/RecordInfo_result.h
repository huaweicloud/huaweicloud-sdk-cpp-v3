...
#ifndef HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_RecordInfo_result_H_
#define HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_RecordInfo_result_H_
...
/// 结果
/// </summary>
class HUAWEICLOUD_CODEARTSBUILD_V3_EXPORT  RecordInfo_result
    : public ModelBase
{
public:
    RecordInfo_result();
    virtual ~RecordInfo_result();
...
#endif // HUAWEICLOUD_SDK_CODEARTSBUILD_V3_MODEL_RecordInfo_result_H_
