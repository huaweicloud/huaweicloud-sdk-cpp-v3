...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ActionDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ActionDto_H_
...
/// **参数解释：** 提交动作设置参数。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ActionDto
    : public ModelBase
{
public:
    ActionDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ActionDto_H_
