...
#ifndef HUAWEICLOUD_SDK_VOD_V1_MODEL_TransTemplateGroup_H_
#define HUAWEICLOUD_SDK_VOD_V1_MODEL_TransTemplateGroup_H_
...
/// 
/// </summary>
class HUAWEICLOUD_VOD_V1_EXPORT  TransTemplateGroup
    : public ModelBase
{
public:
    TransTemplateGroup();
...
#endif // HUAWEICLOUD_SDK_VOD_V1_MODEL_TransTemplateGroup_H_
