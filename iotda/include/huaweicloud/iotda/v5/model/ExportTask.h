...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ExportTask_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ExportTask_H_
...
/// 导出任务信息。
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ExportTask
    : public ModelBase
{
public:
    ExportTask();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ExportTask_H_
