...
#ifndef HUAWEICLOUD_SDK_FRS_V2_MODEL_FaceSearchFaceIdReq_H_
#define HUAWEICLOUD_SDK_FRS_V2_MODEL_FaceSearchFaceIdReq_H_
...
/// 
/// </summary>
class HUAWEICLOUD_FRS_V2_EXPORT  FaceSearchFaceIdReq
    : public ModelBase
{
public:
    FaceSearchFaceIdReq();
    virtual ~FaceSearchFaceIdReq();
...
#endif // HUAWEICLOUD_SDK_FRS_V2_MODEL_FaceSearchFaceIdReq_H_
