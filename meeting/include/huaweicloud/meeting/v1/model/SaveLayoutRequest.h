...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SaveLayoutRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SaveLayoutRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SaveLayoutRequest
    : public ModelBase
{
public:
    SaveLayoutRequest();
    virtual ~SaveLayoutRequest();
    ...
    RestPicLayoutBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestPicLayoutBody& value);
...
protected:
    ...
    RestPicLayoutBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    SaveLayoutRequest& dereference_from_shared_ptr(std::shared_ptr<SaveLayoutRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SaveLayoutRequest_H_
