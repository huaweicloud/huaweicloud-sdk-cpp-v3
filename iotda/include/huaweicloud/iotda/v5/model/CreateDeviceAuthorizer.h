...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_CreateDeviceAuthorizer_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_CreateDeviceAuthorizer_H_
...
/// 创建自定义鉴权请求体。
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  CreateDeviceAuthorizer
    : public ModelBase
{
public:
    CreateDeviceAuthorizer();
    virtual ~CreateDeviceAuthorizer();
    ...
    /////////////////////////////////////////////
    /// CreateDeviceAuthorizer members
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_CreateDeviceAuthorizer_H_
