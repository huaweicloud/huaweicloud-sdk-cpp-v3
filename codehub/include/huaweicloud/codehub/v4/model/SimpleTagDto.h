...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_SimpleTagDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_SimpleTagDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  SimpleTagDto
    : public ModelBase
{
public:
    SimpleTagDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_SimpleTagDto_H_
