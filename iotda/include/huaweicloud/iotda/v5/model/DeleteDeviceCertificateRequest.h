...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DeleteDeviceCertificateRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DeleteDeviceCertificateRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  DeleteDeviceCertificateRequest
    : public ModelBase
{
public:
    DeleteDeviceCertificateRequest();
    virtual ~DeleteDeviceCertificateRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteDeviceCertificateRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteDeviceCertificateRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteDeviceCertificateRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_DeleteDeviceCertificateRequest_H_
