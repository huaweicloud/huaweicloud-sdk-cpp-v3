...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_DeleteInferDeploymentHpaRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_DeleteInferDeploymentHpaRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  DeleteInferDeploymentHpaRequest
    : public ModelBase
{
public:
    DeleteInferDeploymentHpaRequest();
    virtual ~DeleteInferDeploymentHpaRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteInferDeploymentHpaRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteInferDeploymentHpaRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteInferDeploymentHpaRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_DeleteInferDeploymentHpaRequest_H_
