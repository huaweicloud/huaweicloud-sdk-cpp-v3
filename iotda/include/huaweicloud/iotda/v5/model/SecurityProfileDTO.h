...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_SecurityProfileDTO_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_SecurityProfileDTO_H_
...
/// 安全态势感知配置
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  SecurityProfileDTO
    : public ModelBase
{
public:
    SecurityProfileDTO();
    virtual ~SecurityProfileDTO();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_SecurityProfileDTO_H_
