...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_SecretConfig_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_SecretConfig_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  SecretConfig
    : public ModelBase
{
public:
    SecretConfig();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_SecretConfig_H_
