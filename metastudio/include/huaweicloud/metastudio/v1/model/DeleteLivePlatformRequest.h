...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteLivePlatformRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteLivePlatformRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteLivePlatformRequest
    : public ModelBase
{
public:
    DeleteLivePlatformRequest();
    virtual ~DeleteLivePlatformRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteLivePlatformRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteLivePlatformRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteLivePlatformRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteLivePlatformRequest_H_
