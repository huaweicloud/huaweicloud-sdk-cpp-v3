...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_SimpleMergeRequestChangesDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_SimpleMergeRequestChangesDto_H_
...
/// 合并请求文件变更列表详情
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  SimpleMergeRequestChangesDto
    : public ModelBase
{
public:
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_SimpleMergeRequestChangesDto_H_
