...
std::string QuotaDetailBackups::getAllocated() const
{
    return allocated_;
}

void QuotaDetailBackups::setAllocated(const std::string& value)
{
    allocated_ = value;
    allocatedIsSet_ = true;
}

bool QuotaDetailBackups::allocatedIsSet() const
{
    return allocatedIsSet_;
}

void QuotaDetailBackups::unsetallocated()
{
    allocatedIsSet_ = false;
}
