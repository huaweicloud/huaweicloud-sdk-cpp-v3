...
int32_t ObjectsCompareDetailInfo::getStatus() const
{
    return status_;
}

void ObjectsCompareDetailInfo::setStatus(int32_t value)
{
    status_ = value;
    statusIsSet_ = true;
}

bool ObjectsCompareDetailInfo::statusIsSet() const
{
    return statusIsSet_;
}

void ObjectsCompareDetailInfo::unsetstatus()
{
    statusIsSet_ = false;
}
