...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_SmartLiveJob_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_SmartLiveJob_H_
...
/// 数字人直播任务信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  SmartLiveJob
    : public ModelBase
{
public:
    SmartLiveJob();
    virtual ~SmartLiveJob();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_SmartLiveJob_H_
