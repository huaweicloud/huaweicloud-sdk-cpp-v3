...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_ListHistoryWebinarsRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_ListHistoryWebinarsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  ListHistoryWebinarsRequest
    : public ModelBase
{
public:
    ListHistoryWebinarsRequest();
    virtual ~ListHistoryWebinarsRequest();
    ...
    /////////////////////////////////////////////
    /// ListHistoryWebinarsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListHistoryWebinarsRequest& dereference_from_shared_ptr(std::shared_ptr<ListHistoryWebinarsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_ListHistoryWebinarsRequest_H_
