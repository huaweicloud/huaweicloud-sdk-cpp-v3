...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_StartInferDeploymentRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_StartInferDeploymentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  StartInferDeploymentRequest
    : public ModelBase
{
public:
    StartInferDeploymentRequest();
    virtual ~StartInferDeploymentRequest();
    ...
    /////////////////////////////////////////////
    /// StartInferDeploymentRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    StartInferDeploymentRequest& dereference_from_shared_ptr(std::shared_ptr<StartInferDeploymentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_StartInferDeploymentRequest_H_
