...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListUserQuotaDetail_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListUserQuotaDetail_H_
...
/// 配额信息
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListUserQuotaDetail
    : public ModelBase
{
public:
    ListUserQuotaDetail();
    virtual ~ListUserQuotaDetail();
...
protected:
    ...
    float videoTime2dModel_;
    bool videoTime2dModelIsSet_;
    float videoTimeFlexus2dModel_;
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListUserQuotaDetail_H_
