...
#ifndef HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_QueryVO_H_
#define HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_QueryVO_H_
...
/// 
/// </summary>
class HUAWEICLOUD_PROJECTMAN_V4_EXPORT  QueryVO
    : public ModelBase
{
public:
    QueryVO();
    ...
    bool filterModeIsSet() const;
    void unsetfilterMode();
    void setFilterMode(const std::string& value);
...
protected:
    ...
    bool filterIsSet_;
    std::string filterMode_;
    bool filterModeIsSet_;
    PageInfoVO page_;
    bool pageIsSet_;
...
#endif // HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_QueryVO_H_
