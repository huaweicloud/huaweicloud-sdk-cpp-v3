...
public:
    ...
    static HttpRequestDef genRequestDefForAddResourceToIterator();
    static HttpRequestDef genRequestDefForListVisibleServices();
    static HttpRequestDef genRequestDefForBatchDeleteTasks();
    static HttpRequestDef genRequestDefForCreateTask();
    static HttpRequestDef genRequestDefForShowTask();
    static HttpRequestDef genRequestDefForUpdateTask();
    static HttpRequestDef genRequestDefForCreateTestVersionCase();
    static HttpRequestDef genRequestDefForListTestCasesByCondition();
    static HttpRequestDef genRequestDefForShowTestVersionCase();
    static HttpRequestDef genRequestDefForUpdateTestVersionCase();
    static HttpRequestDef genRequestDefForAddFeature();
    static HttpRequestDef genRequestDefForAddIssuesToIterator();
    static HttpRequestDef genRequestDefForCreateBranch();
    static HttpRequestDef genRequestDefForCreateTestIterator();
    static HttpRequestDef genRequestDefForDeleteBranch();
    static HttpRequestDef genRequestDefForDeleteIterator();
    static HttpRequestDef genRequestDefForListTestBranches();
    static HttpRequestDef genRequestDefForShowIterator();
    static HttpRequestDef genRequestDefForShowTestBranch();
    static HttpRequestDef genRequestDefForUpdateBranch();
    static HttpRequestDef genRequestDefForUpdateTestIterator();
