...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeletePluginConfigRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeletePluginConfigRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeletePluginConfigRequest
    : public ModelBase
{
public:
    DeletePluginConfigRequest();
    virtual ~DeletePluginConfigRequest();
    ...
    /////////////////////////////////////////////
    /// DeletePluginConfigRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeletePluginConfigRequest& dereference_from_shared_ptr(std::shared_ptr<DeletePluginConfigRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeletePluginConfigRequest_H_
