...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListDeviceRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListDeviceRequest_H_
...
/// 查询指定设备证书的设备列表结构体。
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListDeviceRequest
    : public ModelBase
{
public:
    ListDeviceRequest();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListDeviceRequest_H_
