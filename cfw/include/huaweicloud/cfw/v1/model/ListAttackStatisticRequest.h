...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_ListAttackStatisticRequest_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_ListAttackStatisticRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  ListAttackStatisticRequest
    : public ModelBase
{
public:
    ListAttackStatisticRequest();
    virtual ~ListAttackStatisticRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListAttackStatisticRequest& dereference_from_shared_ptr(std::shared_ptr<ListAttackStatisticRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_ListAttackStatisticRequest_H_
