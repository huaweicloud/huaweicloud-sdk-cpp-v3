...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteProductRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteProductRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteProductRequest
    : public ModelBase
{
public:
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteProductRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteProductRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteProductRequest_H_
