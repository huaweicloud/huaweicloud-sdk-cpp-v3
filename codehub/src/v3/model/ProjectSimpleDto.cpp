...
#include "huaweicloud/codehub/v3/model/ProjectSimpleDto.h"
...
web::json::value ProjectSimpleDto::toJson() const
{
    ...
    if(memberMgntModeIsSet_) {
        val[utility::conversions::to_string_t("member_mgnt_mode")] = ModelBase::toJson(memberMgntMode_);
    }
    if(visibilityIsSet_) {
...
bool ProjectSimpleDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("member_mgnt_mode"))) {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("member_mgnt_mode"));
        if(!fieldValue.is_null())
        {
            int32_t refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
            setMemberMgntMode(refVal);
        }
    }
...
std::string ProjectSimpleDto::getProductId() const
{
    return productId_;
}

void ProjectSimpleDto::setProductId(const std::string& value)
{
    productId_ = value;
    productIdIsSet_ = true;
}

bool ProjectSimpleDto::productIdIsSet() const
{
    return productIdIsSet_;
}

void ProjectSimpleDto::unsetproductId()
{
    productIdIsSet_ = false;
}

std::string ProjectSimpleDto::getProductName() const
{
    return productName_;
}

void ProjectSimpleDto::setProductName(const std::string& value)
{
    productName_ = value;
    productNameIsSet_ = true;
}

bool ProjectSimpleDto::productNameIsSet() const
{
    return productNameIsSet_;
}

void ProjectSimpleDto::unsetproductName()
{
    productNameIsSet_ = false;
}

int32_t ProjectSimpleDto::getMemberMgntMode() const
{
    return memberMgntMode_;
}

void ProjectSimpleDto::setMemberMgntMode(int32_t value)
{
    memberMgntMode_ = value;
    memberMgntModeIsSet_ = true;
}

bool ProjectSimpleDto::memberMgntModeIsSet() const
{
    return memberMgntModeIsSet_;
}

void ProjectSimpleDto::unsetmemberMgntMode()
{
    memberMgntModeIsSet_ = false;
}

std::string ProjectSimpleDto::getVisibility() const
{
    return visibility_;
}

void ProjectSimpleDto::setVisibility(const std::string& value)
{
    visibility_ = value;
    visibilityIsSet_ = true;
}

bool ProjectSimpleDto::visibilityIsSet() const
{
    return visibilityIsSet_;
}

void ProjectSimpleDto::unsetvisibility()
{
    visibilityIsSet_ = false;
}

NamespaceBasicDto ProjectSimpleDto::getNamespace() const
{
    return namespace_;
}

void ProjectSimpleDto::setNamespace(const NamespaceBasicDto& value)
{
    namespace_ = value;
    namespaceIsSet_ = true;
}

bool ProjectSimpleDto::namespaceIsSet() const
{
    return namespaceIsSet_;
}

void ProjectSimpleDto::unsetnamespace()
{
    namespaceIsSet_ = false;
}

std::string ProjectSimpleDto::getRepoType() const
{
    return repoType_;
}

void ProjectSimpleDto::setRepoType(const std::string& value)
{
    repoType_ = value;
    repoTypeIsSet_ = true;
}

bool ProjectSimpleDto::repoTypeIsSet() const
{
    return repoTypeIsSet_;
}

void ProjectSimpleDto::unsetrepoType()
{
    repoTypeIsSet_ = false;
}
