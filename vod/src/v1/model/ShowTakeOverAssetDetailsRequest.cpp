...
std::string ShowTakeOverAssetDetailsRequest::getAuthorization() const
{
    return authorization_;
}

void ShowTakeOverAssetDetailsRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool ShowTakeOverAssetDetailsRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void ShowTakeOverAssetDetailsRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
