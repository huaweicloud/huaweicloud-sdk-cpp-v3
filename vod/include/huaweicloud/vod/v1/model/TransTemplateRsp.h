...
#ifndef HUAWEICLOUD_SDK_VOD_V1_MODEL_TransTemplateRsp_H_
#define HUAWEICLOUD_SDK_VOD_V1_MODEL_TransTemplateRsp_H_
...
/// 
/// </summary>
class HUAWEICLOUD_VOD_V1_EXPORT  TransTemplateRsp
    : public ModelBase
{
public:
    TransTemplateRsp();
    virtual ~TransTemplateRsp();
...
#endif // HUAWEICLOUD_SDK_VOD_V1_MODEL_TransTemplateRsp_H_
