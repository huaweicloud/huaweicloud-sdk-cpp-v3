...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ListInfluxdbSlowLogsRequestBody_H_
#define HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ListInfluxdbSlowLogsRequestBody_H_
...
/// 查询Influxdb慢日志请求体
/// </summary>
class HUAWEICLOUD_GAUSSDBFORNOSQL_V3_EXPORT  ListInfluxdbSlowLogsRequestBody
    : public ModelBase
{
public:
    ListInfluxdbSlowLogsRequestBody();
    virtual ~ListInfluxdbSlowLogsRequestBody();
    ...
    /////////////////////////////////////////////
    /// ListInfluxdbSlowLogsRequestBody members
    ...
    std::string getRetentionPolicy() const;
    bool retentionPolicyIsSet() const;
    void unsetretentionPolicy();
    void setRetentionPolicy(const std::string& value);
...
protected:
    ...
    bool databaseIsSet_;
    std::string retentionPolicy_;
    bool retentionPolicyIsSet_;
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ListInfluxdbSlowLogsRequestBody_H_
