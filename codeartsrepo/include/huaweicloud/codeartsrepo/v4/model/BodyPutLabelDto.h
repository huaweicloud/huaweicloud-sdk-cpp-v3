...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BodyPutLabelDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BodyPutLabelDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  BodyPutLabelDto
    : public ModelBase
{
public:
    BodyPutLabelDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BodyPutLabelDto_H_
