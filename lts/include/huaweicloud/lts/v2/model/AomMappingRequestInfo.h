...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_AomMappingRequestInfo_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_AomMappingRequestInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  AomMappingRequestInfo
    : public ModelBase
{
public:
    AomMappingRequestInfo();
    virtual ~AomMappingRequestInfo();
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_AomMappingRequestInfo_H_
