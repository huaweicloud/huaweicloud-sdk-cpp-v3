...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_PushEventPayloadDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_PushEventPayloadDto_H_
...
/// **参数解释：** 推送动态负载。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  PushEventPayloadDto
    : public ModelBase
{
public:
    PushEventPayloadDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_PushEventPayloadDto_H_
