...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListVariableGroupsResp_pipeline_variable_groups_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListVariableGroupsResp_pipeline_variable_groups_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  ListVariableGroupsResp_pipeline_variable_groups
    : public ModelBase
{
public:
    ListVariableGroupsResp_pipeline_variable_groups();
    virtual ~ListVariableGroupsResp_pipeline_variable_groups();
    ...
    /////////////////////////////////////////////
    /// ListVariableGroupsResp_pipeline_variable_groups members
    ...
    std::vector<ListVariableGroupsResp_related_pipelines>& getRelatedPipelines();
    bool relatedPipelinesIsSet() const;
    void unsetrelatedPipelines();
    void setRelatedPipelines(const std::vector<ListVariableGroupsResp_related_pipelines>& value);
...
protected:
    ...
    std::vector<ListVariableGroupsResp_related_pipelines> relatedPipelines_;
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListVariableGroupsResp_pipeline_variable_groups_H_
