...
#ifndef HUAWEICLOUD_SDK_IMAGE_V2_MODEL_ImageTaggingReq_H_
#define HUAWEICLOUD_SDK_IMAGE_V2_MODEL_ImageTaggingReq_H_
...
/// </summary>
class HUAWEICLOUD_IMAGE_V2_EXPORT  ImageTaggingReq
    : public ModelBase
{
public:
    ImageTaggingReq();
    virtual ~ImageTaggingReq();
...
#endif // HUAWEICLOUD_SDK_IMAGE_V2_MODEL_ImageTaggingReq_H_
