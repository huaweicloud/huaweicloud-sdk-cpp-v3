...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_PacketThresholdData_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_PacketThresholdData_H_
...
/// 丢包率阈值查询结果结构体
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  PacketThresholdData
    : public ModelBase
{
public:
    PacketThresholdData();
    virtual ~PacketThresholdData();
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_PacketThresholdData_H_
