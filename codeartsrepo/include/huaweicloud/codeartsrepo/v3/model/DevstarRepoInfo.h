...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_DevstarRepoInfo_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_DevstarRepoInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  DevstarRepoInfo
    : public ModelBase
{
public:
    DevstarRepoInfo();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_DevstarRepoInfo_H_
