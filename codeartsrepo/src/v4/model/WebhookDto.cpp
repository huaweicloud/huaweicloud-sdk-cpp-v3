...
std::vector<std::string>& WebhookDto::getNotePlainTextFilter()
{
    return notePlainTextFilter_;
}

void WebhookDto::setNotePlainTextFilter(const std::vector<std::string>& value)
{
    notePlainTextFilter_ = value;
    notePlainTextFilterIsSet_ = true;
}

bool WebhookDto::notePlainTextFilterIsSet() const
{
    return notePlainTextFilterIsSet_;
}

void WebhookDto::unsetnotePlainTextFilter()
{
    notePlainTextFilterIsSet_ = false;
}
...
std::vector<WebHookEventCfgDto>& WebhookDto::getEventCfgs()
{
    return eventCfgs_;
}

void WebhookDto::setEventCfgs(const std::vector<WebHookEventCfgDto>& value)
{
    eventCfgs_ = value;
    eventCfgsIsSet_ = true;
}

bool WebhookDto::eventCfgsIsSet() const
{
    return eventCfgsIsSet_;
}

void WebhookDto::unseteventCfgs()
{
    eventCfgsIsSet_ = false;
}

std::vector<WebHookBranchCfgDto>& WebhookDto::getProjectCfgs()
{
    return projectCfgs_;
}

void WebhookDto::setProjectCfgs(const std::vector<WebHookBranchCfgDto>& value)
{
    projectCfgs_ = value;
    projectCfgsIsSet_ = true;
}

bool WebhookDto::projectCfgsIsSet() const
{
    return projectCfgsIsSet_;
}

void WebhookDto::unsetprojectCfgs()
{
    projectCfgsIsSet_ = false;
}

std::vector<WebHookBranchCfgDto>& WebhookDto::getBranchCfgs()
{
    return branchCfgs_;
}

void WebhookDto::setBranchCfgs(const std::vector<WebHookBranchCfgDto>& value)
{
    branchCfgs_ = value;
    branchCfgsIsSet_ = true;
}

bool WebhookDto::branchCfgsIsSet() const
{
    return branchCfgsIsSet_;
}

void WebhookDto::unsetbranchCfgs()
{
    branchCfgsIsSet_ = false;
}
...
std::string WebhookDto::getService() const
{
    return service_;
}

void WebhookDto::setService(const std::string& value)
{
    service_ = value;
    serviceIsSet_ = true;
}

bool WebhookDto::serviceIsSet() const
{
    return serviceIsSet_;
}

void WebhookDto::unsetservice()
{
    serviceIsSet_ = false;
}
