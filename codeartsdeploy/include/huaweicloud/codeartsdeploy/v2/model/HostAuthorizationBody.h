...
#ifndef HUAWEICLOUD_SDK_CODEARTSDEPLOY_V2_MODEL_HostAuthorizationBody_H_
#define HUAWEICLOUD_SDK_CODEARTSDEPLOY_V2_MODEL_HostAuthorizationBody_H_
...
/// </summary>
class HUAWEICLOUD_CODEARTSDEPLOY_V2_EXPORT  HostAuthorizationBody
    : public ModelBase
{
public:
    HostAuthorizationBody();
    virtual ~HostAuthorizationBody();
...
#endif // HUAWEICLOUD_SDK_CODEARTSDEPLOY_V2_MODEL_HostAuthorizationBody_H_
