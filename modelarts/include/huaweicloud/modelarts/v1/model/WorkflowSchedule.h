...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_WorkflowSchedule_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_WorkflowSchedule_H_
...
/// 工作流调度信息。
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  WorkflowSchedule
    : public ModelBase
{
public:
    WorkflowSchedule();
    virtual ~WorkflowSchedule();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_WorkflowSchedule_H_
