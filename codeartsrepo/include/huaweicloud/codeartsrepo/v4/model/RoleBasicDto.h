...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RoleBasicDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RoleBasicDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  RoleBasicDto
    : public ModelBase
{
public:
    RoleBasicDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RoleBasicDto_H_
