...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_ListAutopilotClusterMasterSnapshotTasksResponse_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_ListAutopilotClusterMasterSnapshotTasksResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  ListAutopilotClusterMasterSnapshotTasksResponse
    : public ModelBase, public HttpResponse
{
public:
    ListAutopilotClusterMasterSnapshotTasksResponse();
    virtual ~ListAutopilotClusterMasterSnapshotTasksResponse();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_ListAutopilotClusterMasterSnapshotTasksResponse_H_
