...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_AomMappingRuleResp_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_AomMappingRuleResp_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  AomMappingRuleResp
    : public ModelBase
{
public:
    AomMappingRuleResp();
    virtual ~AomMappingRuleResp();
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_AomMappingRuleResp_H_
