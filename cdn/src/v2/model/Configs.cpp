...
Sni Configs::getSni() const
{
    return sni_;
}

void Configs::setSni(const Sni& value)
{
    sni_ = value;
    sniIsSet_ = true;
}

bool Configs::sniIsSet() const
{
    return sniIsSet_;
}

void Configs::unsetsni()
{
    sniIsSet_ = false;
}

std::vector<RequestUrlRewrite>& Configs::getRequestUrlRewrite()
{
    return requestUrlRewrite_;
}

void Configs::setRequestUrlRewrite(const std::vector<RequestUrlRewrite>& value)
{
    requestUrlRewrite_ = value;
    requestUrlRewriteIsSet_ = true;
}

bool Configs::requestUrlRewriteIsSet() const
{
    return requestUrlRewriteIsSet_;
}

void Configs::unsetrequestUrlRewrite()
{
    requestUrlRewriteIsSet_ = false;
}

std::vector<BrowserCacheRules>& Configs::getBrowserCacheRules()
{
    return browserCacheRules_;
}

void Configs::setBrowserCacheRules(const std::vector<BrowserCacheRules>& value)
{
    browserCacheRules_ = value;
    browserCacheRulesIsSet_ = true;
}

bool Configs::browserCacheRulesIsSet() const
{
...
ClientCert Configs::getClientCert() const
{
    return clientCert_;
}

void Configs::setClientCert(const ClientCert& value)
{
    clientCert_ = value;
    clientCertIsSet_ = true;
}

bool Configs::clientCertIsSet() const
{
    return clientCertIsSet_;
}

void Configs::unsetclientCert()
{
    clientCertIsSet_ = false;
}

HttpsTlsVersion Configs::getHttpsTlsVersion() const
{
    return httpsTlsVersion_;
}

void Configs::setHttpsTlsVersion(const HttpsTlsVersion& value)
{
    httpsTlsVersion_ = value;
    httpsTlsVersionIsSet_ = true;
}

bool Configs::httpsTlsVersionIsSet() const
{
    return httpsTlsVersionIsSet_;
}

void Configs::unsethttpsTlsVersion()
{
    httpsTlsVersionIsSet_ = false;
}

std::vector<FlowLimitStrategy>& Configs::getFlowLimitStrategy()
{
    return flowLimitStrategy_;
}

void Configs::setFlowLimitStrategy(const std::vector<FlowLimitStrategy>& value)
{
    flowLimitStrategy_ = value;
    flowLimitStrategyIsSet_ = true;
}

bool Configs::flowLimitStrategyIsSet() const
{
    return flowLimitStrategyIsSet_;
}

void Configs::unsetflowLimitStrategy()
{
    flowLimitStrategyIsSet_ = false;
}
