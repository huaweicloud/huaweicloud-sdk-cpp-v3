...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowShortJobRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowShortJobRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowShortJobRequest
    : public ModelBase
{
public:
    ShowShortJobRequest();
    virtual ~ShowShortJobRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowShortJobRequest& dereference_from_shared_ptr(std::shared_ptr<ShowShortJobRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowShortJobRequest_H_
