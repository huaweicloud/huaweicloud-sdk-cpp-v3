...
#ifndef HUAWEICLOUD_SDK_CODEARTSARTIFACT_V2_MODEL_ShowProjectListResult_H_
#define HUAWEICLOUD_SDK_CODEARTSARTIFACT_V2_MODEL_ShowProjectListResult_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSARTIFACT_V2_EXPORT  ShowProjectListResult
    : public ModelBase
{
public:
    ShowProjectListResult();
    virtual ~ShowProjectListResult();
    ...
    std::string getStorageSummaryInfo() const;
    bool storageSummaryInfoIsSet() const;
    void unsetstorageSummaryInfo();
    void setStorageSummaryInfo(const std::string& value);
...
protected:
    ...
    std::string url_;
    bool urlIsSet_;
    std::string storageSummaryInfo_;
...
#endif // HUAWEICLOUD_SDK_CODEARTSARTIFACT_V2_MODEL_ShowProjectListResult_H_
