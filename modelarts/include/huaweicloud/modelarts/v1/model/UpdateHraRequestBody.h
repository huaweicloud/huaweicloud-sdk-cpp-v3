...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_UpdateHraRequestBody_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_UpdateHraRequestBody_H_
...
/// HRA修改请求对象
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  UpdateHraRequestBody
    : public ModelBase
{
public:
    UpdateHraRequestBody();
    virtual ~UpdateHraRequestBody();
    ...
    std::vector<HraRuleUpdateRequest>& getHraRules();
    bool hraRulesIsSet() const;
    void unsethraRules();
    void setHraRules(const std::vector<HraRuleUpdateRequest>& value);
...
protected:
    ...
    std::vector<HraRuleUpdateRequest> hraRules_;
    bool hraRulesIsSet_;
    bool disable_;
    bool disableIsSet_;
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_UpdateHraRequestBody_H_
