...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ShowDeviceMessageRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ShowDeviceMessageRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ShowDeviceMessageRequest
    : public ModelBase
{
public:
    ShowDeviceMessageRequest();
    virtual ~ShowDeviceMessageRequest();
    ...
    /////////////////////////////////////////////
    /// ShowDeviceMessageRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowDeviceMessageRequest& dereference_from_shared_ptr(std::shared_ptr<ShowDeviceMessageRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ShowDeviceMessageRequest_H_
