...
std::vector<SubTemplateResBody>& UpdateNotificationTemplateResponse::getTemplates()
{
    return templates_;
}

void UpdateNotificationTemplateResponse::setTemplates(const std::vector<SubTemplateResBody>& value)
{
    templates_ = value;
