...
#ifndef HUAWEICLOUD_SDK_FRS_V2_MODEL_DeleteFaceByFaceIdRequest_H_
#define HUAWEICLOUD_SDK_FRS_V2_MODEL_DeleteFaceByFaceIdRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_FRS_V2_EXPORT  DeleteFaceByFaceIdRequest
    : public ModelBase
{
public:
    DeleteFaceByFaceIdRequest();
    virtual ~DeleteFaceByFaceIdRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteFaceByFaceIdRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteFaceByFaceIdRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteFaceByFaceIdRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_FRS_V2_MODEL_DeleteFaceByFaceIdRequest_H_
