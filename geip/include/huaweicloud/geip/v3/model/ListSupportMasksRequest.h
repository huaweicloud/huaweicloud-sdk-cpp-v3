...
#ifndef HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListSupportMasksRequest_H_
#define HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListSupportMasksRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GEIP_V3_EXPORT  ListSupportMasksRequest
    : public ModelBase
{
public:
    ListSupportMasksRequest();
    virtual ~ListSupportMasksRequest();
    ...
    /////////////////////////////////////////////
    /// ListSupportMasksRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListSupportMasksRequest& dereference_from_shared_ptr(std::shared_ptr<ListSupportMasksRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GEIP_V3_MODEL_ListSupportMasksRequest_H_
