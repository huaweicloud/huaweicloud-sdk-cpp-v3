...
#ifndef HUAWEICLOUD_SDK_ECS_V2_MODEL_NovaVersion_H_
#define HUAWEICLOUD_SDK_ECS_V2_MODEL_NovaVersion_H_
...
///  
/// </summary>
class HUAWEICLOUD_ECS_V2_EXPORT  NovaVersion
    : public ModelBase
{
public:
    NovaVersion();
...
#endif // HUAWEICLOUD_SDK_ECS_V2_MODEL_NovaVersion_H_
