...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CommitNoteDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CommitNoteDto_H_
...
/// 评论详细信息。
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  CommitNoteDto
    : public ModelBase
{
public:
    CommitNoteDto();
    virtual ~CommitNoteDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CommitNoteDto_H_
