...
#ifndef HUAWEICLOUD_SDK_VOD_V1_MODEL_ImageWatermark_H_
#define HUAWEICLOUD_SDK_VOD_V1_MODEL_ImageWatermark_H_
...
/// 
/// </summary>
class HUAWEICLOUD_VOD_V1_EXPORT  ImageWatermark
    : public ModelBase
{
public:
    ImageWatermark();
    virtual ~ImageWatermark();
...
#endif // HUAWEICLOUD_SDK_VOD_V1_MODEL_ImageWatermark_H_
