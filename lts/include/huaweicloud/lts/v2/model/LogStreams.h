...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_LogStreams_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_LogStreams_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  LogStreams
    : public ModelBase
{
public:
    LogStreams();
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_LogStreams_H_
