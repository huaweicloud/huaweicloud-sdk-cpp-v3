...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_BatchHandRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_BatchHandRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  BatchHandRequest
    : public ModelBase
{
public:
    BatchHandRequest();
    virtual ~BatchHandRequest();
    ...
    RestBatchHandsUpReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestBatchHandsUpReqBody& value);
...
protected:
    ...
    RestBatchHandsUpReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    BatchHandRequest& dereference_from_shared_ptr(std::shared_ptr<BatchHandRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_BatchHandRequest_H_
