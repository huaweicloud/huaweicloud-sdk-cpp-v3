...
#ifndef HUAWEICLOUD_SDK_CORE_AUTH_AUTHCACHE_H
#define HUAWEICLOUD_SDK_CORE_AUTH_AUTHCACHE_H
...
namespace Core {
namespace Auth {
class HUAWEICLOUD_CORE_EXPORT AuthCache {
public:
...
#endif // HUAWEICLOUD_SDK_CORE_AUTH_AUTHCACHE_H
