...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeQuestionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeQuestionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteKnowledgeQuestionRequest
    : public ModelBase
{
public:
    DeleteKnowledgeQuestionRequest();
    virtual ~DeleteKnowledgeQuestionRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteKnowledgeQuestionRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteKnowledgeQuestionRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteKnowledgeQuestionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeQuestionRequest_H_
