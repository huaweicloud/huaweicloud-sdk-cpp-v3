...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateMcpServerRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateMcpServerRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateMcpServerRequest
    : public ModelBase
{
public:
    UpdateMcpServerRequest();
    virtual ~UpdateMcpServerRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateMcpServerRequest members
    ...
    UpdateMcpServerReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateMcpServerReq& value);
...
protected:
    ...
    UpdateMcpServerReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateMcpServerRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateMcpServerRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateMcpServerRequest_H_
