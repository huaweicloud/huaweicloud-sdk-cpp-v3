...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryDirDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryDirDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  RepositoryDirDto
    : public ModelBase
{
public:
    RepositoryDirDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryDirDto_H_
