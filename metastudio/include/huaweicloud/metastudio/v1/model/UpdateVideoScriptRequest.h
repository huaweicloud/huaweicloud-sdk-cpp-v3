...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateVideoScriptRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateVideoScriptRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateVideoScriptRequest
    : public ModelBase
{
public:
    UpdateVideoScriptRequest();
    virtual ~UpdateVideoScriptRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateVideoScriptRequest members
    ...
    UpdateVideoScriptsReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateVideoScriptsReq& value);
...
protected:
    ...
    bool scriptIdIsSet_;
    UpdateVideoScriptsReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateVideoScriptRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateVideoScriptRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateVideoScriptRequest_H_
