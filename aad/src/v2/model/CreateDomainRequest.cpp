...
bool CreateDomainRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("body"))) {
        ...
        {
            CreateAadDomainRequestBody refVal;
...
CreateAadDomainRequestBody CreateDomainRequest::getBody() const
{
    return body_;
}

void CreateDomainRequest::setBody(const CreateAadDomainRequestBody& value)
{
    body_ = value;
    bodyIsSet_ = true;
}
