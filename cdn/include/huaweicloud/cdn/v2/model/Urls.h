...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_Urls_H_
#define HUAWEICLOUD_SDK_CDN_V2_MODEL_Urls_H_
...
/// 具体url信息。
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  Urls
    : public ModelBase
{
public:
    Urls();
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_Urls_H_
