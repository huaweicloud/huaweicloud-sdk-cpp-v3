...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_VoiceConfigRsp_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_VoiceConfigRsp_H_
...
/// 语音配置参数
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  VoiceConfigRsp
    : public ModelBase
{
public:
    VoiceConfigRsp();
    virtual ~VoiceConfigRsp();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_VoiceConfigRsp_H_
