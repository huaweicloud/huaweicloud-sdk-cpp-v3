...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowHotWordsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowHotWordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowHotWordsRequest
    : public ModelBase
{
public:
    ShowHotWordsRequest();
    virtual ~ShowHotWordsRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowHotWordsRequest& dereference_from_shared_ptr(std::shared_ptr<ShowHotWordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowHotWordsRequest_H_
