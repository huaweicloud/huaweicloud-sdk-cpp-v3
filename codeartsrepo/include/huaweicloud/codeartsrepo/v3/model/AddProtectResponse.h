...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_AddProtectResponse_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_AddProtectResponse_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  AddProtectResponse
    : public ModelBase
{
public:
    AddProtectResponse();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_AddProtectResponse_H_
