...
bool CreateMergeRequestResponse::isIsSourceBranchDefault() const
{
    return isSourceBranchDefault_;
}

void CreateMergeRequestResponse::setIsSourceBranchDefault(bool value)
{
    isSourceBranchDefault_ = value;
    isSourceBranchDefaultIsSet_ = true;
}

bool CreateMergeRequestResponse::isSourceBranchDefaultIsSet() const
{
    return isSourceBranchDefaultIsSet_;
}

void CreateMergeRequestResponse::unsetisSourceBranchDefault()
{
    isSourceBranchDefaultIsSet_ = false;
}
...
int32_t CreateMergeRequestResponse::getUpvotes() const
{
    return upvotes_;
}

void CreateMergeRequestResponse::setUpvotes(int32_t value)
{
    upvotes_ = value;
    upvotesIsSet_ = true;
}

bool CreateMergeRequestResponse::upvotesIsSet() const
{
    return upvotesIsSet_;
}

void CreateMergeRequestResponse::unsetupvotes()
{
    upvotesIsSet_ = false;
}

int32_t CreateMergeRequestResponse::getDownvotes() const
{
    return downvotes_;
}

void CreateMergeRequestResponse::setDownvotes(int32_t value)
{
    downvotes_ = value;
    downvotesIsSet_ = true;
}

bool CreateMergeRequestResponse::downvotesIsSet() const
{
    return downvotesIsSet_;
}

void CreateMergeRequestResponse::unsetdownvotes()
{
    downvotesIsSet_ = false;
}
...
UserBasicExternalDto CreateMergeRequestResponse::getAssignee() const
{
    return assignee_;
}

void CreateMergeRequestResponse::setAssignee(const UserBasicExternalDto& value)
{
    assignee_ = value;
    assigneeIsSet_ = true;
}

bool CreateMergeRequestResponse::assigneeIsSet() const
{
    return assigneeIsSet_;
}

void CreateMergeRequestResponse::unsetassignee()
{
    assigneeIsSet_ = false;
}
...
bool CreateMergeRequestResponse::isShouldRemoveSourceBranch() const
{
    return shouldRemoveSourceBranch_;
}

void CreateMergeRequestResponse::setShouldRemoveSourceBranch(bool value)
{
    shouldRemoveSourceBranch_ = value;
    shouldRemoveSourceBranchIsSet_ = true;
}

bool CreateMergeRequestResponse::shouldRemoveSourceBranchIsSet() const
{
    return shouldRemoveSourceBranchIsSet_;
}

void CreateMergeRequestResponse::unsetshouldRemoveSourceBranch()
{
    shouldRemoveSourceBranchIsSet_ = false;
}
...
bool CreateMergeRequestResponse::isOnlyAssigneeCanMerge() const
{
    return onlyAssigneeCanMerge_;
}

void CreateMergeRequestResponse::setOnlyAssigneeCanMerge(bool value)
{
    onlyAssigneeCanMerge_ = value;
    onlyAssigneeCanMergeIsSet_ = true;
}

bool CreateMergeRequestResponse::onlyAssigneeCanMergeIsSet() const
{
    return onlyAssigneeCanMergeIsSet_;
}

void CreateMergeRequestResponse::unsetonlyAssigneeCanMerge()
{
    onlyAssigneeCanMergeIsSet_ = false;
}
...
std::string CreateMergeRequestResponse::getTopic() const
{
    return topic_;
}

void CreateMergeRequestResponse::setTopic(const std::string& value)
{
    topic_ = value;
    topicIsSet_ = true;
}

bool CreateMergeRequestResponse::topicIsSet() const
{
    return topicIsSet_;
}

void CreateMergeRequestResponse::unsettopic()
{
    topicIsSet_ = false;
}
