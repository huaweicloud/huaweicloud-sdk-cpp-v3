...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_PostgreSQLHistoryTableRequest_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_PostgreSQLHistoryTableRequest_H_
...
/// 查询可恢复表的请求信息
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  PostgreSQLHistoryTableRequest
    : public ModelBase
{
public:
    PostgreSQLHistoryTableRequest();
    virtual ~PostgreSQLHistoryTableRequest();
    ...
    /////////////////////////////////////////////
    /// PostgreSQLHistoryTableRequest members
    ...
    std::string getTableNameLike() const;
    bool tableNameLikeIsSet() const;
    void unsettableNameLike();
    void setTableNameLike(const std::string& value);
...
protected:
    ...
    std::string tableNameLike_;
    bool tableNameLikeIsSet_;
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_PostgreSQLHistoryTableRequest_H_
