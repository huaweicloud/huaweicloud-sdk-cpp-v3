...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NetworkListMetadata_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NetworkListMetadata_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  NetworkListMetadata
    : public ModelBase
{
public:
    NetworkListMetadata();
    virtual ~NetworkListMetadata();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_NetworkListMetadata_H_
