...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_Author_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_Author_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  Author
    : public ModelBase
{
public:
    Author();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_Author_H_
