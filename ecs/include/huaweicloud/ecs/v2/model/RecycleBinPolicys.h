...
#ifndef HUAWEICLOUD_SDK_ECS_V2_MODEL_RecycleBinPolicys_H_
#define HUAWEICLOUD_SDK_ECS_V2_MODEL_RecycleBinPolicys_H_
...
/// 
/// </summary>
class HUAWEICLOUD_ECS_V2_EXPORT  RecycleBinPolicys
    : public ModelBase
{
public:
    RecycleBinPolicys();
    virtual ~RecycleBinPolicys();
...
#endif // HUAWEICLOUD_SDK_ECS_V2_MODEL_RecycleBinPolicys_H_
