...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_PacifyWordsInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_PacifyWordsInfo_H_
...
/// 安抚话术基本信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  PacifyWordsInfo
    : public ModelBase
{
public:
    PacifyWordsInfo();
    virtual ~PacifyWordsInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_PacifyWordsInfo_H_
