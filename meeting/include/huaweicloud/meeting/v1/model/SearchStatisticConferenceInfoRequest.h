...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchStatisticConferenceInfoRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchStatisticConferenceInfoRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SearchStatisticConferenceInfoRequest
    : public ModelBase
{
public:
    SearchStatisticConferenceInfoRequest();
    virtual ~SearchStatisticConferenceInfoRequest();
    ...
    /////////////////////////////////////////////
    /// SearchStatisticConferenceInfoRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    SearchStatisticConferenceInfoRequest& dereference_from_shared_ptr(std::shared_ptr<SearchStatisticConferenceInfoRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchStatisticConferenceInfoRequest_H_
