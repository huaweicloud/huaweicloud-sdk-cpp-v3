...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListAsrVocabularyRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListAsrVocabularyRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListAsrVocabularyRequest
    : public ModelBase
{
public:
    ListAsrVocabularyRequest();
    virtual ~ListAsrVocabularyRequest();
    ...
    /////////////////////////////////////////////
    /// ListAsrVocabularyRequest members
    ...
    std::string getVocabularyType() const;
    bool vocabularyTypeIsSet() const;
    void unsetvocabularyType();
    void setVocabularyType(const std::string& value);
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListAsrVocabularyRequest& dereference_from_shared_ptr(std::shared_ptr<ListAsrVocabularyRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListAsrVocabularyRequest_H_
