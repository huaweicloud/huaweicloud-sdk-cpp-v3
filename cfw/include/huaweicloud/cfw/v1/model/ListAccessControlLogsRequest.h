...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_ListAccessControlLogsRequest_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_ListAccessControlLogsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  ListAccessControlLogsRequest
    : public ModelBase
{
public:
    ListAccessControlLogsRequest();
    virtual ~ListAccessControlLogsRequest();
    ...
    int32_t getNextDate() const;
    bool nextDateIsSet() const;
    void unsetnextDate();
    void setNextDate(int32_t value);
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListAccessControlLogsRequest& dereference_from_shared_ptr(std::shared_ptr<ListAccessControlLogsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_ListAccessControlLogsRequest_H_
