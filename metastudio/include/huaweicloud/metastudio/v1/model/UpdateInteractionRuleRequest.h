...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateInteractionRuleRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateInteractionRuleRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateInteractionRuleRequest
    : public ModelBase
{
public:
    UpdateInteractionRuleRequest();
    virtual ~UpdateInteractionRuleRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateInteractionRuleRequest members
    ...
    CreateInteractionRuleReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const CreateInteractionRuleReq& value);
...
protected:
    ...
    std::string ruleId_;
    bool ruleIdIsSet_;
    CreateInteractionRuleReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateInteractionRuleRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateInteractionRuleRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateInteractionRuleRequest_H_
