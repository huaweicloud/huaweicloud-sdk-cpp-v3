...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchStatisticResourceInfoRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchStatisticResourceInfoRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SearchStatisticResourceInfoRequest
    : public ModelBase
{
public:
    SearchStatisticResourceInfoRequest();
    virtual ~SearchStatisticResourceInfoRequest();
    ...
    /////////////////////////////////////////////
    /// SearchStatisticResourceInfoRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    SearchStatisticResourceInfoRequest& dereference_from_shared_ptr(std::shared_ptr<SearchStatisticResourceInfoRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchStatisticResourceInfoRequest_H_
