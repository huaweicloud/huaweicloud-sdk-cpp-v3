...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_ListDbAgentJobsResult_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_ListDbAgentJobsResult_H_
...
/// 数据库代理作业响应信息。
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  ListDbAgentJobsResult
    : public ModelBase
{
public:
    ListDbAgentJobsResult();
    virtual ~ListDbAgentJobsResult();
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_ListDbAgentJobsResult_H_
