...
#ifndef HUAWEICLOUD_SDK_CTS_V3_MODEL_Bucket_H_
#define HUAWEICLOUD_SDK_CTS_V3_MODEL_Bucket_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CTS_V3_EXPORT  Bucket
    : public ModelBase
{
public:
    Bucket();
    ...
    CheckBucketResponse getCheckBucketResponse() const;
    bool checkBucketResponseIsSet() const;
    void unsetcheckBucketResponse();
    void setCheckBucketResponse(const CheckBucketResponse& value);
...
protected:
    ...
    CheckBucketResponse checkBucketResponse_;
    bool checkBucketResponseIsSet_;
...
#endif // HUAWEICLOUD_SDK_CTS_V3_MODEL_Bucket_H_
