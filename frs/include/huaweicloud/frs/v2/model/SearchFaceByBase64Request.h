...
#ifndef HUAWEICLOUD_SDK_FRS_V2_MODEL_SearchFaceByBase64Request_H_
#define HUAWEICLOUD_SDK_FRS_V2_MODEL_SearchFaceByBase64Request_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_FRS_V2_EXPORT  SearchFaceByBase64Request
    : public ModelBase
{
public:
    SearchFaceByBase64Request();
    virtual ~SearchFaceByBase64Request();
    ...
    /////////////////////////////////////////////
    /// SearchFaceByBase64Request members
    ...
    FaceSearchBase64Req getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const FaceSearchBase64Req& value);
...
protected:
    ...
    FaceSearchBase64Req body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    SearchFaceByBase64Request& dereference_from_shared_ptr(std::shared_ptr<SearchFaceByBase64Request> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_FRS_V2_MODEL_SearchFaceByBase64Request_H_
