...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_AddSecurityProfileDTO_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_AddSecurityProfileDTO_H_
...
/// 安全态势感知配置
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  AddSecurityProfileDTO
    : public ModelBase
{
public:
    AddSecurityProfileDTO();
    virtual ~AddSecurityProfileDTO();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_AddSecurityProfileDTO_H_
