...
std::string UpdateAssetMetaRequest::getAuthorization() const
{
    return authorization_;
}

void UpdateAssetMetaRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool UpdateAssetMetaRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void UpdateAssetMetaRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
