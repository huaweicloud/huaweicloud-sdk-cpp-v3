...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_CancelBroadcastRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_CancelBroadcastRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  CancelBroadcastRequest
    : public ModelBase
{
public:
    CancelBroadcastRequest();
    virtual ~CancelBroadcastRequest();
    ...
    /////////////////////////////////////////////
    /// CancelBroadcastRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    CancelBroadcastRequest& dereference_from_shared_ptr(std::shared_ptr<CancelBroadcastRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_CancelBroadcastRequest_H_
