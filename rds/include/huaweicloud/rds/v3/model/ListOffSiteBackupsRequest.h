...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_ListOffSiteBackupsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  ListOffSiteBackupsRequest
    : public ModelBase
{
public:
    ListOffSiteBackupsRequest();
    virtual ~ListOffSiteBackupsRequest();
    ...
    /////////////////////////////////////////////
    /// ListOffSiteBackupsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListOffSiteBackupsRequest& dereference_from_shared_ptr(std::shared_ptr<ListOffSiteBackupsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_ListOffSiteBackupsRequest_H_
