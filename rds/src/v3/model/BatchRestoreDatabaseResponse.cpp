...
std::vector<RestoreResult>& BatchRestoreDatabaseResponse::getRestoreResult()
{
    return restoreResult_;
}

void BatchRestoreDatabaseResponse::setRestoreResult(const std::vector<RestoreResult>& value)
{
