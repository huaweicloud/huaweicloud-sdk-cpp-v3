...
#ifndef HUAWEICLOUD_SDK_ANTIDDOS_V2_MODEL_TriggerQpsDict_H_
#define HUAWEICLOUD_SDK_ANTIDDOS_V2_MODEL_TriggerQpsDict_H_
...
/// HTTP限制列表
/// </summary>
class HUAWEICLOUD_ANTIDDOS_V2_EXPORT  TriggerQpsDict
    : public ModelBase
{
public:
    TriggerQpsDict();
...
#endif // HUAWEICLOUD_SDK_ANTIDDOS_V2_MODEL_TriggerQpsDict_H_
