...
#ifndef HUAWEICLOUD_SDK_KMS_V2_MODEL_UpdateKeyPolicyResponseBody_policy_H_
#define HUAWEICLOUD_SDK_KMS_V2_MODEL_UpdateKeyPolicyResponseBody_policy_H_
...
/// **参数解释：** 密钥策略 **取值范围：** 不涉及
/// </summary>
class HUAWEICLOUD_KMS_V2_EXPORT  UpdateKeyPolicyResponseBody_policy
    : public ModelBase
{
public:
    UpdateKeyPolicyResponseBody_policy();
    virtual ~UpdateKeyPolicyResponseBody_policy();
    ...
    /////////////////////////////////////////////
    /// UpdateKeyPolicyResponseBody_policy members
    ...
    UpdateKeyPolicyResponseBody_policy_validity_period getValidityPeriod() const;
    bool validityPeriodIsSet() const;
    void unsetvalidityPeriod();
    void setValidityPeriod(const UpdateKeyPolicyResponseBody_policy_validity_period& value);
...
protected:
    std::string version_;
    bool versionIsSet_;
    UpdateKeyPolicyResponseBody_policy_validity_period validityPeriod_;
...
#endif // HUAWEICLOUD_SDK_KMS_V2_MODEL_UpdateKeyPolicyResponseBody_policy_H_
