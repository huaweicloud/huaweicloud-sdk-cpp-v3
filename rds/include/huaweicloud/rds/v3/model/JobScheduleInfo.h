...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_JobScheduleInfo_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_JobScheduleInfo_H_
...
/// 创建策略信息。
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  JobScheduleInfo
    : public ModelBase
{
public:
    JobScheduleInfo();
    virtual ~JobScheduleInfo();
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_JobScheduleInfo_H_
