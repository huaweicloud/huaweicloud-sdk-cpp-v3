...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateAudioRecordConfigReq_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateAudioRecordConfigReq_H_
...
/// 创建语音录制配置请求。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateAudioRecordConfigReq
    : public ModelBase
{
public:
    CreateAudioRecordConfigReq();
    virtual ~CreateAudioRecordConfigReq();
    ...
    /////////////////////////////////////////////
    /// CreateAudioRecordConfigReq members
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateAudioRecordConfigReq_H_
