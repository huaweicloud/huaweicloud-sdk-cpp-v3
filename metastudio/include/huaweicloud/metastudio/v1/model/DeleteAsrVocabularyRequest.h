...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteAsrVocabularyRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteAsrVocabularyRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteAsrVocabularyRequest
    : public ModelBase
{
public:
    DeleteAsrVocabularyRequest();
    virtual ~DeleteAsrVocabularyRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteAsrVocabularyRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteAsrVocabularyRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteAsrVocabularyRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteAsrVocabularyRequest_H_
