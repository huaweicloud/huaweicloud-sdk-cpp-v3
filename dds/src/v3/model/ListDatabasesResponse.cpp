...
bool ListDatabasesResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("databases"))) {
        ...
        {
            std::vector<DatabaseInfoItem> refVal;
...
std::vector<DatabaseInfoItem>& ListDatabasesResponse::getDatabases()
{
    return databases_;
}

void ListDatabasesResponse::setDatabases(const std::vector<DatabaseInfoItem>& value)
{
    databases_ = value;
