...
#ifndef HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListDomainTrafficSummaryRequest_H_
#define HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListDomainTrafficSummaryRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_LIVE_V2_EXPORT  ListDomainTrafficSummaryRequest
    : public ModelBase
{
public:
    ListDomainTrafficSummaryRequest();
    virtual ~ListDomainTrafficSummaryRequest();
    ...
    /////////////////////////////////////////////
    /// ListDomainTrafficSummaryRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDomainTrafficSummaryRequest& dereference_from_shared_ptr(std::shared_ptr<ListDomainTrafficSummaryRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_LIVE_V2_MODEL_ListDomainTrafficSummaryRequest_H_
