...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ProjectProtectedActionResultApiDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ProjectProtectedActionResultApiDto_H_
...
#include <huaweicloud/codeartsrepo/v4/model/ForceActionEnableDto.h>
#include <huaweicloud/codeartsrepo/v4/model/RoleBasicDto.h>
#include <string>
#include <vector>
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  ProjectProtectedActionResultApiDto
    : public ModelBase
{
public:
    ProjectProtectedActionResultApiDto();
    virtual ~ProjectProtectedActionResultApiDto();
    ...
    /////////////////////////////////////////////
    /// ProjectProtectedActionResultApiDto members
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ProjectProtectedActionResultApiDto_H_
