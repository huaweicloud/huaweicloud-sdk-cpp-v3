...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInsertCommandsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInsertCommandsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListInsertCommandsRequest
    : public ModelBase
{
public:
    ListInsertCommandsRequest();
    virtual ~ListInsertCommandsRequest();
    ...
    /////////////////////////////////////////////
    /// ListInsertCommandsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListInsertCommandsRequest& dereference_from_shared_ptr(std::shared_ptr<ListInsertCommandsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInsertCommandsRequest_H_
