...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_TrafficTrendVO_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_TrafficTrendVO_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  TrafficTrendVO
    : public ModelBase
{
public:
    TrafficTrendVO();
    virtual ~TrafficTrendVO();
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_TrafficTrendVO_H_
