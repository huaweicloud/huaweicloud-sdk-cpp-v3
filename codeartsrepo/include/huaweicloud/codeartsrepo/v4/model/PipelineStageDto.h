...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_PipelineStageDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_PipelineStageDto_H_
...
/// 阶段信息
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  PipelineStageDto
    : public ModelBase
{
public:
    PipelineStageDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_PipelineStageDto_H_
