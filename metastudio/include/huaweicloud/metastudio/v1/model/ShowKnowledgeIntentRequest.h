...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeIntentRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeIntentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowKnowledgeIntentRequest
    : public ModelBase
{
public:
    ShowKnowledgeIntentRequest();
    virtual ~ShowKnowledgeIntentRequest();
    ...
    /////////////////////////////////////////////
    /// ShowKnowledgeIntentRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowKnowledgeIntentRequest& dereference_from_shared_ptr(std::shared_ptr<ShowKnowledgeIntentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeIntentRequest_H_
