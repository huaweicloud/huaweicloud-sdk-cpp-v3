...
bool ConfigurationParameter::isReadonly() const
{
    return readonly_;
}

void ConfigurationParameter::setReadonly(bool value)
{
    readonly_ = value;
    readonlyIsSet_ = true;
}

bool ConfigurationParameter::readonlyIsSet() const
{
    return readonlyIsSet_;
}

void ConfigurationParameter::unsetreadonly()
{
    readonlyIsSet_ = false;
}
