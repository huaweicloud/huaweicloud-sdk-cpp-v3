...
std::string UpdateAssetCategoryRequest::getAuthorization() const
{
    return authorization_;
}

void UpdateAssetCategoryRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool UpdateAssetCategoryRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void UpdateAssetCategoryRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
