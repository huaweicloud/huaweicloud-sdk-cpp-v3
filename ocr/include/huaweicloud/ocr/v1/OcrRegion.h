...
public:
    ...
    static std::map<std::string, Region> initRegions() {
        ...
        regions["la-south-2"] = Region("la-south-2","https://ocr.la-south-2.myhuaweicloud.com") ;
        regions["af-south-1"] = Region("af-south-1","https://ocr.af-south-1.myhuaweicloud.com") ;
        return regions;
    }
private:
