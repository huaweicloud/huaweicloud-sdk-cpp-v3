...
#ifndef HUAWEICLOUD_SDK_LIVE_V1_MODEL_ModifyHlsConfig_H_
#define HUAWEICLOUD_SDK_LIVE_V1_MODEL_ModifyHlsConfig_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LIVE_V1_EXPORT  ModifyHlsConfig
    : public ModelBase
{
public:
    ModifyHlsConfig();
    virtual ~ModifyHlsConfig();
...
#endif // HUAWEICLOUD_SDK_LIVE_V1_MODEL_ModifyHlsConfig_H_
