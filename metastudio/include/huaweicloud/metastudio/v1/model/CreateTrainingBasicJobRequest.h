...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTrainingBasicJobRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTrainingBasicJobRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateTrainingBasicJobRequest
    : public ModelBase
{
public:
    CreateTrainingBasicJobRequest();
    virtual ~CreateTrainingBasicJobRequest();
    ...
    /////////////////////////////////////////////
    /// CreateTrainingBasicJobRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    CreateTrainingBasicJobRequest& dereference_from_shared_ptr(std::shared_ptr<CreateTrainingBasicJobRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTrainingBasicJobRequest_H_
