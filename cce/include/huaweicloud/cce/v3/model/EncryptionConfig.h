...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_EncryptionConfig_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_EncryptionConfig_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  EncryptionConfig
    : public ModelBase
{
public:
    EncryptionConfig();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_EncryptionConfig_H_
