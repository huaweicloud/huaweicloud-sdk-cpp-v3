...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_PersistentVolumeClaim_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_PersistentVolumeClaim_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  PersistentVolumeClaim
    : public ModelBase
{
public:
    PersistentVolumeClaim();
    virtual ~PersistentVolumeClaim();
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_PersistentVolumeClaim_H_
