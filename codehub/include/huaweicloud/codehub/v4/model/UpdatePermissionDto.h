...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_UpdatePermissionDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_UpdatePermissionDto_H_
...
#include <string>
#include <huaweicloud/codehub/v4/model/UpdatePermissionDetail.h>
#include <vector>
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  UpdatePermissionDto
    : public ModelBase
{
public:
    UpdatePermissionDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_UpdatePermissionDto_H_
