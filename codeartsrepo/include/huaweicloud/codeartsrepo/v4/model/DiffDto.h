...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_DiffDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_DiffDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  DiffDto
    : public ModelBase
{
public:
    DiffDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_DiffDto_H_
