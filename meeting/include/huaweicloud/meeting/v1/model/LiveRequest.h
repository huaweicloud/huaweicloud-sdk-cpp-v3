...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_LiveRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_LiveRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  LiveRequest
    : public ModelBase
{
public:
    LiveRequest();
    ...
    RestSetLiveReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestSetLiveReqBody& value);
...
protected:
    ...
    RestSetLiveReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    LiveRequest& dereference_from_shared_ptr(std::shared_ptr<LiveRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_LiveRequest_H_
