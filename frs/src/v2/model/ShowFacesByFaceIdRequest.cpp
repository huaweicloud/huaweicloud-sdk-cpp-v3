...
void ShowFacesByFaceIdRequest::setEnterpriseProjectId(const std::string& value)
{
    enterpriseProjectId_ = value;
    enterpriseProjectIdIsSet_ = true;
}

bool ShowFacesByFaceIdRequest::enterpriseProjectIdIsSet() const
{
    return enterpriseProjectIdIsSet_;
}

void ShowFacesByFaceIdRequest::unsetenterpriseProjectId()
{
    enterpriseProjectIdIsSet_ = false;
}
