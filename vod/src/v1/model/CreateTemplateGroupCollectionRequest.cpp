...
std::string CreateTemplateGroupCollectionRequest::getAuthorization() const
{
    return authorization_;
}

void CreateTemplateGroupCollectionRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool CreateTemplateGroupCollectionRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void CreateTemplateGroupCollectionRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
