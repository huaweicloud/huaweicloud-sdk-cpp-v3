...
#ifndef HUAWEICLOUD_SDK_IVS_V2_MODEL_RespDataByIdCardImage_H_
#define HUAWEICLOUD_SDK_IVS_V2_MODEL_RespDataByIdCardImage_H_
...
/// 
/// </summary>
class HUAWEICLOUD_IVS_V2_EXPORT  RespDataByIdCardImage
    : public ModelBase
{
public:
    RespDataByIdCardImage();
    virtual ~RespDataByIdCardImage();
...
#endif // HUAWEICLOUD_SDK_IVS_V2_MODEL_RespDataByIdCardImage_H_
