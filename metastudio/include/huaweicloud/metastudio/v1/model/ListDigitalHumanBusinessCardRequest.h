...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListDigitalHumanBusinessCardRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListDigitalHumanBusinessCardRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListDigitalHumanBusinessCardRequest
    : public ModelBase
{
public:
    ListDigitalHumanBusinessCardRequest();
    virtual ~ListDigitalHumanBusinessCardRequest();
    ...
    /////////////////////////////////////////////
    /// ListDigitalHumanBusinessCardRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListDigitalHumanBusinessCardRequest& dereference_from_shared_ptr(std::shared_ptr<ListDigitalHumanBusinessCardRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListDigitalHumanBusinessCardRequest_H_
