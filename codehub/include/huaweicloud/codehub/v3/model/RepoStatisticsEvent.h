...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoStatisticsEvent_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoStatisticsEvent_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  RepoStatisticsEvent
    : public ModelBase
{
public:
    RepoStatisticsEvent();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoStatisticsEvent_H_
