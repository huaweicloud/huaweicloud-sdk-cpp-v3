...
#ifndef HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_AssetTree_H_
#define HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_AssetTree_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CLOUDTEST_V1_EXPORT  AssetTree
    : public ModelBase
{
public:
    AssetTree();
    ...
    int32_t getFactorCnt() const;
    bool factorCntIsSet() const;
    void unsetfactorCnt();
    void setFactorCnt(int32_t value);
...
#endif // HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_AssetTree_H_
