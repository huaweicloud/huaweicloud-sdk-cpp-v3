...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListHarmonySoftBusRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListHarmonySoftBusRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListHarmonySoftBusRequest
    : public ModelBase
{
public:
    ListHarmonySoftBusRequest();
    virtual ~ListHarmonySoftBusRequest();
    ...
    /////////////////////////////////////////////
    /// ListHarmonySoftBusRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListHarmonySoftBusRequest& dereference_from_shared_ptr(std::shared_ptr<ListHarmonySoftBusRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListHarmonySoftBusRequest_H_
