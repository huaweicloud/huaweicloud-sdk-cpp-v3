...
#ifndef HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatisticSecretKeyRequest_H_
#define HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatisticSecretKeyRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CPCS_V1_EXPORT  ShowStatisticSecretKeyRequest
    : public ModelBase
{
public:
    ShowStatisticSecretKeyRequest();
    virtual ~ShowStatisticSecretKeyRequest();
    ...
    /////////////////////////////////////////////
    /// ShowStatisticSecretKeyRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowStatisticSecretKeyRequest& dereference_from_shared_ptr(std::shared_ptr<ShowStatisticSecretKeyRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowStatisticSecretKeyRequest_H_
