...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoStatistics_H_
#define HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoStatistics_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V3_EXPORT  RepoStatistics
    : public ModelBase
{
public:
    RepoStatistics();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V3_MODEL_RepoStatistics_H_
