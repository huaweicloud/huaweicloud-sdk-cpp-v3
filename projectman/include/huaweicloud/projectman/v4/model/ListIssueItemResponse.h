...
#ifndef HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_ListIssueItemResponse_H_
#define HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_ListIssueItemResponse_H_
...
/// 
/// </summary>
class HUAWEICLOUD_PROJECTMAN_V4_EXPORT  ListIssueItemResponse
    : public ModelBase
{
public:
    ListIssueItemResponse();
    virtual ~ListIssueItemResponse();
...
#endif // HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_ListIssueItemResponse_H_
