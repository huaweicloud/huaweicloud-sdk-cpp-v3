...
web::json::value SpeedLimitInfo::toJson() const
{
    ...
    if(isUtcIsSet_) {
        val[utility::conversions::to_string_t("is_utc")] = ModelBase::toJson(isUtc_);
    }
...
bool SpeedLimitInfo::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("is_utc"))) {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("is_utc"));
        if(!fieldValue.is_null())
        {
            bool refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
...
bool SpeedLimitInfo::isIsUtc() const
{
    return isUtc_;
}

void SpeedLimitInfo::setIsUtc(bool value)
{
    isUtc_ = value;
    isUtcIsSet_ = true;
}

bool SpeedLimitInfo::isUtcIsSet() const
{
    return isUtcIsSet_;
}

void SpeedLimitInfo::unsetisUtc()
{
    isUtcIsSet_ = false;
}
