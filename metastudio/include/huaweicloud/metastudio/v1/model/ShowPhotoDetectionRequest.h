...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPhotoDetectionRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPhotoDetectionRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowPhotoDetectionRequest
    : public ModelBase
{
public:
    ShowPhotoDetectionRequest();
    virtual ~ShowPhotoDetectionRequest();
    ...
    /////////////////////////////////////////////
    /// ShowPhotoDetectionRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowPhotoDetectionRequest& dereference_from_shared_ptr(std::shared_ptr<ShowPhotoDetectionRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowPhotoDetectionRequest_H_
