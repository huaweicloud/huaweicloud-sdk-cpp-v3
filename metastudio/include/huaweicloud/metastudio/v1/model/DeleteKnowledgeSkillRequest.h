...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeSkillRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeSkillRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteKnowledgeSkillRequest
    : public ModelBase
{
public:
    DeleteKnowledgeSkillRequest();
    virtual ~DeleteKnowledgeSkillRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteKnowledgeSkillRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteKnowledgeSkillRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteKnowledgeSkillRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeSkillRequest_H_
