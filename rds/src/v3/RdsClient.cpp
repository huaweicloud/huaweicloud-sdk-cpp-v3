...
std::shared_ptr<AddPostgresqlHbaConfResponse> RdsClient::addPostgresqlHbaConf(AddPostgresqlHbaConfRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForAddPostgresqlHbaConf());

    std::shared_ptr<AddPostgresqlHbaConfResponse> localVarResult = std::make_shared<AddPostgresqlHbaConfResponse>();
...
std::shared_ptr<ApplyConfigurationAsyncResponse> RdsClient::applyConfigurationAsync(ApplyConfigurationAsyncRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForApplyConfigurationAsync());
...
std::shared_ptr<AttachEipResponse> RdsClient::attachEip(AttachEipRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForAttachEip());
...
std::shared_ptr<BatchDeleteInstanceResponse> RdsClient::batchDeleteInstance(BatchDeleteInstanceRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/batch-delete";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchDeleteInstance());

    std::shared_ptr<BatchDeleteInstanceResponse> localVarResult = std::make_shared<BatchDeleteInstanceResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchDeleteManualBackupResponse> RdsClient::batchDeleteManualBackup(BatchDeleteManualBackupRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchDeleteManualBackup());
...
std::shared_ptr<BatchExecuteEventsResponse> RdsClient::batchExecuteEvents(BatchExecuteEventsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/schedule-events";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchExecuteEvents());

    std::shared_ptr<BatchExecuteEventsResponse> localVarResult = std::make_shared<BatchExecuteEventsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchResizeFlavorResponse> RdsClient::batchResizeFlavor(BatchResizeFlavorRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/batch/resize";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchResizeFlavor());

    std::shared_ptr<BatchResizeFlavorResponse> localVarResult = std::make_shared<BatchResizeFlavorResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchRestoreDatabaseResponse> RdsClient::batchRestoreDatabase(BatchRestoreDatabaseRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/batch/restore/databases";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchRestoreDatabase());

    std::shared_ptr<BatchRestoreDatabaseResponse> localVarResult = std::make_shared<BatchRestoreDatabaseResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchRestorePostgreSqlTablesResponse> RdsClient::batchRestorePostgreSqlTables(BatchRestorePostgreSqlTablesRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/batch/restore/tables";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchRestorePostgreSqlTables());

    std::shared_ptr<BatchRestorePostgreSqlTablesResponse> localVarResult = std::make_shared<BatchRestorePostgreSqlTablesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchStopInstanceResponse> RdsClient::batchStopInstance(BatchStopInstanceRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/batch/action/shutdown";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchStopInstance());

    std::shared_ptr<BatchStopInstanceResponse> localVarResult = std::make_shared<BatchStopInstanceResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchTagAddActionResponse> RdsClient::batchTagAddAction(BatchTagAddActionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchTagAddAction());
...
std::shared_ptr<BatchTagDelActionResponse> RdsClient::batchTagDelAction(BatchTagDelActionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchTagDelAction());
...
std::shared_ptr<ChangeBackupConfigResponse> RdsClient::changeBackupConfig(ChangeBackupConfigRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForChangeBackupConfig());

    std::shared_ptr<ChangeBackupConfigResponse> localVarResult = std::make_shared<ChangeBackupConfigResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ChangeFailoverModeResponse> RdsClient::changeFailoverMode(ChangeFailoverModeRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForChangeFailoverMode());
...
std::shared_ptr<ChangeFailoverStrategyResponse> RdsClient::changeFailoverStrategy(ChangeFailoverStrategyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForChangeFailoverStrategy());
...
std::shared_ptr<ChangeOpsWindowResponse> RdsClient::changeOpsWindow(ChangeOpsWindowRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForChangeOpsWindow());
...
std::shared_ptr<CheckWeakpwdResponse> RdsClient::checkWeakpwd(CheckWeakpwdRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/weakpwd";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCheckWeakpwd());

    std::shared_ptr<CheckWeakpwdResponse> localVarResult = std::make_shared<CheckWeakpwdResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CompareConfigurationResponse> RdsClient::compareConfiguration(CompareConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCompareConfiguration());
...
std::shared_ptr<CopyConfigurationResponse> RdsClient::copyConfiguration(CopyConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCopyConfiguration());
...
std::shared_ptr<CreateConfigurationResponse> RdsClient::createConfiguration(CreateConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateConfiguration());
...
std::shared_ptr<CreateDnsNameResponse> RdsClient::createDnsName(CreateDnsNameRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateDnsName());
...
std::shared_ptr<CreateDrsJobTaskResponse> RdsClient::createDrsJobTask(CreateDrsJobTaskRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/drs-job/create";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateDrsJobTask());

    std::shared_ptr<CreateDrsJobTaskResponse> localVarResult = std::make_shared<CreateDrsJobTaskResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreateInstanceResponse> RdsClient::createInstance(CreateInstanceRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateInstance());
...
std::shared_ptr<CreateInstanceIam5Response> RdsClient::createInstanceIam5(CreateInstanceIam5Request &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateInstanceIam5());

    std::shared_ptr<CreateInstanceIam5Response> localVarResult = std::make_shared<CreateInstanceIam5Response>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreateManualBackupResponse> RdsClient::createManualBackup(CreateManualBackupRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateManualBackup());
...
std::shared_ptr<CreateRdSforMySqlProxyResponse> RdsClient::createRdSforMySqlProxy(CreateRdSforMySqlProxyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/proxy/open";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateRdSforMySqlProxy());

    std::shared_ptr<CreateRdSforMySqlProxyResponse> localVarResult = std::make_shared<CreateRdSforMySqlProxyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreateRebuildSlaveResponse> RdsClient::createRebuildSlave(CreateRebuildSlaveRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/rebuild";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateRebuildSlave());

    std::shared_ptr<CreateRebuildSlaveResponse> localVarResult = std::make_shared<CreateRebuildSlaveResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<CreateRestoreInstanceResponse> RdsClient::createRestoreInstance(CreateRestoreInstanceRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateRestoreInstance());
...
std::shared_ptr<CreateSqlLimitResponse> RdsClient::createSqlLimit(CreateSqlLimitRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateSqlLimit());

    std::shared_ptr<CreateSqlLimitResponse> localVarResult = std::make_shared<CreateSqlLimitResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreateXelLogDownloadResponse> RdsClient::createXelLogDownload(CreateXelLogDownloadRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/xellog-download";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateXelLogDownload());

    std::shared_ptr<CreateXelLogDownloadResponse> localVarResult = std::make_shared<CreateXelLogDownloadResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<DeleteBackupSelectionResponse> RdsClient::deleteBackupSelection(DeleteBackupSelectionRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/backups/delete-selection";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteBackupSelection());

    std::shared_ptr<DeleteBackupSelectionResponse> localVarResult = std::make_shared<DeleteBackupSelectionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<DeleteConfigurationResponse> RdsClient::deleteConfiguration(DeleteConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteConfiguration());
...
std::shared_ptr<DeleteDisasterRecoveryResponse> RdsClient::deleteDisasterRecovery(DeleteDisasterRecoveryRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/delete-disaster-recovery";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteDisasterRecovery());
...
std::shared_ptr<DeleteInstanceResponse> RdsClient::deleteInstance(DeleteInstanceRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteInstance());
...
std::shared_ptr<DeleteJobResponse> RdsClient::deleteJob(DeleteJobRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteJob());
...
std::shared_ptr<DeleteManualBackupResponse> RdsClient::deleteManualBackup(DeleteManualBackupRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteManualBackup());
...
std::shared_ptr<DeletePostgresqlHbaConfResponse> RdsClient::deletePostgresqlHbaConf(DeletePostgresqlHbaConfRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/hba-info";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeletePostgresqlHbaConf());

    std::shared_ptr<DeletePostgresqlHbaConfResponse> localVarResult = std::make_shared<DeletePostgresqlHbaConfResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<DeleteRdSforMySqlProxyResponse> RdsClient::deleteRdSforMySqlProxy(DeleteRdSforMySqlProxyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/proxy/{proxy_id}";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteRdSforMySqlProxy());

    std::shared_ptr<DeleteRdSforMySqlProxyResponse> localVarResult = std::make_shared<DeleteRdSforMySqlProxyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<DeleteSqlLimitResponse> RdsClient::deleteSqlLimit(DeleteSqlLimitRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/sql-limit";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteSqlLimit());

    std::shared_ptr<DeleteSqlLimitResponse> localVarResult = std::make_shared<DeleteSqlLimitResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<DownloadSlowlogResponse> RdsClient::downloadSlowlog(DownloadSlowlogRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDownloadSlowlog());
...
std::shared_ptr<EnableConfigurationResponse> RdsClient::enableConfiguration(EnableConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForEnableConfiguration());
...
std::shared_ptr<ListBackupsResponse> RdsClient::listBackups(ListBackupsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListBackups());
...
std::shared_ptr<ListCollationsResponse> RdsClient::listCollations(ListCollationsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListCollations());
...
std::shared_ptr<ListConfigurationsResponse> RdsClient::listConfigurations(ListConfigurationsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListConfigurations());
...
std::shared_ptr<ListDatastoresResponse> RdsClient::listDatastores(ListDatastoresRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListDatastores());
...
std::shared_ptr<ListDrInfosResponse> RdsClient::listDrInfos(ListDrInfosRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/disaster-recovery-infos";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListDrInfos());

    std::shared_ptr<ListDrInfosResponse> localVarResult = std::make_shared<ListDrInfosResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ListDrRelationsResponse> RdsClient::listDrRelations(ListDrRelationsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListDrRelations());
...
std::shared_ptr<ListEngineFlavorsResponse> RdsClient::listEngineFlavors(ListEngineFlavorsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListEngineFlavors());
...
std::shared_ptr<ListErrorLogsResponse> RdsClient::listErrorLogs(ListErrorLogsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListErrorLogs());
...
std::shared_ptr<ListErrorLogsNewResponse> RdsClient::listErrorLogsNew(ListErrorLogsNewRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListErrorLogsNew());
...
std::shared_ptr<ListErrorlogForLtsResponse> RdsClient::listErrorlogForLts(ListErrorlogForLtsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListErrorlogForLts());
...
std::shared_ptr<ListFlavorsResponse> RdsClient::listFlavors(ListFlavorsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListFlavors());
...
std::shared_ptr<ListFlavorsResizeResponse> RdsClient::listFlavorsResize(ListFlavorsResizeRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/flavors-resize";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListFlavorsResize());

    std::shared_ptr<ListFlavorsResizeResponse> localVarResult = std::make_shared<ListFlavorsResizeResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListHistoryDatabaseResponse> RdsClient::listHistoryDatabase(ListHistoryDatabaseRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/{engine}/instances/history/databases";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListHistoryDatabase());

    std::shared_ptr<ListHistoryDatabaseResponse> localVarResult = std::make_shared<ListHistoryDatabaseResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ListHistorySessionsResponse> RdsClient::listHistorySessions(ListHistorySessionsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/history-session";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListHistorySessions());

    std::shared_ptr<ListHistorySessionsResponse> localVarResult = std::make_shared<ListHistorySessionsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListHistoryTopSqlsResponse> RdsClient::listHistoryTopSqls(ListHistoryTopSqlsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/history-top-sql";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListHistoryTopSqls());

    std::shared_ptr<ListHistoryTopSqlsResponse> localVarResult = std::make_shared<ListHistoryTopSqlsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListHistoryWaitEventsResponse> RdsClient::listHistoryWaitEvents(ListHistoryWaitEventsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/history-wait-event";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListHistoryWaitEvents());

    std::shared_ptr<ListHistoryWaitEventsResponse> localVarResult = std::make_shared<ListHistoryWaitEventsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListInspectionHistoriesResponse> RdsClient::listInspectionHistories(ListInspectionHistoriesRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/major-version/inspection-histories";
    ...
    if (request.isAvailableIsSet()) {
        localVarQueryParams["is_available"] = parameterToString(request.isIsAvailable());
    }
    if (request.xLanguageIsSet()) {
        localVarHeaderParams["X-Language"] = parameterToString(request.getXLanguage());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListInspectionHistories());

    std::shared_ptr<ListInspectionHistoriesResponse> localVarResult = std::make_shared<ListInspectionHistoriesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListInstanceBackupSummaryResponse> RdsClient::listInstanceBackupSummary(ListInstanceBackupSummaryRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/backups/summary";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListInstanceBackupSummary());

    std::shared_ptr<ListInstanceBackupSummaryResponse> localVarResult = std::make_shared<ListInstanceBackupSummaryResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListInstanceParamHistoriesResponse> RdsClient::listInstanceParamHistories(ListInstanceParamHistoriesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListInstanceParamHistories());
...
std::shared_ptr<ListInstanceTagsResponse> RdsClient::listInstanceTags(ListInstanceTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListInstanceTags());
...
std::shared_ptr<ListInstancesSupportFastRestoreResponse> RdsClient::listInstancesSupportFastRestore(ListInstancesSupportFastRestoreRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListInstancesSupportFastRestore());
...
std::shared_ptr<ListJobInfoResponse> RdsClient::listJobInfo(ListJobInfoRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListJobInfo());
...
std::shared_ptr<ListMajorVersionFeatureResponse> RdsClient::listMajorVersionFeature(ListMajorVersionFeatureRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/major-version-feature";
    ...
    if (request.singleIsSet()) {
        localVarQueryParams["single"] = parameterToString(request.isSingle());
    }
    if (request.xLanguageIsSet()) {
        localVarHeaderParams["X-Language"] = parameterToString(request.getXLanguage());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListMajorVersionFeature());

    std::shared_ptr<ListMajorVersionFeatureResponse> localVarResult = std::make_shared<ListMajorVersionFeatureResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListOffSiteBackupsResponse> RdsClient::listOffSiteBackups(ListOffSiteBackupsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListOffSiteBackups());
...
std::shared_ptr<ListOffSiteInstancesResponse> RdsClient::listOffSiteInstances(ListOffSiteInstancesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListOffSiteInstances());
...
std::shared_ptr<ListOffSiteRestoreTimesResponse> RdsClient::listOffSiteRestoreTimes(ListOffSiteRestoreTimesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListOffSiteRestoreTimes());
...
std::shared_ptr<ListPackLogInfosResponse> RdsClient::listPackLogInfos(ListPackLogInfosRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/packlog/infos";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPackLogInfos());

    std::shared_ptr<ListPackLogInfosResponse> localVarResult = std::make_shared<ListPackLogInfosResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListPostgresqlHbaInfoResponse> RdsClient::listPostgresqlHbaInfo(ListPostgresqlHbaInfoRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/hba-info";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPostgresqlHbaInfo());

    std::shared_ptr<ListPostgresqlHbaInfoResponse> localVarResult = std::make_shared<ListPostgresqlHbaInfoResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListPostgresqlHbaInfoHistoryResponse> RdsClient::listPostgresqlHbaInfoHistory(ListPostgresqlHbaInfoHistoryRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPostgresqlHbaInfoHistory());

    std::shared_ptr<ListPostgresqlHbaInfoHistoryResponse> localVarResult = std::make_shared<ListPostgresqlHbaInfoHistoryResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListPostgresqlListHistoryTablesResponse> RdsClient::listPostgresqlListHistoryTables(ListPostgresqlListHistoryTablesRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/{database_name}/instances/history/tables";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPostgresqlListHistoryTables());

    std::shared_ptr<ListPostgresqlListHistoryTablesResponse> localVarResult = std::make_shared<ListPostgresqlListHistoryTablesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ListPredefinedTagResponse> RdsClient::listPredefinedTag(ListPredefinedTagRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPredefinedTag());
...
std::shared_ptr<ListProjectTagsResponse> RdsClient::listProjectTags(ListProjectTagsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListProjectTags());
...
std::shared_ptr<ListRdSforMySqlProxyResponse> RdsClient::listRdSforMySqlProxy(ListRdSforMySqlProxyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/proxy-list";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListRdSforMySqlProxy());

    std::shared_ptr<ListRdSforMySqlProxyResponse> localVarResult = std::make_shared<ListRdSforMySqlProxyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListRdSforMysqlProxyFlavorsResponse> RdsClient::listRdSforMysqlProxyFlavors(ListRdSforMysqlProxyFlavorsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListRdSforMysqlProxyFlavors());

    std::shared_ptr<ListRdSforMysqlProxyFlavorsResponse> localVarResult = std::make_shared<ListRdSforMysqlProxyFlavorsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListRecycleInstancesResponse> RdsClient::listRecycleInstances(ListRecycleInstancesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListRecycleInstances());
...
std::shared_ptr<ListRestoreTimesResponse> RdsClient::listRestoreTimes(ListRestoreTimesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListRestoreTimes());
...
std::shared_ptr<ListScheduleEventsResponse> RdsClient::listScheduleEvents(ListScheduleEventsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/schedule-events";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListScheduleEvents());

    std::shared_ptr<ListScheduleEventsResponse> localVarResult = std::make_shared<ListScheduleEventsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListShareBackupsResponse> RdsClient::listShareBackups(ListShareBackupsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListShareBackups());

    std::shared_ptr<ListShareBackupsResponse> localVarResult = std::make_shared<ListShareBackupsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListSimplifiedInstancesResponse> RdsClient::listSimplifiedInstances(ListSimplifiedInstancesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSimplifiedInstances());
...
std::shared_ptr<ListSlowLogFileResponse> RdsClient::listSlowLogFile(ListSlowLogFileRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSlowLogFile());
...
std::shared_ptr<ListSlowLogStatisticsForLtsResponse> RdsClient::listSlowLogStatisticsForLts(ListSlowLogStatisticsForLtsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSlowLogStatisticsForLts());
...
std::shared_ptr<ListSlowLogsResponse> RdsClient::listSlowLogs(ListSlowLogsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSlowLogs());
...
std::shared_ptr<ListSlowLogsNewResponse> RdsClient::listSlowLogsNew(ListSlowLogsNewRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSlowLogsNew());
...
std::shared_ptr<ListSlowlogForLtsResponse> RdsClient::listSlowlogForLts(ListSlowlogForLtsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSlowlogForLts());
...
std::shared_ptr<ListSlowlogStatisticsResponse> RdsClient::listSlowlogStatistics(ListSlowlogStatisticsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSlowlogStatistics());
...
std::shared_ptr<ListSparseBackupPolicyResponse> RdsClient::listSparseBackupPolicy(ListSparseBackupPolicyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/backups/sparse-policy";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSparseBackupPolicy());

    std::shared_ptr<ListSparseBackupPolicyResponse> localVarResult = std::make_shared<ListSparseBackupPolicyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListSqlLimitResponse> RdsClient::listSqlLimit(ListSqlLimitRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSqlLimit());

    std::shared_ptr<ListSqlLimitResponse> localVarResult = std::make_shared<ListSqlLimitResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListSslCertDownloadLinkResponse> RdsClient::listSslCertDownloadLink(ListSslCertDownloadLinkRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSslCertDownloadLink());
...
std::shared_ptr<ListTopSqlsResponse> RdsClient::listTopSqls(ListTopSqlsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/top-sqls";
    ...
    if (request.statementIsSet()) {
        localVarQueryParams["statement"] = parameterToString(request.getStatement());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListTopSqls());
...
std::shared_ptr<ListUpdateBackupEnhancePolicyResponse> RdsClient::listUpdateBackupEnhancePolicy(ListUpdateBackupEnhancePolicyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/backups/enhance-policy";
    ...
    if (request.timeZoneIsSet()) {
        localVarQueryParams["time_zone"] = parameterToString(request.getTimeZone());
    }

    std::string localVarHttpBody;

    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListUpdateBackupEnhancePolicy());

    std::shared_ptr<ListUpdateBackupEnhancePolicyResponse> localVarResult = std::make_shared<ListUpdateBackupEnhancePolicyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListUpgradeHistoriesResponse> RdsClient::listUpgradeHistories(ListUpgradeHistoriesRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/major-version/upgrade-histories";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListUpgradeHistories());

    std::shared_ptr<ListUpgradeHistoriesResponse> localVarResult = std::make_shared<ListUpgradeHistoriesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListXellogFilesResponse> RdsClient::listXellogFiles(ListXellogFilesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListXellogFiles());

    std::shared_ptr<ListXellogFilesResponse> localVarResult = std::make_shared<ListXellogFilesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<MigrateFollowerResponse> RdsClient::migrateFollower(MigrateFollowerRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForMigrateFollower());
...
std::shared_ptr<ModifyPostgresqlHbaConfResponse> RdsClient::modifyPostgresqlHbaConf(ModifyPostgresqlHbaConfRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/hba-info";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForModifyPostgresqlHbaConf());

    std::shared_ptr<ModifyPostgresqlHbaConfResponse> localVarResult = std::make_shared<ModifyPostgresqlHbaConfResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ModifyRdSforMySqlProxyRouteModeResponse> RdsClient::modifyRdSforMySqlProxyRouteMode(ModifyRdSforMySqlProxyRouteModeRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForModifyRdSforMySqlProxyRouteMode());

    std::shared_ptr<ModifyRdSforMySqlProxyRouteModeResponse> localVarResult = std::make_shared<ModifyRdSforMySqlProxyRouteModeResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<NotifyReplaceNodeResponse> RdsClient::notifyReplaceNode(NotifyReplaceNodeRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replace-node";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForNotifyReplaceNode());

    std::shared_ptr<NotifyReplaceNodeResponse> localVarResult = std::make_shared<NotifyReplaceNodeResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ResetConfigurationResponse> RdsClient::resetConfiguration(ResetConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForResetConfiguration());
...
std::shared_ptr<RestoreTablesResponse> RdsClient::restoreTables(RestoreTablesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRestoreTables());
...
std::shared_ptr<RestoreTablesNewResponse> RdsClient::restoreTablesNew(RestoreTablesNewRequest &request)
{
    std::string localVarPath = "/v3.1/{project_id}/instances/{instance_id}/restore/tables";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRestoreTablesNew());

    std::shared_ptr<RestoreTablesNewResponse> localVarResult = std::make_shared<RestoreTablesNewResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<RestoreToExistingInstanceResponse> RdsClient::restoreToExistingInstance(RestoreToExistingInstanceRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRestoreToExistingInstance());
...
std::shared_ptr<SetAuditlogPolicyResponse> RdsClient::setAuditlogPolicy(SetAuditlogPolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetAuditlogPolicy());
...
std::shared_ptr<SetAutoEnlargePolicyResponse> RdsClient::setAutoEnlargePolicy(SetAutoEnlargePolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetAutoEnlargePolicy());
...
std::shared_ptr<SetAutoUpgradePolicyResponse> RdsClient::setAutoUpgradePolicy(SetAutoUpgradePolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetAutoUpgradePolicy());

    std::shared_ptr<SetAutoUpgradePolicyResponse> localVarResult = std::make_shared<SetAutoUpgradePolicyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<SetBackupPolicyResponse> RdsClient::setBackupPolicy(SetBackupPolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetBackupPolicy());
...
std::shared_ptr<SetInstancesProxyRestartResponse> RdsClient::setInstancesProxyRestart(SetInstancesProxyRestartRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetInstancesProxyRestart());

    std::shared_ptr<SetInstancesProxyRestartResponse> localVarResult = std::make_shared<SetInstancesProxyRestartResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<SetSecondLevelMonitorResponse> RdsClient::setSecondLevelMonitor(SetSecondLevelMonitorRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetSecondLevelMonitor());
...
std::shared_ptr<SetSecurityGroupResponse> RdsClient::setSecurityGroup(SetSecurityGroupRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetSecurityGroup());
...
std::shared_ptr<SetSensitiveSlowLogResponse> RdsClient::setSensitiveSlowLog(SetSensitiveSlowLogRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetSensitiveSlowLog());
...
std::shared_ptr<ShowAuditlogDownloadLinkResponse> RdsClient::showAuditlogDownloadLink(ShowAuditlogDownloadLinkRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowAuditlogDownloadLink());
...
std::shared_ptr<ShowAuditlogPolicyResponse> RdsClient::showAuditlogPolicy(ShowAuditlogPolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowAuditlogPolicy());
...
std::shared_ptr<ShowAutoEnlargePolicyResponse> RdsClient::showAutoEnlargePolicy(ShowAutoEnlargePolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowAutoEnlargePolicy());
...
std::shared_ptr<ShowAutoUpgradePolicyResponse> RdsClient::showAutoUpgradePolicy(ShowAutoUpgradePolicyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-auto-upgrade";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowAutoUpgradePolicy());

    std::shared_ptr<ShowAutoUpgradePolicyResponse> localVarResult = std::make_shared<ShowAutoUpgradePolicyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowAvailableBuildDrInstanceResponse> RdsClient::showAvailableBuildDrInstance(ShowAvailableBuildDrInstanceRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/disaster-recovery-instance";
...
std::shared_ptr<ShowAvailableVersionResponse> RdsClient::showAvailableVersion(ShowAvailableVersionRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/major-version/available-version";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowAvailableVersion());

    std::shared_ptr<ShowAvailableVersionResponse> localVarResult = std::make_shared<ShowAvailableVersionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowBackupConfigResponse> RdsClient::showBackupConfig(ShowBackupConfigRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/backups/config";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowBackupConfig());

    std::shared_ptr<ShowBackupConfigResponse> localVarResult = std::make_shared<ShowBackupConfigResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowBackupDownloadLinkResponse> RdsClient::showBackupDownloadLink(ShowBackupDownloadLinkRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowBackupDownloadLink());
...
std::shared_ptr<ShowBackupPolicyResponse> RdsClient::showBackupPolicy(ShowBackupPolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowBackupPolicy());
...
std::shared_ptr<ShowBackupUsageResponse> RdsClient::showBackupUsage(ShowBackupUsageRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/backups/backup-usage";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowBackupUsage());

    std::shared_ptr<ShowBackupUsageResponse> localVarResult = std::make_shared<ShowBackupUsageResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowBinlogClearPolicyResponse> RdsClient::showBinlogClearPolicy(ShowBinlogClearPolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowBinlogClearPolicy());
...
std::shared_ptr<ShowConfigurationResponse> RdsClient::showConfiguration(ShowConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowConfiguration());
...
std::shared_ptr<ShowDatabaseLevelDatabaseResponse> RdsClient::showDatabaseLevelDatabase(ShowDatabaseLevelDatabaseRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/database/db-table-name";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowDatabaseLevelDatabase());

    std::shared_ptr<ShowDatabaseLevelDatabaseResponse> localVarResult = std::make_shared<ShowDatabaseLevelDatabaseResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowDnsNameResponse> RdsClient::showDnsName(ShowDnsNameRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowDnsName());
...
std::shared_ptr<ShowDomainNameResponse> RdsClient::showDomainName(ShowDomainNameRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowDomainName());
...
std::shared_ptr<ShowDrReplicaStatusResponse> RdsClient::showDrReplicaStatus(ShowDrReplicaStatusRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowDrReplicaStatus());
...
std::shared_ptr<ShowDrsJobNameResponse> RdsClient::showDrsJobName(ShowDrsJobNameRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/drs-job/name";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowDrsJobName());

    std::shared_ptr<ShowDrsJobNameResponse> localVarResult = std::make_shared<ShowDrsJobNameResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowHistorySessionAnalyseDownloadInfoResponse> RdsClient::showHistorySessionAnalyseDownloadInfo(ShowHistorySessionAnalyseDownloadInfoRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/history-session-analyse-upload";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowHistorySessionAnalyseDownloadInfo());

    std::shared_ptr<ShowHistorySessionAnalyseDownloadInfoResponse> localVarResult = std::make_shared<ShowHistorySessionAnalyseDownloadInfoResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowHotClodSeparationStatusResponse> RdsClient::showHotClodSeparationStatus(ShowHotClodSeparationStatusRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/hot-cold-separation/status";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowHotClodSeparationStatus());

    std::shared_ptr<ShowHotClodSeparationStatusResponse> localVarResult = std::make_shared<ShowHotClodSeparationStatusResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowIncreBackupPolicy1Response> RdsClient::showIncreBackupPolicy1(ShowIncreBackupPolicy1Request &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/incre-backup/policy";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowIncreBackupPolicy1());

    std::shared_ptr<ShowIncreBackupPolicy1Response> localVarResult = std::make_shared<ShowIncreBackupPolicy1Response>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowInstanceConfigurationResponse> RdsClient::showInstanceConfiguration(ShowInstanceConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowInstanceConfiguration());
...
std::shared_ptr<ShowOffSiteBackupPolicyResponse> RdsClient::showOffSiteBackupPolicy(ShowOffSiteBackupPolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowOffSiteBackupPolicy());
...
std::shared_ptr<ShowQuotasResponse> RdsClient::showQuotas(ShowQuotasRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowQuotas());
...
std::shared_ptr<ShowRebuildSlaveStatusResponse> RdsClient::showRebuildSlaveStatus(ShowRebuildSlaveStatusRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/rebuild";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowRebuildSlaveStatus());

    std::shared_ptr<ShowRebuildSlaveStatusResponse> localVarResult = std::make_shared<ShowRebuildSlaveStatusResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowRecyclePolicyResponse> RdsClient::showRecyclePolicy(ShowRecyclePolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowRecyclePolicy());
...
std::shared_ptr<ShowReplicationStatusResponse> RdsClient::showReplicationStatus(ShowReplicationStatusRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowReplicationStatus());
...
std::shared_ptr<ShowRestartPolicyResponse> RdsClient::showRestartPolicy(ShowRestartPolicyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/restart-policy";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowRestartPolicy());

    std::shared_ptr<ShowRestartPolicyResponse> localVarResult = std::make_shared<ShowRestartPolicyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowSecondLevelMonitoringResponse> RdsClient::showSecondLevelMonitoring(ShowSecondLevelMonitoringRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowSecondLevelMonitoring());
...
std::shared_ptr<ShowStorageUsedSpaceResponse> RdsClient::showStorageUsedSpace(ShowStorageUsedSpaceRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/storage-used-space";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowStorageUsedSpace());

    std::shared_ptr<ShowStorageUsedSpaceResponse> localVarResult = std::make_shared<ShowStorageUsedSpaceResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowTaskDetailResponse> RdsClient::showTaskDetail(ShowTaskDetailRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowTaskDetail());
...
std::shared_ptr<ShowTdeStatusResponse> RdsClient::showTdeStatus(ShowTdeStatusRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/tde-status";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowTdeStatus());

    std::shared_ptr<ShowTdeStatusResponse> localVarResult = std::make_shared<ShowTdeStatusResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowTopObjectsResponse> RdsClient::showTopObjects(ShowTopObjectsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/ops/top/objects";
    ...
    if (request.topIsSet()) {
        localVarQueryParams["top"] = parameterToString(request.getTop());
    }
    if (request.databaseNameIsSet()) {
        localVarQueryParams["database_name"] = parameterToString(request.getDatabaseName());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowTopObjects());

    std::shared_ptr<ShowTopObjectsResponse> localVarResult = std::make_shared<ShowTopObjectsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowUpgradeDbMajorVersionStatusResponse> RdsClient::showUpgradeDbMajorVersionStatus(ShowUpgradeDbMajorVersionStatusRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowUpgradeDbMajorVersionStatus());

    std::shared_ptr<ShowUpgradeDbMajorVersionStatusResponse> localVarResult = std::make_shared<ShowUpgradeDbMajorVersionStatusResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<StartFailoverResponse> RdsClient::startFailover(StartFailoverRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStartFailover());
...
std::shared_ptr<StartInstanceEnlargeVolumeActionResponse> RdsClient::startInstanceEnlargeVolumeAction(StartInstanceEnlargeVolumeActionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStartInstanceEnlargeVolumeAction());
...
std::shared_ptr<StartInstanceReduceVolumeActionResponse> RdsClient::startInstanceReduceVolumeAction(StartInstanceReduceVolumeActionRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/action";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStartInstanceReduceVolumeAction());

    std::shared_ptr<StartInstanceReduceVolumeActionResponse> localVarResult = std::make_shared<StartInstanceReduceVolumeActionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<StartInstanceRestartActionResponse> RdsClient::startInstanceRestartAction(StartInstanceRestartActionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStartInstanceRestartAction());
...
std::shared_ptr<StartInstanceSingleToHaActionResponse> RdsClient::startInstanceSingleToHaAction(StartInstanceSingleToHaActionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStartInstanceSingleToHaAction());
...
std::shared_ptr<StartRecyclePolicyResponse> RdsClient::startRecyclePolicy(StartRecyclePolicyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStartRecyclePolicy());
...
std::shared_ptr<StartResizeFlavorActionResponse> RdsClient::startResizeFlavorAction(StartResizeFlavorActionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStartResizeFlavorAction());
...
std::shared_ptr<StartupInstanceResponse> RdsClient::startupInstance(StartupInstanceRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStartupInstance());
...
std::shared_ptr<StopInstanceResponse> RdsClient::stopInstance(StopInstanceRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStopInstance());
...
std::shared_ptr<SwitchSqlLimitResponse> RdsClient::switchSqlLimit(SwitchSqlLimitRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/sql-limit/switch";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSwitchSqlLimit());

    std::shared_ptr<SwitchSqlLimitResponse> localVarResult = std::make_shared<SwitchSqlLimitResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UnlockNodeReadonlyStatusResponse> RdsClient::unlockNodeReadonlyStatus(UnlockNodeReadonlyStatusRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/unlock-node-readonly-status";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUnlockNodeReadonlyStatus());

    std::shared_ptr<UnlockNodeReadonlyStatusResponse> localVarResult = std::make_shared<UnlockNodeReadonlyStatusResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateConfigurationResponse> RdsClient::updateConfiguration(UpdateConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateConfiguration());
...
std::shared_ptr<UpdateDataIpResponse> RdsClient::updateDataIp(UpdateDataIpRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateDataIp());
...
std::shared_ptr<UpdateDnsNameResponse> RdsClient::updateDnsName(UpdateDnsNameRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateDnsName());
...
std::shared_ptr<UpdateIncreBackupPolicy1Response> RdsClient::updateIncreBackupPolicy1(UpdateIncreBackupPolicy1Request &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/incre-backup/policy";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateIncreBackupPolicy1());

    std::shared_ptr<UpdateIncreBackupPolicy1Response> localVarResult = std::make_shared<UpdateIncreBackupPolicy1Response>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateInstanceAliasResponse> RdsClient::updateInstanceAlias(UpdateInstanceAliasRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateInstanceAlias());
...
std::shared_ptr<UpdateInstanceConfigurationResponse> RdsClient::updateInstanceConfiguration(UpdateInstanceConfigurationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateInstanceConfiguration());
...
std::shared_ptr<UpdateInstanceConfigurationAsyncResponse> RdsClient::updateInstanceConfigurationAsync(UpdateInstanceConfigurationAsyncRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateInstanceConfigurationAsync());
...
std::shared_ptr<UpdateInstanceNameResponse> RdsClient::updateInstanceName(UpdateInstanceNameRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateInstanceName());
...
std::shared_ptr<UpdatePortResponse> RdsClient::updatePort(UpdatePortRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdatePort());
...
std::shared_ptr<UpdateSparseBackupPolicyResponse> RdsClient::updateSparseBackupPolicy(UpdateSparseBackupPolicyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/backups/sparse-policy";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateSparseBackupPolicy());

    std::shared_ptr<UpdateSparseBackupPolicyResponse> localVarResult = std::make_shared<UpdateSparseBackupPolicyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateSqlLimitResponse> RdsClient::updateSqlLimit(UpdateSqlLimitRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/sql-limit/update";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateSqlLimit());

    std::shared_ptr<UpdateSqlLimitResponse> localVarResult = std::make_shared<UpdateSqlLimitResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateTdeStatusResponse> RdsClient::updateTdeStatus(UpdateTdeStatusRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/tde";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateTdeStatus());

    std::shared_ptr<UpdateTdeStatusResponse> localVarResult = std::make_shared<UpdateTdeStatusResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateTimeZoneResponse> RdsClient::updateTimeZone(UpdateTimeZoneRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/timezone/modify";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateTimeZone());

    std::shared_ptr<UpdateTimeZoneResponse> localVarResult = std::make_shared<UpdateTimeZoneResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpgradeDbMajorVersionResponse> RdsClient::upgradeDbMajorVersion(UpgradeDbMajorVersionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpgradeDbMajorVersion());

    std::shared_ptr<UpgradeDbMajorVersionResponse> localVarResult = std::make_shared<UpgradeDbMajorVersionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpgradeDbMajorVersionPreCheckResponse> RdsClient::upgradeDbMajorVersionPreCheck(UpgradeDbMajorVersionPreCheckRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/major-version/inspection";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpgradeDbMajorVersionPreCheck());

    std::shared_ptr<UpgradeDbMajorVersionPreCheckResponse> localVarResult = std::make_shared<UpgradeDbMajorVersionPreCheckResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpgradeDbVersionResponse> RdsClient::upgradeDbVersion(UpgradeDbVersionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpgradeDbVersion());
...
std::shared_ptr<UpgradeDbVersionNewResponse> RdsClient::upgradeDbVersionNew(UpgradeDbVersionNewRequest &request)
{
...
std::shared_ptr<UploadHistorySessionAnalyaseResponse> RdsClient::uploadHistorySessionAnalyase(UploadHistorySessionAnalyaseRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/history-session-analyse-upload";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUploadHistorySessionAnalyase());

    std::shared_ptr<UploadHistorySessionAnalyaseResponse> localVarResult = std::make_shared<UploadHistorySessionAnalyaseResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ListApiVersionResponse> RdsClient::listApiVersion(ListApiVersionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListApiVersion());
...
std::shared_ptr<ListApiVersionNewResponse> RdsClient::listApiVersionNew(ListApiVersionNewRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListApiVersionNew());
...
std::shared_ptr<ShowApiVersionResponse> RdsClient::showApiVersion(ShowApiVersionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowApiVersion());
...
std::shared_ptr<ShowMsdtcLocalHostResponse> RdsClient::showMsdtcLocalHost(ShowMsdtcLocalHostRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/msdtc/local-host";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowMsdtcLocalHost());

    std::shared_ptr<ShowMsdtcLocalHostResponse> localVarResult = std::make_shared<ShowMsdtcLocalHostResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<AllowDbUserPrivilegeResponse> RdsClient::allowDbUserPrivilege(AllowDbUserPrivilegeRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForAllowDbUserPrivilege());
...
std::shared_ptr<CreateDatabaseResponse> RdsClient::createDatabase(CreateDatabaseRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateDatabase());
...
std::shared_ptr<CreateDbUserResponse> RdsClient::createDbUser(CreateDbUserRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateDbUser());
...
std::shared_ptr<DeleteDatabaseResponse> RdsClient::deleteDatabase(DeleteDatabaseRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteDatabase());
...
std::shared_ptr<DeleteDbUserResponse> RdsClient::deleteDbUser(DeleteDbUserRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteDbUser());
...
std::shared_ptr<ListAuthorizedDatabasesResponse> RdsClient::listAuthorizedDatabases(ListAuthorizedDatabasesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListAuthorizedDatabases());
...
std::shared_ptr<ListAuthorizedDbUsersResponse> RdsClient::listAuthorizedDbUsers(ListAuthorizedDbUsersRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListAuthorizedDbUsers());
...
std::shared_ptr<ListDatabasesResponse> RdsClient::listDatabases(ListDatabasesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListDatabases());
...
std::shared_ptr<ListDbUsersResponse> RdsClient::listDbUsers(ListDbUsersRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListDbUsers());
...
std::shared_ptr<ResetPwdResponse> RdsClient::resetPwd(ResetPwdRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForResetPwd());
...
std::shared_ptr<RevokeResponse> RdsClient::revoke(RevokeRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRevoke());
...
std::shared_ptr<SetDbUserPwdResponse> RdsClient::setDbUserPwd(SetDbUserPwdRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetDbUserPwd());
...
std::shared_ptr<SetReadOnlySwitchResponse> RdsClient::setReadOnlySwitch(SetReadOnlySwitchRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetReadOnlySwitch());
...
std::shared_ptr<UpdateDatabaseResponse> RdsClient::updateDatabase(UpdateDatabaseRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateDatabase());
...
std::shared_ptr<UpdateDbUserCommentResponse> RdsClient::updateDbUserComment(UpdateDbUserCommentRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateDbUserComment());
...
std::shared_ptr<UpdateHostPrivilegeResponse> RdsClient::updateHostPrivilege(UpdateHostPrivilegeRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/host-privilege";
...
std::shared_ptr<AllowDbPrivilegeResponse> RdsClient::allowDbPrivilege(AllowDbPrivilegeRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForAllowDbPrivilege());
...
std::shared_ptr<ChangeProxyScaleResponse> RdsClient::changeProxyScale(ChangeProxyScaleRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForChangeProxyScale());
...
std::shared_ptr<ChangeTheDelayThresholdResponse> RdsClient::changeTheDelayThreshold(ChangeTheDelayThresholdRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForChangeTheDelayThreshold());
...
std::shared_ptr<CreatePostgresqlDatabaseResponse> RdsClient::createPostgresqlDatabase(CreatePostgresqlDatabaseRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreatePostgresqlDatabase());
...
std::shared_ptr<CreatePostgresqlDatabaseSchemaResponse> RdsClient::createPostgresqlDatabaseSchema(CreatePostgresqlDatabaseSchemaRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreatePostgresqlDatabaseSchema());
...
std::shared_ptr<CreatePostgresqlDbUserResponse> RdsClient::createPostgresqlDbUser(CreatePostgresqlDbUserRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreatePostgresqlDbUser());
...
std::shared_ptr<CreatePostgresqlExtensionResponse> RdsClient::createPostgresqlExtension(CreatePostgresqlExtensionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreatePostgresqlExtension());
...
std::shared_ptr<DeletePostgresqlDatabaseResponse> RdsClient::deletePostgresqlDatabase(DeletePostgresqlDatabaseRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeletePostgresqlDatabase());
...
std::shared_ptr<DeletePostgresqlDbUserResponse> RdsClient::deletePostgresqlDbUser(DeletePostgresqlDbUserRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeletePostgresqlDbUser());
...
std::shared_ptr<DeletePostgresqlExtensionResponse> RdsClient::deletePostgresqlExtension(DeletePostgresqlExtensionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeletePostgresqlExtension());
...
std::shared_ptr<ExecutePrivilegeDatabaseUserRoleResponse> RdsClient::executePrivilegeDatabaseUserRole(ExecutePrivilegeDatabaseUserRoleRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-user-role";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForExecutePrivilegeDatabaseUserRole());

    std::shared_ptr<ExecutePrivilegeDatabaseUserRoleResponse> localVarResult = std::make_shared<ExecutePrivilegeDatabaseUserRoleResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ExecuteRevokeDatabaseUserRoleResponse> RdsClient::executeRevokeDatabaseUserRole(ExecuteRevokeDatabaseUserRoleRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-user-role";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForExecuteRevokeDatabaseUserRole());

    std::shared_ptr<ExecuteRevokeDatabaseUserRoleResponse> localVarResult = std::make_shared<ExecuteRevokeDatabaseUserRoleResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ListDatabaseUserRoleResponse> RdsClient::listDatabaseUserRole(ListDatabaseUserRoleRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/roles";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListDatabaseUserRole());

    std::shared_ptr<ListDatabaseUserRoleResponse> localVarResult = std::make_shared<ListDatabaseUserRoleResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListPostgresqlDatabaseSchemasResponse> RdsClient::listPostgresqlDatabaseSchemas(ListPostgresqlDatabaseSchemasRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPostgresqlDatabaseSchemas());
...
std::shared_ptr<ListPostgresqlDatabasesResponse> RdsClient::listPostgresqlDatabases(ListPostgresqlDatabasesRequest &request)
{
    ...
    if (request.dbIsSet()) {
        localVarQueryParams["db"] = parameterToString(request.getDb());
    }
    if (request.pageIsSet()) {
        localVarQueryParams["page"] = parameterToString(request.getPage());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPostgresqlDatabases());
...
std::shared_ptr<ListPostgresqlDbUserPaginatedResponse> RdsClient::listPostgresqlDbUserPaginated(ListPostgresqlDbUserPaginatedRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPostgresqlDbUserPaginated());
...
std::shared_ptr<ListPostgresqlExtensionResponse> RdsClient::listPostgresqlExtension(ListPostgresqlExtensionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPostgresqlExtension());
...
std::shared_ptr<RevokePostgresqlDbPrivilegeResponse> RdsClient::revokePostgresqlDbPrivilege(RevokePostgresqlDbPrivilegeRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db_privilege";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRevokePostgresqlDbPrivilege());

    std::shared_ptr<RevokePostgresqlDbPrivilegeResponse> localVarResult = std::make_shared<RevokePostgresqlDbPrivilegeResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<SearchQueryScaleComputeFlavorsResponse> RdsClient::searchQueryScaleComputeFlavors(SearchQueryScaleComputeFlavorsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSearchQueryScaleComputeFlavors());
...
std::shared_ptr<SearchQueryScaleFlavorsResponse> RdsClient::searchQueryScaleFlavors(SearchQueryScaleFlavorsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSearchQueryScaleFlavors());
...
std::shared_ptr<SetDatabaseUserPrivilegeResponse> RdsClient::setDatabaseUserPrivilege(SetDatabaseUserPrivilegeRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetDatabaseUserPrivilege());
...
std::shared_ptr<SetPostgresqlDbUserPwdResponse> RdsClient::setPostgresqlDbUserPwd(SetPostgresqlDbUserPwdRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSetPostgresqlDbUserPwd());
...
std::shared_ptr<ShowInformationAboutDatabaseProxyResponse> RdsClient::showInformationAboutDatabaseProxy(ShowInformationAboutDatabaseProxyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowInformationAboutDatabaseProxy());
...
std::shared_ptr<ShowReplayDelayStatusResponse> RdsClient::showReplayDelayStatus(ShowReplayDelayStatusRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replay-delay/show";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowReplayDelayStatus());

    std::shared_ptr<ShowReplayDelayStatusResponse> localVarResult = std::make_shared<ShowReplayDelayStatusResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<StartDatabaseProxyResponse> RdsClient::startDatabaseProxy(StartDatabaseProxyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStartDatabaseProxy());
...
std::shared_ptr<StopDatabaseProxyResponse> RdsClient::stopDatabaseProxy(StopDatabaseProxyRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForStopDatabaseProxy());
...
std::shared_ptr<SwitchLogReplayResponse> RdsClient::switchLogReplay(SwitchLogReplayRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/log-replay/update";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSwitchLogReplay());

    std::shared_ptr<SwitchLogReplayResponse> localVarResult = std::make_shared<SwitchLogReplayResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateDatabaseOwnerResponse> RdsClient::updateDatabaseOwner(UpdateDatabaseOwnerRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/database/owner";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateDatabaseOwner());

    std::shared_ptr<UpdateDatabaseOwnerResponse> localVarResult = std::make_shared<UpdateDatabaseOwnerResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateDbUserPrivilegeResponse> RdsClient::updateDbUserPrivilege(UpdateDbUserPrivilegeRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateDbUserPrivilege());
...
std::shared_ptr<UpdatePostgresqlDatabaseResponse> RdsClient::updatePostgresqlDatabase(UpdatePostgresqlDatabaseRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdatePostgresqlDatabase());
...
std::shared_ptr<UpdatePostgresqlDbUserCommentResponse> RdsClient::updatePostgresqlDbUserComment(UpdatePostgresqlDbUserCommentRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdatePostgresqlDbUserComment());
...
std::shared_ptr<UpdatePostgresqlExtensionResponse> RdsClient::updatePostgresqlExtension(UpdatePostgresqlExtensionRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/extensions";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdatePostgresqlExtension());

    std::shared_ptr<UpdatePostgresqlExtensionResponse> localVarResult = std::make_shared<UpdatePostgresqlExtensionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdatePostgresqlParameterValueResponse> RdsClient::updatePostgresqlParameterValue(UpdatePostgresqlParameterValueRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdatePostgresqlParameterValue());
...
std::shared_ptr<UpdateReadWeightResponse> RdsClient::updateReadWeight(UpdateReadWeightRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateReadWeight());
...
std::shared_ptr<GetInstancesNoIndexTablesResponse> RdsClient::getInstancesNoIndexTables(GetInstancesNoIndexTablesRequest &request)
{
    ...
    if (request.newestIsSet()) {
        localVarQueryParams["newest"] = parameterToString(request.isNewest());
    }
    if (request.tableTypeIsSet()) {
        localVarQueryParams["table_type"] = parameterToString(request.getTableType());
    }
    if (request.offsetIsSet()) {
        localVarQueryParams["offset"] = parameterToString(request.getOffset());
    }
...
std::shared_ptr<RotateAuditLogResponse> RdsClient::rotateAuditLog(RotateAuditLogRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRotateAuditLog());

    std::shared_ptr<RotateAuditLogResponse> localVarResult = std::make_shared<RotateAuditLogResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ShowAutoCesAlarmResponse> RdsClient::showAutoCesAlarm(ShowAutoCesAlarmRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/auto-ces-alarm";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowAutoCesAlarm());

    std::shared_ptr<ShowAutoCesAlarmResponse> localVarResult = std::make_shared<ShowAutoCesAlarmResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowIntelligentKillSessionStatisticResponse> RdsClient::showIntelligentKillSessionStatistic(ShowIntelligentKillSessionStatisticRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/ops/intelligent-kill-session/statistic";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForShowIntelligentKillSessionStatistic());
...
std::shared_ptr<AllowSqlserverDbUserPrivilegeResponse> RdsClient::allowSqlserverDbUserPrivilege(AllowSqlserverDbUserPrivilegeRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForAllowSqlserverDbUserPrivilege());
...
std::shared_ptr<BatchAddMsdtcsResponse> RdsClient::batchAddMsdtcs(BatchAddMsdtcsRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchAddMsdtcs());
...
std::shared_ptr<BatchModifyPublicationResponse> RdsClient::batchModifyPublication(BatchModifyPublicationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchModifyPublication());

    std::shared_ptr<BatchModifyPublicationResponse> localVarResult = std::make_shared<BatchModifyPublicationResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchModifySubscriptionResponse> RdsClient::batchModifySubscription(BatchModifySubscriptionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForBatchModifySubscription());

    std::shared_ptr<BatchModifySubscriptionResponse> localVarResult = std::make_shared<BatchModifySubscriptionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CollectPublicationMonitorResponse> RdsClient::collectPublicationMonitor(CollectPublicationMonitorRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/publications/{publication_id}/monitor";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCollectPublicationMonitor());

    std::shared_ptr<CollectPublicationMonitorResponse> localVarResult = std::make_shared<CollectPublicationMonitorResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<CollectSubscriptionMonitorResponse> RdsClient::collectSubscriptionMonitor(CollectSubscriptionMonitorRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/subscriptions/{subscription_id}/monitor";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCollectSubscriptionMonitor());

    std::shared_ptr<CollectSubscriptionMonitorResponse> localVarResult = std::make_shared<CollectSubscriptionMonitorResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<CreateDistributionResponse> RdsClient::createDistribution(CreateDistributionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateDistribution());

    std::shared_ptr<CreateDistributionResponse> localVarResult = std::make_shared<CreateDistributionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreatePublicationResponse> RdsClient::createPublication(CreatePublicationRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreatePublication());

    std::shared_ptr<CreatePublicationResponse> localVarResult = std::make_shared<CreatePublicationResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreateSqlserverDatabaseResponse> RdsClient::createSqlserverDatabase(CreateSqlserverDatabaseRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForCreateSqlserverDatabase());
...
std::shared_ptr<DeleteDistributionResponse> RdsClient::deleteDistribution(DeleteDistributionRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/distribution";
...
std::shared_ptr<DeleteSqlserverDatabaseResponse> RdsClient::deleteSqlserverDatabase(DeleteSqlserverDatabaseRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteSqlserverDatabase());
...
std::shared_ptr<DeleteSqlserverDatabaseExResponse> RdsClient::deleteSqlserverDatabaseEx(DeleteSqlserverDatabaseExRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteSqlserverDatabaseEx());
...
std::shared_ptr<DeleteSqlserverDbUserResponse> RdsClient::deleteSqlserverDbUser(DeleteSqlserverDbUserRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteSqlserverDbUser());
...
std::shared_ptr<DeleteSubscriptionResponse> RdsClient::deleteSubscription(DeleteSubscriptionRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/subscriptions";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForDeleteSubscription());
...
std::shared_ptr<ListAuthorizedSqlserverDbUsersResponse> RdsClient::listAuthorizedSqlserverDbUsers(ListAuthorizedSqlserverDbUsersRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListAuthorizedSqlserverDbUsers());
...
std::shared_ptr<ListDbAgentJobHistoryStepsResponse> RdsClient::listDbAgentJobHistorySteps(ListDbAgentJobHistoryStepsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-jobs/histories/{history_id}/steps";
    ...
    localVarPathParams["instance_id"] = parameterToString(request.getInstanceId());
    localVarPathParams["history_id"] = parameterToString(request.getHistoryId());
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListDbAgentJobHistorySteps());

    std::shared_ptr<ListDbAgentJobHistoryStepsResponse> localVarResult = std::make_shared<ListDbAgentJobHistoryStepsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListDbAgentJobHistorysResponse> RdsClient::listDbAgentJobHistorys(ListDbAgentJobHistorysRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/histories";
    ...
    if (request.runStatusIsSet()) {
        localVarQueryParams["run_status"] = parameterToString(request.getRunStatus());
    }
    if (request.offsetIsSet()) {
        localVarQueryParams["offset"] = parameterToString(request.getOffset());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListDbAgentJobHistorys());

    std::shared_ptr<ListDbAgentJobHistorysResponse> localVarResult = std::make_shared<ListDbAgentJobHistorysResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListDbAgentJobsResponse> RdsClient::listDbAgentJobs(ListDbAgentJobsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-jobs";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListDbAgentJobs());

    std::shared_ptr<ListDbAgentJobsResponse> localVarResult = std::make_shared<ListDbAgentJobsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListPublications4SubscriptionResponse> RdsClient::listPublications4Subscription(ListPublications4SubscriptionRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/publication-candidates";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListPublications4Subscription());

    std::shared_ptr<ListPublications4SubscriptionResponse> localVarResult = std::make_shared<ListPublications4SubscriptionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ListRemoteDbResponse> RdsClient::listRemoteDb(ListRemoteDbRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/remote-databases";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListRemoteDb());

    std::shared_ptr<ListRemoteDbResponse> localVarResult = std::make_shared<ListRemoteDbResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ListReplicationErrorsResponse> RdsClient::listReplicationErrors(ListReplicationErrorsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/errors";
    ...
    if (request.subscriptionIdIsSet()) {
        localVarQueryParams["subscription_id"] = parameterToString(request.getSubscriptionId());
    }
    if (request.offsetIsSet()) {
        localVarQueryParams["offset"] = parameterToString(request.getOffset());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListReplicationErrors());

    std::shared_ptr<ListReplicationErrorsResponse> localVarResult = std::make_shared<ListReplicationErrorsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListReplicationProfilesResponse> RdsClient::listReplicationProfiles(ListReplicationProfilesRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/profiles";
    ...
    if (request.agentTypeIsSet()) {
        localVarQueryParams["agent_type"] = parameterToString(request.getAgentType());
    }
    if (request.offsetIsSet()) {
        localVarQueryParams["offset"] = parameterToString(request.getOffset());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListReplicationProfiles());

    std::shared_ptr<ListReplicationProfilesResponse> localVarResult = std::make_shared<ListReplicationProfilesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListSqlserverDatabasesResponse> RdsClient::listSqlserverDatabases(ListSqlserverDatabasesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSqlserverDatabases());
...
std::shared_ptr<ListSqlserverDbUsersResponse> RdsClient::listSqlserverDbUsers(ListSqlserverDbUsersRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSqlserverDbUsers());
...
std::shared_ptr<ListSubscriptionsResponse> RdsClient::listSubscriptions(ListSubscriptionsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/subscriptions";
    ...
    if (request.publicationIdIsSet()) {
        localVarQueryParams["publication_id"] = parameterToString(request.getPublicationId());
    }
    if (request.isCloudIsSet()) {
        localVarQueryParams["is_cloud"] = parameterToString(request.isIsCloud());
    }
    if (request.publicationNameIsSet()) {
        localVarQueryParams["publication_name"] = parameterToString(request.getPublicationName());
    }
    if (request.subscriptionDbNameIsSet()) {
        localVarQueryParams["subscription_db_name"] = parameterToString(request.getSubscriptionDbName());
    }
    if (request.offsetIsSet()) {
        localVarQueryParams["offset"] = parameterToString(request.getOffset());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForListSubscriptions());
...
std::shared_ptr<ModifyDbAgentJobResponse> RdsClient::modifyDbAgentJob(ModifyDbAgentJobRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}";
...
std::shared_ptr<RefreshPublicationSnapshotResponse> RdsClient::refreshPublicationSnapshot(RefreshPublicationSnapshotRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/publications/{publication_id}/reinitialize";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRefreshPublicationSnapshot());

    std::shared_ptr<RefreshPublicationSnapshotResponse> localVarResult = std::make_shared<RefreshPublicationSnapshotResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<RefreshSubscriptionResponse> RdsClient::refreshSubscription(RefreshSubscriptionRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/subscriptions/{subscription_id}/reinitialize";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRefreshSubscription());

    std::shared_ptr<RefreshSubscriptionResponse> localVarResult = std::make_shared<RefreshSubscriptionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<RestartDbAgentJobResponse> RdsClient::restartDbAgentJob(RestartDbAgentJobRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/restart";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRestartDbAgentJob());

    std::shared_ptr<RestartDbAgentJobResponse> localVarResult = std::make_shared<RestartDbAgentJobResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<RevokeSqlserverDbUserPrivilegeResponse> RdsClient::revokeSqlserverDbUserPrivilege(RevokeSqlserverDbUserPrivilegeRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForRevokeSqlserverDbUserPrivilege());
...
std::shared_ptr<SetInstancesDbShrinkResponse> RdsClient::setInstancesDbShrink(SetInstancesDbShrinkRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db_shrink";
...
std::shared_ptr<SwitchDbAgentJobResponse> RdsClient::switchDbAgentJob(SwitchDbAgentJobRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/switch";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSwitchDbAgentJob());

    std::shared_ptr<SwitchDbAgentJobResponse> localVarResult = std::make_shared<SwitchDbAgentJobResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<SyncReplicationMetadataResponse> RdsClient::syncReplicationMetadata(SyncReplicationMetadataRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/metadata/sync";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForSyncReplicationMetadata());

    std::shared_ptr<SyncReplicationMetadataResponse> localVarResult = std::make_shared<SyncReplicationMetadataResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<UpdateStatisticsResponse> RdsClient::updateStatistics(UpdateStatisticsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/db-statistics";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForUpdateStatistics());

    std::shared_ptr<UpdateStatisticsResponse> localVarResult = std::make_shared<UpdateStatisticsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ValidateInstanceConnectionResponse> RdsClient::validateInstanceConnection(ValidateInstanceConnectionRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/replication/login-test";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, RdsMeta::genRequestDefForValidateInstanceConnection());

    std::shared_ptr<ValidateInstanceConnectionResponse> localVarResult = std::make_shared<ValidateInstanceConnectionResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
