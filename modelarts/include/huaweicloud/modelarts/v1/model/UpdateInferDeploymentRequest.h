...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_UpdateInferDeploymentRequest_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_UpdateInferDeploymentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  UpdateInferDeploymentRequest
    : public ModelBase
{
public:
    UpdateInferDeploymentRequest();
    virtual ~UpdateInferDeploymentRequest();
    ...
    /////////////////////////////////////////////
    /// UpdateInferDeploymentRequest members
    ...
    GroupConfigUpdateRequest getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const GroupConfigUpdateRequest& value);
...
protected:
    ...
    GroupConfigUpdateRequest body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateInferDeploymentRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateInferDeploymentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_UpdateInferDeploymentRequest_H_
