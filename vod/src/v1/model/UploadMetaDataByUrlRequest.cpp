...
std::string UploadMetaDataByUrlRequest::getAuthorization() const
{
    return authorization_;
}

void UploadMetaDataByUrlRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool UploadMetaDataByUrlRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void UploadMetaDataByUrlRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
