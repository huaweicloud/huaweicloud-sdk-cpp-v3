...
int32_t ChargeInfoOption::getPeriodNum() const
{
    return periodNum_;
}

void ChargeInfoOption::setPeriodNum(int32_t value)
{
    periodNum_ = value;
...
bool ChargeInfoOption::isIsAutoRenew() const
{
    return isAutoRenew_;
}

void ChargeInfoOption::setIsAutoRenew(bool value)
{
    isAutoRenew_ = value;
...
bool ChargeInfoOption::isIsAutoPay() const
{
    return isAutoPay_;
}

void ChargeInfoOption::setIsAutoPay(bool value)
{
    isAutoPay_ = value;
