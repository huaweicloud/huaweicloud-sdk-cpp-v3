...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeLibraryRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeLibraryRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowKnowledgeLibraryRequest
    : public ModelBase
{
public:
    ShowKnowledgeLibraryRequest();
    virtual ~ShowKnowledgeLibraryRequest();
    ...
    /////////////////////////////////////////////
    /// ShowKnowledgeLibraryRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowKnowledgeLibraryRequest& dereference_from_shared_ptr(std::shared_ptr<ShowKnowledgeLibraryRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowKnowledgeLibraryRequest_H_
