...
#ifndef HUAWEICLOUD_SDK_KVS_V1_MODEL_Check_shard_key_kv_H_
#define HUAWEICLOUD_SDK_KVS_V1_MODEL_Check_shard_key_kv_H_
...
/// 
/// </summary>
class HUAWEICLOUD_KVS_V1_EXPORT  Check_shard_key_kv
    : public ModelBase
{
public:
    Check_shard_key_kv();
    virtual ~Check_shard_key_kv();
...
#endif // HUAWEICLOUD_SDK_KVS_V1_MODEL_Check_shard_key_kv_H_
