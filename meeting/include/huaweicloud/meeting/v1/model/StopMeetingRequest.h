...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_StopMeetingRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_StopMeetingRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  StopMeetingRequest
    : public ModelBase
{
public:
    StopMeetingRequest();
    virtual ~StopMeetingRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    StopMeetingRequest& dereference_from_shared_ptr(std::shared_ptr<StopMeetingRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_StopMeetingRequest_H_
