...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchRecordingsRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchRecordingsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SearchRecordingsRequest
    : public ModelBase
{
public:
    SearchRecordingsRequest();
    virtual ~SearchRecordingsRequest();
    ...
    /////////////////////////////////////////////
    /// SearchRecordingsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    SearchRecordingsRequest& dereference_from_shared_ptr(std::shared_ptr<SearchRecordingsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchRecordingsRequest_H_
