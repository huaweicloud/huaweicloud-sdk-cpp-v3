...
bool CreateInstanceResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("instance"))) {
        ...
        {
            OpenGaussInstanceResponse refVal;
...
OpenGaussInstanceResponse CreateInstanceResponse::getInstance() const
{
    return instance_;
}

void CreateInstanceResponse::setInstance(const OpenGaussInstanceResponse& value)
{
    instance_ = value;
    instanceIsSet_ = true;
}
