...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ShowGroupRequest_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ShowGroupRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  ShowGroupRequest
    : public ModelBase
{
public:
    ShowGroupRequest();
    virtual ~ShowGroupRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowGroupRequest& dereference_from_shared_ptr(std::shared_ptr<ShowGroupRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ShowGroupRequest_H_
