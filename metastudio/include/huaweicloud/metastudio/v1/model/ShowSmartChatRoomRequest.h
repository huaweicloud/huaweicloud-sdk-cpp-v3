...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartChatRoomRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartChatRoomRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowSmartChatRoomRequest
    : public ModelBase
{
public:
    ShowSmartChatRoomRequest();
    virtual ~ShowSmartChatRoomRequest();
    ...
    /////////////////////////////////////////////
    /// ShowSmartChatRoomRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowSmartChatRoomRequest& dereference_from_shared_ptr(std::shared_ptr<ShowSmartChatRoomRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowSmartChatRoomRequest_H_
