...
#ifndef HUAWEICLOUD_SDK_OCR_V1_MODEL_MvsInvoiceRequestBody_H_
#define HUAWEICLOUD_SDK_OCR_V1_MODEL_MvsInvoiceRequestBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_OCR_V1_EXPORT  MvsInvoiceRequestBody
    : public ModelBase
{
public:
    MvsInvoiceRequestBody();
    virtual ~MvsInvoiceRequestBody();
...
#endif // HUAWEICLOUD_SDK_OCR_V1_MODEL_MvsInvoiceRequestBody_H_
