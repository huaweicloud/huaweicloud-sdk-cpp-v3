...
#ifndef HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_MetricRequest2_dividend_H_
#define HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_MetricRequest2_dividend_H_
...
/// 指标分子过滤条件
/// </summary>
class HUAWEICLOUD_PROJECTMAN_V4_EXPORT  MetricRequest2_dividend
    : public ModelBase
{
public:
    MetricRequest2_dividend();
    virtual ~MetricRequest2_dividend();
    ...
    /////////////////////////////////////////////
    /// MetricRequest2_dividend members
...
#endif // HUAWEICLOUD_SDK_PROJECTMAN_V4_MODEL_MetricRequest2_dividend_H_
