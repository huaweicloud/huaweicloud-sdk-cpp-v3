...
public:
    ...
    /// - 功能介绍：批量添加或删除凭据标签。
    /// </remarks>
    /// <param name="secretId">凭据ID</param>
    /// <param name="batchCreateOrDeleteTagsRequestBody">action</param>
    ...
    /// </remarks>
    /// <param name="createSecretRequestBody">创建凭据请求消息体。</param>
    ...
    /// </remarks>
    /// <param name="secretId">凭据ID</param>
    /// <param name="createSecretTagRequestBody">创建凭据标签消息请求体</param>
    ...
    /// </remarks>
    /// <param name="secretName">凭据名称。</param>
    /// <param name="createSecretVersionRequestBody">创建凭据请求消息体。</param>
    ...
    /// </remarks>
    /// <param name="secretName">凭据名称。</param>
    /// <param name="deleteSecretForScheduleRequestBody">计划删除凭据请求消息体。</param>
    ...
    /// 删除指定的凭据版本状态。 
    /// </remarks>
    /// <param name="secretName">凭据的资源标识符。</param>
    /// <param name="stageName">凭据版本状态的名称。</param>
    ...
    /// </remarks>
    /// <param name="resourceInstances">定值为resource_instances。</param>
    /// <param name="listResourceInstancesRequestBody">action</param>
    ...
    /// </remarks>
    /// <param name="secretName">凭据名称。</param>
    /// <param name="marker">分页参数，取值为上一页数据的最后一条记录的版本号。 (optional, default to &quot;&quot;)</param>
    /// <param name="limit">每页显示的条目数量。默认值50。 (optional, default to 0)</param>
    ...
    /// 查询当前用户在本项目下创建的所有凭据。
    /// </remarks>
    /// <param name="limit">每页返回的个数。  默认值：50。  (optional, default to &quot;&quot;)</param>
    ...
    /// 查询指定凭据的信息。
    /// </remarks>
    /// <param name="secretName">凭据的名称。</param>
    ...
    /// </remarks>
    /// <param name="secretName">凭据名称。</param>
    /// <param name="versionId">凭据的版本标识符。</param>
    ...
    /// </remarks>
    /// <param name="secretName">凭据名称。</param>
    /// <param name="updateSecretRequestBody">创建凭据请求消息体。</param>
    ...
    /// <param name="secretName">凭据名称。</param>
    /// <param name="stageName">凭据版本状态的名称。</param>
    /// <param name="updateSecretStageRequestBody">创建凭据版本状态请求消息体。</param>
