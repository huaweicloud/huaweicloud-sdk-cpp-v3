...
bool DeleteTagResourceRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("body"))) {
        ...
        if(!fieldValue.is_null())
        {
            DeleteTagResourceReqBody refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
            setBody(refVal);
        }
    }
...
DeleteTagResourceReqBody DeleteTagResourceRequest::getBody() const
{
    return body_;
}

void DeleteTagResourceRequest::setBody(const DeleteTagResourceReqBody& value)
{
    body_ = value;
    bodyIsSet_ = true;
}
