...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListLlmConfigRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListLlmConfigRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListLlmConfigRequest
    : public ModelBase
{
public:
    ListLlmConfigRequest();
    virtual ~ListLlmConfigRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListLlmConfigRequest& dereference_from_shared_ptr(std::shared_ptr<ListLlmConfigRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListLlmConfigRequest_H_
