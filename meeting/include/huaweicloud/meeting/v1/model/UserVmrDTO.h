...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_UserVmrDTO_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_UserVmrDTO_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  UserVmrDTO
    : public ModelBase
{
public:
    UserVmrDTO();
    ...
    int32_t getVmrPkgLength() const;
    bool vmrPkgLengthIsSet() const;
    void unsetvmrPkgLength();
    void setVmrPkgLength(int32_t value);
...
protected:
    ...
    int32_t vmrPkgLength_;
    bool vmrPkgLengthIsSet_;
    int32_t status_;
    bool statusIsSet_;
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_UserVmrDTO_H_
