...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_StartSmartLiveRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_StartSmartLiveRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  StartSmartLiveRequest
    : public ModelBase
{
public:
    StartSmartLiveRequest();
    virtual ~StartSmartLiveRequest();
    ...
    StartSmartLiveReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const StartSmartLiveReq& value);
...
protected:
    ...
    StartSmartLiveReq body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    StartSmartLiveRequest& dereference_from_shared_ptr(std::shared_ptr<StartSmartLiveRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_StartSmartLiveRequest_H_
