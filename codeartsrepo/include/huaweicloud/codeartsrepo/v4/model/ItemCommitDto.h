...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ItemCommitDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ItemCommitDto_H_
...
/// 工作项关联的提交信息
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  ItemCommitDto
    : public ModelBase
{
public:
    ItemCommitDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ItemCommitDto_H_
