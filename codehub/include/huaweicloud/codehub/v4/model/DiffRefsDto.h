...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_DiffRefsDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_DiffRefsDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  DiffRefsDto
    : public ModelBase
{
public:
    DiffRefsDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_DiffRefsDto_H_
