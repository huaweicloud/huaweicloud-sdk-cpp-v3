...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_PipelineLatestRun_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_PipelineLatestRun_H_
...
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  PipelineLatestRun
    : public ModelBase
{
public:
    PipelineLatestRun();
    ...
    std::vector<PipelineLatestRun_stage_status_list>& getStageStatusList();
    bool stageStatusListIsSet() const;
    void unsetstageStatusList();
    void setStageStatusList(const std::vector<PipelineLatestRun_stage_status_list>& value);
    ...
    PipelineLatestRun_build_params getBuildParams() const;
    bool buildParamsIsSet() const;
    void unsetbuildParams();
    void setBuildParams(const PipelineLatestRun_build_params& value);
...
protected:
    ...
    std::vector<PipelineLatestRun_stage_status_list> stageStatusList_;
    ...
    PipelineLatestRun_build_params buildParams_;
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_PipelineLatestRun_H_
