...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteRoleRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteRoleRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteRoleRequest
    : public ModelBase
{
public:
    DeleteRoleRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteRoleRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteRoleRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteRoleRequest_H_
