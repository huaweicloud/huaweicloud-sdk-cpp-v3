...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_PositionDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_PositionDto_H_
...
/// 检视意见位置详情。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  PositionDto
    : public ModelBase
{
public:
    PositionDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_PositionDto_H_
