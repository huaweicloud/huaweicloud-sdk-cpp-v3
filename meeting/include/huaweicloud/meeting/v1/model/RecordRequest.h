...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_RecordRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_RecordRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  RecordRequest
    : public ModelBase
{
public:
    RecordRequest();
    ...
    RestSetRecordReqBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const RestSetRecordReqBody& value);
...
protected:
    ...
    RestSetRecordReqBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    RecordRequest& dereference_from_shared_ptr(std::shared_ptr<RecordRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_RecordRequest_H_
