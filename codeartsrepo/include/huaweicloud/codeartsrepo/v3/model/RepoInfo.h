...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_RepoInfo_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_RepoInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  RepoInfo
    : public ModelBase
{
public:
    RepoInfo();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_RepoInfo_H_
