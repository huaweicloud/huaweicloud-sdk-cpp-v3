...
#ifndef HUAWEICLOUD_SDK_DBSS_V1_MODEL_AuditInstanceBean_H_
#define HUAWEICLOUD_SDK_DBSS_V1_MODEL_AuditInstanceBean_H_
...
/// 审计实例bean
/// </summary>
class HUAWEICLOUD_DBSS_V1_EXPORT  AuditInstanceBean
    : public ModelBase
{
public:
    AuditInstanceBean();
    virtual ~AuditInstanceBean();
...
#endif // HUAWEICLOUD_SDK_DBSS_V1_MODEL_AuditInstanceBean_H_
