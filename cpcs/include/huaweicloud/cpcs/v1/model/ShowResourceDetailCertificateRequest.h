...
#ifndef HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowResourceDetailCertificateRequest_H_
#define HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowResourceDetailCertificateRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CPCS_V1_EXPORT  ShowResourceDetailCertificateRequest
    : public ModelBase
{
public:
    ShowResourceDetailCertificateRequest();
    virtual ~ShowResourceDetailCertificateRequest();
    ...
    /////////////////////////////////////////////
    /// ShowResourceDetailCertificateRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowResourceDetailCertificateRequest& dereference_from_shared_ptr(std::shared_ptr<ShowResourceDetailCertificateRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CPCS_V1_MODEL_ShowResourceDetailCertificateRequest_H_
