...
std::string UnpublishAssetsRequest::getAuthorization() const
{
    return authorization_;
}

void UnpublishAssetsRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool UnpublishAssetsRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void UnpublishAssetsRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
