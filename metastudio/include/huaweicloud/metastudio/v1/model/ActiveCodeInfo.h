...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ActiveCodeInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ActiveCodeInfo_H_
...
/// 激活码基本信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ActiveCodeInfo
    : public ModelBase
{
public:
    ActiveCodeInfo();
    virtual ~ActiveCodeInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ActiveCodeInfo_H_
