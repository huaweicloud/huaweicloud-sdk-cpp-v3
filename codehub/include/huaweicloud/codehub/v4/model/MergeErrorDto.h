...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MergeErrorDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MergeErrorDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  MergeErrorDto
    : public ModelBase
{
public:
    MergeErrorDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_MergeErrorDto_H_
