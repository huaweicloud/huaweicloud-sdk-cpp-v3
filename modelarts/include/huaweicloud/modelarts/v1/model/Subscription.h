...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Subscription_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Subscription_H_
...
/// 
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  Subscription
    : public ModelBase
{
public:
    Subscription();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_Subscription_H_
