...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTtscVocabularyGroupsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTtscVocabularyGroupsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateTtscVocabularyGroupsRequest
    : public ModelBase
{
public:
    CreateTtscVocabularyGroupsRequest();
    virtual ~CreateTtscVocabularyGroupsRequest();
    ...
    /////////////////////////////////////////////
    /// CreateTtscVocabularyGroupsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    CreateTtscVocabularyGroupsRequest& dereference_from_shared_ptr(std::shared_ptr<CreateTtscVocabularyGroupsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateTtscVocabularyGroupsRequest_H_
