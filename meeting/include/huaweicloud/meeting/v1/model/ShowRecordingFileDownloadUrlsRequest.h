...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowRecordingFileDownloadUrlsRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowRecordingFileDownloadUrlsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  ShowRecordingFileDownloadUrlsRequest
    : public ModelBase
{
public:
    ShowRecordingFileDownloadUrlsRequest();
    virtual ~ShowRecordingFileDownloadUrlsRequest();
    ...
    /////////////////////////////////////////////
    /// ShowRecordingFileDownloadUrlsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowRecordingFileDownloadUrlsRequest& dereference_from_shared_ptr(std::shared_ptr<ShowRecordingFileDownloadUrlsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_ShowRecordingFileDownloadUrlsRequest_H_
