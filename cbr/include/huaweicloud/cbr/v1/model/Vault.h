...
#ifndef HUAWEICLOUD_SDK_CBR_V1_MODEL_Vault_H_
#define HUAWEICLOUD_SDK_CBR_V1_MODEL_Vault_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CBR_V1_EXPORT  Vault
    : public ModelBase
{
public:
    Vault();
...
#endif // HUAWEICLOUD_SDK_CBR_V1_MODEL_Vault_H_
