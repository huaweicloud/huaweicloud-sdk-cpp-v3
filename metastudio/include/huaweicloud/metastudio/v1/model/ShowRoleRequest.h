...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowRoleRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowRoleRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowRoleRequest
    : public ModelBase
{
public:
    ShowRoleRequest();
    virtual ~ShowRoleRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowRoleRequest& dereference_from_shared_ptr(std::shared_ptr<ShowRoleRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowRoleRequest_H_
