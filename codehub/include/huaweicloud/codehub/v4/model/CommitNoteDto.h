...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitNoteDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitNoteDto_H_
...
/// 评论详细信息。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  CommitNoteDto
    : public ModelBase
{
public:
    CommitNoteDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommitNoteDto_H_
