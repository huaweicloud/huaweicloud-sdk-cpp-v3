...
bool ListInstanceTagsResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("tags"))) {
        ...
        {
            std::vector<ListInstanceTagsResult> refVal;
...
std::vector<ListInstanceTagsResult>& ListInstanceTagsResponse::getTags()
{
    return tags_;
}

void ListInstanceTagsResponse::setTags(const std::vector<ListInstanceTagsResult>& value)
{
    tags_ = value;
    tagsIsSet_ = true;
}
