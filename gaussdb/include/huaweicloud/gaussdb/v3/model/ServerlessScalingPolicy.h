...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ServerlessScalingPolicy_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ServerlessScalingPolicy_H_
...
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  ServerlessScalingPolicy
    : public ModelBase
{
public:
    ServerlessScalingPolicy();
    virtual ~ServerlessScalingPolicy();
    ...
    /////////////////////////////////////////////
    /// ServerlessScalingPolicy members
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ServerlessScalingPolicy_H_
