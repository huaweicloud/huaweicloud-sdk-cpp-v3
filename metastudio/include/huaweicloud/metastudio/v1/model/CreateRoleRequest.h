...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateRoleRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateRoleRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateRoleRequest
    : public ModelBase
{
public:
    CreateRoleRequest();
    ...
    CreateRoleReq getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const CreateRoleReq& value);
...
protected:
    ...
    RTTR_ENABLE()
public:
    CreateRoleRequest& dereference_from_shared_ptr(std::shared_ptr<CreateRoleRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateRoleRequest_H_
