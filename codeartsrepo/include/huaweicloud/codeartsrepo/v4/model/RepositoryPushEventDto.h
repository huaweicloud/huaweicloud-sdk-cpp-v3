...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryPushEventDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryPushEventDto_H_
...
/// **参数解释：** 推送动态。
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  RepositoryPushEventDto
    : public ModelBase
{
public:
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_RepositoryPushEventDto_H_
