...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ApiVersionResponse_H_
#define HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ApiVersionResponse_H_
...
/// API版本详细信息列表。
/// </summary>
class HUAWEICLOUD_GAUSSDBFORNOSQL_V3_EXPORT  ApiVersionResponse
    : public ModelBase
{
public:
    ApiVersionResponse();
    virtual ~ApiVersionResponse();
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_ApiVersionResponse_H_
