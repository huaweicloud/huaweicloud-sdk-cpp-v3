...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_WelcomeSpeechInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_WelcomeSpeechInfo_H_
...
/// 欢迎词基本信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  WelcomeSpeechInfo
    : public ModelBase
{
public:
    WelcomeSpeechInfo();
    virtual ~WelcomeSpeechInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_WelcomeSpeechInfo_H_
