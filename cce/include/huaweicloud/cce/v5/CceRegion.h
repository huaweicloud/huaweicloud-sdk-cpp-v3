#ifndef HUAWEICLOUD_SDK_CCE_V5_CceRegion_H_
#define HUAWEICLOUD_SDK_CCE_V5_CceRegion_H_
...
class HUAWEICLOUD_CCE_V5_EXPORT CceRegion {
public:
    CceRegion();
    virtual ~CceRegion();
...
#endif // HUAWEICLOUD_SDK_CCE_V5_CceRegion_H_