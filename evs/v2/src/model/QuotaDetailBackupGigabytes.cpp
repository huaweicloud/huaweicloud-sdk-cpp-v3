...
std::string QuotaDetailBackupGigabytes::getAllocated() const
{
    return allocated_;
}

void QuotaDetailBackupGigabytes::setAllocated(const std::string& value)
{
    allocated_ = value;
    allocatedIsSet_ = true;
}

bool QuotaDetailBackupGigabytes::allocatedIsSet() const
{
    return allocatedIsSet_;
}

void QuotaDetailBackupGigabytes::unsetallocated()
{
    allocatedIsSet_ = false;
}
