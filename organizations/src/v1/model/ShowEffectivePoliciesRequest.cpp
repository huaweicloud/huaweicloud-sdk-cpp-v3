...
std::string ShowEffectivePoliciesRequest::getXSecurityToken() const
{
    return xSecurityToken_;
}

void ShowEffectivePoliciesRequest::setXSecurityToken(const std::string& value)
{
    xSecurityToken_ = value;
    xSecurityTokenIsSet_ = true;
}

bool ShowEffectivePoliciesRequest::xSecurityTokenIsSet() const
{
    return xSecurityTokenIsSet_;
}

void ShowEffectivePoliciesRequest::unsetxSecurityToken()
{
    xSecurityTokenIsSet_ = false;
}
