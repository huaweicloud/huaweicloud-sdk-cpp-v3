...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CommitParams_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CommitParams_H_
...
/// **参数解释：** 提交信息参数。
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  CommitParams
    : public ModelBase
{
public:
    CommitParams();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_CommitParams_H_
