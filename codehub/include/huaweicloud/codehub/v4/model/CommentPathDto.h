...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommentPathDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommentPathDto_H_
...
#include <string>
#include <huaweicloud/codehub/v4/model/LineDiscussionDto.h>
#include <vector>
...
/// 单文件下检视意见详情。
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  CommentPathDto
    : public ModelBase
{
public:
    CommentPathDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_CommentPathDto_H_
