...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_MysqlFlavorsInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  MysqlFlavorsInfo
    : public ModelBase
{
public:
    MysqlFlavorsInfo();
    virtual ~MysqlFlavorsInfo();
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_MysqlFlavorsInfo_H_
