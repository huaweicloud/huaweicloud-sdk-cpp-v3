...
#ifndef HUAWEICLOUD_SDK_OCR_V1_MODEL_BankcardRequestBody_H_
#define HUAWEICLOUD_SDK_OCR_V1_MODEL_BankcardRequestBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_OCR_V1_EXPORT  BankcardRequestBody
    : public ModelBase
{
public:
    BankcardRequestBody();
    virtual ~BankcardRequestBody();
...
#endif // HUAWEICLOUD_SDK_OCR_V1_MODEL_BankcardRequestBody_H_
