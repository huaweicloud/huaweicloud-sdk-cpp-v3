...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DocumentInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DocumentInfo_H_
...
/// 文档基本信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DocumentInfo
    : public ModelBase
{
public:
    DocumentInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DocumentInfo_H_
