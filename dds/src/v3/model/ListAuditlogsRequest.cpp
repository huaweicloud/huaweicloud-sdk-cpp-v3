...
std::string ListAuditlogsRequest::getNodeId() const
{
    return nodeId_;
}

void ListAuditlogsRequest::setNodeId(const std::string& value)
{
    nodeId_ = value;
    nodeIdIsSet_ = true;
}

bool ListAuditlogsRequest::nodeIdIsSet() const
{
    return nodeIdIsSet_;
}

void ListAuditlogsRequest::unsetnodeId()
{
    nodeIdIsSet_ = false;
}
