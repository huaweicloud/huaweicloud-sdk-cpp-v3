...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_FrequencyRespBody_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_FrequencyRespBody_H_
...
/// 
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  FrequencyRespBody
    : public ModelBase
{
public:
    FrequencyRespBody();
    virtual ~FrequencyRespBody();
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_FrequencyRespBody_H_
