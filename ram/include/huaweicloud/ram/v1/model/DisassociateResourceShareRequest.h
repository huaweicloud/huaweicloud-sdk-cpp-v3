...
#ifndef HUAWEICLOUD_SDK_RAM_V1_MODEL_DisassociateResourceShareRequest_H_
#define HUAWEICLOUD_SDK_RAM_V1_MODEL_DisassociateResourceShareRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_RAM_V1_EXPORT  DisassociateResourceShareRequest
    : public ModelBase
{
public:
    DisassociateResourceShareRequest();
    virtual ~DisassociateResourceShareRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    DisassociateResourceShareRequest& dereference_from_shared_ptr(std::shared_ptr<DisassociateResourceShareRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_RAM_V1_MODEL_DisassociateResourceShareRequest_H_
