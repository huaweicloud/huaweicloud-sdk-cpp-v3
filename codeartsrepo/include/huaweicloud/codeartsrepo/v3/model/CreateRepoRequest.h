...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CreateRepoRequest_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CreateRepoRequest_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  CreateRepoRequest
    : public ModelBase
{
public:
    CreateRepoRequest();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_CreateRepoRequest_H_
