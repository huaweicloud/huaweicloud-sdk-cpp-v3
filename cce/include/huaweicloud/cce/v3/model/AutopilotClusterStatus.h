...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_AutopilotClusterStatus_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_AutopilotClusterStatus_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  AutopilotClusterStatus
    : public ModelBase
{
public:
    AutopilotClusterStatus();
    virtual ~AutopilotClusterStatus();
    ...
    /////////////////////////////////////////////
    /// AutopilotClusterStatus members
    ...
    std::vector<AutopilotClusterEndpoints>& getEndpoints();
    bool endpointsIsSet() const;
    void unsetendpoints();
    void setEndpoints(const std::vector<AutopilotClusterEndpoints>& value);
...
protected:
    ...
    std::string message_;
    bool messageIsSet_;
    std::vector<AutopilotClusterEndpoints> endpoints_;
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_AutopilotClusterStatus_H_
