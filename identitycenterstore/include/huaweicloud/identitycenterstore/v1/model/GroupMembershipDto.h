...
#ifndef HUAWEICLOUD_SDK_IDENTITYCENTERSTORE_V1_MODEL_GroupMembershipDto_H_
#define HUAWEICLOUD_SDK_IDENTITYCENTERSTORE_V1_MODEL_GroupMembershipDto_H_
...
/// </summary>
class HUAWEICLOUD_IDENTITYCENTERSTORE_V1_EXPORT  GroupMembershipDto
    : public ModelBase
{
public:
    GroupMembershipDto();
    virtual ~GroupMembershipDto();
...
#endif // HUAWEICLOUD_SDK_IDENTITYCENTERSTORE_V1_MODEL_GroupMembershipDto_H_
