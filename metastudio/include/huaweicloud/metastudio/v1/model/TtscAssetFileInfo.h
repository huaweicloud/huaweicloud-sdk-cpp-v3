...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_TtscAssetFileInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_TtscAssetFileInfo_H_
...
/// 文件信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  TtscAssetFileInfo
    : public ModelBase
{
public:
    TtscAssetFileInfo();
    virtual ~TtscAssetFileInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_TtscAssetFileInfo_H_
