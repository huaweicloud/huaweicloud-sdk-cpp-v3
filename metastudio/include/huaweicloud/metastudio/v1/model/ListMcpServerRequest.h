...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListMcpServerRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListMcpServerRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListMcpServerRequest
    : public ModelBase
{
public:
    ListMcpServerRequest();
    virtual ~ListMcpServerRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListMcpServerRequest& dereference_from_shared_ptr(std::shared_ptr<ListMcpServerRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListMcpServerRequest_H_
