...
UpdateSecurityProfileResponse::~UpdateSecurityProfileResponse() = default;

void UpdateSecurityProfileResponse::validate()
{
}

web::json::value UpdateSecurityProfileResponse::toJson() const
{
...
bool UpdateSecurityProfileResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
std::string UpdateSecurityProfileResponse::getProfileId() const
{
    return profileId_;
}

void UpdateSecurityProfileResponse::setProfileId(const std::string& value)
{
    profileId_ = value;
    profileIdIsSet_ = true;
}

bool UpdateSecurityProfileResponse::profileIdIsSet() const
{
    return profileIdIsSet_;
}

void UpdateSecurityProfileResponse::unsetprofileId()
{
    profileIdIsSet_ = false;
}

std::string UpdateSecurityProfileResponse::getSecurityType() const
{
    return securityType_;
}

void UpdateSecurityProfileResponse::setSecurityType(const std::string& value)
{
    securityType_ = value;
    securityTypeIsSet_ = true;
}

bool UpdateSecurityProfileResponse::securityTypeIsSet() const
{
    return securityTypeIsSet_;
}

void UpdateSecurityProfileResponse::unsetsecurityType()
{
    securityTypeIsSet_ = false;
}

std::string UpdateSecurityProfileResponse::getAlarmLevel() const
{
    return alarmLevel_;
}

void UpdateSecurityProfileResponse::setAlarmLevel(const std::string& value)
{
    alarmLevel_ = value;
    alarmLevelIsSet_ = true;
}

bool UpdateSecurityProfileResponse::alarmLevelIsSet() const
{
    return alarmLevelIsSet_;
}

void UpdateSecurityProfileResponse::unsetalarmLevel()
{
    alarmLevelIsSet_ = false;
}

std::string UpdateSecurityProfileResponse::getSecurityLevel() const
{
    return securityLevel_;
}

void UpdateSecurityProfileResponse::setSecurityLevel(const std::string& value)
{
    securityLevel_ = value;
    securityLevelIsSet_ = true;
}

bool UpdateSecurityProfileResponse::securityLevelIsSet() const
{
    return securityLevelIsSet_;
}

void UpdateSecurityProfileResponse::unsetsecurityLevel()
{
    securityLevelIsSet_ = false;
}

bool UpdateSecurityProfileResponse::isEnable() const
{
    return enable_;
}

void UpdateSecurityProfileResponse::setEnable(bool value)
{
    enable_ = value;
    enableIsSet_ = true;
}

bool UpdateSecurityProfileResponse::enableIsSet() const
{
    return enableIsSet_;
}

void UpdateSecurityProfileResponse::unsetenable()
{
    enableIsSet_ = false;
}

std::vector<SecurityProfile>& UpdateSecurityProfileResponse::getProfile()
{
    return profile_;
}

void UpdateSecurityProfileResponse::setProfile(const std::vector<SecurityProfile>& value)
{
    profile_ = value;
    profileIsSet_ = true;
}

bool UpdateSecurityProfileResponse::profileIsSet() const
{
    return profileIsSet_;
}

void UpdateSecurityProfileResponse::unsetprofile()
{
    profileIsSet_ = false;
}

SecurityTarget UpdateSecurityProfileResponse::getProfileTargets() const
{
    return profileTargets_;
}

void UpdateSecurityProfileResponse::setProfileTargets(const SecurityTarget& value)
{
    profileTargets_ = value;
    profileTargetsIsSet_ = true;
}

bool UpdateSecurityProfileResponse::profileTargetsIsSet() const
{
    return profileTargetsIsSet_;
}

void UpdateSecurityProfileResponse::unsetprofileTargets()
{
    profileTargetsIsSet_ = false;
}
