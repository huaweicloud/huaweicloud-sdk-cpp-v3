...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CopyVideoScriptsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CopyVideoScriptsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CopyVideoScriptsRequest
    : public ModelBase
{
public:
    CopyVideoScriptsRequest();
    virtual ~CopyVideoScriptsRequest();
    ...
    /////////////////////////////////////////////
    /// CopyVideoScriptsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    CopyVideoScriptsRequest& dereference_from_shared_ptr(std::shared_ptr<CopyVideoScriptsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CopyVideoScriptsRequest_H_
