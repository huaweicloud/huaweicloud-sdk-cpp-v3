...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigWindowsLogInfo_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigWindowsLogInfo_H_
...
/// 日志接入采集Windows事件日志
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  AccessConfigWindowsLogInfo
    : public ModelBase
{
public:
    AccessConfigWindowsLogInfo();
    virtual ~AccessConfigWindowsLogInfo();
    ...
    /////////////////////////////////////////////
    /// AccessConfigWindowsLogInfo members
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigWindowsLogInfo_H_
