...
#ifndef HUAWEICLOUD_SDK_DDS_V3_MODEL_ListAuditlogsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_DDS_V3_EXPORT  ListAuditlogsRequest
    : public ModelBase
{
public:
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListAuditlogsRequest& dereference_from_shared_ptr(std::shared_ptr<ListAuditlogsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_DDS_V3_MODEL_ListAuditlogsRequest_H_
