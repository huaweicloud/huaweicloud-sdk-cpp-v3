...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_RoleInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_RoleInfo_H_
...
/// 角色信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  RoleInfo
    : public ModelBase
{
public:
    RoleInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_RoleInfo_H_
