...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeIntentRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeIntentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteKnowledgeIntentRequest
    : public ModelBase
{
public:
    DeleteKnowledgeIntentRequest();
    virtual ~DeleteKnowledgeIntentRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteKnowledgeIntentRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteKnowledgeIntentRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteKnowledgeIntentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteKnowledgeIntentRequest_H_
