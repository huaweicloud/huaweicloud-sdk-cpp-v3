...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInteractionRuleGroupsRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInteractionRuleGroupsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ListInteractionRuleGroupsRequest
    : public ModelBase
{
public:
    ListInteractionRuleGroupsRequest();
    virtual ~ListInteractionRuleGroupsRequest();
    ...
    /////////////////////////////////////////////
    /// ListInteractionRuleGroupsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListInteractionRuleGroupsRequest& dereference_from_shared_ptr(std::shared_ptr<ListInteractionRuleGroupsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ListInteractionRuleGroupsRequest_H_
