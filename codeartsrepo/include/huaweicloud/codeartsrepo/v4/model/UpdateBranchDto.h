...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UpdateBranchDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UpdateBranchDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  UpdateBranchDto
    : public ModelBase
{
public:
    UpdateBranchDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UpdateBranchDto_H_
