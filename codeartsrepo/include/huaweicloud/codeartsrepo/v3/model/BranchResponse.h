...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_BranchResponse_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_BranchResponse_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V3_EXPORT  BranchResponse
    : public ModelBase
{
public:
    BranchResponse();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V3_MODEL_BranchResponse_H_
