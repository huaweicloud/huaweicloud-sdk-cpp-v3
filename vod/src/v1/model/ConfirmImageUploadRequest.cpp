...
std::string ConfirmImageUploadRequest::getAuthorization() const
{
    return authorization_;
}

void ConfirmImageUploadRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool ConfirmImageUploadRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void ConfirmImageUploadRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
