...
#ifndef HUAWEICLOUD_SDK_GEIP_V3_MODEL_BatchCreateGlobalEip_H_
#define HUAWEICLOUD_SDK_GEIP_V3_MODEL_BatchCreateGlobalEip_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GEIP_V3_EXPORT  BatchCreateGlobalEip
    : public ModelBase
{
public:
    BatchCreateGlobalEip();
    virtual ~BatchCreateGlobalEip();
...
#endif // HUAWEICLOUD_SDK_GEIP_V3_MODEL_BatchCreateGlobalEip_H_
