...
std::vector<SubTemplateResBody>& CreateNotificationTemplateResponse::getTemplates()
{
    return templates_;
}

void CreateNotificationTemplateResponse::setTemplates(const std::vector<SubTemplateResBody>& value)
{
    templates_ = value;
