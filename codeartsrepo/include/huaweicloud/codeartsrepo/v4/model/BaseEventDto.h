...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BaseEventDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BaseEventDto_H_
...
/// **参数解释：** 动态。
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  BaseEventDto
    : public ModelBase
{
public:
    BaseEventDto();
    virtual ~BaseEventDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_BaseEventDto_H_
