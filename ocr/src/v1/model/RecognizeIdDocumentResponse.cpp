...
std::string RecognizeIdDocumentResponse::getXRequestId() const
{
    return xRequestId_;
}

void RecognizeIdDocumentResponse::setXRequestId(const std::string& value)
{
    xRequestId_ = value;
    xRequestIdIsSet_ = true;
}

bool RecognizeIdDocumentResponse::xRequestIdIsSet() const
{
    return xRequestIdIsSet_;
}

void RecognizeIdDocumentResponse::unsetxRequestId()
{
    xRequestIdIsSet_ = false;
}
