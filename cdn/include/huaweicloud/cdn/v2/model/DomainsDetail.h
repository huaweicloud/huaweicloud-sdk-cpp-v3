...
#ifndef HUAWEICLOUD_SDK_CDN_V2_MODEL_DomainsDetail_H_
#define HUAWEICLOUD_SDK_CDN_V2_MODEL_DomainsDetail_H_
...
/// 域名信息。
/// </summary>
class HUAWEICLOUD_CDN_V2_EXPORT  DomainsDetail
    : public ModelBase
{
public:
    DomainsDetail();
    virtual ~DomainsDetail();
...
#endif // HUAWEICLOUD_SDK_CDN_V2_MODEL_DomainsDetail_H_
