...
#ifndef HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_InferModelResponse_H_
#define HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_InferModelResponse_H_
...
/// </summary>
class HUAWEICLOUD_MODELARTS_V1_EXPORT  InferModelResponse
    : public ModelBase
{
public:
    InferModelResponse();
    virtual ~InferModelResponse();
...
#endif // HUAWEICLOUD_SDK_MODELARTS_V1_MODEL_InferModelResponse_H_
