...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateProductRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateProductRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateProductRequest
    : public ModelBase
{
public:
    ...
    CreateProductRequestBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const CreateProductRequestBody& value);
...
protected:
    ...
    CreateProductRequestBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    CreateProductRequest& dereference_from_shared_ptr(std::shared_ptr<CreateProductRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateProductRequest_H_
