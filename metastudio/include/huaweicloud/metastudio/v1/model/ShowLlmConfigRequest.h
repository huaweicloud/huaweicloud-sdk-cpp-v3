...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowLlmConfigRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowLlmConfigRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowLlmConfigRequest
    : public ModelBase
{
public:
    ShowLlmConfigRequest();
    virtual ~ShowLlmConfigRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowLlmConfigRequest& dereference_from_shared_ptr(std::shared_ptr<ShowLlmConfigRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowLlmConfigRequest_H_
