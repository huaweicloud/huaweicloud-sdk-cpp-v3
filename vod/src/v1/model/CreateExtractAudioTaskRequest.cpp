...
std::string CreateExtractAudioTaskRequest::getAuthorization() const
{
    return authorization_;
}

void CreateExtractAudioTaskRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool CreateExtractAudioTaskRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void CreateExtractAudioTaskRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
