...
#ifndef HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailVolumes_H_
#define HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailVolumes_H_
...
/// </summary>
class HUAWEICLOUD_EVS_EXPORT  QuotaDetailVolumes
    : public ModelBase
{
public:
    QuotaDetailVolumes();
    virtual ~QuotaDetailVolumes();
...
#endif // HUAWEICLOUD_SDK_EVS_V2_MODEL_QuotaDetailVolumes_H_
