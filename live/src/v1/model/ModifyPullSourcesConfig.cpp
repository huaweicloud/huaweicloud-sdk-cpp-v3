...
int32_t ModifyPullSourcesConfig::getSourcePort() const
{
    return sourcePort_;
}

void ModifyPullSourcesConfig::setSourcePort(int32_t value)
{
    sourcePort_ = value;
    sourcePortIsSet_ = true;
}

bool ModifyPullSourcesConfig::sourcePortIsSet() const
{
    return sourcePortIsSet_;
}

void ModifyPullSourcesConfig::unsetsourcePort()
{
    sourcePortIsSet_ = false;
}
