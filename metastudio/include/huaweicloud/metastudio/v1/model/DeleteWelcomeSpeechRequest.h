...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteWelcomeSpeechRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteWelcomeSpeechRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DeleteWelcomeSpeechRequest
    : public ModelBase
{
public:
    DeleteWelcomeSpeechRequest();
    virtual ~DeleteWelcomeSpeechRequest();
    ...
    /////////////////////////////////////////////
    /// DeleteWelcomeSpeechRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    DeleteWelcomeSpeechRequest& dereference_from_shared_ptr(std::shared_ptr<DeleteWelcomeSpeechRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DeleteWelcomeSpeechRequest_H_
