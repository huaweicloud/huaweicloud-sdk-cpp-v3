...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenRoomSettingVO_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenRoomSettingVO_H_
...
/// 网络研讨会高级设置。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  OpenRoomSettingVO
    : public ModelBase
{
public:
    OpenRoomSettingVO();
    virtual ~OpenRoomSettingVO();
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenRoomSettingVO_H_
