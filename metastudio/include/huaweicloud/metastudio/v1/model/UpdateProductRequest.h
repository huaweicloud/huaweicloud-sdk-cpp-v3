...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateProductRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateProductRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  UpdateProductRequest
    : public ModelBase
{
public:
    ...
    UpdateProductRequestBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const UpdateProductRequestBody& value);
...
protected:
    ...
    UpdateProductRequestBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    UpdateProductRequest& dereference_from_shared_ptr(std::shared_ptr<UpdateProductRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_UpdateProductRequest_H_
