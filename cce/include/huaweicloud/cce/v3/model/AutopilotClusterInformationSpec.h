...
#ifndef HUAWEICLOUD_SDK_CCE_V3_MODEL_AutopilotClusterInformationSpec_H_
#define HUAWEICLOUD_SDK_CCE_V3_MODEL_AutopilotClusterInformationSpec_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CCE_V3_EXPORT  AutopilotClusterInformationSpec
    : public ModelBase
{
public:
    AutopilotClusterInformationSpec();
    virtual ~AutopilotClusterInformationSpec();
    ...
    /////////////////////////////////////////////
    /// AutopilotClusterInformationSpec members
    ...
    AutopilotEniNetworkUpdate getEniNetwork() const;
    bool eniNetworkIsSet() const;
    void unseteniNetwork();
    void setEniNetwork(const AutopilotEniNetworkUpdate& value);
...
protected:
    ...
    AutopilotEniNetworkUpdate eniNetwork_;
...
#endif // HUAWEICLOUD_SDK_CCE_V3_MODEL_AutopilotClusterInformationSpec_H_
