...
#ifndef HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigBaseLogInfo_H_
#define HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigBaseLogInfo_H_
...
/// 日志接入基础日志信息。
/// </summary>
class HUAWEICLOUD_LTS_V2_EXPORT  AccessConfigBaseLogInfo
    : public ModelBase
{
public:
    AccessConfigBaseLogInfo();
    virtual ~AccessConfigBaseLogInfo();
    ...
    /////////////////////////////////////////////
    /// AccessConfigBaseLogInfo members
...
#endif // HUAWEICLOUD_SDK_LTS_V2_MODEL_AccessConfigBaseLogInfo_H_
