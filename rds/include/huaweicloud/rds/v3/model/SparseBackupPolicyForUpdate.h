...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_SparseBackupPolicyForUpdate_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_SparseBackupPolicyForUpdate_H_
...
/// 
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  SparseBackupPolicyForUpdate
    : public ModelBase
{
public:
    SparseBackupPolicyForUpdate();
    virtual ~SparseBackupPolicyForUpdate();
    ...
    /////////////////////////////////////////////
    /// SparseBackupPolicyForUpdate members
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_SparseBackupPolicyForUpdate_H_
