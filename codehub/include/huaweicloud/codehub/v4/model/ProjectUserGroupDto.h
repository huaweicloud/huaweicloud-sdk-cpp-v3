...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ProjectUserGroupDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ProjectUserGroupDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  ProjectUserGroupDto
    : public ModelBase
{
public:
    ProjectUserGroupDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_ProjectUserGroupDto_H_
