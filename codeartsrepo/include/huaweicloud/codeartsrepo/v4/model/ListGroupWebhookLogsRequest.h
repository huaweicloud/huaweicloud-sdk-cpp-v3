...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ListGroupWebhookLogsRequest_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ListGroupWebhookLogsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  ListGroupWebhookLogsRequest
    : public ModelBase
{
public:
    ListGroupWebhookLogsRequest();
    virtual ~ListGroupWebhookLogsRequest();
    ...
    /////////////////////////////////////////////
    /// ListGroupWebhookLogsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListGroupWebhookLogsRequest& dereference_from_shared_ptr(std::shared_ptr<ListGroupWebhookLogsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ListGroupWebhookLogsRequest_H_
