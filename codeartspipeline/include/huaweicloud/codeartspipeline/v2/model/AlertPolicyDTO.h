...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_AlertPolicyDTO_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_AlertPolicyDTO_H_
...
/// 告警策略DTO
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  AlertPolicyDTO
    : public ModelBase
{
public:
    AlertPolicyDTO();
    virtual ~AlertPolicyDTO();
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_AlertPolicyDTO_H_
