...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenEditConfReq_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenEditConfReq_H_
...
/// 编辑网路研讨会议。
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  OpenEditConfReq
    : public ModelBase
{
public:
    OpenEditConfReq();
    virtual ~OpenEditConfReq();
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_OpenEditConfReq_H_
