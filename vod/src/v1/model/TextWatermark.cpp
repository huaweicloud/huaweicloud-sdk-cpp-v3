...
float TextWatermark::getRandomTimeMin() const
{
    return randomTimeMin_;
}

void TextWatermark::setRandomTimeMin(float value)
{
...
float TextWatermark::getRandomTimeMax() const
{
    return randomTimeMax_;
}

void TextWatermark::setRandomTimeMax(float value)
{
