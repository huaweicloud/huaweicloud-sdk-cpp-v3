...
std::shared_ptr<ModifyGroupAndStreamResponse> DrsClient::modifyGroupAndStream(ModifyGroupAndStreamRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/jobs/{job_id}/lts-log-switch";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, DrsMeta::genRequestDefForModifyGroupAndStream());

    std::shared_ptr<ModifyGroupAndStreamResponse> localVarResult = std::make_shared<ModifyGroupAndStreamResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<QueryTuningParamsResponse> DrsClient::queryTuningParams(QueryTuningParamsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/job/{job_id}/tuning-params/query-params";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, DrsMeta::genRequestDefForQueryTuningParams());

    std::shared_ptr<QueryTuningParamsResponse> localVarResult = std::make_shared<QueryTuningParamsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<SelectGroupAndStreamResponse> DrsClient::selectGroupAndStream(SelectGroupAndStreamRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/jobs/{job_id}/lts-log-switch";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, DrsMeta::genRequestDefForSelectGroupAndStream());

    std::shared_ptr<SelectGroupAndStreamResponse> localVarResult = std::make_shared<SelectGroupAndStreamResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
