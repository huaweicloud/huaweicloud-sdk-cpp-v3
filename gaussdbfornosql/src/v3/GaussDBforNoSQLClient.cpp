...
std::shared_ptr<ApplyConfigurationToInstancesResponse> GaussDBforNoSQLClient::applyConfigurationToInstances(ApplyConfigurationToInstancesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForApplyConfigurationToInstances());

    std::shared_ptr<ApplyConfigurationToInstancesResponse> localVarResult = std::make_shared<ApplyConfigurationToInstancesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<BatchDeleteManualBackupResponse> GaussDBforNoSQLClient::batchDeleteManualBackup(BatchDeleteManualBackupRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForBatchDeleteManualBackup());
...
std::shared_ptr<BatchUpgradeDatabaseVersionResponse> GaussDBforNoSQLClient::batchUpgradeDatabaseVersion(BatchUpgradeDatabaseVersionRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForBatchUpgradeDatabaseVersion());
...
std::shared_ptr<CancelInstanceScheduleWindowResponse> GaussDBforNoSQLClient::cancelInstanceScheduleWindow(CancelInstanceScheduleWindowRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForCancelInstanceScheduleWindow());

    std::shared_ptr<CancelInstanceScheduleWindowResponse> localVarResult = std::make_shared<CancelInstanceScheduleWindowResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ClearInstanceSessionsResponse> GaussDBforNoSQLClient::clearInstanceSessions(ClearInstanceSessionsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/sessions";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForClearInstanceSessions());

    std::shared_ptr<ClearInstanceSessionsResponse> localVarResult = std::make_shared<ClearInstanceSessionsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<CreateDbCacheMappingResponse> GaussDBforNoSQLClient::createDbCacheMapping(CreateDbCacheMappingRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/dbcache/mapping";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForCreateDbCacheMapping());

    std::shared_ptr<CreateDbCacheMappingResponse> localVarResult = std::make_shared<CreateDbCacheMappingResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreateDbCacheRuleResponse> GaussDBforNoSQLClient::createDbCacheRule(CreateDbCacheRuleRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/dbcache/rule";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForCreateDbCacheRule());

    std::shared_ptr<CreateDbCacheRuleResponse> localVarResult = std::make_shared<CreateDbCacheRuleResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<CreateGeminiDbDualActiveResponse> GaussDBforNoSQLClient::createGeminiDbDualActive(CreateGeminiDbDualActiveRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/dual-active-relationship";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForCreateGeminiDbDualActive());

    std::shared_ptr<CreateGeminiDbDualActiveResponse> localVarResult = std::make_shared<CreateGeminiDbDualActiveResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<DeleteDbCacheMappingResponse> GaussDBforNoSQLClient::deleteDbCacheMapping(DeleteDbCacheMappingRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/dbcache/mapping";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForDeleteDbCacheMapping());

    std::shared_ptr<DeleteDbCacheMappingResponse> localVarResult = std::make_shared<DeleteDbCacheMappingResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<DeleteDbCacheRuleResponse> GaussDBforNoSQLClient::deleteDbCacheRule(DeleteDbCacheRuleRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/dbcache/rule";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForDeleteDbCacheRule());

    std::shared_ptr<DeleteDbCacheRuleResponse> localVarResult = std::make_shared<DeleteDbCacheRuleResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<DeleteGeminiDbDualActiveResponse> GaussDBforNoSQLClient::deleteGeminiDbDualActive(DeleteGeminiDbDualActiveRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/dual-active-relationship";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForDeleteGeminiDbDualActive());

    std::shared_ptr<DeleteGeminiDbDualActiveResponse> localVarResult = std::make_shared<DeleteGeminiDbDualActiveResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<DeleteRedisDisabledCommandsResponse> GaussDBforNoSQLClient::deleteRedisDisabledCommands(DeleteRedisDisabledCommandsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/redis/instances/{instance_id}/disabled-commands";
    ...
    std::unique_ptr<HttpResponse> res = callApi("DELETE", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForDeleteRedisDisabledCommands());

    std::shared_ptr<DeleteRedisDisabledCommandsResponse> localVarResult = std::make_shared<DeleteRedisDisabledCommandsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ListDbCacheMappingsResponse> GaussDBforNoSQLClient::listDbCacheMappings(ListDbCacheMappingsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/dbcache/mappings";
    ...
    if (request.sourceInstanceNameIsSet()) {
        localVarQueryParams["source_instance_name"] = parameterToString(request.getSourceInstanceName());
    }
    if (request.targetInstanceIdIsSet()) {
        localVarQueryParams["target_instance_id"] = parameterToString(request.getTargetInstanceId());
    }
    if (request.targetInstanceNameIsSet()) {
        localVarQueryParams["target_instance_name"] = parameterToString(request.getTargetInstanceName());
    }
    if (request.offsetIsSet()) {
        localVarQueryParams["offset"] = parameterToString(request.getOffset());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForListDbCacheMappings());

    std::shared_ptr<ListDbCacheMappingsResponse> localVarResult = std::make_shared<ListDbCacheMappingsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListDbCacheRulesResponse> GaussDBforNoSQLClient::listDbCacheRules(ListDbCacheRulesRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/dbcache/rules";
    ...
    if (request.dbcacheMappingIdIsSet()) {
        localVarQueryParams["dbcache_mapping_id"] = parameterToString(request.getDbcacheMappingId());
    }
    ...
    if (request.sourceDbSchemaIsSet()) {
        localVarQueryParams["source_db_schema"] = parameterToString(request.getSourceDbSchema());
    }
    if (request.sourceDbTableIsSet()) {
        localVarQueryParams["source_db_table"] = parameterToString(request.getSourceDbTable());
    }
    if (request.offsetIsSet()) {
        localVarQueryParams["offset"] = parameterToString(request.getOffset());
    }
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForListDbCacheRules());

    std::shared_ptr<ListDbCacheRulesResponse> localVarResult = std::make_shared<ListDbCacheRulesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListInstanceMaintenanceWindowResponse> GaussDBforNoSQLClient::listInstanceMaintenanceWindow(ListInstanceMaintenanceWindowRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForListInstanceMaintenanceWindow());

    std::shared_ptr<ListInstanceMaintenanceWindowResponse> localVarResult = std::make_shared<ListInstanceMaintenanceWindowResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListInstanceSessionsResponse> GaussDBforNoSQLClient::listInstanceSessions(ListInstanceSessionsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/sessions";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForListInstanceSessions());

    std::shared_ptr<ListInstanceSessionsResponse> localVarResult = std::make_shared<ListInstanceSessionsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListNosqlTaskListResponse> GaussDBforNoSQLClient::listNosqlTaskList(ListNosqlTaskListRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForListNosqlTaskList());

    std::shared_ptr<ListNosqlTaskListResponse> localVarResult = std::make_shared<ListNosqlTaskListResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ListRedisPitrRestoreTimeResponse> GaussDBforNoSQLClient::listRedisPitrRestoreTime(ListRedisPitrRestoreTimeRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/redis/instances/{instance_id}/pitr/restorable-time-periods";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForListRedisPitrRestoreTime());

    std::shared_ptr<ListRedisPitrRestoreTimeResponse> localVarResult = std::make_shared<ListRedisPitrRestoreTimeResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ModifyInstanceMaintenanceWindowResponse> GaussDBforNoSQLClient::modifyInstanceMaintenanceWindow(ModifyInstanceMaintenanceWindowRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForModifyInstanceMaintenanceWindow());

    std::shared_ptr<ModifyInstanceMaintenanceWindowResponse> localVarResult = std::make_shared<ModifyInstanceMaintenanceWindowResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<RestoreRedisPitrResponse> GaussDBforNoSQLClient::restoreRedisPitr(RestoreRedisPitrRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForRestoreRedisPitr());

    std::shared_ptr<RestoreRedisPitrResponse> localVarResult = std::make_shared<RestoreRedisPitrResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<SaveRedisDisabledCommandsResponse> GaussDBforNoSQLClient::saveRedisDisabledCommands(SaveRedisDisabledCommandsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/redis/instances/{instance_id}/disabled-commands";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForSaveRedisDisabledCommands());

    std::shared_ptr<SaveRedisDisabledCommandsResponse> localVarResult = std::make_shared<SaveRedisDisabledCommandsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<SetDisasterRecoverySettingsResponse> GaussDBforNoSQLClient::setDisasterRecoverySettings(SetDisasterRecoverySettingsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/disaster-recovery/settings";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForSetDisasterRecoverySettings());

    std::shared_ptr<SetDisasterRecoverySettingsResponse> localVarResult = std::make_shared<SetDisasterRecoverySettingsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<SetInstanceDataDumpResponse> GaussDBforNoSQLClient::setInstanceDataDump(SetInstanceDataDumpRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/data-dump";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForSetInstanceDataDump());

    std::shared_ptr<SetInstanceDataDumpResponse> localVarResult = std::make_shared<SetInstanceDataDumpResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<SetRedisPitrPolicyResponse> GaussDBforNoSQLClient::setRedisPitrPolicy(SetRedisPitrPolicyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/redis/instances/{instance_id}/pitr/policy";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForSetRedisPitrPolicy());

    std::shared_ptr<SetRedisPitrPolicyResponse> localVarResult = std::make_shared<SetRedisPitrPolicyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ShowBackupPoliciesResponse> GaussDBforNoSQLClient::showBackupPolicies(ShowBackupPoliciesRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForShowBackupPolicies());

    std::shared_ptr<ShowBackupPoliciesResponse> localVarResult = std::make_shared<ShowBackupPoliciesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowDisasterRecoverySettingsResponse> GaussDBforNoSQLClient::showDisasterRecoverySettings(ShowDisasterRecoverySettingsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/disaster-recovery/settings";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForShowDisasterRecoverySettings());

    std::shared_ptr<ShowDisasterRecoverySettingsResponse> localVarResult = std::make_shared<ShowDisasterRecoverySettingsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowPasswordlessConfigResponse> GaussDBforNoSQLClient::showPasswordlessConfig(ShowPasswordlessConfigRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/passwordless-config";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForShowPasswordlessConfig());

    std::shared_ptr<ShowPasswordlessConfigResponse> localVarResult = std::make_shared<ShowPasswordlessConfigResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowRedisBigKeysResponse> GaussDBforNoSQLClient::showRedisBigKeys(ShowRedisBigKeysRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/big-keys";
    ...
    std::unique_ptr<HttpResponse> res = callApi("POST", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForShowRedisBigKeys());

    std::shared_ptr<ShowRedisBigKeysResponse> localVarResult = std::make_shared<ShowRedisBigKeysResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<ShowRedisDisabledCommandsResponse> GaussDBforNoSQLClient::showRedisDisabledCommands(ShowRedisDisabledCommandsRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/redis/instances/{instance_id}/disabled-commands";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForShowRedisDisabledCommands());

    std::shared_ptr<ShowRedisDisabledCommandsResponse> localVarResult = std::make_shared<ShowRedisDisabledCommandsResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowRedisHotKeysResponse> GaussDBforNoSQLClient::showRedisHotKeys(ShowRedisHotKeysRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/hot-keys";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForShowRedisHotKeys());

    std::shared_ptr<ShowRedisHotKeysResponse> localVarResult = std::make_shared<ShowRedisHotKeysResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowRedisPitrInfoResponse> GaussDBforNoSQLClient::showRedisPitrInfo(ShowRedisPitrInfoRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/redis/instances/{instance_id}/pitr";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForShowRedisPitrInfo());

    std::shared_ptr<ShowRedisPitrInfoResponse> localVarResult = std::make_shared<ShowRedisPitrInfoResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowRedisPitrPolicyResponse> GaussDBforNoSQLClient::showRedisPitrPolicy(ShowRedisPitrPolicyRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/redis/instances/{instance_id}/pitr/policy";
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForShowRedisPitrPolicy());

    std::shared_ptr<ShowRedisPitrPolicyResponse> localVarResult = std::make_shared<ShowRedisPitrPolicyResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<ShowSecondLevelMonitoringStatusResponse> GaussDBforNoSQLClient::showSecondLevelMonitoringStatus(ShowSecondLevelMonitoringStatusRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("GET", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForShowSecondLevelMonitoringStatus());
...
std::shared_ptr<StopBackupResponse> GaussDBforNoSQLClient::stopBackup(StopBackupRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/backups/{backup_id}";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForStopBackup());
...
std::shared_ptr<SwitchOverResponse> GaussDBforNoSQLClient::switchOver(SwitchOverRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instance/{instance_id}/switchover";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForSwitchOver());

    std::shared_ptr<SwitchOverResponse> localVarResult = std::make_shared<SwitchOverResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
...
std::shared_ptr<SwitchSecondLevelMonitoringResponse> GaussDBforNoSQLClient::switchSecondLevelMonitoring(SwitchSecondLevelMonitoringRequest &request)
{
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForSwitchSecondLevelMonitoring());
...
std::shared_ptr<UpdateDatabasesResponse> GaussDBforNoSQLClient::updateDatabases(UpdateDatabasesRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/databases";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForUpdateDatabases());

    std::shared_ptr<UpdateDatabasesResponse> localVarResult = std::make_shared<UpdateDatabasesResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateDbCacheRuleResponse> GaussDBforNoSQLClient::updateDbCacheRule(UpdateDbCacheRuleRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/dbcache/rule";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForUpdateDbCacheRule());

    std::shared_ptr<UpdateDbCacheRuleResponse> localVarResult = std::make_shared<UpdateDbCacheRuleResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
...
std::shared_ptr<UpdateInstanceConfigurationsResponse> GaussDBforNoSQLClient::updateInstanceConfigurations(UpdateInstanceConfigurationsRequest &request)
{
...
std::shared_ptr<UpdatePasswordlessConfigResponse> GaussDBforNoSQLClient::updatePasswordlessConfig(UpdatePasswordlessConfigRequest &request)
{
    std::string localVarPath = "/v3/{project_id}/instances/{instance_id}/passwordless-config";
    ...
    std::unique_ptr<HttpResponse> res = callApi("PUT", localVarPath, localVarPathParams, localVarQueryParams,
        localVarHeaderParams, localVarHttpBody, GaussDBforNoSQLMeta::genRequestDefForUpdatePasswordlessConfig());

    std::shared_ptr<UpdatePasswordlessConfigResponse> localVarResult = std::make_shared<UpdatePasswordlessConfigResponse>();
    localVarResult->setStatusCode(res->getStatusCode());
    localVarResult->setHeaderParams(res->getHeaderParams());
    localVarResult->setHttpBody(res->getHttpBody());
    if (!res->getHttpBody().empty()) {
