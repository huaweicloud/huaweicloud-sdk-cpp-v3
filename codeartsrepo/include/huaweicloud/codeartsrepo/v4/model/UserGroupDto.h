...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UserGroupDto_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UserGroupDto_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  UserGroupDto
    : public ModelBase
{
public:
    UserGroupDto();
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_UserGroupDto_H_
