...
#ifndef HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_CasePassVo_H_
#define HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_CasePassVo_H_
...
/// 需求关联用例通过情况
/// </summary>
class HUAWEICLOUD_CLOUDTEST_V1_EXPORT  CasePassVo
    : public ModelBase
{
public:
    CasePassVo();
...
#endif // HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_CasePassVo_H_
