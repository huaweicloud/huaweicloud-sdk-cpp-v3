...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_MongodbSlowLogDetail_H_
#define HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_MongodbSlowLogDetail_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GAUSSDBFORNOSQL_V3_EXPORT  MongodbSlowLogDetail
    : public ModelBase
{
public:
    MongodbSlowLogDetail();
    virtual ~MongodbSlowLogDetail();
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFORNOSQL_V3_MODEL_MongodbSlowLogDetail_H_
