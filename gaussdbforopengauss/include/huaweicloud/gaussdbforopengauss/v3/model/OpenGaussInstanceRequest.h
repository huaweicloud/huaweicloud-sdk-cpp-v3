...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_OpenGaussInstanceRequest_H_
...
/// 实例信息
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  OpenGaussInstanceRequest
    : public ModelBase
{
public:
    OpenGaussInstanceRequest();
    virtual ~OpenGaussInstanceRequest();
    ...
    /////////////////////////////////////////////
    /// OpenGaussInstanceRequest members
    ...
    OpenGaussDatastore getDatastore() const;
    bool datastoreIsSet() const;
    void unsetdatastore();
    void setDatastore(const OpenGaussDatastore& value);

    /// <summary>
    /// 
    /// </summary>

    OpenGaussHa getHa() const;
    bool haIsSet() const;
    void unsetha();
    void setHa(const OpenGaussHa& value);
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_OpenGaussInstanceRequest_H_
