...
bool ListProjectTagsResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("tags"))) {
        ...
        {
            std::vector<QueryProjectTagItem> refVal;
...
std::vector<QueryProjectTagItem>& ListProjectTagsResponse::getTags()
{
    return tags_;
}

void ListProjectTagsResponse::setTags(const std::vector<QueryProjectTagItem>& value)
{
    tags_ = value;
    tagsIsSet_ = true;
}
