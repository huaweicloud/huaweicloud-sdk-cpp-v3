...
#ifndef HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_AfterHbaConfOption_H_
#define HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_AfterHbaConfOption_H_
...
/// </summary>
class HUAWEICLOUD_GAUSSDBFOROPENGAUSS_V3_EXPORT  AfterHbaConfOption
    : public ModelBase
{
public:
    AfterHbaConfOption();
    virtual ~AfterHbaConfOption();
...
#endif // HUAWEICLOUD_SDK_GAUSSDBFOROPENGAUSS_V3_MODEL_AfterHbaConfOption_H_
