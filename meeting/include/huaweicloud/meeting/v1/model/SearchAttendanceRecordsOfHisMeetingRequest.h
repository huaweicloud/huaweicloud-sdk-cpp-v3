...
#ifndef HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchAttendanceRecordsOfHisMeetingRequest_H_
#define HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchAttendanceRecordsOfHisMeetingRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_MEETING_V1_EXPORT  SearchAttendanceRecordsOfHisMeetingRequest
    : public ModelBase
{
public:
    SearchAttendanceRecordsOfHisMeetingRequest();
    virtual ~SearchAttendanceRecordsOfHisMeetingRequest();
    ...
    /////////////////////////////////////////////
    /// SearchAttendanceRecordsOfHisMeetingRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    SearchAttendanceRecordsOfHisMeetingRequest& dereference_from_shared_ptr(std::shared_ptr<SearchAttendanceRecordsOfHisMeetingRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_MEETING_V1_MODEL_SearchAttendanceRecordsOfHisMeetingRequest_H_
