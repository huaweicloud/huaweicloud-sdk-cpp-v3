...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListOtaPackageInfoRequest_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListOtaPackageInfoRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ListOtaPackageInfoRequest
    : public ModelBase
{
public:
    ListOtaPackageInfoRequest();
    virtual ~ListOtaPackageInfoRequest();
    ...
    /////////////////////////////////////////////
    /// ListOtaPackageInfoRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListOtaPackageInfoRequest& dereference_from_shared_ptr(std::shared_ptr<ListOtaPackageInfoRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ListOtaPackageInfoRequest_H_
