...
#ifndef HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListStrategyRequest_H_
#define HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListStrategyRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CODEARTSPIPELINE_V2_EXPORT  ListStrategyRequest
    : public ModelBase
{
public:
    ListStrategyRequest();
    virtual ~ListStrategyRequest();
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListStrategyRequest& dereference_from_shared_ptr(std::shared_ptr<ListStrategyRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CODEARTSPIPELINE_V2_MODEL_ListStrategyRequest_H_
