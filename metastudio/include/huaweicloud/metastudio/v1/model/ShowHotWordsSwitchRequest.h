...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowHotWordsSwitchRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowHotWordsSwitchRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowHotWordsSwitchRequest
    : public ModelBase
{
public:
    ShowHotWordsSwitchRequest();
    virtual ~ShowHotWordsSwitchRequest();
    ...
    /////////////////////////////////////////////
    /// ShowHotWordsSwitchRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowHotWordsSwitchRequest& dereference_from_shared_ptr(std::shared_ptr<ShowHotWordsSwitchRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowHotWordsSwitchRequest_H_
