...
#ifndef HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_ListAlertTemplatesResponse_H_
#define HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_ListAlertTemplatesResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_CLOUDTEST_V1_EXPORT  ListAlertTemplatesResponse
    : public ModelBase, public HttpResponse
{
public:
    ListAlertTemplatesResponse();
    virtual ~ListAlertTemplatesResponse();
    ...
    /////////////////////////////////////////////
    /// ListAlertTemplatesResponse members
    ...
    std::vector<AlertTemplateVo>& getList();
    bool listIsSet() const;
    void unsetlist();
    void setList(const std::vector<AlertTemplateVo>& value);
...
protected:
    ...
    std::vector<AlertTemplateVo> list_;
    bool listIsSet_;
...
#endif // HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_ListAlertTemplatesResponse_H_
