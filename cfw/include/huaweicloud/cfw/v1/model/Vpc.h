...
#ifndef HUAWEICLOUD_SDK_CFW_V1_MODEL_Vpc_H_
#define HUAWEICLOUD_SDK_CFW_V1_MODEL_Vpc_H_
...
/// 
/// </summary>
class HUAWEICLOUD_CFW_V1_EXPORT  Vpc
    : public ModelBase
{
public:
    Vpc();
...
#endif // HUAWEICLOUD_SDK_CFW_V1_MODEL_Vpc_H_
