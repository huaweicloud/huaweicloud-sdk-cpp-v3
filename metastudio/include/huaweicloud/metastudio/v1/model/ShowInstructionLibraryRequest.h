...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowInstructionLibraryRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowInstructionLibraryRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  ShowInstructionLibraryRequest
    : public ModelBase
{
public:
    ShowInstructionLibraryRequest();
    virtual ~ShowInstructionLibraryRequest();
    ...
    /////////////////////////////////////////////
    /// ShowInstructionLibraryRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowInstructionLibraryRequest& dereference_from_shared_ptr(std::shared_ptr<ShowInstructionLibraryRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_ShowInstructionLibraryRequest_H_
