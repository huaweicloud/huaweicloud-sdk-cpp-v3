...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateDocumentRequest_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateDocumentRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  CreateDocumentRequest
    : public ModelBase
{
public:
    ...
    CreateDocumentRequestBody getBody() const;
    bool bodyIsSet() const;
    void unsetbody();
    void setBody(const CreateDocumentRequestBody& value);
...
protected:
    ...
    CreateDocumentRequestBody body_;
    bool bodyIsSet_;

#ifdef RTTR_FLAG
    RTTR_ENABLE()
public:
    CreateDocumentRequest& dereference_from_shared_ptr(std::shared_ptr<CreateDocumentRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_CreateDocumentRequest_H_
