...
std::string ListRootsRequest::getXSecurityToken() const
{
    return xSecurityToken_;
}

void ListRootsRequest::setXSecurityToken(const std::string& value)
{
    xSecurityToken_ = value;
    xSecurityTokenIsSet_ = true;
}

bool ListRootsRequest::xSecurityTokenIsSet() const
{
    return xSecurityTokenIsSet_;
}

void ListRootsRequest::unsetxSecurityToken()
{
    xSecurityTokenIsSet_ = false;
}
