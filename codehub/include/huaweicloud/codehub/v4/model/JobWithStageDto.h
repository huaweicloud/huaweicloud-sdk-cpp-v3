...
#ifndef HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_JobWithStageDto_H_
#define HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_JobWithStageDto_H_
...
/// 任务带阶段信息
/// </summary>
class HUAWEICLOUD_CODEHUB_V4_EXPORT  JobWithStageDto
    : public ModelBase
{
public:
    JobWithStageDto();
...
#endif // HUAWEICLOUD_SDK_CODEHUB_V4_MODEL_JobWithStageDto_H_
