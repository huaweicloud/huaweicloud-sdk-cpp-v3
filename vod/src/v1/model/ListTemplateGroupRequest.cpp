...
std::string ListTemplateGroupRequest::getAuthorization() const
{
    return authorization_;
}

void ListTemplateGroupRequest::setAuthorization(const std::string& value)
{
    authorization_ = value;
    authorizationIsSet_ = true;
}

bool ListTemplateGroupRequest::authorizationIsSet() const
{
    return authorizationIsSet_;
}

void ListTemplateGroupRequest::unsetauthorization()
{
    authorizationIsSet_ = false;
}
