...
#ifndef HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DigitalAssetInfo_H_
#define HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DigitalAssetInfo_H_
...
/// 资产信息。
/// </summary>
class HUAWEICLOUD_METASTUDIO_V1_EXPORT  DigitalAssetInfo
    : public ModelBase
{
public:
    DigitalAssetInfo();
    virtual ~DigitalAssetInfo();
...
#endif // HUAWEICLOUD_SDK_METASTUDIO_V1_MODEL_DigitalAssetInfo_H_
