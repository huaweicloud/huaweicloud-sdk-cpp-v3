...
bool CreateWorkflowResponse::isEnableStreamResponse() const
{
    return enableStreamResponse_;
}

void CreateWorkflowResponse::setEnableStreamResponse(bool value)
{
    enableStreamResponse_ = value;
    enableStreamResponseIsSet_ = true;
}

bool CreateWorkflowResponse::enableStreamResponseIsSet() const
{
    return enableStreamResponseIsSet_;
}

void CreateWorkflowResponse::unsetenableStreamResponse()
{
    enableStreamResponseIsSet_ = false;
}

std::string CreateWorkflowResponse::getId() const
{
    return id_;
}

void CreateWorkflowResponse::setId(const std::string& value)
{
    id_ = value;
    idIsSet_ = true;
}

bool CreateWorkflowResponse::idIsSet() const
{
    return idIsSet_;
}

void CreateWorkflowResponse::unsetid()
{
    idIsSet_ = false;
}

std::string CreateWorkflowResponse::getWorkflowUrn() const
{
    return workflowUrn_;
}

void CreateWorkflowResponse::setWorkflowUrn(const std::string& value)
{
    workflowUrn_ = value;
    workflowUrnIsSet_ = true;
}

bool CreateWorkflowResponse::workflowUrnIsSet() const
{
    return workflowUrnIsSet_;
}

void CreateWorkflowResponse::unsetworkflowUrn()
{
    workflowUrnIsSet_ = false;
}
...
std::string CreateWorkflowResponse::getCreatedTime() const
{
    return createdTime_;
}

void CreateWorkflowResponse::setCreatedTime(const std::string& value)
{
    createdTime_ = value;
    createdTimeIsSet_ = true;
}

bool CreateWorkflowResponse::createdTimeIsSet() const
{
    return createdTimeIsSet_;
}

void CreateWorkflowResponse::unsetcreatedTime()
{
    createdTimeIsSet_ = false;
}

std::string CreateWorkflowResponse::getUpdatedTime() const
{
    return updatedTime_;
}

void CreateWorkflowResponse::setUpdatedTime(const std::string& value)
{
    updatedTime_ = value;
    updatedTimeIsSet_ = true;
}

bool CreateWorkflowResponse::updatedTimeIsSet() const
{
    return updatedTimeIsSet_;
}

void CreateWorkflowResponse::unsetupdatedTime()
{
    updatedTimeIsSet_ = false;
}

std::string CreateWorkflowResponse::getCreatedBy() const
{
    return createdBy_;
}

void CreateWorkflowResponse::setCreatedBy(const std::string& value)
{
    createdBy_ = value;
    createdByIsSet_ = true;
}

bool CreateWorkflowResponse::createdByIsSet() const
{
    return createdByIsSet_;
}

void CreateWorkflowResponse::unsetcreatedBy()
{
    createdByIsSet_ = false;
}
