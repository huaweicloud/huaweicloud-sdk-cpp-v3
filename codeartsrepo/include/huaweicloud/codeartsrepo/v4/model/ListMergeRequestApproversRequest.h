...
#ifndef HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ListMergeRequestApproversRequest_H_
#define HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ListMergeRequestApproversRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_CODEARTSREPO_V4_EXPORT  ListMergeRequestApproversRequest
    : public ModelBase
{
public:
    ListMergeRequestApproversRequest();
    virtual ~ListMergeRequestApproversRequest();
    ...
    /////////////////////////////////////////////
    /// ListMergeRequestApproversRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListMergeRequestApproversRequest& dereference_from_shared_ptr(std::shared_ptr<ListMergeRequestApproversRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_CODEARTSREPO_V4_MODEL_ListMergeRequestApproversRequest_H_
